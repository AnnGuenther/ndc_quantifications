...
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 40.9903 * (1 - 0.9900586236255896) = 0.4074999999999943 MtCO2eq
...
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 3.442409661505222 * 0.51 * 28.399856418615766 + 0.4074999999999943 = 50.26710946161003 MtCO2eq
- tar_emi_inclLU
  - bl_onlyLU_refyr < 0., so add emi_bl_onlyLU_refyr as is.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * emi_cov_exclLU_refyr + bl_onlyLU_refyr + emi_notcov_exclLU_taryr = 3.442409661505222 * nan * 28.399856418615766 + -25.4958182 + 0.4074999999999943 = nan MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = 50.26710946161003 MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = nan MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_inclLU is nan. So calculate tar_emi_inclLU = np.nansum([tar_emi_exclLU, bl_onlyLU_taryr]) = np.nansum([50.26710946161003, 46.444490037586554]) = 96.71159949919658 MtCO2eq
- tar_emi_exclLU = 50.26710946161003 MtCO2eq
- tar_emi_inclLU = 96.71159949919658 MtCO2eq
...
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 40.9903 * (1 - 0.9900586236255896) = 0.4074999999999943 MtCO2eq
- intensity_growth = ict[ict['int_ref'] + '\_taryr'] / ict[ict['int_ref'] + '\_refyr'] = 94985125609.7469 2011GKD / 27592626953.125 2011GKD = 3.442409661505222
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 3.442409661505222 * 0.48 * 28.399856418615766 + 0.4074999999999943 = 47.334191257985914 MtCO2eq
- tar_emi_inclLU
  - bl_onlyLU_refyr < 0., so add emi_bl_onlyLU_refyr as is.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * emi_cov_exclLU_refyr + bl_onlyLU_refyr + emi_notcov_exclLU_taryr = 3.442409661505222 * nan * 28.399856418615766 + -25.4958182 + 0.4074999999999943 = nan MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = 47.334191257985914 MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = nan MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_inclLU is nan. So calculate tar_emi_inclLU = np.nansum([tar_emi_exclLU, bl_onlyLU_taryr]) = np.nansum([47.334191257985914, 46.444490037586554]) = 93.77868129557247 MtCO2eq
- tar_emi_exclLU = 47.334191257985914 MtCO2eq
- tar_emi_inclLU = 93.77868129557247 MtCO2eq
...
- LULUCF
  ...
  - Get the LULUCF data for the reference and target year (bl_onlyLU_refyr/taryr).
    ...
    - bl_onlyLU_taryr = 46.444490037586554 MtCO2eq
### tar_type_used = RBU
- emi_cov_exclLU_refyr = ict['emi_bl_exclLU_refyr'] * ict['pc_cov_exclLU_refyr'] = 40.9903 * 0.9900586236255896 = 40.582800000000006 MtCO2eq
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 40.9903 * (1 - 0.9900586236255896) = 0.4074999999999943 MtCO2eq
- intensity_growth = 1.
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 1.0 * 0.516 * 40.582800000000006 + 0.4074999999999943 = 21.3482248 MtCO2eq
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.44200000000000006 * (40.582800000000006 + 46.444490037586554) + 0.4074999999999943 = 38.87356219661326 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = 21.3482248 MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = 38.87356219661326 MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU = 21.3482248 MtCO2eq
- tar_emi_inclLU = 38.87356219661326 MtCO2eq
...
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 40.9903 * (1 - 0.9900586236255896) = 0.4074999999999943 MtCO2eq
- intensity_growth = 1.
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 1.0 * 0.481 * 40.582800000000006 + 0.4074999999999943 = 19.9278268 MtCO2eq
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.40700000000000003 * (40.582800000000006 + 46.444490037586554) + 0.4074999999999943 = 35.827607045297725 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = 19.9278268 MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = 35.827607045297725 MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU = 19.9278268 MtCO2eq
- tar_emi_inclLU = 35.827607045297725 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU = 19.9278268 MtCO2eq
- tar_emi_inclLU = 35.827607045297725 MtCO2eq    Second method also didn't work for all targets ... so the negative tar_emi_exclLU are set to 0.