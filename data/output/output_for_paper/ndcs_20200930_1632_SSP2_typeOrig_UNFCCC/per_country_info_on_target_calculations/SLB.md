...
- bl_inclLU_taryr = ndcs_emi_inclLU[taryr] = nan
  - np.isnan(bl_inclLU_taryr), so bl_inclLU_taryr = np.nansum([ict['emi_bl_exclLU_taryr'], bl_onlyLU_taryr]) = np.nansum([0.48979, 1.9284142857142856]) = 2.418204285714286
- tar_emi_inclLU = bl_inclLU_taryr + ndc_value_inclLU = 2.418204285714286 + -0.0083 = 2.4099042857142856
- tar_emi_exclLU = ndc_value_exclLU = nan
- tar_emi_inclLU = ndc_value_inclLU = 2.4099042857142856
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([2.4099042857142856, - 1.9284142857142856]) = 0.48149.
- tar_emi_exclLU = 0.48149
- tar_emi_inclLU = 2.4099042857142856
...
- bl_inclLU_taryr = ndcs_emi_inclLU[taryr] = nan
  - np.isnan(bl_inclLU_taryr), so bl_inclLU_taryr = np.nansum([ict['emi_bl_exclLU_taryr'], bl_onlyLU_taryr]) = np.nansum([0.48979, 1.9284142857142856]) = 2.418204285714286
- tar_emi_inclLU = bl_inclLU_taryr + ndc_value_inclLU = 2.418204285714286 + -0.0188 = 2.3994042857142857
- tar_emi_exclLU = ndc_value_exclLU = nan
- tar_emi_inclLU = ndc_value_inclLU = 2.3994042857142857
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([2.3994042857142857, - 1.9284142857142856]) = 0.47099.
- tar_emi_exclLU = 0.47099
- tar_emi_inclLU = 2.3994042857142857
...
- LULUCF
  ...
  - Get the LULUCF data for the reference and target year (bl_onlyLU_refyr/taryr).
    ...
    - bl_onlyLU_taryr = 1.9284142857142856
### tar_type_used = RBU
- emi_cov_exclLU_refyr = ict['emi_bl_exclLU_refyr'] * ict['pc_cov_exclLU_refyr'] = 0.48979 * 0.538169173 = 0.26358987924367
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 0.48979 * (1 - 0.538169173) = 0.22620012075633
- intensity_growth = 1.
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 1.0 * nan * 0.26358987924367 + 0.22620012075633 = nan
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.88 * (0.26358987924367 + 1.9284142857142856) + 0.22620012075633 = 2.155163785919331
- tar_emi_exclLU = ndc_value_exclLU = nan
...
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.73 * (0.26358987924367 + 1.9284142857142856) + 0.22620012075633 = 1.8263631611756375
- tar_emi_exclLU = ndc_value_exclLU = nan
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_inclLU_taryr)):
    ...
    - bl_inclLU_taryr = np.nansum([ict['emi_bl_exclLU_taryr'], bl_onlyLU_taryr]) = np.nansum([0.48979, 1.9284142857142856]) = 2.418204285714286
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    ...
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 0.48979
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 2.4099042857142856 - 2.418204285714286 = -0.008300000000000196
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -0.008300000000000196 * 0.48979/2.418204285714286 = -0.0016811056964938372
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 0.48979 + -0.0016811056964938372 = 0.4881088943035062
- tar_emi_exclLU = 0.4881088943035062
- tar_emi_inclLU = 2.4099042857142856
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    - calculating tar_exclLU from tar_inclLU: the bl_exclLU_taryr is the external_bl_exclLU_taryr.
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 0.48979
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 2.3994042857142857 - 2.418204285714286 = -0.01880000000000015
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -0.01880000000000015 * 0.48979/2.418204285714286 = -0.0038078056739859812
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 0.48979 + -0.0038078056739859812 = 0.485982194326014
- tar_emi_exclLU = 0.485982194326014
- tar_emi_inclLU = 2.3994042857142857
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    - calculating tar_exclLU from tar_inclLU: the bl_exclLU_taryr is the external_bl_exclLU_taryr.
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 0.48979
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 2.155163785919331 - 2.418204285714286 = -0.2630404997949549
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -0.2630404997949549 * 0.48979/2.418204285714286 = -0.053276973808900514
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 0.48979 + -0.053276973808900514 = 0.4365130261910995
- tar_emi_exclLU = 0.4365130261910995
- tar_emi_inclLU = 2.155163785919331
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    - calculating tar_exclLU from tar_inclLU: the bl_exclLU_taryr is the external_bl_exclLU_taryr.
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 0.48979
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 1.8263631611756375 - 2.418204285714286 = -0.5918411245386483
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -0.5918411245386483 * 0.48979/2.418204285714286 = -0.1198731910700261
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 0.48979 + -0.1198731910700261 = 0.3699168089299739
