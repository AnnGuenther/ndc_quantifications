...
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([36.02015200042847, - -8.686782928571429]) = 44.7069349289999.
- tar_emi_exclLU = 44.7069349289999
...
- tar_emi_inclLU
  ...
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * emi_cov_exclLU_refyr + bl_onlyLU_refyr + emi_notcov_exclLU_taryr = 1.2915787210907426 * 0.75 * 27.491 + -8.7073846 + 0.0 = 17.9227083661292
- tar_emi_exclLU = ndc_value_exclLU = nan
- tar_emi_inclLU = ndc_value_inclLU = 17.9227083661292
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([17.9227083661292, - -8.686782928571429]) = 26.60949129470063.
- tar_emi_exclLU = 26.60949129470063
- tar_emi_inclLU = 17.9227083661292