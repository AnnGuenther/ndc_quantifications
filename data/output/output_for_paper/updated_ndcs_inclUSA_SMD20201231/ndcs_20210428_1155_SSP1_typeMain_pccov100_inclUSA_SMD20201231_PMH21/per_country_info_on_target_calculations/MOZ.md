...
- tar_emi_inclLU = bl_inclLU_taryr + ndc_value_inclLU = 89.87300571428571 + -9.2 = 80.67300571428571 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = nan MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = 80.67300571428571 MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([80.67300571428571, - 38.377205714285715]) = 42.29579999999999 MtCO2eq.
- tar_emi_exclLU = 42.29579999999999 MtCO2eq
- tar_emi_inclLU = 80.67300571428571 MtCO2eq
...
- tar_emi_inclLU = bl_inclLU_taryr + ndc_value_inclLU = 100.31420571428572 + -12.2 = 88.11420571428572 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = nan MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = 88.11420571428572 MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([88.11420571428572, - 38.377205714285715]) = 49.737 MtCO2eq.
- tar_emi_exclLU = 49.737 MtCO2eq
- tar_emi_inclLU = 88.11420571428572 MtCO2eq