...
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([16.182557720914886, - -0.53857]) = 16.721127720914886 MtCO2eq.
- tar_emi_exclLU = 16.721127720914886 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([15.869935252147611, - -0.53857]) = 16.408505252147613 MtCO2eq.
- tar_emi_exclLU = 16.408505252147613 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([5.3996144872430785, - -0.53857]) = 5.9381844872430785 MtCO2eq.
- tar_emi_exclLU = 5.9381844872430785 MtCO2eq
