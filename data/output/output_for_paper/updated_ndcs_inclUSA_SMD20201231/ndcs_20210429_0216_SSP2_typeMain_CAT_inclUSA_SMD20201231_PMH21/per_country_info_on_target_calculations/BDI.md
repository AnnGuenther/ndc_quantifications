...
- LULUCF
  ...
  - Get the LULUCF data for the reference and target year (bl_onlyLU_refyr/taryr).
    ...
    - bl_onlyLU_taryr = 72.86029804193566 MtCO2eq
### tar_type_used = RBU
- emi_cov_exclLU_refyr = ict['emi_bl_exclLU_refyr'] * ict['pc_cov_exclLU_refyr'] = 9.3641 * 0.7664934466487086 = 7.1775212837631726 MtCO2eq
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 9.3641 * (1 - 0.7664934466487086) = 2.1865787162368284 MtCO2eq
- intensity_growth = 1.
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 1.0 * nan * 7.1775212837631726 + 2.1865787162368284 = nan MtCO2eq
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.97 * (7.1775212837631726 + 72.86029804193566) + 2.1865787162368284 = 79.82326346216469 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = nan MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = 79.82326346216469 MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([79.82326346216469, - 72.86029804193566]) = 6.962965420229025 MtCO2eq.
- tar_emi_exclLU = 6.962965420229025 MtCO2eq
- tar_emi_inclLU = 79.82326346216469 MtCO2eq
...
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.8 * (7.1775212837631726 + 72.86029804193566) + 2.1865787162368284 = 66.2168341767959 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = nan MtCO2eq
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    - calculating tar_exclLU from tar_inclLU: the bl_exclLU_taryr is the external_bl_exclLU_taryr.
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 9.3641 MtCO2eq
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 79.82326346216469 - 82.22439804193567 = -2.401134579770982 MtCO2eq
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -2.401134579770982 * 9.3641/82.22439804193567 = -0.2734524648871986 MtCO2eq
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 9.3641 + -0.2734524648871986 = 9.090647535112803 MtCO2eq
- tar_emi_exclLU = 9.090647535112803 MtCO2eq
- tar_emi_inclLU = 79.82326346216469 MtCO2eq
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -16.007563865139772 * 9.3641/82.22439804193567 = -1.8230164325813116 MtCO2eq
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 9.3641 + -1.8230164325813116 = 7.5410835674186885 MtCO2eq
- tar_emi_exclLU = 7.5410835674186885 MtCO2eq
- tar_emi_inclLU = 66.2168341767959 MtCO2eq