...
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([12.8, - -0.8411542857142856]) = 13.641154285714286 MtCO2eq.
- tar_emi_exclLU = 13.641154285714286 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([5.2, - -0.8411542857142856]) = 6.041154285714286 MtCO2eq.
- tar_emi_exclLU = 6.041154285714286 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([12.043670000000002, - -0.8411542857142856]) = 12.884824285714288 MtCO2eq.
- tar_emi_exclLU = 12.884824285714288 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([3.900668, - -0.8411542857142856]) = 4.741822285714286 MtCO2eq.
- tar_emi_exclLU = 4.741822285714286 MtCO2eq
