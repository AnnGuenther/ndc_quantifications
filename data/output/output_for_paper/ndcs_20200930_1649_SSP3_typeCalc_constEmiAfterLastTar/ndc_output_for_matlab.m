...
data_act.path = 'C:\Users\annikag\primap\ndc_quantifications\data\output\ndc_quantifications_20200930_1649_SSP3_typeCalc_constEmiAfterLastTar\KYOTOGHGAR4_CATM0EL_TOTAL_NET_BAU_NDCISIPEDIA.csv';
...
data_act.sheet_note = '';
data_act.sheet_subsource = {''};
data_act.path = 'C:\Users\annikag\primap\ndc_quantifications\data\output\ndc_quantifications_20200930_1649_SSP3_typeCalc_constEmiAfterLastTar\KYOTOGHGAR4_CATM0EL_TOTAL_NET_NDCUCW_NDCISIPEDIA.csv';
data_act.sheet_tablekind = '';
data_load = readtable(data_act.path, 'ReadRowNames', true);
data_act.colcodes_years = cellfun(@str2num, erase(data_load.Properties.VariableNames, 'Y'));
data_act.rowcodes_countries = data_load.Properties.RowNames;
...
data_act.sheet_note = '';
data_act.sheet_subsource = {''};
data_act.path = 'C:\Users\annikag\primap\ndc_quantifications\data\output\ndc_quantifications_20200930_1649_SSP3_typeCalc_constEmiAfterLastTar\KYOTOGHGAR4_CATM0EL_TOTAL_NET_NDCUCB_NDCISIPEDIA.csv';
data_act.sheet_tablekind = '';
data_load = readtable(data_act.path, 'ReadRowNames', true);
data_act.colcodes_years = cellfun(@str2num, erase(data_load.Properties.VariableNames, 'Y'));
data_act.rowcodes_countries = data_load.Properties.RowNames;
...
data_act.sheet_note = '';
data_act.sheet_subsource = {''};
data_act.path = 'C:\Users\annikag\primap\ndc_quantifications\data\output\ndc_quantifications_20200930_1649_SSP3_typeCalc_constEmiAfterLastTar\KYOTOGHGAR4_CATM0EL_TOTAL_NET_NDCCW_NDCISIPEDIA.csv';
data_act.sheet_tablekind = '';
data_load = readtable(data_act.path, 'ReadRowNames', true);
data_act.colcodes_years = cellfun(@str2num, erase(data_load.Properties.VariableNames, 'Y'));
data_act.rowcodes_countries = data_load.Properties.RowNames;
...
data_act.sheet_note = '';
data_act.sheet_subsource = {''};
data_act.path = 'C:\Users\annikag\primap\ndc_quantifications\data\output\ndc_quantifications_20200930_1649_SSP3_typeCalc_constEmiAfterLastTar\KYOTOGHGAR4_CATM0EL_TOTAL_NET_NDCCB_NDCISIPEDIA.csv';
data_act.sheet_tablekind = '';
data_load = readtable(data_act.path, 'ReadRowNames', true);
data_act.colcodes_years = cellfun(@str2num, erase(data_load.Properties.VariableNames, 'Y'));
data_act.rowcodes_countries = data_load.Properties.RowNames;
