...
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 5.6328 * (1 - 1.0) = 0.0
- intensity_growth = 1.
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_inclLU_taryr)):
    ...
    - bl_inclLU_taryr = np.nansum([ict['emi_bl_exclLU_taryr'], bl_onlyLU_taryr]) = np.nansum([5.6328, 9.397525]) = 15.030325
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    ...
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 5.6328
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 7.81434 - 15.030325 = -7.215985
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -7.215985 * 5.6328/15.030325 = -2.704279535405921
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 5.6328 + -2.704279535405921 = 2.9285204645940786
- tar_emi_exclLU = 2.9285204645940786
- tar_emi_inclLU = 7.81434