...
- tar_emi_inclLU
  ...
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * emi_cov_exclLU_refyr + bl_onlyLU_refyr + emi_notcov_exclLU_taryr = 3.4787616240964754 * nan * 28.399856418615766 + -25.4958182 + 0.42679999999999146 = nan MtCO2eq
...
- tar_emi_inclLU is nan. So calculate tar_emi_inclLU = np.nansum([tar_emi_exclLU, bl_onlyLU_taryr]) = np.nansum([47.84903870668663, 46.371290037586554]) = 94.22032874427319 MtCO2eq
- tar_emi_exclLU = 47.84903870668663 MtCO2eq
- tar_emi_inclLU = 94.22032874427319 MtCO2eq    Second method also didn't work for all targets ... so the negative tar_emi_exclLU are set to 0.