...
- tar_emi_inclLU = bl_inclLU_taryr + ndc_value_inclLU = 93.71550571428571 + -9.2 = 84.51550571428571 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = nan MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = 84.51550571428571 MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([84.51550571428571, - 38.377205714285715]) = 46.138299999999994 MtCO2eq.
- tar_emi_exclLU = 46.138299999999994 MtCO2eq
- tar_emi_inclLU = 84.51550571428571 MtCO2eq
...
- tar_emi_inclLU = bl_inclLU_taryr + ndc_value_inclLU = 104.65340571428573 + -12.2 = 92.45340571428572 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = nan MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = 92.45340571428572 MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([92.45340571428572, - 38.377205714285715]) = 54.07620000000001 MtCO2eq.
- tar_emi_exclLU = 54.07620000000001 MtCO2eq
- tar_emi_inclLU = 92.45340571428572 MtCO2eq