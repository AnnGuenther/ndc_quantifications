...
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([12.8, - -1.0822478000000002]) = 13.882247800000002 MtCO2eq.
- tar_emi_exclLU = 13.882247800000002 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([5.2, - -1.0822478000000002]) = 6.2822478 MtCO2eq.
- tar_emi_exclLU = 6.2822478 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([12.043670000000002, - -1.0822478000000002]) = 13.125917800000003 MtCO2eq.
- tar_emi_exclLU = 13.125917800000003 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([3.900668, - -1.0822478000000002]) = 4.982915800000001 MtCO2eq.
- tar_emi_exclLU = 4.982915800000001 MtCO2eq
