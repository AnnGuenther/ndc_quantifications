...
- tar_emi_inclLU = bl_inclLU_taryr + ndc_value_inclLU = 92.64390571428572 + -4.6 = 88.04390571428573 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = nan MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = 88.04390571428573 MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([88.04390571428573, - 38.377205714285715]) = 49.66670000000001 MtCO2eq.
- tar_emi_exclLU = 49.66670000000001 MtCO2eq
- tar_emi_inclLU = 88.04390571428573 MtCO2eq
...
- tar_emi_inclLU = bl_inclLU_taryr + ndc_value_inclLU = 102.84660571428572 + -8.9 = 93.94660571428571 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = nan MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = 93.94660571428571 MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([93.94660571428571, - 38.377205714285715]) = 55.569399999999995 MtCO2eq.
- tar_emi_exclLU = 55.569399999999995 MtCO2eq
- tar_emi_inclLU = 93.94660571428571 MtCO2eq