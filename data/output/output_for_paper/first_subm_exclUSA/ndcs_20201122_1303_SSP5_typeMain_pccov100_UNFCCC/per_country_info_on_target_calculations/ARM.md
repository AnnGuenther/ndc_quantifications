...
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([15.710123589447639, - -0.53857]) = 16.24869358944764 MtCO2eq.
- tar_emi_exclLU = 16.24869358944764 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([15.07176525077147, - -0.53857]) = 15.61033525077147 MtCO2eq.
- tar_emi_exclLU = 15.61033525077147 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([4.654890530975969, - -0.53857]) = 5.193460530975969 MtCO2eq.
- tar_emi_exclLU = 5.193460530975969 MtCO2eq
