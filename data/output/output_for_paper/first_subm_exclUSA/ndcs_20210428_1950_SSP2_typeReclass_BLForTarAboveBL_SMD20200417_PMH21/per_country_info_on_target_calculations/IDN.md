...
- LULUCF
  ...
  - Get the LULUCF data for the reference and target year (bl_onlyLU_refyr/taryr).
    ...
    - bl_onlyLU_taryr = 714.0 MtCO2eq
### tar_type_used = RBU
- emi_cov_exclLU_refyr = ict['emi_bl_exclLU_refyr'] * ict['pc_cov_exclLU_refyr'] = 2154.26 * 0.9884319754741394 = 2129.3394674849196 MtCO2eq
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 2154.26 * (1 - 0.9884319754741394) = 24.92053251508043 MtCO2eq
- intensity_growth = 1.
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 1.0 * 0.844 * 2129.3394674849196 + 24.92053251508043 = 1822.0830430723524 MtCO2eq
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.71 * (2129.3394674849196 + 714.0) + 24.92053251508043 = 2043.6915544293731 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = 1822.0830430723524 MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = 2043.6915544293731 MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU = 1822.0830430723524 MtCO2eq
- tar_emi_inclLU = 2043.6915544293731 MtCO2eq
...
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 2154.26 * (1 - 0.9884319754741394) = 24.92053251508043 MtCO2eq
- intensity_growth = 1.
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 1.0 * 0.8 * 2129.3394674849196 + 24.92053251508043 = 1728.392106503016 MtCO2eq
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.5900000000000001 * (2129.3394674849196 + 714.0) + 24.92053251508043 = 1702.4908183311832 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = 1728.392106503016 MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = 1702.4908183311832 MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU = 1728.392106503016 MtCO2eq
- tar_emi_inclLU = 1702.4908183311832 MtCO2eq
...
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 2154.26 * (1 - 0.9884319754741394) = 24.92053251508043 MtCO2eq
- intensity_growth = 1.
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 1.0 * 0.81 * 2129.3394674849196 + 24.92053251508043 = 1749.6855011778653 MtCO2eq
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.6175999999999999 * (2129.3394674849196 + 714.0) + 24.92053251508043 = 1780.9669876337666 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = 1749.6855011778653 MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = 1780.9669876337666 MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU = 1749.6855011778653 MtCO2eq
- tar_emi_inclLU = 1780.9669876337666 MtCO2eq