...
- LULUCF
  ...
  - Get the LULUCF data for the reference and target year (bl_onlyLU_refyr/taryr).
    ...
    - bl_onlyLU_taryr = 45.964949107006596 MtCO2eq
### tar_type_used = RBU
- emi_cov_exclLU_refyr = ict['emi_bl_exclLU_refyr'] * ict['pc_cov_exclLU_refyr'] = 78.7131 * 0.989748847396431 = 77.90620000000001 MtCO2eq
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 78.7131 * (1 - 0.989748847396431) = 0.8068999999999881 MtCO2eq
- intensity_growth = 1.
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 1.0 * 0.91 * 77.90620000000001 + 0.8068999999999881 = 71.701542 MtCO2eq
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.9 * (77.90620000000001 + 45.964949107006596) + 0.8068999999999881 = 112.29093419630593 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = 71.701542 MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = 112.29093419630593 MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU = 71.701542 MtCO2eq
- tar_emi_inclLU = 112.29093419630593 MtCO2eq
...
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 78.7131 * (1 - 0.989748847396431) = 0.8068999999999881 MtCO2eq
- intensity_growth = 1.
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 1.0 * 0.791 * 77.90620000000001 + 0.8068999999999881 = 62.430704199999994 MtCO2eq
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.74 * (77.90620000000001 + 45.964949107006596) + 0.8068999999999881 = 92.47155033918487 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = 62.430704199999994 MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = 92.47155033918487 MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU = 62.430704199999994 MtCO2eq
- tar_emi_inclLU = 92.47155033918487 MtCO2eq