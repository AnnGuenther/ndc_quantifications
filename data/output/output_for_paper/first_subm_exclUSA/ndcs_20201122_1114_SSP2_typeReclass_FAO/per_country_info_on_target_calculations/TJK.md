...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([20.041777381457223, - 0.0]) = 20.041777381457223 MtCO2eq.
- tar_emi_exclLU = 20.041777381457223 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([17.59266148368023, - 0.0]) = 17.59266148368023 MtCO2eq.
- tar_emi_exclLU = 17.59266148368023 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([16.368103534791736, - 0.0]) = 16.368103534791736 MtCO2eq.
- tar_emi_exclLU = 16.368103534791736 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([13.918987637014741, - 0.0]) = 13.918987637014741 MtCO2eq.
- tar_emi_exclLU = 13.918987637014741 MtCO2eq
