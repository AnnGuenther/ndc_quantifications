...
- LULUCF
  ...
  - Get the LULUCF data for the reference and target year (bl_onlyLU_refyr/taryr).
    - emi_onlyLU 2030: ndcs_emi_inclLU minus external_emi_exclLU used. ndcs_emi_inclLU[yr_int] - ict[f'emi_bl_exclLU_refyr'] = 443.3325074460556 - 79.8136 = 363.5189074460556 MtCO2eq
    - bl_onlyLU_refyr = 363.5189074460556 MtCO2eq
    - emi_onlyLU 2030: ndcs_emi_inclLU minus external_emi_exclLU used. ndcs_emi_inclLU[yr_int] - ict[f'emi_bl_exclLU_taryr'] = 443.3325074460556 - 79.8136 = 363.5189074460556 MtCO2eq
...
- LULUCF
  ...
  - Get the LULUCF data for the reference and target year (bl_onlyLU_refyr/taryr).
    ...
    - bl_onlyLU_taryr = 363.5189074460556 MtCO2eq
### tar_type_used = RBU
- emi_cov_exclLU_refyr = ict['emi_bl_exclLU_refyr'] * ict['pc_cov_exclLU_refyr'] = 79.8136 * 1.0 = 79.8136 MtCO2eq
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 79.8136 * (1 - 1.0) = 0.0 MtCO2eq
- intensity_growth = 1.
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 1.0 * nan * 79.8136 + 0.0 = nan MtCO2eq
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.9 * (79.8136 + 363.5189074460556) + 0.0 = 398.99925670145007 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = nan MtCO2eq
...
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.8 * (79.8136 + 363.5189074460556) + 0.0 = 354.6660059568445 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = nan MtCO2eq
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    ...
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 79.8136 MtCO2eq
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 398.57297544429036 - 443.3325074460556 = -44.75953200176525 MtCO2eq
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -44.75953200176525 * 79.8136/443.3325074460556 = -8.05810384615385 MtCO2eq
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 79.8136 + -8.05810384615385 = 71.75549615384614 MtCO2eq
- tar_emi_exclLU = 71.75549615384614 MtCO2eq
- tar_emi_inclLU = 398.57297544429036 MtCO2eq
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -83.0 * 79.8136/443.3325074460556 = -14.942574001988941 MtCO2eq
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 79.8136 + -14.942574001988941 = 64.87102599801105 MtCO2eq
- tar_emi_exclLU = 64.87102599801105 MtCO2eq
- tar_emi_inclLU = 360.3325074460556 MtCO2eq
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_inclLU_taryr)):
    ...
    - bl_inclLU_taryr = np.nansum([ict['emi_bl_exclLU_taryr'], bl_onlyLU_taryr]) = np.nansum([79.8136, 363.5189074460556]) = 443.3325074460556 MtCO2eq
  - bl_exclLU_taryr = ndcs_emi_exclLU[taryr] = nan MtCO2eq
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    - calculating tar_exclLU from tar_inclLU: the bl_exclLU_taryr is the external_bl_exclLU_taryr.
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 79.8136 MtCO2eq
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 398.99925670145007 - 443.3325074460556 = -44.33325074460555 MtCO2eq
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -44.33325074460555 * 79.8136/443.3325074460556 = -7.981359999999997 MtCO2eq
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 79.8136 + -7.981359999999997 = 71.83224 MtCO2eq
- tar_emi_exclLU = 71.83224 MtCO2eq
- tar_emi_inclLU = 398.99925670145007 MtCO2eq
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -88.6665014892111 * 79.8136/443.3325074460556 = -15.962719999999994 MtCO2eq
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 79.8136 + -15.962719999999994 = 63.850880000000004 MtCO2eq
- tar_emi_exclLU = 63.850880000000004 MtCO2eq
- tar_emi_inclLU = 354.6660059568445 MtCO2eq
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -88.45336086063128 * 79.8136/443.3325074460556 = -15.924348076923073 MtCO2eq
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 79.8136 + -15.924348076923073 = 63.88925192307692 MtCO2eq
- tar_emi_exclLU = 63.88925192307692 MtCO2eq
- tar_emi_inclLU = 354.87914658542434 MtCO2eq