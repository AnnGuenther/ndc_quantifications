...
- tar_emi_inclLU
  ...
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.3062594143683657 * nan * (46.5928 + 0.40575) + 0.0 = nan MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = 40.16910720357637 MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = nan MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_inclLU is nan. So calculate tar_emi_inclLU = np.nansum([tar_emi_exclLU, bl_onlyLU_taryr]) = np.nansum([40.16910720357637, -4.068149999999998]) = 36.10095720357637 MtCO2eq
- tar_emi_exclLU = 40.16910720357637 MtCO2eq
- tar_emi_inclLU = 36.10095720357637 MtCO2eq
...
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_inclLU is nan. So calculate tar_emi_inclLU = np.nansum([tar_emi_exclLU, bl_onlyLU_taryr]) = np.nansum([34.691501675815964, -4.068149999999998]) = 30.623351675815965 MtCO2eq
- tar_emi_exclLU = 34.691501675815964 MtCO2eq
- tar_emi_inclLU = 30.623351675815965 MtCO2eq
...
- tar_emi_inclLU
  ...
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * emi_cov_exclLU_refyr + bl_onlyLU_refyr + emi_notcov_exclLU_taryr = 1.0 * nan * 19.5328 + -4.068149999999998 + 0.0 = nan MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = 16.602880000000003 MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = nan MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_inclLU is nan. So calculate tar_emi_inclLU = np.nansum([tar_emi_exclLU, bl_onlyLU_taryr]) = np.nansum([16.602880000000003, -4.068149999999998]) = 12.534730000000003 MtCO2eq
- tar_emi_exclLU = 16.602880000000003 MtCO2eq
- tar_emi_inclLU = 12.534730000000003 MtCO2eq
...
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_inclLU is nan. So calculate tar_emi_inclLU = np.nansum([tar_emi_exclLU, bl_onlyLU_taryr]) = np.nansum([14.649600000000001, -4.068149999999998]) = 10.581450000000004 MtCO2eq
- tar_emi_exclLU = 14.649600000000001 MtCO2eq
- tar_emi_inclLU = 10.581450000000004 MtCO2eq