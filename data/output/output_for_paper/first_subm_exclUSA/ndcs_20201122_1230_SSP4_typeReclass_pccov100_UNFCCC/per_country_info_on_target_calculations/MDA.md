...
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([9.7442, - -0.91355775]) = 10.65775775 MtCO2eq.
- tar_emi_exclLU = 10.65775775 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([8.4416, - -0.91355775]) = 9.35515775 MtCO2eq.
- tar_emi_exclLU = 9.35515775 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([3.6655, - -0.91355775]) = 4.5790577500000005 MtCO2eq.
- tar_emi_exclLU = 4.5790577500000005 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([10.399403999999999, - -0.91355775]) = 11.31296175 MtCO2eq.
- tar_emi_exclLU = 11.31296175 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([9.042236999999998, - -0.91355775]) = 9.955794749999999 MtCO2eq.
- tar_emi_exclLU = 9.955794749999999 MtCO2eq
...
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([4.065958, - -0.91355775]) = 4.97951575 MtCO2eq.
- tar_emi_exclLU = 4.97951575 MtCO2eq
