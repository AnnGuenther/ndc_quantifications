...
- LULUCF
  ...
  - is_LU_covered_secinfo: True
  - Get the LULUCF data for the reference and target year (bl_onlyLU_refyr/taryr).
    - emi_onlyLU 2030: ndcs_emi_inclLU minus external_emi_exclLU used. ndcs_emi_inclLU[yr_int] - ict[f'emi_bl_exclLU_refyr'] = 82.22439804193567 - 10.3132 = 71.91119804193568
    - bl_onlyLU_refyr = 71.91119804193568
    - emi_onlyLU 2030: ndcs_emi_inclLU minus external_emi_exclLU used. ndcs_emi_inclLU[yr_int] - ict[f'emi_bl_exclLU_taryr'] = 82.22439804193567 - 10.3132 = 71.91119804193568
...
- LULUCF
  ...
  - Get the LULUCF data for the reference and target year (bl_onlyLU_refyr/taryr).
    ...
    - bl_onlyLU_taryr = 71.91119804193568
### tar_type_used = RBU
- emi_cov_exclLU_refyr = ict['emi_bl_exclLU_refyr'] * ict['pc_cov_exclLU_refyr'] = 10.3132 * 0.771044135 = 7.951932373082
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 10.3132 * (1 - 0.771044135) = 2.361267626918
- intensity_growth = 1.
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 1.0 * nan * 7.951932373082 + 2.361267626918 = nan
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.97 * (7.951932373082 + 71.91119804193568) + 2.361267626918 = 79.82850412948514
- tar_emi_exclLU = ndc_value_exclLU = nan
...
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.8 * (7.951932373082 + 71.91119804193568) + 2.361267626918 = 66.25177195893215
- tar_emi_exclLU = ndc_value_exclLU = nan
- tar_emi_inclLU = ndc_value_inclLU = 66.25177195893215
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([66.25177195893215, - 71.91119804193568]) = -5.659426083003524.
- tar_emi_exclLU = -5.659426083003524
- tar_emi_inclLU = 66.25177195893215
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    - calculating tar_exclLU from tar_inclLU: the bl_exclLU_taryr is the external_bl_exclLU_taryr.
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 10.3132
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 79.75716934322148 - 82.22439804193567 = -2.4672286987141945
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -2.4672286987141945 * 10.3132/82.22439804193567 = -0.3094583070416872
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 10.3132 + -0.3094583070416872 = 10.003741692958313
- tar_emi_exclLU = 10.003741692958313
- tar_emi_inclLU = 79.75716934322148
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -16.44487960838714 * 10.3132/82.22439804193567 = -2.0626400000000005
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 10.3132 + -2.0626400000000005 = 8.25056
- tar_emi_exclLU = 8.25056
- tar_emi_inclLU = 65.77951843354853
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -2.4672286987141803 * 10.3132/82.22439804193567 = -0.3094583070416854
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 10.3132 + -0.3094583070416854 = 10.003741692958315
- tar_emi_exclLU = 10.003741692958315
- tar_emi_inclLU = 79.75716934322149
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -16.444879608387126 * 10.3132/82.22439804193567 = -2.0626399999999987
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 10.3132 + -2.0626399999999987 = 8.250560000000002
- tar_emi_exclLU = 8.250560000000002
- tar_emi_inclLU = 65.77951843354855
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_inclLU_taryr)):
    - calculating tar_exclLU from tar_inclLU: the bl_inclLU_taryr is the sum over external_bl_exclLU_taryr and bl_onlyLU_taryr.
    - bl_inclLU_taryr = np.nansum([ict['emi_bl_exclLU_taryr'], bl_onlyLU_taryr]) = np.nansum([10.3132, 71.91119804193568]) = 82.22439804193567
  - bl_exclLU_taryr = ndcs_emi_exclLU[taryr] = nan
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    - calculating tar_exclLU from tar_inclLU: the bl_exclLU_taryr is the external_bl_exclLU_taryr.
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 10.3132
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 79.82850412948514 - 82.22439804193567 = -2.395893912450532
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -2.395893912450532 * 10.3132/82.22439804193567 = -0.30051096373223307
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 10.3132 + -0.30051096373223307 = 10.012689036267767
- tar_emi_exclLU = 10.012689036267767
- tar_emi_inclLU = 79.82850412948514
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    - calculating tar_exclLU from tar_inclLU: the bl_exclLU_taryr is the external_bl_exclLU_taryr.
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 10.3132
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 66.25177195893215 - 82.22439804193567 = -15.972626083003519
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -15.972626083003519 * 10.3132/82.22439804193567 = -2.0034064248815504
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 10.3132 + -2.0034064248815504 = 8.30979357511845
- tar_emi_exclLU = 8.30979357511845
- tar_emi_inclLU = 66.25177195893215