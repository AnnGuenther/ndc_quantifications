...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_inclLU_taryr)):
    ...
    - bl_inclLU_taryr = np.nansum([ict['emi_bl_exclLU_taryr'], bl_onlyLU_taryr]) = np.nansum([5.6634, 9.397525]) = 15.060925000000001
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    ...
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 5.6634
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 7.81434 - 15.060925000000001 = -7.246585000000001
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -7.246585000000001 * 5.6634/15.060925000000001 = -2.7249527827142095
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 5.6634 + -2.7249527827142095 = 2.9384472172857907
- tar_emi_exclLU = 2.9384472172857907
- tar_emi_inclLU = 7.81434