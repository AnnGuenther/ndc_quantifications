...
- LULUCF
  ...
  - Get the LULUCF data for the reference and target year (bl_onlyLU_refyr/taryr).
    - emi_onlyLU 2030: ndcs_emi_inclLU minus external_emi_exclLU used. ndcs_emi_inclLU[yr_int] - ict[f'emi_bl_exclLU_refyr'] = 443.3325074460556 - 75.3533 = 367.9792074460556
    - bl_onlyLU_refyr = 367.9792074460556
    - emi_onlyLU 2030: ndcs_emi_inclLU minus external_emi_exclLU used. ndcs_emi_inclLU[yr_int] - ict[f'emi_bl_exclLU_taryr'] = 443.3325074460556 - 75.3533 = 367.9792074460556
...
- LULUCF
  ...
  - Get the LULUCF data for the reference and target year (bl_onlyLU_refyr/taryr).
    ...
    - bl_onlyLU_taryr = 367.9792074460556
### tar_type_used = RBU
- emi_cov_exclLU_refyr = ict['emi_bl_exclLU_refyr'] * ict['pc_cov_exclLU_refyr'] = 75.3533 * 1.0 = 75.3533
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 75.3533 * (1 - 1.0) = 0.0
- intensity_growth = 1.
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 1.0 * nan * 75.3533 + 0.0 = nan
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.9 * (75.3533 + 367.9792074460556) + 0.0 = 398.99925670145007
- tar_emi_exclLU = ndc_value_exclLU = nan
...
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.8 * (75.3533 + 367.9792074460556) + 0.0 = 354.6660059568445
- tar_emi_exclLU = ndc_value_exclLU = nan
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    ...
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 75.3533
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 398.57297544429036 - 443.3325074460556 = -44.75953200176525
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -44.75953200176525 * 75.3533/443.3325074460556 = -7.60778509615385
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 75.3533 + -7.60778509615385 = 67.74551490384616
- tar_emi_exclLU = 67.74551490384616
- tar_emi_inclLU = 398.57297544429036
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -83.0 * 75.3533/443.3325074460556 = -14.107523799754345
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 75.3533 + -14.107523799754345 = 61.24577620024566
- tar_emi_exclLU = 61.24577620024566
- tar_emi_inclLU = 360.3325074460556
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -88.45336086063128 * 75.3533/443.3325074460556 = -15.034432451923076
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 75.3533 + -15.034432451923076 = 60.31886754807693
- tar_emi_exclLU = 60.31886754807693
- tar_emi_inclLU = 354.87914658542434
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_inclLU_taryr)):
    ...
    - bl_inclLU_taryr = np.nansum([ict['emi_bl_exclLU_taryr'], bl_onlyLU_taryr]) = np.nansum([75.3533, 367.9792074460556]) = 443.3325074460556
  - bl_exclLU_taryr = ndcs_emi_exclLU[taryr] = nan
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    - calculating tar_exclLU from tar_inclLU: the bl_exclLU_taryr is the external_bl_exclLU_taryr.
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 75.3533
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 398.99925670145007 - 443.3325074460556 = -44.33325074460555
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -44.33325074460555 * 75.3533/443.3325074460556 = -7.535329999999999
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 75.3533 + -7.535329999999999 = 67.81797
- tar_emi_exclLU = 67.81797
- tar_emi_inclLU = 398.99925670145007
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -88.6665014892111 * 75.3533/443.3325074460556 = -15.070659999999998
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 75.3533 + -15.070659999999998 = 60.28264000000001
- tar_emi_exclLU = 60.28264000000001
- tar_emi_inclLU = 354.6660059568445