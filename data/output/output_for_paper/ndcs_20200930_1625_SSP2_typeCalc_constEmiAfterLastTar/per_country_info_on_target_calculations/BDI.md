...
- LULUCF
  ...
  - is_LU_covered_secinfo: True
  - Get the LULUCF data for the reference and target year (bl_onlyLU_refyr/taryr).
    - emi_onlyLU 2030: ndcs_emi_inclLU minus external_emi_exclLU used. ndcs_emi_inclLU[yr_int] - ict[f'emi_bl_exclLU_refyr'] = 82.22439804193567 - 9.364100000000008 = 72.86029804193566
    - bl_onlyLU_refyr = 72.86029804193566
    - emi_onlyLU 2030: ndcs_emi_inclLU minus external_emi_exclLU used. ndcs_emi_inclLU[yr_int] - ict[f'emi_bl_exclLU_taryr'] = 82.22439804193567 - 9.364100000000008 = 72.86029804193566
...
- LULUCF
  ...
  - Get the LULUCF data for the reference and target year (bl_onlyLU_refyr/taryr).
    ...
    - bl_onlyLU_taryr = 72.86029804193566
### tar_type_used = RBU
- emi_cov_exclLU_refyr = ict['emi_bl_exclLU_refyr'] * ict['pc_cov_exclLU_refyr'] = 9.364100000000008 * 0.766493447 = 7.177521287052706
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 9.364100000000008 * (1 - 0.766493447) = 2.186578712947302
- intensity_growth = 1.
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 1.0 * nan * 7.177521287052706 + 2.186578712947302 = nan
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.97 * (7.177521287052706 + 72.86029804193566) + 2.186578712947302 = 79.82326346206602
- tar_emi_exclLU = ndc_value_exclLU = nan
- tar_emi_inclLU = ndc_value_inclLU = 79.82326346206602
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([79.82326346206602, - 72.86029804193566]) = 6.9629654201303595.
- tar_emi_exclLU = 6.9629654201303595
- tar_emi_inclLU = 79.82326346206602
...
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.8 * (7.177521287052706 + 72.86029804193566) + 2.186578712947302 = 66.21683417613801
- tar_emi_exclLU = ndc_value_exclLU = nan
- tar_emi_inclLU = ndc_value_inclLU = 66.21683417613801
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([66.21683417613801, - 72.86029804193566]) = -6.643463865797656.
- tar_emi_exclLU = -6.643463865797656
- tar_emi_inclLU = 66.21683417613801
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    - calculating tar_exclLU from tar_inclLU: the bl_exclLU_taryr is the external_bl_exclLU_taryr.
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 9.364100000000008
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 79.75716934322148 - 82.22439804193567 = -2.4672286987141945
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -2.4672286987141945 * 9.364100000000008/82.22439804193567 = -0.2809795730684041
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 9.364100000000008 + -0.2809795730684041 = 9.083120426931604
- tar_emi_exclLU = 9.083120426931604
- tar_emi_inclLU = 79.75716934322148
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -16.44487960838714 * 9.364100000000008/82.22439804193567 = -1.8728200000000021
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 9.364100000000008 + -1.8728200000000021 = 7.491280000000005
- tar_emi_exclLU = 7.491280000000005
- tar_emi_inclLU = 65.77951843354853
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -2.4672286987141803 * 9.364100000000008/82.22439804193567 = -0.2809795730684025
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 9.364100000000008 + -0.2809795730684025 = 9.083120426931606
- tar_emi_exclLU = 9.083120426931606
- tar_emi_inclLU = 79.75716934322149
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -16.444879608387126 * 9.364100000000008/82.22439804193567 = -1.8728200000000006
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 9.364100000000008 + -1.8728200000000006 = 7.491280000000007
- tar_emi_exclLU = 7.491280000000007
- tar_emi_inclLU = 65.77951843354855
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_inclLU_taryr)):
    - calculating tar_exclLU from tar_inclLU: the bl_inclLU_taryr is the sum over external_bl_exclLU_taryr and bl_onlyLU_taryr.
    - bl_inclLU_taryr = np.nansum([ict['emi_bl_exclLU_taryr'], bl_onlyLU_taryr]) = np.nansum([9.364100000000008, 72.86029804193566]) = 82.22439804193567
  - bl_exclLU_taryr = ndcs_emi_exclLU[taryr] = nan
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    - calculating tar_exclLU from tar_inclLU: the bl_exclLU_taryr is the external_bl_exclLU_taryr.
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 9.364100000000008
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 79.82326346206602 - 82.22439804193567 = -2.401134579869648
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -2.401134579869648 * 9.364100000000008/82.22439804193567 = -0.27345246489843533
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 9.364100000000008 + -0.27345246489843533 = 9.090647535101573
- tar_emi_exclLU = 9.090647535101573
- tar_emi_inclLU = 79.82326346206602
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    - calculating tar_exclLU from tar_inclLU: the bl_exclLU_taryr is the external_bl_exclLU_taryr.
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 9.364100000000008
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 66.21683417613801 - 82.22439804193567 = -16.007563865797664
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -16.007563865797664 * 9.364100000000008/82.22439804193567 = -1.8230164326562366
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 9.364100000000008 + -1.8230164326562366 = 7.541083567343771
- tar_emi_exclLU = 7.541083567343771
- tar_emi_inclLU = 66.21683417613801