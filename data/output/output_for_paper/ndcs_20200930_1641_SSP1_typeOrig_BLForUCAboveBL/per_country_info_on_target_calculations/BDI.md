...
- LULUCF
  ...
  - Get the LULUCF data for the reference and target year (bl_onlyLU_refyr/taryr).
    - emi_onlyLU 2025: ndcs_emi_inclLU minus external_emi_exclLU used. ndcs_emi_inclLU[yr_int] - ict[f'emi_bl_exclLU_refyr'] = 64.26716795603694 - 8.4081 = 55.859067956036945
    - bl_onlyLU_refyr = 55.859067956036945
    - emi_onlyLU 2025: ndcs_emi_inclLU minus external_emi_exclLU used. ndcs_emi_inclLU[yr_int] - ict[f'emi_bl_exclLU_taryr'] = 64.26716795603694 - 8.4081 = 55.859067956036945
...
- LULUCF
  ...
  - Get the LULUCF data for the reference and target year (bl_onlyLU_refyr/taryr).
    ...
    - bl_onlyLU_taryr = 55.859067956036945
### tar_type_used = RBU
- emi_cov_exclLU_refyr = ict['emi_bl_exclLU_refyr'] * ict['pc_cov_exclLU_refyr'] = 8.4081 * 0.7608710870000001 = 6.3974801866046995
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 8.4081 * (1 - 0.7608710870000001) = 2.0106198133952993
- intensity_growth = 1.
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 1.0 * nan * 6.3974801866046995 + 2.0106198133952993 = nan
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.98 * (6.3974801866046995 + 55.859067956036945) + 2.0106198133952993 = 63.022036993184116
- tar_emi_exclLU = ndc_value_exclLU = nan
- tar_emi_inclLU = ndc_value_inclLU = 63.022036993184116
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([63.022036993184116, - 55.859067956036945]) = 7.162969037147171.
- tar_emi_exclLU = 7.162969037147171
- tar_emi_inclLU = 63.022036993184116
...
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.83 * (6.3974801866046995 + 55.859067956036945) + 2.0106198133952993 = 53.68355477178787
- tar_emi_exclLU = ndc_value_exclLU = nan
- tar_emi_inclLU = ndc_value_inclLU = 53.68355477178787
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU is nan. So calculate it.
- lulucf_first_try, so tar_emi_exclLU = np.nansum([tar_emi_inclLU, -bl_onlyLU_taryr]) = np.nansum([53.68355477178787, - 55.859067956036945]) = -2.175513184249077.
- tar_emi_exclLU = -2.175513184249077
- tar_emi_inclLU = 53.68355477178787
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    ...
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 8.4081
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 62.982222002881095 - 64.26716795603694 = -1.284945953155848
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -1.284945953155848 * 8.4081/64.26716795603694 = -0.16811000721426397
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 8.4081 + -0.16811000721426397 = 8.239989992785736
- tar_emi_exclLU = 8.239989992785736
- tar_emi_inclLU = 62.982222002881095
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -10.925352318198797 * 8.4081/64.26716795603694 = -1.4293683345357104
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 8.4081 + -1.4293683345357104 = 6.978731665464289
- tar_emi_exclLU = 6.978731665464289
- tar_emi_inclLU = 53.341815637838145
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -10.925352318198804 * 8.4081/64.26716795603694 = -1.4293683345357113
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 8.4081 + -1.4293683345357113 = 6.978731665464288
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_inclLU_taryr)):
    ...
    - bl_inclLU_taryr = np.nansum([ict['emi_bl_exclLU_taryr'], bl_onlyLU_taryr]) = np.nansum([8.4081, 55.859067956036945]) = 64.26716795603694
  - bl_exclLU_taryr = ndcs_emi_exclLU[taryr] = nan
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    - calculating tar_exclLU from tar_inclLU: the bl_exclLU_taryr is the external_bl_exclLU_taryr.
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 8.4081
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 63.022036993184116 - 64.26716795603694 = -1.2451309628528264
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -1.2451309628528264 * 8.4081/64.26716795603694 = -0.16290099566740635
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 8.4081 + -0.16290099566740635 = 8.245199004332592
- tar_emi_exclLU = 8.245199004332592
- tar_emi_inclLU = 63.022036993184116
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    - calculating tar_exclLU from tar_inclLU: the bl_exclLU_taryr is the external_bl_exclLU_taryr.
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 8.4081
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 53.68355477178787 - 64.26716795603694 = -10.583613184249074
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -10.583613184249074 * 8.4081/64.26716795603694 = -1.3846584631729602
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 8.4081 + -1.3846584631729602 = 7.023441536827039
- tar_emi_exclLU = 7.023441536827039
- tar_emi_inclLU = 53.68355477178787
