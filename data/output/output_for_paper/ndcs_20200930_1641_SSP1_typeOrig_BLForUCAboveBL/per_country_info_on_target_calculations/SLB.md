...
- bl_inclLU_taryr = ndcs_emi_inclLU[taryr] = nan
  - np.isnan(bl_inclLU_taryr), so bl_inclLU_taryr = np.nansum([ict['emi_bl_exclLU_taryr'], bl_onlyLU_taryr]) = np.nansum([0.46656, 1.9284142857142856]) = 2.3949742857142855
...
- LULUCF
  ...
  - Get the LULUCF data for the reference and target year (bl_onlyLU_refyr/taryr).
    ...
    - bl_onlyLU_taryr = 1.9284142857142856
### tar_type_used = RBU
- emi_cov_exclLU_refyr = ict['emi_bl_exclLU_refyr'] * ict['pc_cov_exclLU_refyr'] = 0.46656 * 0.532735721 = 0.24855317798975998
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 0.46656 * (1 - 0.532735721) = 0.21800682201024
- intensity_growth = 1.
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 1.0 * nan * 0.24855317798975998 + 0.21800682201024 = nan
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.88 * (0.24855317798975998 + 1.9284142857142856) + 0.21800682201024 = 2.1337381900698
- tar_emi_exclLU = ndc_value_exclLU = nan
...
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.73 * (0.24855317798975998 + 1.9284142857142856) + 0.21800682201024 = 1.8071930705141934
- tar_emi_exclLU = ndc_value_exclLU = nan
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_inclLU_taryr)):
    ...
    - bl_inclLU_taryr = np.nansum([ict['emi_bl_exclLU_taryr'], bl_onlyLU_taryr]) = np.nansum([0.46656, 1.9284142857142856]) = 2.3949742857142855
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    ...
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 0.46656
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 2.3866742857142853 - 2.3949742857142855 = -0.008300000000000196
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -0.008300000000000196 * 0.46656/2.3949742857142855 = -0.0016169058779038868
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 0.46656 + -0.0016169058779038868 = 0.4649430941220961
- tar_emi_exclLU = 0.4649430941220961
- tar_emi_inclLU = 2.3866742857142853
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -0.01880000000000015 * 0.46656/2.3949742857142855 = -0.003662389217420795
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 0.46656 + -0.003662389217420795 = 0.4628976107825792
- tar_emi_exclLU = 0.4628976107825792
- tar_emi_inclLU = 2.3761742857142854
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -0.26123609564448547 * 0.46656/2.3949742857142855 = -0.05089086488773742
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 0.46656 + -0.05089086488773742 = 0.41566913511226256
- tar_emi_exclLU = 0.41566913511226256
- tar_emi_inclLU = 2.1337381900698
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -0.5877812152000921 * 0.46656/2.3949742857142855 = -0.11450444599740914
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 0.46656 + -0.11450444599740914 = 0.3520555540025908
- tar_emi_exclLU = 0.3520555540025908
- tar_emi_inclLU = 1.8071930705141934
