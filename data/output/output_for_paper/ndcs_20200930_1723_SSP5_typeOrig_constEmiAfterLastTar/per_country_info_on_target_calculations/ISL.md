...
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 6.0305 * (1 - 1.0) = 0.0
- intensity_growth = 1.
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_inclLU_taryr)):
    ...
    - bl_inclLU_taryr = np.nansum([ict['emi_bl_exclLU_taryr'], bl_onlyLU_taryr]) = np.nansum([6.0305, 9.397525]) = 15.428025
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    ...
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 6.0305
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 7.81434 - 15.428025 = -7.613685
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -7.613685 * 6.0305/15.428025 = -2.9760340284968425
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 6.0305 + -2.9760340284968425 = 3.0544659715031575
- tar_emi_exclLU = 3.0544659715031575
- tar_emi_inclLU = 7.81434