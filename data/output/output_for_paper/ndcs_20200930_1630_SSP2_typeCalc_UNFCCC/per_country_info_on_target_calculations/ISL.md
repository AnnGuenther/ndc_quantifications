...
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 5.0638 * (1 - 1.0) = 0.0
- intensity_growth = 1.
...
- It is lulucf second try. Get the ABU_inclLU and split it into the onlyLU and exclLU parts (depending on the onlyLU and exclLU contributions in the target year).
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_inclLU_taryr)):
    ...
    - bl_inclLU_taryr = np.nansum([ict['emi_bl_exclLU_taryr'], bl_onlyLU_taryr]) = np.nansum([5.0638, 9.397525]) = 14.461324999999999
  ...
  - (tar_type_used in ['RBY', 'RBU', 'REI'] or np.isnan(bl_exclLU_taryr)):
    ...
    - bl_exclLU_taryr = ict['emi_bl_exclLU_taryr'] = 5.0638
  - ABU_inclLU = tar_emi_inclLU - bl_inclLU_taryr = 7.81434 - 14.461324999999999 = -6.646984999999999
  - ABU_exclLU = ABU_inclLU * bl_exclLU_taryr/bl_inclLU_taryr = -6.646984999999999 * 5.0638/14.461324999999999 = -2.327518580973735
  - tar_emi_exclLU = bl_exclLU_taryr + ABU_exclLU = 5.0638 + -2.327518580973735 = 2.7362814190262648
- tar_emi_exclLU = 2.7362814190262648
- tar_emi_inclLU = 7.81434