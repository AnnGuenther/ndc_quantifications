...
- LULUCF
  ...
  - Get the LULUCF data for the reference and target year (bl_onlyLU_refyr/taryr).
    ...
    - bl_onlyLU_taryr = 45.964949107006596 MtCO2eq
### tar_type_used = RBU
- emi_cov_exclLU_refyr = ict['emi_bl_exclLU_refyr'] * ict['pc_cov_exclLU_refyr'] = 77.2998 * 0.9906067027340304 = 76.5737 MtCO2eq
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 77.2998 * (1 - 0.9906067027340304) = 0.7260999999999971 MtCO2eq
- intensity_growth = 1.
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 1.0 * 0.91 * 76.5737 + 0.7260999999999971 = 70.408167 MtCO2eq
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.9 * (76.5737 + 45.964949107006596) + 0.7260999999999971 = 111.01088419630594 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = 70.408167 MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = 111.01088419630594 MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU = 70.408167 MtCO2eq
- tar_emi_inclLU = 111.01088419630594 MtCO2eq
...
- emi_notcov_exclLU_taryr = ict['emi_bl_exclLU_taryr'] * (1 - ict['pc_cov_exclLU_taryr']) = 77.2998 * (1 - 0.9906067027340304) = 0.7260999999999971 MtCO2eq
- intensity_growth = 1.
- tar_emi_exclLU = intensity_growth * ndc_level_exclLU * emi_cov_exclLU_refyr + emi_notcov_exclLU_taryr = 1.0 * 0.791 * 76.5737 + 0.7260999999999971 = 61.2958967 MtCO2eq
- tar_emi_inclLU
  - bl_onlyLU_refyr >= 0., so apply the reduction to the emi_bl_onlyLU_refyr part as well.
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * 0.74 * (76.5737 + 45.964949107006596) + 0.7260999999999971 = 91.40470033918488 MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = 61.2958967 MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = 91.40470033918488 MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_exclLU = 61.2958967 MtCO2eq
- tar_emi_inclLU = 91.40470033918488 MtCO2eq