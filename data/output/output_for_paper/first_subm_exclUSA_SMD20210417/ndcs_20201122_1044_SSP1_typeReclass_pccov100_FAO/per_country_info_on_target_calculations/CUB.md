...
- tar_emi_inclLU is nan. So calculate tar_emi_inclLU = np.nansum([tar_emi_exclLU, bl_onlyLU_taryr]) = np.nansum([45.4774, -6.471992000000001]) = 39.005408 MtCO2eq
- tar_emi_exclLU = 45.4774 MtCO2eq
- tar_emi_inclLU = 39.005408 MtCO2eq