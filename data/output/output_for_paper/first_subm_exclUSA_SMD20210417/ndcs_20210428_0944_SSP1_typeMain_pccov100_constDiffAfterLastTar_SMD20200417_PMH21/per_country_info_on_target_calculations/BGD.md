...
- tar_emi_inclLU
  ...
  - tar_emi_inclLU = intensity_growth * ndc_level_inclLU * (emi_cov_exclLU_refyr + bl_onlyLU_refyr) + emi_notcov_exclLU_taryr = 1.0 * nan * (202.8198 + 18.2055) + 0.0 = nan MtCO2eq
- tar_emi_exclLU = ndc_value_exclLU = 192.67880999999997 MtCO2eq
- tar_emi_inclLU = ndc_value_inclLU = nan MtCO2eq
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_inclLU is nan. So calculate tar_emi_inclLU = np.nansum([tar_emi_exclLU, bl_onlyLU_taryr]) = np.nansum([192.67880999999997, 18.2055]) = 210.88430999999997 MtCO2eq
- tar_emi_exclLU = 192.67880999999997 MtCO2eq
- tar_emi_inclLU = 210.88430999999997 MtCO2eq
...
### Function calc_targets_inclLU_exclLU()
If not both, inclLU and exclLU information are given calculate the 'other case' from the given case.
- tar_emi_inclLU is nan. So calculate tar_emi_inclLU = np.nansum([tar_emi_exclLU, bl_onlyLU_taryr]) = np.nansum([172.39683, 18.2055]) = 190.60233 MtCO2eq
- tar_emi_exclLU = 172.39683 MtCO2eq
- tar_emi_inclLU = 190.60233 MtCO2eq
