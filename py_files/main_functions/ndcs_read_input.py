...
# %%
"""
**Read input for NDCmitiQ main_ndc_quantifications.py from input_all_runs.csv**
...
PREPROCESSING:
If you want to do the preprocessing of data, run preprocessing_general.py and preprocessing_current_pc_cov.py, and update the 'folder_preprocess' in setup_metadata.py.
Else, the folder_preprocess stored in setup_metadata.py will be used.
"""
