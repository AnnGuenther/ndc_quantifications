...
def plotting_together_types_onePlot_diff():
    ...
    for tpe, tpe_data, add_x0, tpe_const, tpe_blUncondi, tpe_unfccc, tpe_fao in \
        ...
        for ssp, add_x in zip(meta.ssps.scens.short, 
            ...
            axa.plot([2033 + add_xx, 2033 + add_xx], [data_upper['2030'], data_lower['2030']],
            ...
            axa.plot([2036 + add_xx, 2036 + add_xx], [data_upper2030, data_lower2030], color=colour_act, linewidth=linewdth_all)
            ...
            axa.plot([2039 + add_xx, 2039 + add_xx], [data_upper2030, data_lower2030], color=colour_act, linewidth=linewdth_all)
            ...
            axa.plot([2042 + add_xx, 2042 + add_xx], [data_upper2030, data_lower2030], color=colour_act, linewidth=linewdth_all)
            ...
            axa.plot([2045 + add_xx, 2045 + add_xx], [data_upper2030, data_lower2030], color=colour_act, linewidth=linewdth_all)
            ...
            axa.plot([2048 + add_xx, 2048 + add_xx], [data_upper2030, data_lower2030], color=colour_act, linewidth=linewdth_all)
    ...
    axa.text(2030, YL[1] + .17*np.diff(YL), 'median of SSP1 to SSP4 (upper edge):', va='center', ha='right')
    axa.text(2030, YL[1] + .07*np.diff(YL), 'median of SSP1 to SSP4 (lower edge):', va='center', ha='right')
    ...
    if numbers_diff:
        axa.text(year_x-.7, txt_y2, f"{median_lower.loc['calc_100pc', 'median']/1000 :.1f}", rotation=90, ha='center', va='top', fontweight='bold')
        axa.text(year_x+.7, txt_y2, f"{median_lower.loc['orig_100pc', 'median']/1000 - median_default_condi_best :+.1f}", rotation=90, ha='center', va='top')
        axa.text(year_x-.7, txt_y3, f"{median_upper.loc['calc_100pc', 'median']/1000 :.1f}", rotation=90, ha='center', va='top', fontweight='bold')
        axa.text(year_x+.7, txt_y3, f"{median_upper.loc['orig_100pc', 'median']/1000 - median_default_uncondi_worst :+.1f}", rotation=90, ha='center', va='top')
    else:
        axa.text(year_x-.7, txt_y2, f"{median_lower.loc['calc_100pc', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x+.7, txt_y2, f"{median_lower.loc['orig_100pc', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x-.7, txt_y3, f"{median_upper.loc['calc_100pc', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x+.7, txt_y3, f"{median_upper.loc['orig_100pc', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
    ...
    if numbers_diff:
        axa.text(year_x-.7, txt_y2, f"{median_lower.loc['calc', 'median']/1000 - median_default_condi_best :+.1f}", rotation=90, ha='center', va='top')
        axa.text(year_x+.7, txt_y2, f"{median_lower.loc['orig', 'median']/1000 - median_default_condi_best :+.1f}", rotation=90, ha='center', va='top')
        axa.text(year_x-.7, txt_y3, f"{median_upper.loc['calc', 'median']/1000 - median_default_uncondi_worst :+.1f}", rotation=90, ha='center', va='top')
        axa.text(year_x+.7, txt_y3, f"{median_upper.loc['orig', 'median']/1000 - median_default_uncondi_worst :+.1f}", rotation=90, ha='center', va='top')
    else:
        axa.text(year_x-.7, txt_y2, f"{median_lower.loc['calc', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x+.7, txt_y2, f"{median_lower.loc['orig', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x-.7, txt_y3, f"{median_upper.loc['calc', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x+.7, txt_y3, f"{median_upper.loc['orig', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
    ...
    if numbers_diff:
        axa.text(year_x-.7, txt_y2, f"{median_lower.loc['calc_const', 'median']/1000 - median_default_condi_best :+.1f}", rotation=90, ha='center', va='top')
        axa.text(year_x+.7, txt_y2, f"{median_lower.loc['orig_const', 'median']/1000 - median_default_condi_best :+.1f}", rotation=90, ha='center', va='top')
        axa.text(year_x-.7, txt_y3, f"{median_upper.loc['calc_const', 'median']/1000 - median_default_uncondi_worst :+.1f}", rotation=90, ha='center', va='top')
        axa.text(year_x+.7, txt_y3, f"{median_upper.loc['orig_const', 'median']/1000 - median_default_uncondi_worst :+.1f}", rotation=90, ha='center', va='top')
    else:
        axa.text(year_x-.7, txt_y2, f"{median_lower.loc['calc_const', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x+.7, txt_y2, f"{median_lower.loc['orig_const', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x-.7, txt_y3, f"{median_upper.loc['calc_const', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x+.7, txt_y3, f"{median_upper.loc['orig_const', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
    ...
    if numbers_diff:
        axa.text(year_x-.7, txt_y2, f"{median_lower.loc['calc_blUncondi', 'median']/1000 - median_default_condi_best :+.1f}", rotation=90, ha='center', va='top')
        axa.text(year_x+.7, txt_y2, f"{median_lower.loc['orig_blUncondi', 'median']/1000 - median_default_condi_best :+.1f}", rotation=90, ha='center', va='top')
        axa.text(year_x-.7, txt_y3, f"{median_upper.loc['calc_blUncondi', 'median']/1000 - median_default_uncondi_worst :+.1f}", rotation=90, ha='center', va='top')
        axa.text(year_x+.7, txt_y3, f"{median_upper.loc['orig_blUncondi', 'median']/1000 - median_default_uncondi_worst :+.1f}", rotation=90, ha='center', va='top')
    else:
        axa.text(year_x-.7, txt_y2, f"{median_lower.loc['calc_blUncondi', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x+.7, txt_y2, f"{median_lower.loc['orig_blUncondi', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x-.7, txt_y3, f"{median_upper.loc['calc_blUncondi', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x+.7, txt_y3, f"{median_upper.loc['orig_blUncondi', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
    ...
    if numbers_diff:
        axa.text(year_x-.7, txt_y2, f"{median_lower.loc['calc_unfccc', 'median']/1000 - median_default_condi_best :+.1f}", rotation=90, ha='center', va='top')
        axa.text(year_x+.7, txt_y2, f"{median_lower.loc['orig_unfccc', 'median']/1000 - median_default_condi_best :+.1f}", rotation=90, ha='center', va='top')
        axa.text(year_x-.7, txt_y3, f"{median_upper.loc['calc_unfccc', 'median']/1000 - median_default_uncondi_worst :+.1f}", rotation=90, ha='center', va='top')
        axa.text(year_x+.7, txt_y3, f"{median_upper.loc['orig_unfccc', 'median']/1000 - median_default_uncondi_worst :+.1f}", rotation=90, ha='center', va='top')
    else:
        axa.text(year_x-.7, txt_y2, f"{median_lower.loc['calc_unfccc', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x+.7, txt_y2, f"{median_lower.loc['orig_unfccc', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x-.7, txt_y3, f"{median_upper.loc['calc_unfccc', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x+.7, txt_y3, f"{median_upper.loc['orig_unfccc', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
    ...
    if numbers_diff:
        axa.text(year_x-.7, txt_y2, f"{median_lower.loc['calc_fao', 'median']/1000 - median_default_condi_best :+.1f}", rotation=90, ha='center', va='top')
        axa.text(year_x+.7, txt_y2, f"{median_lower.loc['orig_fao', 'median']/1000 - median_default_condi_best :+.1f}", rotation=90, ha='center', va='top')
        axa.text(year_x-.7, txt_y3, f"{median_upper.loc['calc_fao', 'median']/1000 - median_default_uncondi_worst :+.1f}", rotation=90, ha='center', va='top')
        axa.text(year_x+.7, txt_y3, f"{median_upper.loc['orig_fao', 'median']/1000 - median_default_uncondi_worst :+.1f}", rotation=90, ha='center', va='top')
    else:
        axa.text(year_x-.7, txt_y2, f"{median_lower.loc['calc_fao', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x+.7, txt_y2, f"{median_lower.loc['orig_fao', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x-.7, txt_y3, f"{median_upper.loc['calc_fao', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
        axa.text(year_x+.7, txt_y3, f"{median_upper.loc['orig_fao', 'median']/1000 :.1f}", rotation=90, ha='center', va='bottom')
