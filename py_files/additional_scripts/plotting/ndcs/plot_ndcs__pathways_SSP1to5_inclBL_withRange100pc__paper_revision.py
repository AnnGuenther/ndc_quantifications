...
def plotting():
    ...
    for tpe, add_x0, \
        ...
        for ssp, add_x in zip(meta.ssps.scens.short, range(0, 45, 7)):
            ...
            # baseline if target above bl
            txt_options += ['baseline tar']
            data_upper2030 = tpe_blTar100[ssp]
            data_upper2030 = 1e-3 * data_upper2030.loc[
                (data_upper2030.group == 'EARTH') & (data_upper2030.condi.isin(['unconditional', 'conditional'])) &
                (data_upper2030.category == cat), '2030'].max()
            
            data_lower2030 = tpe_blTar100[ssp]
            data_lower2030 = 1e-3 * data_lower2030.loc[
                (data_lower2030.group == 'EARTH') & (data_lower2030.condi.isin(['unconditional', 'conditional'])) &
                (data_lower2030.category == cat), '2030'].min()
            ...
            # constant difference to baseline after last target year
            txt_options += ['constant diff']
            data_upper2030 = tpe_constDiff100[ssp]
            data_upper2030 = 1e-3 * data_upper2030.loc[
                (data_upper2030.group == 'EARTH') & (data_upper2030.condi.isin(['unconditional', 'conditional'])) &
                (data_upper2030.category == cat), '2030'].max()
            
            data_lower2030 = tpe_constDiff100[ssp]
            data_lower2030 = 1e-3 * data_lower2030.loc[
                (data_lower2030.group == 'EARTH') & (data_lower2030.condi.isin(['unconditional', 'conditional'])) &
                (data_lower2030.category == cat), '2030'].min()
            ...
            # CAT
            txt_options += ['CAT']
            data_upper2030 = tpe_cat100[ssp]
            data_upper2030 = 1e-3 * data_upper2030.loc[
                (data_upper2030.group == 'EARTH') & (data_upper2030.condi.isin(['unconditional', 'conditional'])) &
                (data_upper2030.category == cat), '2030'].max()
            
            data_lower2030 = tpe_cat100[ssp]
            data_lower2030 = 1e-3 * data_lower2030.loc[
                (data_lower2030.group == 'EARTH') & (data_lower2030.condi.isin(['unconditional', 'conditional'])) &
                (data_lower2030.category == cat), '2030'].min()
            ...
            # baseline if target above bl
            txt_options += ['baseline tar (*)']
            data_upper2030 = tpe_blTar[ssp]
            data_upper2030 = 1e-3 * data_upper2030.loc[
                (data_upper2030.group == 'EARTH') & (data_upper2030.condi.isin(['unconditional', 'conditional'])) &
                (data_upper2030.category == cat), '2030'].max()
            
            data_lower2030 = tpe_blTar[ssp]
            data_lower2030 = 1e-3 * data_lower2030.loc[
                (data_lower2030.group == 'EARTH') & (data_lower2030.condi.isin(['unconditional', 'conditional'])) &
                (data_lower2030.category == cat), '2030'].min()
            ...
            if (ssp == 'SSP5' and tpe == 'type_reclass'):
                axa.text(yr_plt + add_xx, data_act.values.max()+.1, "3", ha='center', va='bottom', fontsize=6)
            ...
            if (ssp == 'SSP5' and tpe == 'type_reclass'):
                axa.text(yr_plt + add_xx, data_act.values.min()-.2, "4", ha='center', va='top', fontsize=6)
            
            # constant emissions difference to baseline after last target year
            txt_options += ['constant diff (*)']
            data_upper2030 = tpe_constDiff[ssp]
            data_upper2030 = 1e-3 * data_upper2030.loc[
                (data_upper2030.group == 'EARTH') & (data_upper2030.condi.isin(['unconditional', 'conditional'])) &
                (data_upper2030.category == cat), '2030'].max()
            
            data_lower2030 = tpe_constDiff[ssp]
            data_lower2030 = 1e-3 * data_lower2030.loc[
                (data_lower2030.group == 'EARTH') & (data_lower2030.condi.isin(['unconditional', 'conditional'])) &
                (data_lower2030.category == cat), '2030'].min()
            ...
            if (ssp == 'SSP5' and tpe == 'type_reclass'):
                axa.text(yr_plt + add_xx, data_act.values.min()-.2, "5", ha='center', va='top', fontsize=6)
            ...
            if (ssp == 'SSP5' and tpe == 'type_reclass'):
                axa.text(yr_plt + add_xx, data_act.values.max()+.1, "6", ha='center', va='bottom', fontsize=6)
            
            # CAT
            txt_options += ['CAT (*)']
            data_upper2030 = tpe_cat[ssp]
            data_upper2030 = 1e-3 * data_upper2030.loc[
                (data_upper2030.group == 'EARTH') & (data_upper2030.condi.isin(['unconditional', 'conditional'])) &
                (data_upper2030.category == cat), '2030'].max()
            
            data_lower2030 = tpe_cat[ssp]
            data_lower2030 = 1e-3 * data_lower2030.loc[
                (data_lower2030.group == 'EARTH') & (data_lower2030.condi.isin(['unconditional', 'conditional'])) &
                (data_lower2030.category == cat), '2030'].min()
            ...
            if (ssp == 'SSP5' and tpe == 'type_reclass'):
                axa.text(yr_plt + add_xx, data_act.values.max()+.1, "7", ha='center', va='bottom', fontsize=6)
...
path_to_plot = Path(meta.path.main, 'plots', 'ndc_quantifications', 
    'comparison_of_ssps', f'ndcs_global_{cat}_new.png')

plotting()

# %%
files = hpf.get_all_files_and_or_folders_in_dir(Path(meta.path.main, 'data', 'output', 'output_for_paper', 'first_subm_exclUSA'))
