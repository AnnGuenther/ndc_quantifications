...
def plotting():
    ...
    for tpe, add_x0, \
        ...
        ['type_calc', 0, 
         ptws['calc100'], ptws['calc100_const'], ptws['calc100_blUncondi'], ptws['calc100_fao'], 
         ptws['calc'], ptws['calc_const'], ptws['calc_blUncondi'], ptws['calc_fao']], \
        ['type_orig', +2, 
         ptws['orig100'], ptws['orig100_const'], ptws['orig100_blUncondi'], ptws['orig100_fao'], 
         ptws['orig'], ptws['orig_const'], ptws['orig_blUncondi'], ptws['orig_fao']]:
...
path_to_plot = Path(meta.path.main, 'plots', 'ndc_quantifications', 
    'comparison_of_ssps', f'ndcs_comparison_ssps_prioCalcAndOrig_{cat}_onePlot_diff5.png')
