...
#meta.strengthen_targets = {'use_it': False}
#meta.strengthen_targets = {'use_it': True, 'pc': 5, 'how_to': 'multiply', 'countries': 'all'}
#meta.strengthen_targets = {'use_it': True, 'pc': 10, 'how_to': 'multiply', 'countries': ['EU28', 'CHN', 'IND', 'USA', 'AUS']}

# %%
"""
Predefine that the coverage used for the pathways is 100% for certain countries.
Only relative targets / reductions.
