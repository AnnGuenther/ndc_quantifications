...
def prep_ssps_split_fgases(meta, database, nrvalues):
    ...
    **Split up the SSP FGASES basket based on historical ratios**
    ...
    def calc_and_store_data(database, meta, fgases_share, nrvalues):
        ...
        set_atts = {
            'clss': 'TOTAL', 'tpe': 'NET', 'srce': 'SSPSPLIT',
            'unit': meta.units.default['emi'], 'gwp': meta.gwps.default,
            'family': 'emi'}
        
        for ssp in meta.ssps.scens.long:
            
            tablename_ssp = ('FGASES' + meta.gwps.default + '_IPCM0EL_TOTAL_NET_' + ssp + 'FILLED_' + meta.ssps.emi['srce'])
            ...
            for gas in meta.gases.fgases:
                ...
                # Set attributes.
                tablename_primap_fgases = 'FGASES' + meta.gwps.default + '_IPCM0EL_TOTAL_NET_HISTCR_PRIMAPHIST21'
    ...
    for gas in meta.gases.fgases:
        ...
        fgases_primap[gas] = deepcopy(getattr(database, gas + meta.gwps.default + '_IPCM0EL_TOTAL_NET_' + 
            meta.primap.emi['scen'] + '_' + meta.primap.emi['srce']).data.reindex(index=meta.isos.EARTH))
    ...
    test = hpf.ratios_w_zeros(
        ...
        getattr(database, 'FGASES' + meta.gwps.default + '_IPCM0EL_TOTAL_NET_HISTCR_' + 
