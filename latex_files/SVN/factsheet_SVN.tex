\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Slovenia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 18.1~Mt CO$_2$eq, Slovenia contributed 0.03\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Slovenia is estimated to emit 17.5~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -3.3\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 15.1--20.6~Mt CO$_2$eq in 2030, and 14.7--33.7~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 159 in 2017, and 48 regarding the per-capita emissions (157 and 60 in 2030).
 In terms of accumulated historical emissions, Slovenia contributed to the global 1850--2017 emissions by 0.04\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Slovenia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 18.1 & Mt CO$_2$eq & 0.03\% & 122 \tabularnewline 
 \bfseries  & 2030 & 17.5 & Mt CO$_2$eq & 0.03\% & 128 \tabularnewline \hline
 \bfseries GDP & 2017 & 69.9 & Billion 2011~GK\$ & 0.06\% & 95 \tabularnewline 
 \bfseries  & 2030 & 84.1 & Billion 2011~GK\$ & 0.04\% & 109 \tabularnewline \hline
 \bfseries Emissions & 2017 & 259.2 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 159 \tabularnewline 
 \bfseries per GDP & 2030 & 208.5 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 157 \tabularnewline \hline
 \bfseries Population & 2017 & 2.1 & Million Pers & 0.02\% & 146 \tabularnewline 
 \bfseries  & 2030 & 2.1 & Million Pers & 0.02\% & 148 \tabularnewline \hline
 \bfseries Emissions & 2017 & 8.7 & t CO$_2$eq /  Pers & 0.6\% & 48 \tabularnewline 
 \bfseries per capita & 2030 & 8.2 & t CO$_2$eq /  Pers & 0.6\% & 60 \tabularnewline 
 \end{tabular}
 \end{table}

 For Slovenia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (77.2\%), followed by IPPU (9.9\%)
 ...
 The total CO$_2$ emissions are expected to be 79.7\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SVN/ts_emi_exclLU_SVN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SVN/ts_gdp_pop_SVN.png}
 ...
 Slovenia's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Slovenia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -1.5~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 18.1~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -7.7---1.5~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SVN/ts_emi_onlyLU_SVN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Slovenia's NDC (if needed). 
 ...
 Slovenia has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Slovenia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Slovenia is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SVN/ts_pc_cov_SVN.png}
 \caption{Timeseries of Slovenia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Slovenia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Slovenia's 2017 emissions (exclLU, exclBunkers; total 18.1~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -1.5~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 74.0\% & \bfseries 2.4\% & \bfseries 0.9\% & / & / & / & / & 77.2\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 7.7\% & \bfseries 0.02\% & \bfseries 0.1\% & \bfseries 2.0\% & \bfseries 0.09\% & \bfseries 0.08\% & \bfseries / & 9.9\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 6.6\% & \bfseries 2.7\% & / & / & / & / & 9.3\% \tabularnewline 
 ...
 \bfseries Total &  &  & 81.9\% & 11.6\% & 4.3\% & 2.0\% & 0.09\% & 0.08\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SVN/ts_ndcs_quantis_SVN.png}
