\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Morocco: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 115.2~Mt CO$_2$eq, Morocco contributed 0.2\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Morocco is estimated to emit 151.8~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 31.8\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 143.5--187.4~Mt CO$_2$eq in 2030, and 177.4--363.6~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 105 in 2017, and 132 regarding the per-capita emissions (118 and 125 in 2030).
 In terms of accumulated historical emissions, Morocco contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Morocco, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 115.2 & Mt CO$_2$eq & 0.2\% & 47 \tabularnewline 
 \bfseries  & 2030 & 151.8 & Mt CO$_2$eq & 0.2\% & 47 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.2 & Trillion 2011~GK\$ & 0.2\% & 56 \tabularnewline 
 \bfseries  & 2030 & 0.6 & Trillion 2011~GK\$ & 0.3\% & 47 \tabularnewline \hline
 \bfseries Emissions & 2017 & 411.2 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 105 \tabularnewline 
 \bfseries per GDP & 2030 & 271.6 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 118 \tabularnewline \hline
 \bfseries Population & 2017 & 36.1 & Million Pers & 0.4\% & 40 \tabularnewline 
 \bfseries  & 2030 & 38.7 & Million Pers & 0.4\% & 41 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.2 & t CO$_2$eq /  Pers & 0.2\% & 132 \tabularnewline 
 \bfseries per capita & 2030 & 3.9 & t CO$_2$eq /  Pers & 0.2\% & 125 \tabularnewline 
 \end{tabular}
 \end{table}

 For Morocco, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (51.9\%), followed by Agriculture (21.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  53.2\% of the national emissions. 
 Second largest contributor was N$_2$O (26.5\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by N$_2$O emissions from the Waste sector, which contributed 10.1\% to Morocco's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 66.6\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MAR/ts_emi_exclLU_MAR.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MAR/ts_gdp_pop_MAR.png}
 ...
 Morocco's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Morocco are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 4, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net source of 4.5~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 115.2~Mt CO$_2$eq.
 The large emissions range for UNFCCC (2019) and 1990--2017 is -4.5--4.5~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MAR/ts_emi_onlyLU_MAR.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Morocco's NDC (if needed). 
 ...
 Morocco has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Morocco's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 99.90 Mt~CO$_2$eq SAR & 2025 & exclLU \tabularnewline 
 ABS & condi. & best & 56.89 Mt~CO$_2$eq SAR & 2025 & exclLU \tabularnewline 
 ABS & uncondi. & best & 123.70 Mt~CO$_2$eq SAR & 2030 & exclLU \tabularnewline 
 ABS & condi. & best & 0.0 Mt~CO$_2$eq SAR & 2030 & exclLU \tabularnewline 
 ABS & uncondi. & best & 116.70 Mt~CO$_2$eq SAR & 2025 & inclLU \tabularnewline 
 ABS & condi. & best & 91.59 Mt~CO$_2$eq SAR & 2025 & inclLU \tabularnewline 
 ABS & uncondi. & best & 141.40 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 98.90 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -15.8\% & 2025 & exclLU \tabularnewline 
 RBU & condi. & best & -31.5\% & 2025 & exclLU \tabularnewline 
 RBU & uncondi. & best & -14.6\% & 2030 & exclLU \tabularnewline 
 RBU & condi. & best & -37.0\% & 2030 & exclLU \tabularnewline 
 RBU & uncondi. & best & -18.2\% & 2025 & inclLU \tabularnewline 
 RBU & condi. & best & -35.8\% & 2025 & inclLU \tabularnewline 
 RBU & uncondi. & best & -17.2\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -42.1\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MAR/ts_pc_cov_MAR.png}
 \caption{Timeseries of Morocco's national emissions (exclLU) and the share of emissions that is assumed to be covered by Morocco's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Morocco's 2017 emissions (exclLU, exclBunkers; total 115.2~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 4.5~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 45.9\% & \bfseries 5.4\% & \bfseries 0.7\% & / & / & / & / & 51.9\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 7.1\% & \bfseries / & \bfseries 0.02\% & / & / & / & / & 7.2\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 5.9\% & \bfseries 15.4\% & / & / & / & / & 21.5\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 9.0\% & \bfseries 10.1\% & / & / & / & / & 19.1\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 53.2\% & 20.3\% & 26.5\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MAR/ts_ndcs_quantis_MAR.png}
