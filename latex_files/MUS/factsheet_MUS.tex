\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Mauritius: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 8.5~Mt CO$_2$eq, Mauritius contributed 0.01\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Mauritius is estimated to emit 11.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 29.0\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 10.1--16.4~Mt CO$_2$eq in 2030, and 12.9--26.9~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 142 in 2017, and 78 regarding the per-capita emissions (130 and 59 in 2030).
 In terms of accumulated historical emissions, Mauritius contributed to the global 1850--2017 emissions by 0.008\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.01\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Mauritius, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 8.5 & Mt CO$_2$eq & 0.01\% & 149 \tabularnewline 
 \bfseries  & 2030 & 11.0 & Mt CO$_2$eq & 0.01\% & 147 \tabularnewline \hline
 \bfseries GDP & 2017 & 28.2 & Billion 2011~GK\$ & 0.02\% & 131 \tabularnewline 
 \bfseries  & 2030 & 43.3 & Billion 2011~GK\$ & 0.02\% & 138 \tabularnewline \hline
 \bfseries Emissions & 2017 & 302.6 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 142 \tabularnewline 
 \bfseries per GDP & 2030 & 254.4 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 130 \tabularnewline \hline
 \bfseries Population & 2017 & 1.3 & Million Pers & 0.01\% & 153 \tabularnewline 
 \bfseries  & 2030 & 1.3 & Million Pers & 0.01\% & 155 \tabularnewline \hline
 \bfseries Emissions & 2017 & 6.8 & t CO$_2$eq /  Pers & 0.4\% & 78 \tabularnewline 
 \bfseries per capita & 2030 & 8.2 & t CO$_2$eq /  Pers & 0.6\% & 59 \tabularnewline 
 \end{tabular}
 \end{table}

 For Mauritius, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (60.3\%), followed by Waste (24.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  58.1\% of the national emissions. 
 Second largest contributor was CH$_4$ (27.1\%)
 The total of F-gasesrepresented 13.4\%.
 The trend in total emissions is mostly driven by F-gases emissions from the IPPU sector, which contributed 13.4\% to Mauritius's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 59.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MUS/ts_emi_exclLU_MUS.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MUS/ts_gdp_pop_MUS.png}
 ...
 Mauritius's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Mauritius are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 9, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.4~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 8.5~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -0.5---0.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MUS/ts_emi_onlyLU_MUS.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Mauritius's NDC (if needed). 
 ...
 Mauritius has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Mauritius's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 4.90 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline \hline
 RBU & condi. & best & -30\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MUS/ts_pc_cov_MUS.png}
 \caption{Timeseries of Mauritius's national emissions (exclLU) and the share of emissions that is assumed to be covered by Mauritius's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Mauritius's 2017 emissions (exclLU, exclBunkers; total 8.5~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -0.4~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 57.6\% & 2.4\% & 0.3\% & / & / & / & / & 60.3\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 0.4\% & / & 0.0\% & 13.4\% & / & / & / & 13.9\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & 0.2\% & 0.3\% & / & / & / & / & 0.6\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & 24.5\% & 0.1\% & / & / & / & / & 24.6\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & / & 0.6\% & / & / & / & / & 0.6\% \tabularnewline \hline
 \bfseries Total &  &  & 58.1\% & 27.1\% & 1.4\% & 13.4\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MUS/ts_ndcs_quantis_MUS.png}
