\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Somalia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 28.1~Mt CO$_2$eq, Somalia contributed 0.05\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.06\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Somalia is estimated to emit 37.3~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 32.8\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 35.0--75.4~Mt CO$_2$eq in 2030, and 42.7--352.5~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 9 in 2017, and 169 regarding the per-capita emissions (13 and 165 in 2030).
 In terms of accumulated historical emissions, Somalia contributed to the global 1850--2017 emissions by 0.07\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Somalia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 28.1 & Mt CO$_2$eq & 0.05\% & 108 \tabularnewline 
 \bfseries  & 2030 & 37.3 & Mt CO$_2$eq & 0.06\% & 109 \tabularnewline \hline
 \bfseries GDP & 2017 & 20.2 & Billion 2011~GK\$ & 0.01\% & 145 \tabularnewline 
 \bfseries  & 2030 & 49.7 & Billion 2011~GK\$ & 0.02\% & 129 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.4 & t CO$_2$eq / Thousand 2011~GK\$ & 1.3\% & 9 \tabularnewline 
 \bfseries per GDP & 2030 & 0.8 & t CO$_2$eq / Thousand 2011~GK\$ & 1.0\% & 13 \tabularnewline \hline
 \bfseries Population & 2017 & 14.6 & Million Pers & 0.1\% & 73 \tabularnewline 
 \bfseries  & 2030 & 17.9 & Million Pers & 0.2\% & 71 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.9 & t CO$_2$eq /  Pers & 0.1\% & 169 \tabularnewline 
 \bfseries per capita & 2030 & 2.1 & t CO$_2$eq /  Pers & 0.1\% & 165 \tabularnewline 
 \end{tabular}
 \end{table}

 For Somalia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (79.2\%), followed by Energy (13.1\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting as much as 73.4\% of the national emissions. 
 Second largest contributor was N$_2$O (24.0\%)
 The total of F-gasesonly represented 0.01\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Energy and Agriculture sectors, which contributed 9.8\% and 56.9\% to Somalia's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 6.7\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SOM/ts_emi_exclLU_SOM.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SOM/ts_gdp_pop_SOM.png}
 ...
 Somalia's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Somalia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 13.5~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 28.1~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 13.2--17.6~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SOM/ts_emi_onlyLU_SOM.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Somalia's NDC (if needed). 
 ...
 Somalia has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SOM/ts_pc_cov_SOM.png}
 \caption{Timeseries of Somalia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Somalia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Somalia's 2017 emissions (exclLU, exclBunkers; total 28.1~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 13.5~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 2.4\% & \bfseries 9.8\% & \bfseries 0.9\% & / & / & / & / & 13.1\% \tabularnewline 
 \bfseries IPPU & / & -- & 0.1\% & / & 0.0\% & 0.01\% & / & / & / & 0.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 56.9\% & \bfseries 22.3\% & / & / & / & / & 79.2\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 6.7\% & \bfseries 0.4\% & / & / & / & / & 7.2\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 2.5\% & 73.4\% & 24.0\% & 0.01\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SOM/ts_ndcs_quantis_SOM.png}
