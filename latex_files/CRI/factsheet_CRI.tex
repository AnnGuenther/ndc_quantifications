\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Costa Rica: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 17.4~Mt CO$_2$eq, Costa Rica contributed 0.03\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.04\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Costa Rica is estimated to emit 24.2~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 38.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 21.3--29.5~Mt CO$_2$eq in 2030, and 29.2--48.6~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 177 in 2017, and 120 regarding the per-capita emissions (166 and 117 in 2030).
 In terms of accumulated historical emissions, Costa Rica contributed to the global 1850--2017 emissions by 0.02\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.03\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Costa Rica, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 17.4 & Mt CO$_2$eq & 0.03\% & 125 \tabularnewline 
 \bfseries  & 2030 & 24.2 & Mt CO$_2$eq & 0.04\% & 120 \tabularnewline \hline
 \bfseries GDP & 2017 & 79.1 & Billion 2011~GK\$ & 0.07\% & 90 \tabularnewline 
 \bfseries  & 2030 & 125.6 & Billion 2011~GK\$ & 0.06\% & 95 \tabularnewline \hline
 \bfseries Emissions & 2017 & 220.4 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 177 \tabularnewline 
 \bfseries per GDP & 2030 & 192.4 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 166 \tabularnewline \hline
 \bfseries Population & 2017 & 4.9 & Million Pers & 0.06\% & 120 \tabularnewline 
 \bfseries  & 2030 & 5.7 & Million Pers & 0.06\% & 121 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.5 & t CO$_2$eq /  Pers & 0.2\% & 120 \tabularnewline 
 \bfseries per capita & 2030 & 4.2 & t CO$_2$eq /  Pers & 0.2\% & 117 \tabularnewline 
 \end{tabular}
 \end{table}

 For Costa Rica, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (49.1\%), followed by Agriculture (35.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  50.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (29.4\%)
 The total of F-gasesonly represented 1.0\%.
 The total CO$_2$ emissions are expected to be 55.8\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CRI/ts_emi_exclLU_CRI.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CRI/ts_gdp_pop_CRI.png}
 ...
 Costa Rica's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Costa Rica are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 4, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -3.5~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 17.4~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -3.5--2.5~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CRI/ts_emi_onlyLU_CRI.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Costa Rica's NDC (if needed). 
 ...
 Costa Rica has an NDC, with a GHG mitigation target of the type ABS (absolute emissions target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Costa Rica's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & condi. & best & 9.37 Mt~CO$_2$eq & 2012 & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 5.96 Mt~CO$_2$eq & 2012 & 2050 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CRI/ts_pc_cov_CRI.png}
 \caption{Timeseries of Costa Rica's national emissions (exclLU) and the share of emissions that is assumed to be covered by Costa Rica's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Costa Rica's 2017 emissions (exclLU, exclBunkers; total 17.4~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -3.5~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 47.1\% & \bfseries 1.2\% & \bfseries 0.8\% & / & / & / & / & 49.1\% \tabularnewline 
 \bfseries IPPU & / & \bfseries + & \bfseries 2.7\% & \bfseries / & \bfseries 0.0\% & \bfseries 1.0\% & \bfseries / & \bfseries / & / & 3.7\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.3\% & \bfseries 17.2\% & \bfseries 17.7\% & / & / & / & / & 35.3\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 11.0\% & \bfseries 0.4\% & / & / & / & / & 11.4\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 50.2\% & 29.4\% & 19.4\% & 1.0\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CRI/ts_ndcs_quantis_CRI.png}
