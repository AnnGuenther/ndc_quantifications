\documentclass[12pt]{article}
 ...
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Anguilla is estimated to emit 150.7~kt CO$_2$eq in 2030.
 ...
 The country's global rank in terms of total emissions per unit of GDP was 89 in 2017, and 35 regarding the per-capita emissions (61 and 34 in 2030).
 ...
 For Anguilla, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (97.5\%), followed by Waste (2.4\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 95.9\% of the national emissions. 
 Second largest contributor was CH$_4$ (3.8\%)
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/AIA/ts_emi_exclLU_AIA.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/AIA/ts_gdp_pop_AIA.png}
 ...
 LULUCF emissions data for Anguilla are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 10.5~kt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 156.0~kt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is -36.7--73.3~kt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/AIA/ts_emi_onlyLU_AIA.png}
