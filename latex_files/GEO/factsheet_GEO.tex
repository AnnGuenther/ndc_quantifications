\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Georgia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 17.7~Mt CO$_2$eq, Georgia contributed 0.03\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Georgia is estimated to emit 19.5~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 10.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 19.5--27.8~Mt CO$_2$eq in 2030, and 26.5--41.2~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 110 in 2017, and 106 regarding the per-capita emissions (119 and 100 in 2030).
 In terms of accumulated historical emissions, Georgia contributed to the global 1850--2017 emissions by 0.07\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Georgia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 17.7 & Mt CO$_2$eq & 0.03\% & 123 \tabularnewline 
 \bfseries  & 2030 & 19.5 & Mt CO$_2$eq & 0.03\% & 126 \tabularnewline \hline
 \bfseries GDP & 2017 & 45.3 & Billion 2011~GK\$ & 0.04\% & 110 \tabularnewline 
 \bfseries  & 2030 & 72.3 & Billion 2011~GK\$ & 0.04\% & 114 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 110 \tabularnewline 
 \bfseries per GDP & 2030 & 0.2 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 119 \tabularnewline \hline
 \bfseries Population & 2017 & 4.0 & Million Pers & 0.05\% & 131 \tabularnewline 
 \bfseries  & 2030 & 3.6 & Million Pers & 0.04\% & 131 \tabularnewline \hline
 \bfseries Emissions & 2017 & 4.4 & t CO$_2$eq /  Pers & 0.2\% & 106 \tabularnewline 
 \bfseries per capita & 2030 & 5.4 & t CO$_2$eq /  Pers & 0.3\% & 100 \tabularnewline 
 \end{tabular}
 \end{table}

 For Georgia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (53.8\%), followed by IPPU (24.9\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  55.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (29.9\%)
 The total of F-gasesonly represented 3.3\%.
 The trend in total emissions is mostly driven by CO$_2$ emissions from the IPPU sector, which contributed 16.2\% to Georgia's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 62.1\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GEO/ts_emi_exclLU_GEO.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GEO/ts_gdp_pop_GEO.png}
 ...
 Georgia's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Georgia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 17, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -4.1~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 17.7~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -6.0--1.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GEO/ts_emi_onlyLU_GEO.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Georgia's NDC (if needed). 
 ...
 Georgia has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Georgia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & uncondi. & best & 32.65 Mt~CO$_2$eq SAR & 1990 & 2030 & GDP & exclLU \tabularnewline 
 ABS & condi. & best & 28.30 Mt~CO$_2$eq SAR & 1990 & 2030 & GDP & exclLU \tabularnewline \hline
 RBU & uncondi. & best & -15\% & 1990 & 2030 & GDP & exclLU \tabularnewline 
 RBU & condi. & best & -25\% & 1990 & 2030 & GDP & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GEO/ts_pc_cov_GEO.png}
 \caption{Timeseries of Georgia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Georgia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Georgia's 2017 emissions (exclLU, exclBunkers; total 17.7~Mt CO$_2$eq).
 ...
 LULUCF: NDC '--' and adapted '--' (estimated as a net sink of -4.1~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 38.9\% & \bfseries 14.6\% & \bfseries 0.2\% & / & / & / & / & 53.8\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 16.2\% & \bfseries 0.04\% & \bfseries 5.4\% & \bfseries 3.3\% & \bfseries / & \bfseries / & / & 24.9\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.06\% & \bfseries 8.1\% & \bfseries 5.3\% & / & / & / & / & 13.4\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 7.2\% & \bfseries 0.5\% & / & / & / & / & 7.7\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 55.2\% & 29.9\% & 11.6\% & 3.3\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GEO/ts_ndcs_quantis_GEO.png}
