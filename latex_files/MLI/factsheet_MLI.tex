\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Mali: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 70.5~Mt CO$_2$eq, Mali contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Mali is estimated to emit 75.3~Mt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 6.8\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 75.3--116.7~Mt CO$_2$eq in 2030, and 108.5--314.3~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 6 in 2017, and 115 regarding the per-capita emissions (12 and 139 in 2030).
 In terms of accumulated historical emissions, Mali contributed to the global 1850--2017 emissions by 0.06\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.08\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Mali, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 70.5 & Mt CO$_2$eq & 0.1\% & 71 \tabularnewline 
 \bfseries  & 2030 & 75.3 & Mt CO$_2$eq & 0.1\% & 69 \tabularnewline \hline
 \bfseries GDP & 2017 & 45.0 & Billion 2011~GK\$ & 0.04\% & 111 \tabularnewline 
 \bfseries  & 2030 & 98.4 & Billion 2011~GK\$ & 0.05\% & 103 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.6 & t CO$_2$eq / Thousand 2011~GK\$ & 1.4\% & 6 \tabularnewline 
 \bfseries per GDP & 2030 & 0.8 & t CO$_2$eq / Thousand 2011~GK\$ & 1.0\% & 12 \tabularnewline \hline
 \bfseries Population & 2017 & 18.5 & Million Pers & 0.2\% & 61 \tabularnewline 
 \bfseries  & 2030 & 25.3 & Million Pers & 0.3\% & 58 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.8 & t CO$_2$eq /  Pers & 0.2\% & 115 \tabularnewline 
 \bfseries per capita & 2030 & 3.0 & t CO$_2$eq /  Pers & 0.2\% & 139 \tabularnewline 
 \end{tabular}
 \end{table}

 For Mali, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (89.2\%), followed by Energy (9.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was N$_2$O, constituting  63.8\% of the national emissions. 
 Second largest contributor was CH$_4$ (29.8\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by N$_2$O and CH$_4$ emissions from the Agriculture sector, which contributed 60.9\% and 28.3\% to Mali's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 12.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MLI/ts_emi_exclLU_MLI.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MLI/ts_gdp_pop_MLI.png}
 ...
 Mali's population is assumed to grow towards 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Mali are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 3, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -244.7~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 70.5~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -244.7---9.6~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MLI/ts_emi_onlyLU_MLI.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Mali's NDC (if needed). 
 ...
 Mali has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Mali's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 72.33 Mt~CO$_2$eq & 2025 & exclLU \tabularnewline \hline
 ABS & condi. & best & 68.14 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 ABS & uncondi. & best & -79.72 Mt~CO$_2$eq & 2025 & inclLU \tabularnewline 
 ABS & condi. & best & -95.49 Mt~CO$_2$eq & 2025 & inclLU \tabularnewline 
 ABS & uncondi. & best & -33.62 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & -84.93 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -27\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MLI/ts_pc_cov_MLI.png}
 \caption{Timeseries of Mali's national emissions (exclLU) and the share of emissions that is assumed to be covered by Mali's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Mali's 2017 emissions (exclLU, exclBunkers; total 70.5~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -244.7~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 6.3\% & \bfseries 0.9\% & \bfseries 2.4\% & / & / & / & / & 9.6\% \tabularnewline 
 \bfseries IPPU & / & \bfseries + & \bfseries 0.1\% & \bfseries / & \bfseries 0.0\% & / & / & / & / & 0.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 28.3\% & \bfseries 60.9\% & / & / & / & / & 89.2\% \tabularnewline 
 \bfseries Waste & / & \bfseries + & \bfseries / & \bfseries 0.6\% & \bfseries 0.4\% & / & / & / & / & 1.0\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.09\% & / & / & / & / & 0.09\% \tabularnewline \hline
 \bfseries Total &  &  & 6.4\% & 29.8\% & 63.8\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MLI/ts_ndcs_quantis_MLI.png}
