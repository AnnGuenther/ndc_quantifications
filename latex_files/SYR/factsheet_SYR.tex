\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Syria: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 60.6~Mt CO$_2$eq, Syria contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Syria is estimated to emit 78.9~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 30.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 74.4--95.6~Mt CO$_2$eq in 2030, and 106.3--218.9~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 47 in 2017, and 118 regarding the per-capita emissions (52 and 127 in 2030).
 In terms of accumulated historical emissions, Syria contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Syria, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 60.6 & Mt CO$_2$eq & 0.1\% & 76 \tabularnewline 
 \bfseries  & 2030 & 78.9 & Mt CO$_2$eq & 0.1\% & 68 \tabularnewline \hline
 \bfseries GDP & 2017 & 82.3 & Billion 2011~GK\$ & 0.07\% & 89 \tabularnewline 
 \bfseries  & 2030 & 177.2 & Billion 2011~GK\$ & 0.09\% & 85 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.7 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 47 \tabularnewline 
 \bfseries per GDP & 2030 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 52 \tabularnewline \hline
 \bfseries Population & 2017 & 17.1 & Million Pers & 0.2\% & 65 \tabularnewline 
 \bfseries  & 2030 & 21.4 & Million Pers & 0.2\% & 63 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.5 & t CO$_2$eq /  Pers & 0.2\% & 118 \tabularnewline 
 \bfseries per capita & 2030 & 3.7 & t CO$_2$eq /  Pers & 0.2\% & 127 \tabularnewline 
 \end{tabular}
 \end{table}

 For Syria, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (73.4\%), followed by Agriculture (12.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 74.9\% of the national emissions. 
 Second largest contributor was CH$_4$ (16.7\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 78.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SYR/ts_emi_exclLU_SYR.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SYR/ts_gdp_pop_SYR.png}
 ...
 Syria's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Syria are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -1.3~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 60.6~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -2.3---1.2~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SYR/ts_emi_onlyLU_SYR.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Syria's NDC (if needed). 
 ...
 Syria has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SYR/ts_pc_cov_SYR.png}
 \caption{Timeseries of Syria's national emissions (exclLU) and the share of emissions that is assumed to be covered by Syria's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Syria's 2017 emissions (exclLU, exclBunkers; total 60.6~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -1.3~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 72.0\% & \bfseries 0.8\% & \bfseries 0.6\% & / & / & / & / & 73.4\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 1.9\% & \bfseries / & \bfseries 2.2\% & / & / & / & / & 4.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 1.0\% & \bfseries 6.4\% & \bfseries 4.6\% & / & / & / & / & 12.0\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 9.5\% & \bfseries 0.3\% & / & / & / & / & 9.9\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.5\% & / & / & / & / & 0.5\% \tabularnewline \hline
 \bfseries Total &  &  & 74.9\% & 16.7\% & 8.4\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SYR/ts_ndcs_quantis_SYR.png}
