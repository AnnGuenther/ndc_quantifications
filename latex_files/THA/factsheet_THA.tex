\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Thailand: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 475.1~Mt CO$_2$eq, Thailand contributed 1.0\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Thailand is estimated to emit 532.5~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 12.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 490.5--574.7~Mt CO$_2$eq in 2030, and 556.7--891.7~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 104 in 2017, and 76 regarding the per-capita emissions (122 and 70 in 2030).
 In terms of accumulated historical emissions, Thailand contributed to the global 1850--2017 emissions by 0.6\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.9\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Thailand, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 475.1 & Mt CO$_2$eq & 1.0\% & 18 \tabularnewline 
 \bfseries  & 2030 & 532.5 & Mt CO$_2$eq & 1.0\% & 18 \tabularnewline \hline
 \bfseries GDP & 2017 & 1.1 & Trillion 2011~GK\$ & 1.0\% & 20 \tabularnewline 
 \bfseries  & 2030 & 2.0 & Trillion 2011~GK\$ & 1.1\% & 19 \tabularnewline \hline
 \bfseries Emissions & 2017 & 417.4 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 104 \tabularnewline 
 \bfseries per GDP & 2030 & 265.3 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 122 \tabularnewline \hline
 \bfseries Population & 2017 & 69.2 & Million Pers & 0.9\% & 20 \tabularnewline 
 \bfseries  & 2030 & 72.3 & Million Pers & 0.9\% & 23 \tabularnewline \hline
 \bfseries Emissions & 2017 & 6.9 & t CO$_2$eq /  Pers & 0.4\% & 76 \tabularnewline 
 \bfseries per capita & 2030 & 7.4 & t CO$_2$eq /  Pers & 0.4\% & 70 \tabularnewline 
 \end{tabular}
 \end{table}

 For Thailand, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (74.9\%), followed by Agriculture (15.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 73.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (20.9\%)
 The total of F-gasesonly represented 0.2\%.
 The total CO$_2$ emissions are expected to be 73.5\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/THA/ts_emi_exclLU_THA.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/THA/ts_gdp_pop_THA.png}
 ...
 Thailand's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Thailand are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 15.3~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 475.1~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 1.1--20.0~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/THA/ts_emi_onlyLU_THA.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Thailand's NDC (if needed). 
 ...
 Thailand has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Thailand's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 444 Mt~CO$_2$eq AR4 & 2030 & exclLU \tabularnewline 
 ABS & condi. & best & 416 Mt~CO$_2$eq AR4 & 2030 & exclLU \tabularnewline \hline
 RBU & uncondi. & best & -20\% & 2030 & exclLU \tabularnewline 
 RBU & condi. & best & -25\% & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/THA/ts_pc_cov_THA.png}
 \caption{Timeseries of Thailand's national emissions (exclLU) and the share of emissions that is assumed to be covered by Thailand's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Thailand's 2017 emissions (exclLU, exclBunkers; total 475.1~Mt CO$_2$eq).
 ...
 LULUCF: NDC '--' and adapted '--' (estimated as a net source of 15.3~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 67.2\% & \bfseries 6.4\% & \bfseries 1.3\% & / & / & / & / & 74.9\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 5.6\% & \bfseries 0.0\% & \bfseries 0.1\% & \bfseries / & \bfseries / & \bfseries 0.2\% & / & 6.0\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.3\% & \bfseries 11.0\% & \bfseries 3.6\% & / & / & / & / & 15.0\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.01\% & \bfseries 3.5\% & \bfseries 0.1\% & / & / & / & / & 3.7\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 73.2\% & 20.9\% & 5.6\% & / & / & 0.2\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/THA/ts_ndcs_quantis_THA.png}
