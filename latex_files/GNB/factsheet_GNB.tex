\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Guinea-Bissau: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 2.8~Mt CO$_2$eq, Guinea-Bissau contributed 0.005\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Guinea-Bissau is estimated to emit 3.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 6.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 3.0--4.6~Mt CO$_2$eq in 2030, and 4.8--15.5~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 28 in 2017, and 180 regarding the per-capita emissions (40 and 187 in 2030).
 In terms of accumulated historical emissions, Guinea-Bissau contributed to the global 1850--2017 emissions by 0.005\%. 
 When only accounting for the years 1990--2017, its contribution stays the same to 0.005\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Guinea-Bissau, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 2.8 & Mt CO$_2$eq & 0.005\% & 164 \tabularnewline 
 \bfseries  & 2030 & 3.0 & Mt CO$_2$eq & 0.005\% & 166 \tabularnewline \hline
 \bfseries GDP & 2017 & 3.3 & Billion 2011~GK\$ & 0.002\% & 174 \tabularnewline 
 \bfseries  & 2030 & 6.2 & Billion 2011~GK\$ & 0.003\% & 171 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.8 & t CO$_2$eq / Thousand 2011~GK\$ & 0.8\% & 28 \tabularnewline 
 \bfseries per GDP & 2030 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 40 \tabularnewline \hline
 \bfseries Population & 2017 & 1.8 & Million Pers & 0.02\% & 149 \tabularnewline 
 \bfseries  & 2030 & 2.2 & Million Pers & 0.02\% & 146 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.5 & t CO$_2$eq /  Pers & 0.1\% & 180 \tabularnewline 
 \bfseries per capita & 2030 & 1.4 & t CO$_2$eq /  Pers & 0.09\% & 187 \tabularnewline 
 \end{tabular}
 \end{table}

 For Guinea-Bissau, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (68.8\%), followed by Energy (18.7\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  57.6\% of the national emissions. 
 Second largest contributor was N$_2$O (28.7\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ and N$_2$O emissions from the Agriculture sector, which contributed 41.3\% and 27.5\% to Guinea-Bissau's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GNB/ts_emi_exclLU_GNB.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GNB/ts_gdp_pop_GNB.png}
 ...
 Guinea-Bissau's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Guinea-Bissau are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 1.5~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 2.8~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 1.5--2.8~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GNB/ts_emi_onlyLU_GNB.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Guinea-Bissau's NDC (if needed). 
 ...
 Guinea-Bissau has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GNB/ts_pc_cov_GNB.png}
 \caption{Timeseries of Guinea-Bissau's national emissions (exclLU) and the share of emissions that is assumed to be covered by Guinea-Bissau's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Guinea-Bissau's 2017 emissions (exclLU, exclBunkers; total 2.8~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 1.5~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 13.3\% & \bfseries 5.0\% & \bfseries 0.4\% & / & / & / & / & 18.7\% \tabularnewline 
 \bfseries IPPU & / & -- & 0.3\% & / & 0.0\% & / & / & / & / & 0.3\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.0\% & 41.3\% & 27.5\% & / & / & / & / & 68.8\% \tabularnewline 
 \bfseries Waste & / & -- & / & 11.3\% & 0.5\% & / & / & / & / & 11.8\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 13.7\% & 57.6\% & 28.7\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GNB/ts_ndcs_quantis_GNB.png}
