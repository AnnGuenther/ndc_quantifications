\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Mauritania: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 10.9~Mt CO$_2$eq, Mauritania contributed 0.02\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Mauritania is estimated to emit 13.3~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 22.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 12.6--18.1~Mt CO$_2$eq in 2030, and 15.5--37.4~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 30 in 2017, and 147 regarding the per-capita emissions (35 and 149 in 2030).
 In terms of accumulated historical emissions, Mauritania contributed to the global 1850--2017 emissions by 0.01\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Mauritania, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 10.9 & Mt CO$_2$eq & 0.02\% & 142 \tabularnewline 
 \bfseries  & 2030 & 13.3 & Mt CO$_2$eq & 0.02\% & 140 \tabularnewline \hline
 \bfseries GDP & 2017 & 13.0 & Billion 2011~GK\$ & 0.01\% & 151 \tabularnewline 
 \bfseries  & 2030 & 25.7 & Billion 2011~GK\$ & 0.01\% & 149 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.8 & t CO$_2$eq / Thousand 2011~GK\$ & 0.8\% & 30 \tabularnewline 
 \bfseries per GDP & 2030 & 0.5 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 35 \tabularnewline \hline
 \bfseries Population & 2017 & 4.3 & Million Pers & 0.05\% & 126 \tabularnewline 
 \bfseries  & 2030 & 5.3 & Million Pers & 0.06\% & 126 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.5 & t CO$_2$eq /  Pers & 0.1\% & 147 \tabularnewline 
 \bfseries per capita & 2030 & 2.5 & t CO$_2$eq /  Pers & 0.1\% & 149 \tabularnewline 
 \end{tabular}
 \end{table}

 For Mauritania, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (58.6\%), followed by Energy (36.8\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  65.2\% of the national emissions. 
 Second largest contributor was CO$_2$ (33.7\%)
 The total of F-gasesonly represented 0.1\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Agriculture sector, which contributed 58.4\% to Mauritania's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 42.5\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MRT/ts_emi_exclLU_MRT.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MRT/ts_gdp_pop_MRT.png}
 ...
 Mauritania's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Mauritania are available from the following sources (Fig.~\ref{fig:tsLULUCF}): BUR (1$^{st}$)~/ 23, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from BUR (1$^{st}$), for the year 2017, LULUCF is estimated to be a net sink of -0.3~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 10.9~Mt CO$_2$eq.
 The emissions range for BUR (1$^{st}$) and 1990--2017 is -0.9---0.2~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MRT/ts_emi_onlyLU_MRT.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Mauritania's NDC (if needed). 
 ...
 Mauritania has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Mauritania's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 18.33 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 14.64 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -2.7\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -22.3\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MRT/ts_pc_cov_MRT.png}
 \caption{Timeseries of Mauritania's national emissions (exclLU) and the share of emissions that is assumed to be covered by Mauritania's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Mauritania's 2017 emissions (exclLU, exclBunkers; total 10.9~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 29.7\% & \bfseries 6.8\% & \bfseries 0.3\% & / & / & / & / & 36.8\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 3.9\% & \bfseries / & \bfseries 0.0\% & 0.1\% & / & / & / & 4.0\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.04\% & \bfseries 58.4\% & \bfseries 0.2\% & / & / & / & / & 58.6\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 0.0\% & \bfseries 0.0\% & / & / & / & / & 0.0\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.5\% & / & / & / & / & 0.5\% \tabularnewline \hline
 \bfseries Total &  &  & 33.7\% & 65.2\% & 1.1\% & 0.1\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MRT/ts_ndcs_quantis_MRT.png}
