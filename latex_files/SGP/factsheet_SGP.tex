\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Singapore: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 99.7~Mt CO$_2$eq, Singapore contributed 0.2\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.1\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Singapore is estimated to emit 97.1~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -2.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 81.8--109.8~Mt CO$_2$eq in 2030, and 61.1--117.4~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 174 in 2017, and 17 regarding the per-capita emissions (181 and 20 in 2030).
 In terms of accumulated historical emissions, Singapore contributed to the global 1850--2017 emissions by 0.07\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Singapore, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 99.7 & Mt CO$_2$eq & 0.2\% & 55 \tabularnewline 
 \bfseries  & 2030 & 97.1 & Mt CO$_2$eq & 0.1\% & 59 \tabularnewline \hline
 \bfseries GDP & 2017 & 441.9 & Billion 2011~GK\$ & 0.3\% & 41 \tabularnewline 
 \bfseries  & 2030 & 601.6 & Billion 2011~GK\$ & 0.3\% & 46 \tabularnewline \hline
 \bfseries Emissions & 2017 & 225.5 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 174 \tabularnewline 
 \bfseries per GDP & 2030 & 161.4 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 181 \tabularnewline \hline
 \bfseries Population & 2017 & 5.7 & Million Pers & 0.07\% & 115 \tabularnewline 
 \bfseries  & 2030 & 6.3 & Million Pers & 0.07\% & 116 \tabularnewline \hline
 \bfseries Emissions & 2017 & 17.5 & t CO$_2$eq /  Pers & 1.2\% & 17 \tabularnewline 
 \bfseries per capita & 2030 & 15.4 & t CO$_2$eq /  Pers & 1.0\% & 20 \tabularnewline 
 \end{tabular}
 \end{table}

 For Singapore, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (88.1\%), followed by IPPU (11.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 96.8\% of the national emissions. 
 Second largest contributor was PFCs (1.6\%)
 The total of F-gasesonly represented 1.8\%.
 The total CO$_2$ emissions are expected to be 92.8\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SGP/ts_emi_exclLU_SGP.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SGP/ts_gdp_pop_SGP.png}
 ...
 Singapore's population is assumed to grow towards 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Singapore are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.04~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 99.7~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is -0.0--0.07~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SGP/ts_emi_onlyLU_SGP.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Singapore's NDC (if needed). 
 ...
 Singapore has an NDC, with a GHG mitigation target of the type ABS (absolute emissions target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Singapore's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries peakYr & \bfseries intensRef & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 65 Mt~CO$_2$eq AR5 & 2030 & 2030 & GDP & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SGP/ts_pc_cov_SGP.png}
 \caption{Timeseries of Singapore's national emissions (exclLU) and the share of emissions that is assumed to be covered by Singapore's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Singapore's 2017 emissions (exclLU, exclBunkers; total 99.7~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 0.04~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 87.2\% & \bfseries 0.6\% & \bfseries 0.3\% & / & / & / & / & 88.1\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 9.5\% & \bfseries 0.03\% & \bfseries 0.0\% & \bfseries 0.06\% & \bfseries 1.6\% & \bfseries 0.06\% & \bfseries 0.0\% & 11.3\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 0.0\% & \bfseries 0.1\% & / & / & / & / & 0.1\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 0.04\% & \bfseries 0.1\% & / & / & / & / & 0.3\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 96.8\% & 0.7\% & 0.7\% & 0.06\% & 1.6\% & 0.06\% & 0.0\% & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SGP/ts_ndcs_quantis_SGP.png}
