\documentclass[12pt]{article}
 ...
 LULUCF emissions data for Hong Kong are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.0007~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 52.6~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 0.0--0.002~Mt CO$_2$eq.
