\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Kenya: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 71.5~Mt CO$_2$eq, Kenya contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Kenya is estimated to emit 91.1~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 27.4\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 89.9--130.2~Mt CO$_2$eq in 2030, and 137.9--387.6~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 83 in 2017, and 185 regarding the per-capita emissions (105 and 185 in 2030).
 In terms of accumulated historical emissions, Kenya contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Kenya, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 71.5 & Mt CO$_2$eq & 0.1\% & 68 \tabularnewline 
 \bfseries  & 2030 & 91.1 & Mt CO$_2$eq & 0.1\% & 61 \tabularnewline \hline
 \bfseries GDP & 2017 & 147.0 & Billion 2011~GK\$ & 0.1\% & 71 \tabularnewline 
 \bfseries  & 2030 & 302.3 & Billion 2011~GK\$ & 0.1\% & 68 \tabularnewline \hline
 \bfseries Emissions & 2017 & 486.6 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 83 \tabularnewline 
 \bfseries per GDP & 2030 & 301.4 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 105 \tabularnewline \hline
 \bfseries Population & 2017 & 50.2 & Million Pers & 0.7\% & 28 \tabularnewline 
 \bfseries  & 2030 & 63.9 & Million Pers & 0.8\% & 24 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.4 & t CO$_2$eq /  Pers & 0.09\% & 185 \tabularnewline 
 \bfseries per capita & 2030 & 1.4 & t CO$_2$eq /  Pers & 0.09\% & 185 \tabularnewline 
 \end{tabular}
 \end{table}

 For Kenya, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (48.0\%), followed by Energy (41.7\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  53.1\% of the national emissions. 
 Second largest contributor was CO$_2$ (26.5\%)
 The total of F-gasesonly represented 0.1\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Agriculture and Energy sectors, which contributed 30.6\% and 20.0\% to Kenya's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 39.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KEN/ts_emi_exclLU_KEN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KEN/ts_gdp_pop_KEN.png}
 ...
 Kenya's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Kenya are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 4, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net source of 21.2~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 71.5~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is 9.8--21.2~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KEN/ts_emi_onlyLU_KEN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Kenya's NDC (if needed). 
 ...
 Kenya has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Kenya's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 100.099 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline \hline
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KEN/ts_pc_cov_KEN.png}
 \caption{Timeseries of Kenya's national emissions (exclLU) and the share of emissions that is assumed to be covered by Kenya's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Kenya's 2017 emissions (exclLU, exclBunkers; total 71.5~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 21.2~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 20.5\% & \bfseries 20.0\% & \bfseries 1.2\% & / & / & / & / & 41.7\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 6.0\% & \bfseries / & \bfseries 0.0\% & 0.1\% & 0.0\% & / & / & 6.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.06\% & \bfseries 30.6\% & \bfseries 17.3\% & / & / & / & / & 48.0\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.01\% & \bfseries 2.5\% & \bfseries 1.1\% & / & / & / & / & 3.6\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.6\% & / & / & / & / & 0.6\% \tabularnewline \hline
 \bfseries Total &  &  & 26.5\% & 53.1\% & 20.2\% & 0.1\% & 0.0\% & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KEN/ts_ndcs_quantis_KEN.png}
