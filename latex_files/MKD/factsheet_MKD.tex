\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Macedonia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 13.2~Mt CO$_2$eq, Macedonia contributed 0.02\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Macedonia is estimated to emit 16.1~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 21.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 15.1--19.2~Mt CO$_2$eq in 2030, and 16.9--33.5~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 93 in 2017, and 82 regarding the per-capita emissions (87 and 68 in 2030).
 In terms of accumulated historical emissions, Macedonia contributed to the global 1850--2017 emissions by 0.03\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Macedonia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 13.2 & Mt CO$_2$eq & 0.02\% & 134 \tabularnewline 
 \bfseries  & 2030 & 16.1 & Mt CO$_2$eq & 0.02\% & 134 \tabularnewline \hline
 \bfseries GDP & 2017 & 29.0 & Billion 2011~GK\$ & 0.02\% & 130 \tabularnewline 
 \bfseries  & 2030 & 47.4 & Billion 2011~GK\$ & 0.02\% & 131 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.4\% & 93 \tabularnewline 
 \bfseries per GDP & 2030 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.4\% & 87 \tabularnewline \hline
 \bfseries Population & 2017 & 2.1 & Million Pers & 0.02\% & 145 \tabularnewline 
 \bfseries  & 2030 & 2.2 & Million Pers & 0.02\% & 147 \tabularnewline \hline
 \bfseries Emissions & 2017 & 6.4 & t CO$_2$eq /  Pers & 0.4\% & 82 \tabularnewline 
 \bfseries per capita & 2030 & 7.4 & t CO$_2$eq /  Pers & 0.5\% & 68 \tabularnewline 
 \end{tabular}
 \end{table}

 For Macedonia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (61.2\%), followed by Waste (21.4\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  64.6\% of the national emissions. 
 Second largest contributor was CH$_4$ (29.2\%)
 The total of F-gasesonly represented 2.5\%.
 The total CO$_2$ emissions are expected to be 64.7\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MKD/ts_emi_exclLU_MKD.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MKD/ts_gdp_pop_MKD.png}
 ...
 Macedonia's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Macedonia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): BUR (2$^{nd}$)~/ 6, UNFCCC (2019)~/ 20, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net source of 0.06~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 13.2~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -3.8--1.9~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MKD/ts_emi_onlyLU_MKD.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Macedonia's NDC (if needed). 
 ...
 Macedonia has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Macedonia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 RBU & condi. & worst & -30\% & 2030 & exclLU \tabularnewline 
 RBU & condi. & best & -36\% & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MKD/ts_pc_cov_MKD.png}
 \caption{Timeseries of Macedonia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Macedonia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Macedonia's 2017 emissions (exclLU, exclBunkers; total 13.2~Mt CO$_2$eq).
 ...
 LULUCF: NDC '--' and adapted '--' (estimated as a net source of 0.06~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 58.6\% & 2.1\% & 0.4\% & / & / & / & / & 61.2\% \tabularnewline 
 \bfseries IPPU & -- & -- & 5.9\% & 0.01\% & 0.05\% & 2.5\% & 0.0\% & / & / & 8.5\% \tabularnewline 
 \bfseries Agri. & -- & -- & 0.01\% & 6.1\% & 2.5\% & / & / & / & / & 8.6\% \tabularnewline 
 \bfseries Waste & -- & -- & 0.09\% & 21.0\% & 0.3\% & / & / & / & / & 21.4\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 64.6\% & 29.2\% & 3.6\% & 2.5\% & 0.0\% & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MKD/ts_ndcs_quantis_MKD.png}
