\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Switzerland: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 47.2~Mt CO$_2$eq, Switzerland contributed 0.09\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.1\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Switzerland is estimated to emit 64.4~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 36.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 49.6--78.4~Mt CO$_2$eq in 2030, and 61.6--175.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 197 in 2017, and 93 regarding the per-capita emissions (197 and 74 in 2030).
 In terms of accumulated historical emissions, Switzerland contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Switzerland, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 47.2 & Mt CO$_2$eq & 0.09\% & 87 \tabularnewline 
 \bfseries  & 2030 & 64.4 & Mt CO$_2$eq & 0.1\% & 81 \tabularnewline \hline
 \bfseries GDP & 2017 & 518.3 & Billion 2011~GK\$ & 0.4\% & 37 \tabularnewline 
 \bfseries  & 2030 & 645.6 & Billion 2011~GK\$ & 0.3\% & 44 \tabularnewline \hline
 \bfseries Emissions & 2017 & 91.0 & t CO$_2$eq / Million 2011~GK\$ & 0.08\% & 197 \tabularnewline 
 \bfseries per GDP & 2030 & 99.7 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 197 \tabularnewline \hline
 \bfseries Population & 2017 & 8.5 & Million Pers & 0.1\% & 100 \tabularnewline 
 \bfseries  & 2030 & 9.0 & Million Pers & 0.1\% & 101 \tabularnewline \hline
 \bfseries Emissions & 2017 & 5.6 & t CO$_2$eq /  Pers & 0.3\% & 93 \tabularnewline 
 \bfseries per capita & 2030 & 7.1 & t CO$_2$eq /  Pers & 0.4\% & 74 \tabularnewline 
 \end{tabular}
 \end{table}

 For Switzerland, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (77.3\%), followed by Agriculture (12.9\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 80.9\% of the national emissions. 
 Second largest contributor was CH$_4$ (10.3\%)
 The total of F-gasesonly represented 3.7\%.
 The total CO$_2$ emissions are expected to be 78.7\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CHE/ts_emi_exclLU_CHE.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CHE/ts_gdp_pop_CHE.png}
 ...
 The emissions per GDP are estimated to rise towards 2050. 
 Switzerland's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Switzerland are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -1.6~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 47.2~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -6.5--5.6~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CHE/ts_emi_onlyLU_CHE.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Switzerland's NDC (if needed). 
 ...
 Switzerland has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Switzerland's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & uncondi. & best & 34.64 Mt~CO$_2$eq AR4 & 1990 & 2025 & exclLU \tabularnewline 
 ABS & uncondi. & best & 26.64 Mt~CO$_2$eq AR4 & 1990 & 2030 & exclLU \tabularnewline 
 ABS & uncondi. & worst & 15.99 Mt~CO$_2$eq AR4 & 1990 & 2050 & exclLU \tabularnewline 
 ABS & uncondi. & best & 7.99 Mt~CO$_2$eq AR4 & 1990 & 2050 & exclLU \tabularnewline \hline
 RBY & uncondi. & best & -35\% & 1990 & 2025 & exclLU \tabularnewline 
 RBY & uncondi. & best & -50\% & 1990 & 2030 & exclLU \tabularnewline 
 RBY & uncondi. & worst & -70\% & 1990 & 2050 & exclLU \tabularnewline 
 RBY & uncondi. & best & -85\% & 1990 & 2050 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CHE/ts_pc_cov_CHE.png}
 \caption{Timeseries of Switzerland's national emissions (exclLU) and the share of emissions that is assumed to be covered by Switzerland's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Switzerland's 2017 emissions (exclLU, exclBunkers; total 47.2~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -1.6~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 76.3\% & \bfseries 0.6\% & \bfseries 0.4\% & / & / & / & / & 77.3\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 4.5\% & \bfseries 0.0\% & \bfseries 0.08\% & \bfseries 3.2\% & \bfseries 0.06\% & \bfseries 0.4\% & \bfseries 0.0\% & 8.3\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 8.6\% & \bfseries 4.2\% & / & / & / & / & 12.9\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.02\% & \bfseries 1.1\% & \bfseries 0.3\% & / & / & / & / & 1.5\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries 0.02\% & \bfseries 0.0\% & \bfseries 0.0\% & / & / & / & / & 0.02\% \tabularnewline \hline
 \bfseries Total &  &  & 80.9\% & 10.3\% & 5.1\% & 3.2\% & 0.06\% & 0.4\% & 0.0\% & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CHE/ts_ndcs_quantis_CHE.png}
