\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Rep. Congo: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 13.1~Mt CO$_2$eq, Rep. Congo contributed 0.02\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.03\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Rep. Congo is estimated to emit 17.9~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 36.4\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 17.4--25.6~Mt CO$_2$eq in 2030, and 21.2--55.8~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 71 in 2017, and 146 regarding the per-capita emissions (78 and 142 in 2030).
 In terms of accumulated historical emissions, Rep. Congo contributed to the global 1850--2017 emissions by 0.03\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Rep. Congo, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 13.1 & Mt CO$_2$eq & 0.02\% & 135 \tabularnewline 
 \bfseries  & 2030 & 17.9 & Mt CO$_2$eq & 0.03\% & 127 \tabularnewline \hline
 \bfseries GDP & 2017 & 23.3 & Billion 2011~GK\$ & 0.02\% & 137 \tabularnewline 
 \bfseries  & 2030 & 49.0 & Billion 2011~GK\$ & 0.02\% & 130 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.6 & t CO$_2$eq / Thousand 2011~GK\$ & 0.5\% & 71 \tabularnewline 
 \bfseries per GDP & 2030 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.4\% & 78 \tabularnewline \hline
 \bfseries Population & 2017 & 5.1 & Million Pers & 0.06\% & 119 \tabularnewline 
 \bfseries  & 2030 & 6.5 & Million Pers & 0.07\% & 113 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.6 & t CO$_2$eq /  Pers & 0.1\% & 146 \tabularnewline 
 \bfseries per capita & 2030 & 2.8 & t CO$_2$eq /  Pers & 0.1\% & 142 \tabularnewline 
 \end{tabular}
 \end{table}

 For Rep. Congo, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (69.8\%), followed by Agriculture (19.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  65.2\% of the national emissions. 
 Second largest contributor was CO$_2$ (22.7\%)
 The total of F-gasesonly represented 0.1\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Energy sector, which contributed 49.8\% to Rep. Congo's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 35.0\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COG/ts_emi_exclLU_COG.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COG/ts_gdp_pop_COG.png}
 ...
 Rep. Congo's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Rep. Congo are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 36.7~Mt CO$_2$eq, which in absolute terms is higher than the non-LULUCF emissions of 13.1~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 14.8--42.7~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COG/ts_emi_onlyLU_COG.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Rep. Congo's NDC (if needed). 
 ...
 Rep. Congo has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Rep. Congo's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 8.79 Mt~CO$_2$eq SAR & 2025 & exclLU \tabularnewline 
 ABS & condi. & best & 15.85 Mt~CO$_2$eq SAR & 2030 & exclLU \tabularnewline \hline
 RBU & condi. & best & -48\% & 2025 & exclLU \tabularnewline 
 RBU & condi. & best & -54\% & 2035 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COG/ts_pc_cov_COG.png}
 \caption{Timeseries of Rep. Congo's national emissions (exclLU) and the share of emissions that is assumed to be covered by Rep. Congo's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Rep. Congo's 2017 emissions (exclLU, exclBunkers; total 13.1~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 36.7~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 19.7\% & \bfseries 49.8\% & \bfseries 0.3\% & / & / & / & / & 69.8\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 3.0\% & \bfseries / & \bfseries 0.0\% & 0.1\% & / & / & / & 3.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 8.3\% & \bfseries 10.9\% & / & / & / & / & 19.2\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 7.2\% & \bfseries 0.3\% & / & / & / & / & 7.5\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 22.7\% & 65.2\% & 12.0\% & 0.1\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COG/ts_ndcs_quantis_COG.png}
