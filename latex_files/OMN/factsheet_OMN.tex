\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Oman: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 96.7~Mt CO$_2$eq, Oman contributed 0.2\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Oman is estimated to emit 122.6~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 26.8\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 117.9--143.6~Mt CO$_2$eq in 2030, and 101.2--184.2~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 44 in 2017, and 9 regarding the per-capita emissions (33 and 11 in 2030).
 In terms of accumulated historical emissions, Oman contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Oman, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 96.7 & Mt CO$_2$eq & 0.2\% & 56 \tabularnewline 
 \bfseries  & 2030 & 122.6 & Mt CO$_2$eq & 0.2\% & 53 \tabularnewline \hline
 \bfseries GDP & 2017 & 129.0 & Billion 2011~GK\$ & 0.1\% & 78 \tabularnewline 
 \bfseries  & 2030 & 232.9 & Billion 2011~GK\$ & 0.1\% & 76 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.7 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 44 \tabularnewline 
 \bfseries per GDP & 2030 & 0.5 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 33 \tabularnewline \hline
 \bfseries Population & 2017 & 4.7 & Million Pers & 0.06\% & 124 \tabularnewline 
 \bfseries  & 2030 & 5.8 & Million Pers & 0.06\% & 120 \tabularnewline \hline
 \bfseries Emissions & 2017 & 20.7 & t CO$_2$eq /  Pers & 1.4\% & 9 \tabularnewline 
 \bfseries per capita & 2030 & 21.2 & t CO$_2$eq /  Pers & 1.4\% & 11 \tabularnewline 
 \end{tabular}
 \end{table}

 For Oman, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (86.5\%), followed by IPPU (9.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 71.8\% of the national emissions. 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/OMN/ts_emi_exclLU_OMN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/OMN/ts_gdp_pop_OMN.png}
 ...
 Oman's population is assumed to grow towards 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 

 LULUCF emissions data for Oman are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.0~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 96.7~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -0.0--0.0~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/OMN/ts_emi_onlyLU_OMN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Oman's NDC (if needed). 
 ...
 Oman has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Oman's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 88.71 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline \hline
 RBU & condi. & best & -2\% & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/OMN/ts_pc_cov_OMN.png}
 \caption{Timeseries of Oman's national emissions (exclLU) and the share of emissions that is assumed to be covered by Oman's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Oman's 2017 emissions (exclLU, exclBunkers; total 96.7~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 63.5\% & \bfseries 22.9\% & \bfseries 0.1\% & / & / & / & / & 86.5\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 8.3\% & \bfseries 0.08\% & \bfseries 0.1\% & \bfseries 0.6\% & \bfseries 0.03\% & / & / & 9.2\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.0\% & 1.1\% & 0.7\% & / & / & / & / & 1.8\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 2.1\% & \bfseries 0.04\% & / & / & / & / & 2.2\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 71.8\% & 26.2\% & 1.4\% & 0.6\% & 0.03\% & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/OMN/ts_ndcs_quantis_OMN.png}
