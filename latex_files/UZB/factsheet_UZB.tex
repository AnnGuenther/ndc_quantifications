\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Uzbekistan: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 243.4~Mt CO$_2$eq, Uzbekistan contributed 0.5\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Uzbekistan is estimated to emit 288.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 18.3\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 288.0--393.1~Mt CO$_2$eq in 2030, and 453.5--649.2~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 39 in 2017, and 61 regarding the per-capita emissions (53 and 57 in 2030).
 In terms of accumulated historical emissions, Uzbekistan contributed to the global 1850--2017 emissions by 0.4\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.6\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Uzbekistan, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 243.4 & Mt CO$_2$eq & 0.5\% & 35 \tabularnewline 
 \bfseries  & 2030 & 288.0 & Mt CO$_2$eq & 0.5\% & 34 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.3 & Trillion 2011~GK\$ & 0.2\% & 51 \tabularnewline 
 \bfseries  & 2030 & 0.7 & Trillion 2011~GK\$ & 0.3\% & 43 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.8 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 39 \tabularnewline 
 \bfseries per GDP & 2030 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 53 \tabularnewline \hline
 \bfseries Population & 2017 & 32.0 & Million Pers & 0.4\% & 42 \tabularnewline 
 \bfseries  & 2030 & 34.8 & Million Pers & 0.4\% & 48 \tabularnewline \hline
 \bfseries Emissions & 2017 & 7.6 & t CO$_2$eq /  Pers & 0.5\% & 61 \tabularnewline 
 \bfseries per capita & 2030 & 8.3 & t CO$_2$eq /  Pers & 0.6\% & 57 \tabularnewline 
 \end{tabular}
 \end{table}

 For Uzbekistan, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (79.1\%), followed by Agriculture (12.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  53.1\% of the national emissions. 
 Second largest contributor was CO$_2$ (41.5\%)
 The total of F-gasesonly represented 0.03\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Energy and Agriculture sectors, which contributed 41.1\% and 8.1\% to Uzbekistan's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 48.0\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/UZB/ts_emi_exclLU_UZB.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/UZB/ts_gdp_pop_UZB.png}
 ...
 Uzbekistan's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Uzbekistan are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 23, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -2.8~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 243.4~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -3.1--0.5~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/UZB/ts_emi_onlyLU_UZB.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Uzbekistan's NDC (if needed). 
 ...
 Uzbekistan has an NDC, with a GHG mitigation target of the type REI (relative emissions intensity reduction; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Uzbekistan's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 REI & condi. & best & -10\% & 2010 & 2030 & GDP & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/UZB/ts_pc_cov_UZB.png}
 \caption{Timeseries of Uzbekistan's national emissions (exclLU) and the share of emissions that is assumed to be covered by Uzbekistan's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Uzbekistan's 2017 emissions (exclLU, exclBunkers; total 243.4~Mt CO$_2$eq).
 ...
 LULUCF: NDC '/' and adapted '--' (estimated as a net sink of -2.8~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 38.0\% & \bfseries 41.1\% & \bfseries 0.03\% & / & / & / & / & 79.1\% \tabularnewline 
 \bfseries IPPU & / & -- & 3.3\% & 0.0\% & 0.8\% & 0.03\% & / & / & / & 4.1\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.1\% & 8.1\% & 4.2\% & / & / & / & / & 12.5\% \tabularnewline 
 \bfseries Waste & / & -- & / & 4.0\% & 0.2\% & / & / & / & / & 4.2\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.08\% & / & / & / & / & 0.08\% \tabularnewline \hline
 \bfseries Total &  &  & 41.5\% & 53.1\% & 5.4\% & 0.03\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/UZB/ts_ndcs_quantis_UZB.png}
