\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Iceland: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 4.8~Mt CO$_2$eq, Iceland contributed 0.01\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.009\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Iceland is estimated to emit 5.1~Mt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 6.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 4.5--6.0~Mt CO$_2$eq in 2030, and 5.1--11.4~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 151 in 2017, and 23 regarding the per-capita emissions (143 and 23 in 2030).
 In terms of accumulated historical emissions, Iceland contributed to the global 1850--2017 emissions by 0.01\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Iceland, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 4.8 & Mt CO$_2$eq & 0.01\% & 156 \tabularnewline 
 \bfseries  & 2030 & 5.1 & Mt CO$_2$eq & 0.009\% & 158 \tabularnewline \hline
 \bfseries GDP & 2017 & 17.1 & Billion 2011~GK\$ & 0.01\% & 149 \tabularnewline 
 \bfseries  & 2030 & 22.3 & Billion 2011~GK\$ & 0.01\% & 153 \tabularnewline \hline
 \bfseries Emissions & 2017 & 278.2 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 151 \tabularnewline 
 \bfseries per GDP & 2030 & 227.5 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 143 \tabularnewline \hline
 \bfseries Population & 2017 & 334.4 & Thousand Pers & 0.004\% & 174 \tabularnewline 
 \bfseries  & 2030 & 392.1 & Thousand Pers & 0.004\% & 174 \tabularnewline \hline
 \bfseries Emissions & 2017 & 14.3 & t CO$_2$eq /  Pers & 1.0\% & 23 \tabularnewline 
 \bfseries per capita & 2030 & 12.9 & t CO$_2$eq /  Pers & 0.9\% & 23 \tabularnewline 
 \end{tabular}
 \end{table}

 For Iceland, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the IPPU sector (42.9\%), followed by Energy (40.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 75.9\% of the national emissions. 
 Second largest contributor was CH$_4$ (12.2\%)
 The total of F-gasesonly represented 5.8\%.
 The trend in total emissions is mostly driven by F-gases emissions from the IPPU sector, which contributed 5.8\% to Iceland's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 74.5\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ISL/ts_emi_exclLU_ISL.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ISL/ts_gdp_pop_ISL.png}
 ...
 Iceland's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Iceland are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net source of 9.3~Mt CO$_2$eq, which in absolute terms is higher than the non-LULUCF emissions of 4.8~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is 9.3--9.5~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ISL/ts_emi_onlyLU_ISL.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Iceland's NDC (if needed). 
 ...
 Iceland has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Iceland's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ISL/ts_pc_cov_ISL.png}
 \caption{Timeseries of Iceland's national emissions (exclLU) and the share of emissions that is assumed to be covered by Iceland's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Iceland's 2017 emissions (exclLU, exclBunkers; total 4.8~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 9.3~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 38.7\% & \bfseries 0.1\% & \bfseries 1.2\% & / & / & / & / & 40.0\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 36.9\% & \bfseries 0.06\% & \bfseries 0.1\% & \bfseries 4.3\% & \bfseries 1.4\% & \bfseries 0.04\% & \bfseries / & 42.9\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 7.5\% & \bfseries 4.5\% & / & / & / & / & 12.1\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 4.5\% & \bfseries 0.1\% & / & / & / & / & 4.8\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 75.9\% & 12.2\% & 6.2\% & 4.3\% & 1.4\% & 0.04\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ISL/ts_ndcs_quantis_ISL.png}
