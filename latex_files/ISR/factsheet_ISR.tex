\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Israel: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 87.2~Mt CO$_2$eq, Israel contributed 0.1\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.2\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Israel is estimated to emit 113.4~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 30.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 102.6--136.6~Mt CO$_2$eq in 2030, and 136.1--271.5~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 163 in 2017, and 79 regarding the per-capita emissions (158 and 79 in 2030).
 In terms of accumulated historical emissions, Israel contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Israel, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 87.2 & Mt CO$_2$eq & 0.1\% & 61 \tabularnewline 
 \bfseries  & 2030 & 113.4 & Mt CO$_2$eq & 0.2\% & 55 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.3 & Trillion 2011~GK\$ & 0.3\% & 49 \tabularnewline 
 \bfseries  & 2030 & 0.5 & Trillion 2011~GK\$ & 0.3\% & 48 \tabularnewline \hline
 \bfseries Emissions & 2017 & 254.8 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 163 \tabularnewline 
 \bfseries per GDP & 2030 & 208.3 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 158 \tabularnewline \hline
 \bfseries Population & 2017 & 13.0 & Million Pers & 0.1\% & 75 \tabularnewline 
 \bfseries  & 2030 & 16.5 & Million Pers & 0.1\% & 74 \tabularnewline \hline
 \bfseries Emissions & 2017 & 6.7 & t CO$_2$eq /  Pers & 0.4\% & 79 \tabularnewline 
 \bfseries per capita & 2030 & 6.9 & t CO$_2$eq /  Pers & 0.4\% & 79 \tabularnewline 
 \end{tabular}
 \end{table}

 For Israel, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (77.3\%), followed by IPPU (9.9\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 78.6\% of the national emissions. 
 Second largest contributor was CH$_4$ (13.2\%)
 The total of F-gasesonly represented 4.2\%.
 The total CO$_2$ emissions are expected to be 80.8\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ISR/ts_emi_exclLU_ISR.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ISR/ts_gdp_pop_ISR.png}
 ...
 Israel's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Israel are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 15, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.3~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 87.2~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -0.4---0.2~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ISR/ts_emi_onlyLU_ISR.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Israel's NDC (if needed). 
 ...
 Israel has an NDC, with a GHG mitigation target of the type AEI (absolute emissions intensity target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Israel's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & uncondi. & best & 81.65 Mt~CO$_2$eq SAR & 2005 & 2030 & POP & exclLU \tabularnewline 
 AEI & uncondi. & best & 8.80 t~CO$_2$eq SAR/capita & 2005 & 2025 & POP & exclLU \tabularnewline \hline
 AEI & uncondi. & best & 7.70 t~CO$_2$eq SAR/capita & 2005 & 2030 & POP & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ISR/ts_pc_cov_ISR.png}
 \caption{Timeseries of Israel's national emissions (exclLU) and the share of emissions that is assumed to be covered by Israel's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Israel's 2017 emissions (exclLU, exclBunkers; total 87.2~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 74.6\% & \bfseries 2.5\% & \bfseries 0.2\% & / & / & / & / & 77.3\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 4.0\% & \bfseries 0.0\% & \bfseries 1.6\% & \bfseries 3.8\% & \bfseries 0.1\% & \bfseries 0.2\% & / & 9.9\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.01\% & \bfseries 1.2\% & \bfseries 1.5\% & / & / & / & / & 2.7\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 9.5\% & \bfseries 0.3\% & / & / & / & / & 9.8\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 78.6\% & 13.2\% & 3.9\% & 3.8\% & 0.1\% & 0.2\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ISR/ts_ndcs_quantis_ISR.png}
