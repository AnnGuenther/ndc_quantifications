\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Ghana: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 32.9~Mt CO$_2$eq, Ghana contributed 0.06\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.09\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Ghana is estimated to emit 54.6~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 66.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 50.3--74.0~Mt CO$_2$eq in 2030, and 85.8--265.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 175 in 2017, and 194 regarding the per-capita emissions (180 and 184 in 2030).
 In terms of accumulated historical emissions, Ghana contributed to the global 1850--2017 emissions by 0.03\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Ghana, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 32.9 & Mt CO$_2$eq & 0.06\% & 104 \tabularnewline 
 \bfseries  & 2030 & 54.6 & Mt CO$_2$eq & 0.09\% & 93 \tabularnewline \hline
 \bfseries GDP & 2017 & 146.2 & Billion 2011~GK\$ & 0.1\% & 72 \tabularnewline 
 \bfseries  & 2030 & 334.8 & Billion 2011~GK\$ & 0.1\% & 63 \tabularnewline \hline
 \bfseries Emissions & 2017 & 224.8 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 175 \tabularnewline 
 \bfseries per GDP & 2030 & 163.1 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 180 \tabularnewline \hline
 \bfseries Population & 2017 & 29.1 & Million Pers & 0.3\% & 47 \tabularnewline 
 \bfseries  & 2030 & 36.8 & Million Pers & 0.4\% & 44 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.1 & t CO$_2$eq /  Pers & 0.07\% & 194 \tabularnewline 
 \bfseries per capita & 2030 & 1.5 & t CO$_2$eq /  Pers & 0.1\% & 184 \tabularnewline 
 \end{tabular}
 \end{table}

 For Ghana, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (58.9\%), followed by Agriculture (26.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  44.2\% of the national emissions. 
 Second largest contributor was CO$_2$ (40.5\%)
 The total of F-gasesonly represented 0.06\%.
 The total CO$_2$ emissions are expected to be 56.0\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GHA/ts_emi_exclLU_GHA.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GHA/ts_gdp_pop_GHA.png}
 ...
 Ghana's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Ghana are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 17, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net source of 5.8~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 32.9~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -28.6--9.8~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GHA/ts_emi_onlyLU_GHA.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Ghana's NDC (if needed). 
 ...
 Ghana has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Ghana's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 47.079 Mt~CO$_2$eq SAR & 2025 & inclLU \tabularnewline 
 ABS & condi. & best & 39.049 Mt~CO$_2$eq SAR & 2025 & inclLU \tabularnewline 
 ABS & uncondi. & best & 62.85 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 40.67 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -12\% & 2025 & inclLU \tabularnewline 
 RBU & condi. & best & -27\% & 2025 & inclLU \tabularnewline 
 RBU & uncondi. & best & -15\% & 2030 & inclLU \tabularnewline 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GHA/ts_pc_cov_GHA.png}
 \caption{Timeseries of Ghana's national emissions (exclLU) and the share of emissions that is assumed to be covered by Ghana's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Ghana's 2017 emissions (exclLU, exclBunkers; total 32.9~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 5.8~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 38.4\% & \bfseries 19.5\% & \bfseries 1.0\% & / & / & / & / & 58.9\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 2.1\% & \bfseries / & \bfseries 0.0\% & \bfseries 0.06\% & 0.0\% & / & / & 2.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 13.3\% & \bfseries 12.9\% & / & / & / & / & 26.2\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 11.4\% & \bfseries 0.7\% & / & / & / & / & 12.0\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.7\% & / & / & / & / & 0.7\% \tabularnewline \hline
 \bfseries Total &  &  & 40.5\% & 44.2\% & 15.3\% & 0.06\% & 0.0\% & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GHA/ts_ndcs_quantis_GHA.png}
