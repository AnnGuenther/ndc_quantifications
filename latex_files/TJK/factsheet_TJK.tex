\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Tajikistan: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 11.7~Mt CO$_2$eq, Tajikistan contributed 0.02\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Tajikistan is estimated to emit 14.9~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 27.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 14.9--20.4~Mt CO$_2$eq in 2030, and 20.7--40.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 117 in 2017, and 187 regarding the per-capita emissions (135 and 182 in 2030).
 In terms of accumulated historical emissions, Tajikistan contributed to the global 1850--2017 emissions by 0.04\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 0.03\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Tajikistan, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 11.7 & Mt CO$_2$eq & 0.02\% & 140 \tabularnewline 
 \bfseries  & 2030 & 14.9 & Mt CO$_2$eq & 0.02\% & 138 \tabularnewline \hline
 \bfseries GDP & 2017 & 31.4 & Billion 2011~GK\$ & 0.02\% & 127 \tabularnewline 
 \bfseries  & 2030 & 61.0 & Billion 2011~GK\$ & 0.03\% & 122 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 117 \tabularnewline 
 \bfseries per GDP & 2030 & 0.2 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 135 \tabularnewline \hline
 \bfseries Population & 2017 & 8.9 & Million Pers & 0.1\% & 97 \tabularnewline 
 \bfseries  & 2030 & 9.5 & Million Pers & 0.1\% & 96 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.3 & t CO$_2$eq /  Pers & 0.08\% & 187 \tabularnewline 
 \bfseries per capita & 2030 & 1.6 & t CO$_2$eq /  Pers & 0.1\% & 182 \tabularnewline 
 \end{tabular}
 \end{table}

 For Tajikistan, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (65.5\%), followed by Energy (16.7\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  44.2\% of the national emissions. 
 Second largest contributor was N$_2$O (29.2\%)
 The total of F-gasesonly represented 0.3\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Agriculture sector, and CO$_2$ emissions from the IPPU sector, which contributed 37.2\% and 10.6\% to Tajikistan's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 38.2\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TJK/ts_emi_exclLU_TJK.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TJK/ts_gdp_pop_TJK.png}
 ...
 Tajikistan's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Tajikistan are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 21, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -2.1~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 11.7~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -2.1---1.9~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TJK/ts_emi_onlyLU_TJK.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Tajikistan's NDC (if needed). 
 ...
 Tajikistan has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Tajikistan's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & uncondi. & worst & 22.94 Mt~CO$_2$eq AR4 & 1990 & 2030 & inclLU \tabularnewline 
 ABS & uncondi. & best & 20.39 Mt~CO$_2$eq AR4 & 1990 & 2030 & inclLU \tabularnewline 
 ABS & condi. & worst & 19.12 Mt~CO$_2$eq AR4 & 1990 & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 16.57 Mt~CO$_2$eq AR4 & 1990 & 2030 & inclLU \tabularnewline \hline
 RBY & uncondi. & worst & -10\% & 1990 & 2030 & inclLU \tabularnewline 
 RBY & uncondi. & best & -20\% & 1990 & 2030 & inclLU \tabularnewline 
 RBY & condi. & worst & -25\% & 1990 & 2030 & inclLU \tabularnewline 
 RBY & condi. & best & -35\% & 1990 & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TJK/ts_pc_cov_TJK.png}
 \caption{Timeseries of Tajikistan's national emissions (exclLU) and the share of emissions that is assumed to be covered by Tajikistan's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Tajikistan's 2017 emissions (exclLU, exclBunkers; total 11.7~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 15.7\% & \bfseries 0.9\% & \bfseries 0.07\% & / & / & / & / & 16.7\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 10.6\% & \bfseries / & \bfseries 0.0\% & 0.3\% & 0.0\% & / & / & 10.9\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 37.2\% & \bfseries 28.3\% & / & / & / & / & 65.5\% \tabularnewline 
 \bfseries Waste & / & -- & / & 6.0\% & 0.7\% & / & / & / & / & 6.8\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.06\% & / & / & / & / & 0.06\% \tabularnewline \hline
 \bfseries Total &  &  & 26.3\% & 44.2\% & 29.2\% & 0.3\% & 0.0\% & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TJK/ts_ndcs_quantis_TJK.png}
