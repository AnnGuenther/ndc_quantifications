\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Taiwan: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 320.9~Mt CO$_2$eq, Taiwan contributed 0.7\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.4\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Taiwan is estimated to emit 278.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial decrease of -13.4\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 239.2--305.7~Mt CO$_2$eq in 2030, and 174.4--305.5~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 147 in 2017, and 24 regarding the per-capita emissions (173 and 27 in 2030).
 In terms of accumulated historical emissions, Taiwan contributed to the global 1850--2017 emissions by 0.4\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.7\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Taiwan, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 320.9 & Mt CO$_2$eq & 0.7\% & 30 \tabularnewline 
 \bfseries  & 2030 & 278.0 & Mt CO$_2$eq & 0.4\% & 35 \tabularnewline \hline
 \bfseries GDP & 2017 & 1.1 & Trillion 2011~GK\$ & 1.0\% & 21 \tabularnewline 
 \bfseries  & 2030 & 1.5 & Trillion 2011~GK\$ & 0.8\% & 25 \tabularnewline \hline
 \bfseries Emissions & 2017 & 288.4 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 147 \tabularnewline 
 \bfseries per GDP & 2030 & 188.4 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 173 \tabularnewline \hline
 \bfseries Population & 2017 & 23.7 & Million Pers & 0.3\% & 56 \tabularnewline 
 \bfseries  & 2030 & 23.5 & Million Pers & 0.2\% & 60 \tabularnewline \hline
 \bfseries Emissions & 2017 & 13.6 & t CO$_2$eq /  Pers & 0.9\% & 24 \tabularnewline 
 \bfseries per capita & 2030 & 11.8 & t CO$_2$eq /  Pers & 0.8\% & 27 \tabularnewline 
 \end{tabular}
 \end{table}

 For Taiwan, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (87.2\%), followed by IPPU (8.7\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 91.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (3.2\%)
 The total of F-gasesonly represented 3.8\%.
 The total CO$_2$ emissions are expected to be 87.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TWN/ts_emi_exclLU_TWN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TWN/ts_gdp_pop_TWN.png}
 ...
 Taiwan's population is assumed to diminish towars 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Taiwan are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.0009~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 320.9~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 0.0--0.009~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TWN/ts_emi_onlyLU_TWN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Taiwan's NDC (if needed). 
