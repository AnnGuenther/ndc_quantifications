\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Bahamas: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 3.3~Mt CO$_2$eq, Bahamas contributed 0.007\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.006\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Bahamas is estimated to emit 3.7~Mt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 9.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 3.5--4.4~Mt CO$_2$eq in 2030, and 3.4--5.2~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 139 in 2017, and 47 regarding the per-capita emissions (129 and 54 in 2030).
 In terms of accumulated historical emissions, Bahamas contributed to the global 1850--2017 emissions by 0.008\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 0.006\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Bahamas, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 3.3 & Mt CO$_2$eq & 0.007\% & 162 \tabularnewline 
 \bfseries  & 2030 & 3.7 & Mt CO$_2$eq & 0.006\% & 163 \tabularnewline \hline
 \bfseries GDP & 2017 & 11.0 & Billion 2011~GK\$ & 0.009\% & 153 \tabularnewline 
 \bfseries  & 2030 & 14.4 & Billion 2011~GK\$ & 0.008\% & 159 \tabularnewline \hline
 \bfseries Emissions & 2017 & 305.0 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 139 \tabularnewline 
 \bfseries per GDP & 2030 & 255.2 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 129 \tabularnewline \hline
 \bfseries Population & 2017 & 381.8 & Thousand Pers & 0.005\% & 172 \tabularnewline 
 \bfseries  & 2030 & 435.5 & Thousand Pers & 0.005\% & 172 \tabularnewline \hline
 \bfseries Emissions & 2017 & 8.8 & t CO$_2$eq /  Pers & 0.6\% & 47 \tabularnewline 
 \bfseries per capita & 2030 & 8.4 & t CO$_2$eq /  Pers & 0.6\% & 54 \tabularnewline 
 \end{tabular}
 \end{table}

 For Bahamas, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (77.4\%), followed by IPPU (14.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 89.6\% of the national emissions. 
 Second largest contributor was CH$_4$ (6.9\%)
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BHS/ts_emi_exclLU_BHS.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BHS/ts_gdp_pop_BHS.png}
 ...
 Bahamas's population is assumed to grow towards 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Bahamas are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 1.1~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 3.3~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is -1.4--5.0~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BHS/ts_emi_onlyLU_BHS.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Bahamas's NDC (if needed). 
 ...
 Bahamas has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Bahamas's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BHS/ts_pc_cov_BHS.png}
 \caption{Timeseries of Bahamas's national emissions (exclLU) and the share of emissions that is assumed to be covered by Bahamas's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Bahamas's 2017 emissions (exclLU, exclBunkers; total 3.3~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 1.1~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 75.4\% & \bfseries 1.4\% & \bfseries 0.6\% & / & / & / & / & 77.4\% \tabularnewline 
 \bfseries IPPU & / & \bfseries + & \bfseries 14.2\% & \bfseries / & \bfseries 0.0\% & / & / & / & / & 14.2\% \tabularnewline 
 \bfseries Agri. & / & \bfseries + & \bfseries 0.0\% & \bfseries 0.2\% & \bfseries 0.7\% & / & / & / & / & 0.9\% \tabularnewline 
 \bfseries Waste & / & \bfseries + & \bfseries / & \bfseries 5.2\% & \bfseries 0.1\% & / & / & / & / & 5.4\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 2.1\% & / & / & / & / & 2.1\% \tabularnewline \hline
 \bfseries Total &  &  & 89.6\% & 6.9\% & 3.5\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BHS/ts_ndcs_quantis_BHS.png}
