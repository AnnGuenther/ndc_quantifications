\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Nigeria: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 0.3~Gt CO$_2$eq, Nigeria contributed 0.7\% to global emissions in 2017, while in 2030 its share is estimated to increase to 1.0\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Nigeria is estimated to emit 0.5~Gt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 58.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 0.5--0.7~Gt CO$_2$eq in 2030, and 0.9--2.3~Gt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 107 in 2017, and 175 regarding the per-capita emissions (128 and 166 in 2030).
 In terms of accumulated historical emissions, Nigeria contributed to the global 1850--2017 emissions by 0.7\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Nigeria, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 0.3 & Gt CO$_2$eq & 0.7\% & 28 \tabularnewline 
 \bfseries  & 2030 & 0.5 & Gt CO$_2$eq & 1.0\% & 19 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.8 & Trillion 2011~GK\$ & 0.7\% & 26 \tabularnewline 
 \bfseries  & 2030 & 2.1 & Trillion 2011~GK\$ & 1.1\% & 18 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 107 \tabularnewline 
 \bfseries per GDP & 2030 & 0.2 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 128 \tabularnewline \hline
 \bfseries Population & 2017 & 190.9 & Million Pers & 2.5\% & 7 \tabularnewline 
 \bfseries  & 2030 & 256.0 & Million Pers & 3.0\% & 5 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.8 & t CO$_2$eq /  Pers & 0.1\% & 175 \tabularnewline 
 \bfseries per capita & 2030 & 2.1 & t CO$_2$eq /  Pers & 0.1\% & 166 \tabularnewline 
 \end{tabular}
 \end{table}

 For Nigeria, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (61.1\%), followed by Agriculture (24.7\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  50.7\% of the national emissions. 
 Second largest contributor was CO$_2$ (36.1\%)
 The total of F-gasesonly represented 0.4\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Agriculture sector, which contributed 15.1\% to Nigeria's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 47.7\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NGA/ts_emi_exclLU_NGA.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NGA/ts_gdp_pop_NGA.png}
 ...
 Nigeria's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Nigeria are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.1~Gt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 0.3~Gt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 0.1--0.1~Gt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NGA/ts_emi_onlyLU_NGA.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Nigeria's NDC (if needed). 
 ...
 Nigeria has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Nigeria's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 720 Mt~CO$_2$eq AR4 & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 495 Mt~CO$_2$eq AR4 & 2030 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -20\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -45\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NGA/ts_pc_cov_NGA.png}
 \caption{Timeseries of Nigeria's national emissions (exclLU) and the share of emissions that is assumed to be covered by Nigeria's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Nigeria's 2017 emissions (exclLU, exclBunkers; total 0.3~Gt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 0.1~Gt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 33.0\% & \bfseries 26.4\% & \bfseries 1.7\% & / & / & / & / & 61.1\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 3.0\% & \bfseries 0.0\% & \bfseries 0.0\% & 0.2\% & 0.0\% & 0.1\% & / & 3.5\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.09\% & \bfseries 15.1\% & \bfseries 9.5\% & / & / & / & / & 24.7\% \tabularnewline 
 \bfseries Waste & / & -- & / & 9.2\% & 0.7\% & / & / & / & / & 9.9\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.9\% & / & / & / & / & 0.9\% \tabularnewline \hline
 \bfseries Total &  &  & 36.1\% & 50.7\% & 12.7\% & 0.2\% & 0.0\% & 0.1\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NGA/ts_ndcs_quantis_NGA.png}
