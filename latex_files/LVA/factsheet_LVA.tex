\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Latvia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 11.8~Mt CO$_2$eq, Latvia contributed 0.02\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Latvia is estimated to emit 13.1~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 10.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 11.8--15.7~Mt CO$_2$eq in 2030, and 11.8--25.4~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 172 in 2017, and 86 regarding the per-capita emissions (165 and 73 in 2030).
 In terms of accumulated historical emissions, Latvia contributed to the global 1850--2017 emissions by 0.05\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Latvia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 11.8 & Mt CO$_2$eq & 0.02\% & 139 \tabularnewline 
 \bfseries  & 2030 & 13.1 & Mt CO$_2$eq & 0.02\% & 141 \tabularnewline \hline
 \bfseries GDP & 2017 & 51.6 & Billion 2011~GK\$ & 0.04\% & 107 \tabularnewline 
 \bfseries  & 2030 & 67.8 & Billion 2011~GK\$ & 0.03\% & 118 \tabularnewline \hline
 \bfseries Emissions & 2017 & 229.5 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 172 \tabularnewline 
 \bfseries per GDP & 2030 & 193.6 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 165 \tabularnewline \hline
 \bfseries Population & 2017 & 2.0 & Million Pers & 0.02\% & 148 \tabularnewline 
 \bfseries  & 2030 & 1.8 & Million Pers & 0.02\% & 150 \tabularnewline \hline
 \bfseries Emissions & 2017 & 6.1 & t CO$_2$eq /  Pers & 0.4\% & 86 \tabularnewline 
 \bfseries per capita & 2030 & 7.2 & t CO$_2$eq /  Pers & 0.4\% & 73 \tabularnewline 
 \end{tabular}
 \end{table}

 For Latvia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (61.2\%), followed by Agriculture (23.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  64.7\% of the national emissions. 
 Second largest contributor was N$_2$O (17.6\%)
 The total of F-gasesonly represented 2.1\%.
 The total CO$_2$ emissions are expected to be 65.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LVA/ts_emi_exclLU_LVA.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LVA/ts_gdp_pop_LVA.png}
 ...
 Latvia's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Latvia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -1.7~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 11.8~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -13.5--3.0~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LVA/ts_emi_onlyLU_LVA.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Latvia's NDC (if needed). 
 ...
 Latvia has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Latvia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Latvia is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LVA/ts_pc_cov_LVA.png}
 \caption{Timeseries of Latvia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Latvia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Latvia's 2017 emissions (exclLU, exclBunkers; total 11.8~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -1.7~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 56.7\% & \bfseries 2.9\% & \bfseries 1.6\% & / & / & / & / & 61.2\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 7.8\% & \bfseries 0.0\% & \bfseries 0.03\% & \bfseries 2.0\% & \bfseries 0.07\% & \bfseries 0.08\% & \bfseries / & 9.9\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.2\% & \bfseries 8.3\% & \bfseries 15.0\% & / & / & / & / & 23.6\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 4.3\% & \bfseries 0.4\% & / & / & / & / & 4.8\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 64.7\% & 15.5\% & 17.6\% & 2.0\% & 0.07\% & 0.08\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LVA/ts_ndcs_quantis_LVA.png}
