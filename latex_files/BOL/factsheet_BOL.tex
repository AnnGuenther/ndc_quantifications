\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Bolivia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 92.0~Mt CO$_2$eq, Bolivia contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Bolivia is estimated to emit 107.8~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 17.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 107.8--169.2~Mt CO$_2$eq in 2030, and 138.2--223.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 10 in 2017, and 56 regarding the per-capita emissions (11 and 55 in 2030).
 In terms of accumulated historical emissions, Bolivia contributed to the global 1850--2017 emissions by 0.08\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Bolivia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 92.0 & Mt CO$_2$eq & 0.1\% & 59 \tabularnewline 
 \bfseries  & 2030 & 107.8 & Mt CO$_2$eq & 0.1\% & 57 \tabularnewline \hline
 \bfseries GDP & 2017 & 67.7 & Billion 2011~GK\$ & 0.06\% & 97 \tabularnewline 
 \bfseries  & 2030 & 130.6 & Billion 2011~GK\$ & 0.07\% & 94 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.4 & t CO$_2$eq / Thousand 2011~GK\$ & 1.2\% & 10 \tabularnewline 
 \bfseries per GDP & 2030 & 0.8 & t CO$_2$eq / Thousand 2011~GK\$ & 1.1\% & 11 \tabularnewline \hline
 \bfseries Population & 2017 & 11.2 & Million Pers & 0.1\% & 81 \tabularnewline 
 \bfseries  & 2030 & 12.9 & Million Pers & 0.1\% & 82 \tabularnewline \hline
 \bfseries Emissions & 2017 & 8.2 & t CO$_2$eq /  Pers & 0.6\% & 56 \tabularnewline 
 \bfseries per capita & 2030 & 8.4 & t CO$_2$eq /  Pers & 0.6\% & 55 \tabularnewline 
 \end{tabular}
 \end{table}

 For Bolivia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the IPPU sector (58.1\%), followed by Energy (20.8\%)
 The Kyoto~GHG with the highest emissions in 2017 was HFCs, constituting  55.8\% of the national emissions. 
 Second largest contributor was CH$_4$ (22.4\%)
 The total of F-gasesrepresented 55.8\%.
 The trend in total emissions is mostly driven by F-gases emissions from the IPPU sector, which contributed 55.8\% to Bolivia's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 26.8\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BOL/ts_emi_exclLU_BOL.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BOL/ts_gdp_pop_BOL.png}
 ...
 Bolivia's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Bolivia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 6, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net source of 49.6~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 92.0~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is 23.5--49.6~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BOL/ts_emi_onlyLU_BOL.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Bolivia's NDC (if needed). 
 ...
 Bolivia has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BOL/ts_pc_cov_BOL.png}
 \caption{Timeseries of Bolivia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Bolivia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Bolivia's 2017 emissions (exclLU, exclBunkers; total 92.0~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 49.6~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 17.4\% & \bfseries 3.1\% & \bfseries 0.2\% & / & / & / & / & 20.8\% \tabularnewline 
 \bfseries IPPU & / & -- & 2.3\% & / & 0.01\% & 55.8\% & / & / & / & 58.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 16.6\% & \bfseries 1.5\% & / & / & / & / & 18.0\% \tabularnewline 
 \bfseries Waste & / & -- & / & 2.7\% & 0.2\% & / & / & / & / & 2.9\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 19.7\% & 22.4\% & 2.2\% & 55.8\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BOL/ts_ndcs_quantis_BOL.png}
