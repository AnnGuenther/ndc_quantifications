\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Kazakhstan: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 355.1~Mt CO$_2$eq, Kazakhstan contributed 0.7\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.8\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Kazakhstan is estimated to emit 431.8~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 21.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 431.8--593.4~Mt CO$_2$eq in 2030, and 424.2--771.0~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 25 in 2017, and 13 regarding the per-capita emissions (36 and 9 in 2030).
 In terms of accumulated historical emissions, Kazakhstan contributed to the global 1850--2017 emissions by 0.9\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 0.7\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Kazakhstan, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 355.1 & Mt CO$_2$eq & 0.7\% & 25 \tabularnewline 
 \bfseries  & 2030 & 431.8 & Mt CO$_2$eq & 0.8\% & 23 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.4 & Trillion 2011~GK\$ & 0.3\% & 45 \tabularnewline 
 \bfseries  & 2030 & 0.8 & Trillion 2011~GK\$ & 0.4\% & 36 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.9 & t CO$_2$eq / Thousand 2011~GK\$ & 0.8\% & 25 \tabularnewline 
 \bfseries per GDP & 2030 & 0.5 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 36 \tabularnewline \hline
 \bfseries Population & 2017 & 18.1 & Million Pers & 0.2\% & 63 \tabularnewline 
 \bfseries  & 2030 & 19.6 & Million Pers & 0.2\% & 67 \tabularnewline \hline
 \bfseries Emissions & 2017 & 19.6 & t CO$_2$eq /  Pers & 1.3\% & 13 \tabularnewline 
 \bfseries per capita & 2030 & 22.0 & t CO$_2$eq /  Pers & 1.5\% & 9 \tabularnewline 
 \end{tabular}
 \end{table}

 For Kazakhstan, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (81.3\%), followed by Agriculture (9.7\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 79.9\% of the national emissions. 
 Second largest contributor was CH$_4$ (14.8\%)
 The total of F-gasesonly represented 0.3\%.
 The total CO$_2$ emissions are expected to be 80.9\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KAZ/ts_emi_exclLU_KAZ.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KAZ/ts_gdp_pop_KAZ.png}
 ...
 Kazakhstan's population is assumed to grow towards 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 

 LULUCF emissions data for Kazakhstan are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -7.1~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 355.1~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -31.1---3.9~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KAZ/ts_emi_onlyLU_KAZ.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Kazakhstan's NDC (if needed). 
 ...
 Kazakhstan has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Kazakhstan's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 RBY & uncondi. & best & -15\% & 1990 & 2030 & inclLU \tabularnewline 
 RBY & condi. & best & -25\% & 1990 & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KAZ/ts_pc_cov_KAZ.png}
 \caption{Timeseries of Kazakhstan's national emissions (exclLU) and the share of emissions that is assumed to be covered by Kazakhstan's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Kazakhstan's 2017 emissions (exclLU, exclBunkers; total 355.1~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -7.1~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 72.9\% & \bfseries 8.2\% & \bfseries 0.3\% & / & / & / & / & 81.3\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 7.1\% & \bfseries 0.0\% & \bfseries 0.05\% & \bfseries 0.1\% & \bfseries 0.1\% & \bfseries 0.0\% & / & 7.5\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 5.6\% & \bfseries 4.0\% & / & / & / & / & 9.7\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 1.0\% & \bfseries 0.09\% & / & / & / & / & 1.1\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 79.9\% & 14.8\% & 4.9\% & 0.1\% & 0.1\% & 0.0\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KAZ/ts_ndcs_quantis_KAZ.png}
