\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Cuba: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 49.1~Mt CO$_2$eq, Cuba contributed 0.1\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.08\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Cuba is estimated to emit 49.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -0.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 49.0--65.2~Mt CO$_2$eq in 2030, and 50.0--76.9~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 76 in 2017, and 107 regarding the per-capita emissions (64 and 112 in 2030).
 In terms of accumulated historical emissions, Cuba contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Cuba, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 49.1 & Mt CO$_2$eq & 0.1\% & 85 \tabularnewline 
 \bfseries  & 2030 & 49.0 & Mt CO$_2$eq & 0.08\% & 100 \tabularnewline \hline
 \bfseries GDP & 2017 & 93.0 & Billion 2011~GK\$ & 0.08\% & 83 \tabularnewline 
 \bfseries  & 2030 & 121.1 & Billion 2011~GK\$ & 0.06\% & 96 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.5 & t CO$_2$eq / Thousand 2011~GK\$ & 0.4\% & 76 \tabularnewline 
 \bfseries per GDP & 2030 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.5\% & 64 \tabularnewline \hline
 \bfseries Population & 2017 & 11.3 & Million Pers & 0.1\% & 80 \tabularnewline 
 \bfseries  & 2030 & 10.9 & Million Pers & 0.1\% & 90 \tabularnewline \hline
 \bfseries Emissions & 2017 & 4.3 & t CO$_2$eq /  Pers & 0.2\% & 107 \tabularnewline 
 \bfseries per capita & 2030 & 4.5 & t CO$_2$eq /  Pers & 0.3\% & 112 \tabularnewline 
 \end{tabular}
 \end{table}

 For Cuba, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (76.1\%), followed by Agriculture (14.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 72.4\% of the national emissions. 
 Second largest contributor was CH$_4$ (20.7\%)
 The total of F-gasesonly represented 0.8\%.
 The total CO$_2$ emissions are expected to be 72.8\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CUB/ts_emi_exclLU_CUB.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CUB/ts_gdp_pop_CUB.png}
 ...
 Cuba's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Cuba are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 3, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -13.1~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 49.1~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -13.1---10.6~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CUB/ts_emi_onlyLU_CUB.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Cuba's NDC (if needed). 
 ...
 Cuba has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 The reclassified target type is ABU (absolute reduction compared to Business-As-Usual).

 \begin{table}[H]
 \centering
 \caption{Information on Cuba's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABU & condi. & best & -6 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CUB/ts_pc_cov_CUB.png}
 \caption{Timeseries of Cuba's national emissions (exclLU) and the share of emissions that is assumed to be covered by Cuba's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Cuba's 2017 emissions (exclLU, exclBunkers; total 49.1~Mt CO$_2$eq).
 ...
 LULUCF: NDC '/' and adapted '--' (estimated as a net sink of -13.1~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 69.4\% & \bfseries 6.5\% & \bfseries 0.1\% & / & / & / & / & 76.1\% \tabularnewline 
 \bfseries IPPU & / & -- & 2.9\% & / & 0.0\% & 0.8\% & / & / & / & 3.7\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 9.3\% & \bfseries 5.3\% & / & / & / & / & 14.6\% \tabularnewline 
 \bfseries Waste & / & -- & / & 4.9\% & 0.4\% & / & / & / & / & 5.3\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 72.4\% & 20.7\% & 6.1\% & 0.8\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CUB/ts_ndcs_quantis_CUB.png}
