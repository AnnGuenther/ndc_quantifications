\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Papua New Guinea: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 15.7~Mt CO$_2$eq, Papua New Guinea contributed 0.03\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Papua New Guinea is estimated to emit 17.4~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 10.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 15.5--18.9~Mt CO$_2$eq in 2030, and 23.5--44.5~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 86 in 2017, and 170 regarding the per-capita emissions (111 and 176 in 2030).
 In terms of accumulated historical emissions, Papua New Guinea contributed to the global 1850--2017 emissions by 0.02\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Papua New Guinea, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 15.7 & Mt CO$_2$eq & 0.03\% & 128 \tabularnewline 
 \bfseries  & 2030 & 17.4 & Mt CO$_2$eq & 0.03\% & 129 \tabularnewline \hline
 \bfseries GDP & 2017 & 32.7 & Billion 2011~GK\$ & 0.02\% & 125 \tabularnewline 
 \bfseries  & 2030 & 60.6 & Billion 2011~GK\$ & 0.03\% & 123 \tabularnewline \hline
 \bfseries Emissions & 2017 & 480.0 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 86 \tabularnewline 
 \bfseries per GDP & 2030 & 287.0 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 111 \tabularnewline \hline
 \bfseries Population & 2017 & 8.4 & Million Pers & 0.1\% & 101 \tabularnewline 
 \bfseries  & 2030 & 10.3 & Million Pers & 0.1\% & 95 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.9 & t CO$_2$eq /  Pers & 0.1\% & 170 \tabularnewline 
 \bfseries per capita & 2030 & 1.7 & t CO$_2$eq /  Pers & 0.1\% & 176 \tabularnewline 
 \end{tabular}
 \end{table}

 For Papua New Guinea, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (60.2\%), followed by Agriculture (29.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  50.9\% of the national emissions. 
 Second largest contributor was N$_2$O (25.8\%)
 The total of F-gasesonly represented 1.1\%.
 The total CO$_2$ emissions are expected to be 52.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PNG/ts_emi_exclLU_PNG.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PNG/ts_gdp_pop_PNG.png}
 ...
 Papua New Guinea's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Papua New Guinea are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 56.2~Mt CO$_2$eq, which in absolute terms is higher than the non-LULUCF emissions of 15.7~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 39.0--156.9~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PNG/ts_emi_onlyLU_PNG.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Papua New Guinea's NDC (if needed). 
 ...
 Papua New Guinea has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PNG/ts_pc_cov_PNG.png}
 \caption{Timeseries of Papua New Guinea's national emissions (exclLU) and the share of emissions that is assumed to be covered by Papua New Guinea's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Papua New Guinea's 2017 emissions (exclLU, exclBunkers; total 15.7~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 56.2~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 49.7\% & 9.9\% & 0.6\% & / & / & / & / & 60.2\% \tabularnewline 
 \bfseries IPPU & / & -- & 1.2\% & / & 0.0\% & 1.1\% & / & / & / & 2.3\% \tabularnewline 
 \bfseries Agri. & / & -- & / & 6.4\% & 22.6\% & / & / & / & / & 29.0\% \tabularnewline 
 \bfseries Waste & / & -- & 0.0\% & 5.9\% & 1.8\% & / & / & / & / & 7.7\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.8\% & / & / & / & / & 0.8\% \tabularnewline \hline
 \bfseries Total &  &  & 50.9\% & 22.2\% & 25.8\% & 1.1\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PNG/ts_ndcs_quantis_PNG.png}
