\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Guatemala: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 34.2~Mt CO$_2$eq, Guatemala contributed 0.07\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.09\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Guatemala is estimated to emit 51.3~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 49.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 47.8--64.0~Mt CO$_2$eq in 2030, and 70.0--142.6~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 152 in 2017, and 164 regarding the per-capita emissions (139 and 151 in 2030).
 In terms of accumulated historical emissions, Guatemala contributed to the global 1850--2017 emissions by 0.04\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Guatemala, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 34.2 & Mt CO$_2$eq & 0.07\% & 100 \tabularnewline 
 \bfseries  & 2030 & 51.3 & Mt CO$_2$eq & 0.09\% & 97 \tabularnewline \hline
 \bfseries GDP & 2017 & 125.2 & Billion 2011~GK\$ & 0.1\% & 79 \tabularnewline 
 \bfseries  & 2030 & 221.2 & Billion 2011~GK\$ & 0.1\% & 80 \tabularnewline \hline
 \bfseries Emissions & 2017 & 273.3 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 152 \tabularnewline 
 \bfseries per GDP & 2030 & 231.9 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 139 \tabularnewline \hline
 \bfseries Population & 2017 & 16.9 & Million Pers & 0.2\% & 67 \tabularnewline 
 \bfseries  & 2030 & 20.8 & Million Pers & 0.2\% & 64 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.0 & t CO$_2$eq /  Pers & 0.1\% & 164 \tabularnewline 
 \bfseries per capita & 2030 & 2.5 & t CO$_2$eq /  Pers & 0.1\% & 151 \tabularnewline 
 \end{tabular}
 \end{table}

 For Guatemala, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (49.3\%), followed by Agriculture (34.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  49.4\% of the national emissions. 
 Second largest contributor was CH$_4$ (26.9\%)
 The total of F-gasesonly represented 3.9\%.
 The total CO$_2$ emissions are expected to be 55.5\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GTM/ts_emi_exclLU_GTM.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GTM/ts_gdp_pop_GTM.png}
 ...
 Guatemala's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Guatemala are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 4, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -16.0~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 34.2~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -39.5---16.0~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GTM/ts_emi_onlyLU_GTM.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Guatemala's NDC (if needed). 
 ...
 Guatemala has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Guatemala's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 47.81 Mt~CO$_2$eq SAr & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 41.65 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -11.2\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -22.6\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GTM/ts_pc_cov_GTM.png}
 \caption{Timeseries of Guatemala's national emissions (exclLU) and the share of emissions that is assumed to be covered by Guatemala's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Guatemala's 2017 emissions (exclLU, exclBunkers; total 34.2~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -16.0~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 42.1\% & \bfseries 6.2\% & \bfseries 1.0\% & / & / & / & / & 49.3\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 6.5\% & \bfseries / & \bfseries 0.0\% & 3.9\% & / & / & / & 10.4\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.8\% & \bfseries 15.9\% & \bfseries 17.3\% & / & / & / & / & 34.0\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 4.9\% & \bfseries 0.7\% & / & / & / & / & 5.6\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.7\% & / & / & / & / & 0.7\% \tabularnewline \hline
 \bfseries Total &  &  & 49.4\% & 26.9\% & 19.7\% & 3.9\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GTM/ts_ndcs_quantis_GTM.png}
