\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Palau: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 321.8~kt CO$_2$eq, Palau contributed 0.0006\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.0005\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Palau is estimated to emit 281.2~kt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial decrease of -12.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 281.2--281.2~kt CO$_2$eq in 2030, and 281.2--281.2~kt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 16 in 2017, and 15 regarding the per-capita emissions (8 and 18 in 2030).
 In terms of accumulated historical emissions, Palau contributed to the global 1850--2017 emissions by 0.0004\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Palau, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 321.8 & kt CO$_2$eq & 0.0006\% & 186 \tabularnewline 
 \bfseries  & 2030 & 281.2 & kt CO$_2$eq & 0.0005\% & 186 \tabularnewline \hline
 \bfseries GDP & 2017 & 293.4 & Million 2011~GK\$ & 0.0002\% & 194 \tabularnewline 
 \bfseries  & 2030 & 283.8 & Million 2011~GK\$ & 0.0001\% & 194 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.1 & t CO$_2$eq / Thousand 2011~GK\$ & 1.0\% & 16 \tabularnewline 
 \bfseries per GDP & 2030 & 1.0 & t CO$_2$eq / Thousand 2011~GK\$ & 1.3\% & 8 \tabularnewline \hline
 \bfseries Population & 2017 & 17.8 & Thousand Pers & 0.0002\% & 198 \tabularnewline 
 \bfseries  & 2030 & 17.7 & Thousand Pers & 0.0002\% & 199 \tabularnewline \hline
 \bfseries Emissions & 2017 & 18.1 & t CO$_2$eq /  Pers & 1.2\% & 15 \tabularnewline 
 \bfseries per capita & 2030 & 15.9 & t CO$_2$eq /  Pers & 1.1\% & 18 \tabularnewline 
 \end{tabular}
 \end{table}

 For Palau, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (99.2\%), followed by Waste (0.7\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 99.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (0.7\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 99.0\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PLW/ts_emi_exclLU_PLW.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PLW/ts_gdp_pop_PLW.png}
 ...
 Palau's population is assumed to diminish towars 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Palau are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.0~kt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 321.8~kt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -146.7--0.0~kt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PLW/ts_emi_onlyLU_PLW.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Palau's NDC (if needed). 
 ...
 Palau has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Palau's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 RBY & condi. & best & -22\% & 2005 & 2025 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PLW/ts_pc_cov_PLW.png}
 \caption{Timeseries of Palau's national emissions (exclLU) and the share of emissions that is assumed to be covered by Palau's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Palau's 2017 emissions (exclLU, exclBunkers; total 321.8~kt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 99.2\% & \bfseries 0.02\% & 0.05\% & / & / & / & / & 99.2\% \tabularnewline 
 \bfseries IPPU & / & -- & 0.0\% & / & 0.04\% & / & / & / & / & 0.04\% \tabularnewline 
 \bfseries Agri. & / & -- & / & / & / & / & / & / & / & / \tabularnewline 
 \bfseries Waste & \bfseries + & -- & / & 0.7\% & / & / & / & / & / & 0.7\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.03\% & / & / & / & / & 0.03\% \tabularnewline \hline
 \bfseries Total &  &  & 99.2\% & 0.7\% & 0.1\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PLW/ts_ndcs_quantis_PLW.png}
