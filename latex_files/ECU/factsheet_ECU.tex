\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Ecuador: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 64.7~Mt CO$_2$eq, Ecuador contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Ecuador is estimated to emit 87.8~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 35.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 83.7--105.5~Mt CO$_2$eq in 2030, and 116.0--165.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 111 in 2017, and 110 regarding the per-capita emissions (97 and 111 in 2030).
 In terms of accumulated historical emissions, Ecuador contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Ecuador, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 64.7 & Mt CO$_2$eq & 0.1\% & 72 \tabularnewline 
 \bfseries  & 2030 & 87.8 & Mt CO$_2$eq & 0.1\% & 63 \tabularnewline \hline
 \bfseries GDP & 2017 & 166.4 & Billion 2011~GK\$ & 0.1\% & 64 \tabularnewline 
 \bfseries  & 2030 & 275.5 & Billion 2011~GK\$ & 0.1\% & 70 \tabularnewline \hline
 \bfseries Emissions & 2017 & 389.2 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 111 \tabularnewline 
 \bfseries per GDP & 2030 & 318.6 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 97 \tabularnewline \hline
 \bfseries Population & 2017 & 16.8 & Million Pers & 0.2\% & 69 \tabularnewline 
 \bfseries  & 2030 & 19.0 & Million Pers & 0.2\% & 69 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.9 & t CO$_2$eq /  Pers & 0.2\% & 110 \tabularnewline 
 \bfseries per capita & 2030 & 4.6 & t CO$_2$eq /  Pers & 0.3\% & 111 \tabularnewline 
 \end{tabular}
 \end{table}

 For Ecuador, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (69.8\%), followed by Agriculture (20.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  59.9\% of the national emissions. 
 Second largest contributor was CH$_4$ (31.8\%)
 The total of F-gasesonly represented 0.2\%.
 The total CO$_2$ emissions are expected to be 63.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ECU/ts_emi_exclLU_ECU.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ECU/ts_gdp_pop_ECU.png}
 ...
 Ecuador's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Ecuador are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 30.6~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 64.7~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 10.7--42.4~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ECU/ts_emi_onlyLU_ECU.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Ecuador's NDC (if needed). 
 ...
 Ecuador has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Ecuador's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 67.77 Mt~CO$_2$eq SAR & 2025 & exclLU \tabularnewline 
 ABS & condi. & best & 60.82 Mt~CO$_2$eq SAR & 2025 & exclLU \tabularnewline 
 ABS & uncondi. & best & 109.77 Mt~CO$_2$eq SAR & 2025 & inclLU \tabularnewline 
 ABS & condi. & best & 95.82 Mt~CO$_2$eq SAR & 2025 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -9\% & 2025 & exclLU \tabularnewline 
 RBU & condi. & best & -20.9\% & 2025 & exclLU \tabularnewline 
 RBU & uncondi. & best & -10\% & 2025 & inclLU \tabularnewline 
 RBU & condi. & best & -26\% & 2025 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ECU/ts_pc_cov_ECU.png}
 \caption{Timeseries of Ecuador's national emissions (exclLU) and the share of emissions that is assumed to be covered by Ecuador's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Ecuador's 2017 emissions (exclLU, exclBunkers; total 64.7~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 30.6~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 55.7\% & \bfseries 13.8\% & \bfseries 0.3\% & / & / & / & / & 69.8\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 3.7\% & \bfseries 0.0\% & \bfseries 0.02\% & 0.2\% & / & / & / & 4.0\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.4\% & \bfseries 13.2\% & \bfseries 6.5\% & / & / & / & / & 20.2\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 4.8\% & \bfseries 0.3\% & / & / & / & / & 5.2\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.8\% & / & / & / & / & 0.8\% \tabularnewline \hline
 \bfseries Total &  &  & 59.9\% & 31.8\% & 8.0\% & 0.2\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ECU/ts_ndcs_quantis_ECU.png}
