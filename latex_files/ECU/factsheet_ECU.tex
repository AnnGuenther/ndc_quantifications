\documentclass[12pt]{article}
 ...
 \label{sec:emiLULUCF}
 LULUCF emissions data for Ecuador are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019).
 ...
 ABS & condi. & best & 95.82 Mt~CO$_2$eq SAR & 2025 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}
