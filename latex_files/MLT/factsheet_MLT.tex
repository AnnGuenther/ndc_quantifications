\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Malta: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 2.2~Mt CO$_2$eq, Malta contributed 0.004\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.005\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Malta is estimated to emit 2.9~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 30.4\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 2.4--3.4~Mt CO$_2$eq in 2030, and 2.8--6.9~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 194 in 2017, and 104 regarding the per-capita emissions (192 and 88 in 2030).
 In terms of accumulated historical emissions, Malta contributed to the global 1850--2017 emissions by 0.005\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.007\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Malta, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 2.2 & Mt CO$_2$eq & 0.004\% & 168 \tabularnewline 
 \bfseries  & 2030 & 2.9 & Mt CO$_2$eq & 0.005\% & 167 \tabularnewline \hline
 \bfseries GDP & 2017 & 17.8 & Billion 2011~GK\$ & 0.01\% & 148 \tabularnewline 
 \bfseries  & 2030 & 22.5 & Billion 2011~GK\$ & 0.01\% & 151 \tabularnewline \hline
 \bfseries Emissions & 2017 & 123.8 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 194 \tabularnewline 
 \bfseries per GDP & 2030 & 127.7 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 192 \tabularnewline \hline
 \bfseries Population & 2017 & 437.9 & Thousand Pers & 0.005\% & 170 \tabularnewline 
 \bfseries  & 2030 & 455.3 & Thousand Pers & 0.005\% & 171 \tabularnewline \hline
 \bfseries Emissions & 2017 & 5.0 & t CO$_2$eq /  Pers & 0.3\% & 104 \tabularnewline 
 \bfseries per capita & 2030 & 6.3 & t CO$_2$eq /  Pers & 0.4\% & 88 \tabularnewline 
 \end{tabular}
 \end{table}

 For Malta, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (73.2\%), followed by IPPU (16.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 74.8\% of the national emissions. 
 Second largest contributor was HFCs (14.1\%)
 The total of F-gasesrepresented 14.1\%.
 The total CO$_2$ emissions are expected to be 74.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MLT/ts_emi_exclLU_MLT.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MLT/ts_gdp_pop_MLT.png}
 ...
 Malta's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Malta are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net source of 0.003~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 2.2~Mt CO$_2$eq.
 The large emissions range for CRF (2019) and 1990--2017 is 0.001--0.004~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MLT/ts_emi_onlyLU_MLT.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Malta's NDC (if needed). 
 ...
 Malta has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Malta's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Malta is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MLT/ts_pc_cov_MLT.png}
 \caption{Timeseries of Malta's national emissions (exclLU) and the share of emissions that is assumed to be covered by Malta's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Malta's 2017 emissions (exclLU, exclBunkers; total 2.2~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 0.003~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 72.6\% & \bfseries 0.3\% & \bfseries 0.3\% & / & / & / & / & 73.2\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 2.2\% & \bfseries / & \bfseries 0.03\% & \bfseries 14.1\% & \bfseries 0.0\% & \bfseries 0.04\% & \bfseries / & 16.3\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 1.6\% & \bfseries 1.3\% & / & / & / & / & 3.0\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.02\% & \bfseries 6.6\% & \bfseries 0.2\% & / & / & / & / & 6.8\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.6\% & / & / & / & / & 0.6\% \tabularnewline \hline
 \bfseries Total &  &  & 74.8\% & 8.5\% & 2.6\% & 14.1\% & 0.0\% & 0.04\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MLT/ts_ndcs_quantis_MLT.png}
