\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Kiribati: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 137.7~kt CO$_2$eq, Kiribati contributed 0.0002\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Kiribati is estimated to emit 121.2~kt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial decrease of -12.0\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 121.2--121.2~kt CO$_2$eq in 2030, and 121.2--121.2~kt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 69 in 2017, and 191 regarding the per-capita emissions (25 and 196 in 2030).
 In terms of accumulated historical emissions, Kiribati contributed to the global 1850--2017 emissions by 0.0001\%. 
 When only accounting for the years 1990--2017, its contribution stays the same to 0.0001\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Kiribati, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 137.7 & kt CO$_2$eq & 0.0002\% & 199 \tabularnewline 
 \bfseries  & 2030 & 121.2 & kt CO$_2$eq & 0.0002\% & 199 \tabularnewline \hline
 \bfseries GDP & 2017 & 231.2 & Million 2011~GK\$ & 0.0002\% & 195 \tabularnewline 
 \bfseries  & 2030 & 211.8 & Million 2011~GK\$ & 0.0001\% & 195 \tabularnewline \hline
 \bfseries Emissions & 2017 & 595.6 & t CO$_2$eq / Million 2011~GK\$ & 0.5\% & 69 \tabularnewline 
 \bfseries per GDP & 2030 & 572.1 & t CO$_2$eq / Million 2011~GK\$ & 0.8\% & 25 \tabularnewline \hline
 \bfseries Population & 2017 & 114.2 & Thousand Pers & 0.001\% & 181 \tabularnewline 
 \bfseries  & 2030 & 110.2 & Thousand Pers & 0.001\% & 184 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.2 & t CO$_2$eq /  Pers & 0.08\% & 191 \tabularnewline 
 \bfseries per capita & 2030 & 1.1 & t CO$_2$eq /  Pers & 0.07\% & 196 \tabularnewline 
 \end{tabular}
 \end{table}

 For Kiribati, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (73.9\%), followed by Waste (20.1\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 72.4\% of the national emissions. 
 Second largest contributor was CH$_4$ (22.6\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 70.0\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KIR/ts_emi_exclLU_KIR.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KIR/ts_gdp_pop_KIR.png}
 ...
 Kiribati's population is assumed to diminish towars 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Kiribati are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -5.2~kt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 137.7~kt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -36.7--0.0~kt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KIR/ts_emi_onlyLU_KIR.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Kiribati's NDC (if needed). 
 ...
 Kiribati has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Kiribati's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 0.063 Mt~CO$_2$eq & 2025 & exclLU \tabularnewline 
 ABS & condi. & best & 0.027 Mt~CO$_2$eq & 2025 & exclLU \tabularnewline 
 ABS & uncondi. & best & 0.068 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 ABS & condi. & best & 0.030 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline \hline
 RBU & uncondi. & best & -13.7\% & 2025 & exclLU \tabularnewline 
 RBU & condi. & best & -62.5\% & 2025 & exclLU \tabularnewline 
 RBU & uncondi. & best & -12.8\% & 2030 & exclLU \tabularnewline 
 RBU & condi. & best & -61.8\% & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KIR/ts_pc_cov_KIR.png}
 \caption{Timeseries of Kiribati's national emissions (exclLU) and the share of emissions that is assumed to be covered by Kiribati's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Kiribati's 2017 emissions (exclLU, exclBunkers; total 137.7~kt CO$_2$eq).
 ...
 LULUCF: NDC '--' and adapted '--' (estimated as a net sink of -5.2~kt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 72.0\% & 1.6\% & 0.3\% & / & / & / & / & 73.9\% \tabularnewline 
 \bfseries IPPU & / & -- & 0.4\% & / & 0.5\% & / & / & / & / & 1.0\% \tabularnewline 
 \bfseries Agri. & / & -- & / & 2.1\% & 2.5\% & / & / & / & / & 4.7\% \tabularnewline 
 \bfseries Waste & / & -- & / & 18.9\% & 1.2\% & / & / & / & / & 20.1\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 72.4\% & 22.6\% & 4.9\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KIR/ts_ndcs_quantis_KIR.png}
