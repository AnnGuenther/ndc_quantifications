\documentclass[12pt]{article}
 ...
 \label{sec:emiLULUCF}
 LULUCF emissions data for Kiribati are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019).
 ...
 ABS & condi. & best & 0.030 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}
