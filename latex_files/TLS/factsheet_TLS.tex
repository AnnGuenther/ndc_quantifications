\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Timor-Leste: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 3.4~Mt CO$_2$eq, Timor-Leste contributed 0.007\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.009\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Timor-Leste is estimated to emit 5.5~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 63.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 5.0--6.5~Mt CO$_2$eq in 2030, and 6.7--14.9~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 108 in 2017, and 142 regarding the per-capita emissions (127 and 131 in 2030).
 In terms of accumulated historical emissions, Timor-Leste contributed to the global 1850--2017 emissions by 0.003\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Timor-Leste, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 3.4 & Mt CO$_2$eq & 0.007\% & 161 \tabularnewline 
 \bfseries  & 2030 & 5.5 & Mt CO$_2$eq & 0.009\% & 157 \tabularnewline \hline
 \bfseries GDP & 2017 & 8.4 & Billion 2011~GK\$ & 0.007\% & 157 \tabularnewline 
 \bfseries  & 2030 & 21.3 & Billion 2011~GK\$ & 0.01\% & 154 \tabularnewline \hline
 \bfseries Emissions & 2017 & 400.7 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 108 \tabularnewline 
 \bfseries per GDP & 2030 & 257.4 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 127 \tabularnewline \hline
 \bfseries Population & 2017 & 1.2 & Million Pers & 0.01\% & 155 \tabularnewline 
 \bfseries  & 2030 & 1.6 & Million Pers & 0.01\% & 152 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.7 & t CO$_2$eq /  Pers & 0.1\% & 142 \tabularnewline 
 \bfseries per capita & 2030 & 3.5 & t CO$_2$eq /  Pers & 0.2\% & 131 \tabularnewline 
 \end{tabular}
 \end{table}

 For Timor-Leste, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (66.3\%), followed by Agriculture (27.9\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting as much as 77.2\% of the national emissions. 
 Second largest contributor was CO$_2$ (15.0\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Energy sector, which contributed 51.3\% to Timor-Leste's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 24.9\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TLS/ts_emi_exclLU_TLS.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TLS/ts_gdp_pop_TLS.png}
 ...
 Timor-Leste's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Timor-Leste are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 6.3~Mt CO$_2$eq, which in absolute terms is higher than the non-LULUCF emissions of 3.4~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 3.6--7.5~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TLS/ts_emi_onlyLU_TLS.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Timor-Leste's NDC (if needed). 
 ...
 Timor-Leste has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TLS/ts_pc_cov_TLS.png}
 \caption{Timeseries of Timor-Leste's national emissions (exclLU) and the share of emissions that is assumed to be covered by Timor-Leste's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Timor-Leste's 2017 emissions (exclLU, exclBunkers; total 3.4~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 6.3~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 14.9\% & \bfseries 51.3\% & \bfseries 0.08\% & / & / & / & / & 66.3\% \tabularnewline 
 \bfseries IPPU & / & \bfseries + & \bfseries 0.1\% & \bfseries / & \bfseries 0.0\% & / & / & / & / & 0.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries / & \bfseries 20.7\% & \bfseries 7.2\% & / & / & / & / & 27.9\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 5.2\% & \bfseries 0.3\% & / & / & / & / & 5.6\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 15.0\% & 77.2\% & 7.8\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TLS/ts_ndcs_quantis_TLS.png}
