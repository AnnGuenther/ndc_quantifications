\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Gabon: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 9.8~Mt CO$_2$eq, Gabon contributed 0.02\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Gabon is estimated to emit 11.4~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 15.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 10.7--14.5~Mt CO$_2$eq in 2030, and 10.3--23.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 103 in 2017, and 105 regarding the per-capita emissions (106 and 110 in 2030).
 In terms of accumulated historical emissions, Gabon contributed to the global 1850--2017 emissions by 0.03\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.04\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Gabon, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 9.8 & Mt CO$_2$eq & 0.02\% & 147 \tabularnewline 
 \bfseries  & 2030 & 11.4 & Mt CO$_2$eq & 0.02\% & 146 \tabularnewline \hline
 \bfseries GDP & 2017 & 23.5 & Billion 2011~GK\$ & 0.02\% & 135 \tabularnewline 
 \bfseries  & 2030 & 38.1 & Billion 2011~GK\$ & 0.02\% & 144 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 103 \tabularnewline 
 \bfseries per GDP & 2030 & 0.2 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 106 \tabularnewline \hline
 \bfseries Population & 2017 & 2.1 & Million Pers & 0.02\% & 147 \tabularnewline 
 \bfseries  & 2030 & 2.4 & Million Pers & 0.02\% & 144 \tabularnewline \hline
 \bfseries Emissions & 2017 & 4.8 & t CO$_2$eq /  Pers & 0.3\% & 105 \tabularnewline 
 \bfseries per capita & 2030 & 4.7 & t CO$_2$eq /  Pers & 0.3\% & 110 \tabularnewline 
 \end{tabular}
 \end{table}

 For Gabon, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (87.9\%), followed by Agriculture (5.4\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  47.9\% of the national emissions. 
 Second largest contributor was CH$_4$ (46.7\%)
 The total of F-gasesonly represented 0.2\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Energy sector, which contributed 40.3\% to Gabon's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 59.2\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GAB/ts_emi_exclLU_GAB.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GAB/ts_gdp_pop_GAB.png}
 ...
 Gabon's population is assumed to grow towards 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 

 LULUCF emissions data for Gabon are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -79.6~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 9.8~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -93.5--2.3~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GAB/ts_emi_onlyLU_GAB.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Gabon's NDC (if needed). 
 ...
 Gabon has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Gabon's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 RBU & condi. & best & -50\% & 2025 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GAB/ts_pc_cov_GAB.png}
 \caption{Timeseries of Gabon's national emissions (exclLU) and the share of emissions that is assumed to be covered by Gabon's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Gabon's 2017 emissions (exclLU, exclBunkers; total 9.8~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -79.6~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 46.8\% & \bfseries 40.3\% & \bfseries 0.9\% & / & / & / & / & 87.9\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 1.1\% & \bfseries / & \bfseries 0.0\% & 0.2\% & / & / & / & 1.3\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 1.9\% & \bfseries 3.5\% & / & / & / & / & 5.4\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 4.5\% & \bfseries 0.2\% & / & / & / & / & 4.8\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.6\% & / & / & / & / & 0.6\% \tabularnewline \hline
 \bfseries Total &  &  & 47.9\% & 46.7\% & 5.2\% & 0.2\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GAB/ts_ndcs_quantis_GAB.png}
