\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Qatar: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 205.6~Mt CO$_2$eq, Qatar contributed 0.4\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Qatar is estimated to emit 240.3~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 16.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 202.1--335.2~Mt CO$_2$eq in 2030, and 115.0--352.9~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 33 in 2017, and 1 regarding the per-capita emissions (31 and 1 in 2030).
 In terms of accumulated historical emissions, Qatar contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Qatar, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 205.6 & Mt CO$_2$eq & 0.4\% & 38 \tabularnewline 
 \bfseries  & 2030 & 240.3 & Mt CO$_2$eq & 0.4\% & 38 \tabularnewline \hline
 \bfseries GDP & 2017 & 252.6 & Billion 2011~GK\$ & 0.2\% & 60 \tabularnewline 
 \bfseries  & 2030 & 441.8 & Billion 2011~GK\$ & 0.2\% & 54 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.8 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 33 \tabularnewline 
 \bfseries per GDP & 2030 & 0.5 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 31 \tabularnewline \hline
 \bfseries Population & 2017 & 2.7 & Million Pers & 0.03\% & 140 \tabularnewline 
 \bfseries  & 2030 & 3.6 & Million Pers & 0.04\% & 132 \tabularnewline \hline
 \bfseries Emissions & 2017 & 75.4 & t CO$_2$eq /  Pers & 5.1\% & 1 \tabularnewline 
 \bfseries per capita & 2030 & 66.9 & t CO$_2$eq /  Pers & 4.5\% & 1 \tabularnewline 
 \end{tabular}
 \end{table}

 For Qatar, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (92.1\%), followed by IPPU (6.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  64.7\% of the national emissions. 
 Second largest contributor was CH$_4$ (34.7\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 71.5\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/QAT/ts_emi_exclLU_QAT.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/QAT/ts_gdp_pop_QAT.png}
 ...
 Qatar's population is assumed to grow towards 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 
 No LULUCF data are available for Qatar from the following sources: CRF (2019), CRF (2018), BUR (3$^{rd}$), BUR (2$^{nd}$), BUR (1$^{st}$), UNFCCC (2019), FAO (2019).
 ...
 Qatar has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/QAT/ts_pc_cov_QAT.png}
 \caption{Timeseries of Qatar's national emissions (exclLU) and the share of emissions that is assumed to be covered by Qatar's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Qatar's 2017 emissions (exclLU, exclBunkers; total 205.6~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 58.6\% & \bfseries 33.5\% & 0.05\% & / & / & / & / & 92.1\% \tabularnewline 
 \bfseries IPPU & / & \bfseries + & \bfseries 6.2\% & \bfseries 0.03\% & 0.05\% & \bfseries / & / & / & / & 6.2\% \tabularnewline 
 \bfseries Agri. & / & -- & / & 0.06\% & 0.3\% & / & / & / & / & 0.4\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 1.1\% & 0.0\% & / & / & / & / & 1.1\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 64.7\% & 34.7\% & 0.6\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/QAT/ts_ndcs_quantis_QAT.png}
