\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Poland: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 417.6~Mt CO$_2$eq, Poland contributed 0.9\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.8\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Poland is estimated to emit 428.4~Mt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 2.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 384.4--501.4~Mt CO$_2$eq in 2030, and 323.5--657.2~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 113 in 2017, and 33 regarding the per-capita emissions (110 and 29 in 2030).
 In terms of accumulated historical emissions, Poland contributed to the global 1850--2017 emissions by 1.5\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 1.1\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Poland, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 417.6 & Mt CO$_2$eq & 0.9\% & 22 \tabularnewline 
 \bfseries  & 2030 & 428.4 & Mt CO$_2$eq & 0.8\% & 25 \tabularnewline \hline
 \bfseries GDP & 2017 & 1.1 & Trillion 2011~GK\$ & 1.0\% & 22 \tabularnewline 
 \bfseries  & 2030 & 1.5 & Trillion 2011~GK\$ & 0.8\% & 24 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 113 \tabularnewline 
 \bfseries per GDP & 2030 & 0.2 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 110 \tabularnewline \hline
 \bfseries Population & 2017 & 38.0 & Million Pers & 0.5\% & 36 \tabularnewline 
 \bfseries  & 2030 & 37.5 & Million Pers & 0.4\% & 43 \tabularnewline \hline
 \bfseries Emissions & 2017 & 11.0 & t CO$_2$eq /  Pers & 0.7\% & 33 \tabularnewline 
 \bfseries per capita & 2030 & 11.4 & t CO$_2$eq /  Pers & 0.8\% & 29 \tabularnewline 
 \end{tabular}
 \end{table}

 For Poland, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (82.2\%), followed by Agriculture (7.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 81.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (11.8\%)
 The total of F-gasesonly represented 1.7\%.
 The total CO$_2$ emissions are expected to be 79.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/POL/ts_emi_exclLU_POL.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/POL/ts_gdp_pop_POL.png}
 ...
 Poland's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Poland are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -33.8~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 417.6~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -51.8--1.4~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/POL/ts_emi_onlyLU_POL.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Poland's NDC (if needed). 
 ...
 Poland has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Poland's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Poland is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/POL/ts_pc_cov_POL.png}
 \caption{Timeseries of Poland's national emissions (exclLU) and the share of emissions that is assumed to be covered by Poland's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Poland's 2017 emissions (exclLU, exclBunkers; total 417.6~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -33.8~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 76.0\% & \bfseries 5.6\% & \bfseries 0.7\% & / & / & / & / & 82.2\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 4.9\% & \bfseries 0.01\% & \bfseries 0.2\% & \bfseries 1.7\% & \bfseries 0.0\% & \bfseries 0.01\% & \bfseries / & 6.8\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.2\% & \bfseries 3.5\% & \bfseries 3.9\% & / & / & / & / & 7.6\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 2.7\% & \bfseries 0.2\% & / & / & / & / & 3.1\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 81.2\% & 11.8\% & 5.2\% & 1.7\% & 0.0\% & 0.01\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/POL/ts_ndcs_quantis_POL.png}
