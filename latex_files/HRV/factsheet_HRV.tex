\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Croatia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 26.3~Mt CO$_2$eq, Croatia contributed 0.05\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.04\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Croatia is estimated to emit 24.2~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -7.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 21.2--28.2~Mt CO$_2$eq in 2030, and 19.7--42.5~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 160 in 2017, and 84 regarding the per-capita emissions (162 and 96 in 2030).
 In terms of accumulated historical emissions, Croatia contributed to the global 1850--2017 emissions by 0.07\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Croatia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 26.3 & Mt CO$_2$eq & 0.05\% & 112 \tabularnewline 
 \bfseries  & 2030 & 24.2 & Mt CO$_2$eq & 0.04\% & 119 \tabularnewline \hline
 \bfseries GDP & 2017 & 101.6 & Billion 2011~GK\$ & 0.09\% & 82 \tabularnewline 
 \bfseries  & 2030 & 120.8 & Billion 2011~GK\$ & 0.06\% & 97 \tabularnewline \hline
 \bfseries Emissions & 2017 & 258.8 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 160 \tabularnewline 
 \bfseries per GDP & 2030 & 200.5 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 162 \tabularnewline \hline
 \bfseries Population & 2017 & 4.2 & Million Pers & 0.05\% & 127 \tabularnewline 
 \bfseries  & 2030 & 4.1 & Million Pers & 0.04\% & 130 \tabularnewline \hline
 \bfseries Emissions & 2017 & 6.3 & t CO$_2$eq /  Pers & 0.4\% & 84 \tabularnewline 
 \bfseries per capita & 2030 & 5.9 & t CO$_2$eq /  Pers & 0.4\% & 96 \tabularnewline 
 \end{tabular}
 \end{table}

 For Croatia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (66.0\%), followed by IPPU (14.7\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 75.5\% of the national emissions. 
 Second largest contributor was CH$_4$ (15.7\%)
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HRV/ts_emi_exclLU_HRV.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HRV/ts_gdp_pop_HRV.png}
 ...
 Croatia's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Croatia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -4.8~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 26.3~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -9.1---4.8~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HRV/ts_emi_onlyLU_HRV.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Croatia's NDC (if needed). 
 ...
 Croatia has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Croatia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Croatia is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HRV/ts_pc_cov_HRV.png}
 \caption{Timeseries of Croatia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Croatia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Croatia's 2017 emissions (exclLU, exclBunkers; total 26.3~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -4.8~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 63.0\% & \bfseries 2.2\% & \bfseries 0.8\% & / & / & / & / & 66.0\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 12.2\% & \bfseries 0.0\% & \bfseries 0.6\% & \bfseries 1.9\% & \bfseries 0.0\% & \bfseries 0.02\% & \bfseries / & 14.7\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.3\% & \bfseries 5.9\% & \bfseries 4.7\% & / & / & / & / & 10.9\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 7.6\% & \bfseries 0.3\% & / & / & / & / & 8.0\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 75.5\% & 15.7\% & 6.9\% & 1.9\% & 0.0\% & 0.02\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HRV/ts_ndcs_quantis_HRV.png}
