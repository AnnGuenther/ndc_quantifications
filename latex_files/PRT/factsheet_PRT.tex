\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Portugal: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 71.4~Mt CO$_2$eq, Portugal contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Portugal is estimated to emit 70.7~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -1.0\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 61.5--83.9~Mt CO$_2$eq in 2030, and 60.1--138.7~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 161 in 2017, and 75 regarding the per-capita emissions (163 and 84 in 2030).
 In terms of accumulated historical emissions, Portugal contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Portugal, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 71.4 & Mt CO$_2$eq & 0.1\% & 69 \tabularnewline 
 \bfseries  & 2030 & 70.7 & Mt CO$_2$eq & 0.1\% & 75 \tabularnewline \hline
 \bfseries GDP & 2017 & 276.2 & Billion 2011~GK\$ & 0.2\% & 57 \tabularnewline 
 \bfseries  & 2030 & 357.4 & Billion 2011~GK\$ & 0.1\% & 58 \tabularnewline \hline
 \bfseries Emissions & 2017 & 258.4 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 161 \tabularnewline 
 \bfseries per GDP & 2030 & 197.8 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 163 \tabularnewline \hline
 \bfseries Population & 2017 & 10.3 & Million Pers & 0.1\% & 89 \tabularnewline 
 \bfseries  & 2030 & 10.5 & Million Pers & 0.1\% & 93 \tabularnewline \hline
 \bfseries Emissions & 2017 & 6.9 & t CO$_2$eq /  Pers & 0.4\% & 75 \tabularnewline 
 \bfseries per capita & 2030 & 6.7 & t CO$_2$eq /  Pers & 0.4\% & 84 \tabularnewline 
 \end{tabular}
 \end{table}

 For Portugal, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (71.7\%), followed by IPPU (11.8\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 77.5\% of the national emissions. 
 Second largest contributor was CH$_4$ (13.3\%)
 The total of F-gasesonly represented 4.6\%.
 The total CO$_2$ emissions are expected to be 74.6\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PRT/ts_emi_exclLU_PRT.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PRT/ts_gdp_pop_PRT.png}
 ...
 The population decreased, while the per capita emissions were on the rise. 
 ...
 Portugal's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Portugal are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net source of 7.2~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 71.4~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -13.6--7.2~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PRT/ts_emi_onlyLU_PRT.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Portugal's NDC (if needed). 
 ...
 Portugal has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Portugal's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Portugal is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PRT/ts_pc_cov_PRT.png}
 \caption{Timeseries of Portugal's national emissions (exclLU) and the share of emissions that is assumed to be covered by Portugal's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Portugal's 2017 emissions (exclLU, exclBunkers; total 71.4~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 70.3\% & \bfseries 0.6\% & \bfseries 0.8\% & / & / & / & / & 71.7\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 7.0\% & \bfseries 0.06\% & \bfseries 0.1\% & \bfseries 4.6\% & \bfseries 0.02\% & \bfseries 0.03\% & \bfseries / & 11.8\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.07\% & \bfseries 6.4\% & \bfseries 3.2\% & / & / & / & / & 9.7\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.03\% & \bfseries 6.2\% & \bfseries 0.2\% & / & / & / & / & 6.5\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 77.5\% & 13.3\% & 4.6\% & 4.6\% & 0.02\% & 0.03\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PRT/ts_ndcs_quantis_PRT.png}
