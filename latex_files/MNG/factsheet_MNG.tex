\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Mongolia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 45.7~Mt CO$_2$eq, Mongolia contributed 0.09\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.1\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Mongolia is estimated to emit 63.2~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 38.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 61.1--80.0~Mt CO$_2$eq in 2030, and 69.6--121.3~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 11 in 2017, and 21 regarding the per-capita emissions (18 and 14 in 2030).
 In terms of accumulated historical emissions, Mongolia contributed to the global 1850--2017 emissions by 0.06\%. 
 When only accounting for the years 1990--2017, its contribution stays the same to 0.06\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Mongolia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 45.7 & Mt CO$_2$eq & 0.09\% & 88 \tabularnewline 
 \bfseries  & 2030 & 63.2 & Mt CO$_2$eq & 0.1\% & 83 \tabularnewline \hline
 \bfseries GDP & 2017 & 36.4 & Billion 2011~GK\$ & 0.03\% & 119 \tabularnewline 
 \bfseries  & 2030 & 90.8 & Billion 2011~GK\$ & 0.05\% & 107 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.3 & t CO$_2$eq / Thousand 2011~GK\$ & 1.1\% & 11 \tabularnewline 
 \bfseries per GDP & 2030 & 0.7 & t CO$_2$eq / Thousand 2011~GK\$ & 0.9\% & 18 \tabularnewline \hline
 \bfseries Population & 2017 & 3.1 & Million Pers & 0.04\% & 135 \tabularnewline 
 \bfseries  & 2030 & 3.5 & Million Pers & 0.04\% & 134 \tabularnewline \hline
 \bfseries Emissions & 2017 & 14.7 & t CO$_2$eq /  Pers & 1.0\% & 21 \tabularnewline 
 \bfseries per capita & 2030 & 18.1 & t CO$_2$eq /  Pers & 1.2\% & 14 \tabularnewline 
 \end{tabular}
 \end{table}

 For Mongolia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (51.9\%), followed by Energy (46.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  43.1\% of the national emissions. 
 Second largest contributor was CH$_4$ (37.3\%)
 The total of F-gasesonly represented 0.2\%.
 The trend in total emissions is mostly driven by CH$_4$ and N$_2$O emissions from the Agriculture sector, which contributed 33.2\% and 18.7\% to Mongolia's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 45.0\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MNG/ts_emi_exclLU_MNG.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MNG/ts_gdp_pop_MNG.png}
 ...
 Mongolia's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Mongolia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): BUR (1$^{st}$)~/ 25, UNFCCC (2019)~/ 10, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -24.5~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 45.7~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -25.9---23.0~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MNG/ts_emi_onlyLU_MNG.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Mongolia's NDC (if needed). 
 ...
 Mongolia has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Mongolia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 43.89 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MNG/ts_pc_cov_MNG.png}
 \caption{Timeseries of Mongolia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Mongolia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Mongolia's 2017 emissions (exclLU, exclBunkers; total 45.7~Mt CO$_2$eq).
 ...
 LULUCF: NDC '--' and adapted '--' (estimated as a net sink of -24.5~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 42.5\% & \bfseries 3.8\% & \bfseries 0.3\% & / & / & / & / & 46.6\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 0.6\% & \bfseries / & \bfseries 0.0\% & 0.2\% & / & / & / & 0.8\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 33.2\% & \bfseries 18.7\% & / & / & / & / & 51.9\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 0.3\% & \bfseries 0.04\% & / & / & / & / & 0.4\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 43.1\% & 37.3\% & 19.3\% & 0.2\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MNG/ts_ndcs_quantis_MNG.png}
