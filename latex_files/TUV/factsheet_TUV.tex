\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Tuvalu: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 25.0~kt CO$_2$eq, Tuvalu contributed 0.00005\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.00004\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Tuvalu is estimated to emit 23.1~kt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -7.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 23.1--23.1~kt CO$_2$eq in 2030, and 23.1--23.1~kt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 64 in 2017, and 158 regarding the per-capita emissions (21 and 164 in 2030).
 In terms of accumulated historical emissions, Tuvalu contributed to the global 1850--2017 emissions by 0.00004\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.00005\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Tuvalu, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 25.0 & kt CO$_2$eq & 0.00005\% & 202 \tabularnewline 
 \bfseries  & 2030 & 23.1 & kt CO$_2$eq & 0.00004\% & 202 \tabularnewline \hline
 \bfseries GDP & 2017 & 40.3 & Million 2011~GK\$ & 0.00003\% & 198 \tabularnewline 
 \bfseries  & 2030 & 36.3 & Million 2011~GK\$ & 0.00002\% & 198 \tabularnewline \hline
 \bfseries Emissions & 2017 & 620.0 & t CO$_2$eq / Million 2011~GK\$ & 0.6\% & 64 \tabularnewline 
 \bfseries per GDP & 2030 & 637.6 & t CO$_2$eq / Million 2011~GK\$ & 0.8\% & 21 \tabularnewline \hline
 \bfseries Population & 2017 & 11.4 & Thousand Pers & 0.0001\% & 201 \tabularnewline 
 \bfseries  & 2030 & 11.0 & Thousand Pers & 0.0001\% & 201 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.2 & t CO$_2$eq /  Pers & 0.1\% & 158 \tabularnewline 
 \bfseries per capita & 2030 & 2.1 & t CO$_2$eq /  Pers & 0.1\% & 164 \tabularnewline 
 \end{tabular}
 \end{table}

 For Tuvalu, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (53.9\%), followed by Agriculture (26.8\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  56.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (38.4\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 53.7\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TUV/ts_emi_exclLU_TUV.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TUV/ts_gdp_pop_TUV.png}
 ...
 Tuvalu's population is assumed to diminish towars 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Tuvalu are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.0~kt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 25.0~kt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -36.7--0.0~kt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TUV/ts_emi_onlyLU_TUV.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Tuvalu's NDC (if needed). 
 ...
 Tuvalu has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Tuvalu's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 RBY & uncondi. & best & -41\% & 2010 & 2025 & exclLU \tabularnewline 
 RBY & condi. & best & -60\% & 2010 & 2025 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TUV/ts_pc_cov_TUV.png}
 \caption{Timeseries of Tuvalu's national emissions (exclLU) and the share of emissions that is assumed to be covered by Tuvalu's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Tuvalu's 2017 emissions (exclLU, exclBunkers; total 25.0~kt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 53.9\% & \bfseries / & / & / & / & / & / & 53.9\% \tabularnewline 
 \bfseries IPPU & / & -- & 2.3\% & / & 0.2\% & / & / & / & / & 2.6\% \tabularnewline 
 \bfseries Agri. & \bfseries + & -- & / & 21.7\% & 5.1\% & / & / & / & / & 26.8\% \tabularnewline 
 \bfseries Waste & \bfseries + & -- & / & 16.7\% & / & / & / & / & / & 16.7\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.02\% & / & / & / & / & 0.02\% \tabularnewline \hline
 \bfseries Total &  &  & 56.2\% & 38.4\% & 5.4\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TUV/ts_ndcs_quantis_TUV.png}
