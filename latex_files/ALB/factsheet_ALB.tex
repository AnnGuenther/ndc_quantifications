\documentclass[12pt]{article}
 ...
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Albania is estimated to emit 11.5~Mt CO$_2$eq in 2030.
 ...
 The country's global rank in terms of total emissions per unit of GDP was 141 in 2017, and 117 regarding the per-capita emissions (132 and 123 in 2030).
 ...
 For Albania, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (49.1\%), followed by Agriculture (24.1\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  61.1\% of the national emissions. 
 ...
 LULUCF emissions data for Albania are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 20, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net source of 0.9~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 10.2~Mt CO$_2$eq.
 The large emissions range for UNFCCC (2019) and 1990--2017 is 0.9--3.5~Mt CO$_2$eq.
 ...
 ABS & uncondi. & best & 5.44 Mt~CO$_2$eq SAR & 2030 & exclLU \tabularnewline \hline
