\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Tunisia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 37.6~Mt CO$_2$eq, Tunisia contributed 0.07\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.09\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Tunisia is estimated to emit 55.7~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 48.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 50.2--67.1~Mt CO$_2$eq in 2030, and 58.2--123.5~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 143 in 2017, and 127 regarding the per-capita emissions (142 and 113 in 2030).
 In terms of accumulated historical emissions, Tunisia contributed to the global 1850--2017 emissions by 0.05\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Tunisia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 37.6 & Mt CO$_2$eq & 0.07\% & 96 \tabularnewline 
 \bfseries  & 2030 & 55.7 & Mt CO$_2$eq & 0.09\% & 90 \tabularnewline \hline
 \bfseries GDP & 2017 & 124.9 & Billion 2011~GK\$ & 0.1\% & 80 \tabularnewline 
 \bfseries  & 2030 & 244.8 & Billion 2011~GK\$ & 0.1\% & 73 \tabularnewline \hline
 \bfseries Emissions & 2017 & 301.0 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 143 \tabularnewline 
 \bfseries per GDP & 2030 & 227.7 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 142 \tabularnewline \hline
 \bfseries Population & 2017 & 11.4 & Million Pers & 0.1\% & 78 \tabularnewline 
 \bfseries  & 2030 & 12.4 & Million Pers & 0.1\% & 83 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.3 & t CO$_2$eq /  Pers & 0.2\% & 127 \tabularnewline 
 \bfseries per capita & 2030 & 4.5 & t CO$_2$eq /  Pers & 0.3\% & 113 \tabularnewline 
 \end{tabular}
 \end{table}

 For Tunisia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (69.3\%), followed by Agriculture (13.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  65.6\% of the national emissions. 
 Second largest contributor was CH$_4$ (25.1\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 75.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TUN/ts_emi_exclLU_TUN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TUN/ts_gdp_pop_TUN.png}
 ...
 Tunisia's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Tunisia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.3~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 37.6~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -0.7---0.3~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TUN/ts_emi_onlyLU_TUN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Tunisia's NDC (if needed). 
 ...
 Tunisia has an NDC, with a GHG mitigation target of the type REI (relative emissions intensity reduction; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Tunisia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & uncondi. & best & 47.39 Mt~CO$_2$eq AR4 & 2010 & 2025 & GDP & inclLU \tabularnewline 
 ABS & condi. & best & 0.0 Mt~CO$_2$eq AR4 & 2010 & 2025 & GDP & inclLU \tabularnewline \hline
 ABS & uncondi. & best & 62.20 Mt~CO$_2$eq AR4 & 2010 & 2030 & GDP & inclLU \tabularnewline 
 ABS & condi. & best & 42.39 Mt~CO$_2$eq AR4 & 2010 & 2030 & GDP & inclLU \tabularnewline 
 REI & uncondi. & best & -13\% & 2010 & 2030 & GDP & inclLU \tabularnewline 
 REI & condi. & best & -41\% & 2010 & 2030 & GDP & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TUN/ts_pc_cov_TUN.png}
 \caption{Timeseries of Tunisia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Tunisia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Tunisia's 2017 emissions (exclLU, exclBunkers; total 37.6~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -0.3~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 55.4\% & \bfseries 13.3\% & \bfseries 0.6\% & / & / & / & / & 69.3\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 9.8\% & \bfseries 0.0\% & \bfseries 0.7\% & / & 0.0\% & / & / & 10.5\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.3\% & \bfseries 5.7\% & \bfseries 7.0\% & / & / & / & / & 13.0\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 6.2\% & \bfseries 0.6\% & / & / & / & / & 6.7\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 65.6\% & 25.1\% & 9.3\% & / & 0.0\% & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TUN/ts_ndcs_quantis_TUN.png}
