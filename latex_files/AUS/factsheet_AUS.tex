\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Australia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 0.6~Gt CO$_2$eq, Australia contributed 1.2\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 1.0\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Australia is estimated to emit 0.6~Gt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 5.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 0.5--0.7~Gt CO$_2$eq in 2030, and 0.5--1.1~Gt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 85 in 2017, and 7 regarding the per-capita emissions (80 and 12 in 2030).
 In terms of accumulated historical emissions, Australia contributed to the global 1850--2017 emissions by 1.3\%. 
 When only accounting for the years 1990--2017, its contribution stays the same to 1.3\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Australia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 0.6 & Gt CO$_2$eq & 1.2\% & 14 \tabularnewline 
 \bfseries  & 2030 & 0.6 & Gt CO$_2$eq & 1.0\% & 16 \tabularnewline \hline
 \bfseries GDP & 2017 & 1.2 & Trillion 2011~GK\$ & 1.0\% & 19 \tabularnewline 
 \bfseries  & 2030 & 1.6 & Trillion 2011~GK\$ & 0.9\% & 23 \tabularnewline \hline
 \bfseries Emissions & 2017 & 482.4 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 85 \tabularnewline 
 \bfseries per GDP & 2030 & 358.0 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 80 \tabularnewline \hline
 \bfseries Population & 2017 & 24.6 & Million Pers & 0.3\% & 53 \tabularnewline 
 \bfseries  & 2030 & 29.3 & Million Pers & 0.3\% & 54 \tabularnewline \hline
 \bfseries Emissions & 2017 & 22.7 & t CO$_2$eq /  Pers & 1.5\% & 7 \tabularnewline 
 \bfseries per capita & 2030 & 20.0 & t CO$_2$eq /  Pers & 1.4\% & 12 \tabularnewline 
 \end{tabular}
 \end{table}

 For Australia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (78.2\%), followed by Agriculture (13.1\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 75.1\% of the national emissions. 
 Second largest contributor was CH$_4$ (18.6\%)
 The total of F-gasesonly represented 2.3\%.
 The total CO$_2$ emissions are expected to be 74.2\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/AUS/ts_emi_exclLU_AUS.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/AUS/ts_gdp_pop_AUS.png}
 ...
 Australia's population is assumed to grow towards 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Australia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.0~Gt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 0.6~Gt CO$_2$eq.
 The large emissions range for CRF (2019) and 1990--2017 is -0.0--0.1~Gt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/AUS/ts_emi_onlyLU_AUS.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Australia's NDC (if needed). 
 ...
 Australia has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Australia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 RBY & uncondi. & worst & -26\% & 2005 & 2030 & inclLU \tabularnewline 
 RBY & uncondi. & best & -28\% & 2005 & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/AUS/ts_pc_cov_AUS.png}
 \caption{Timeseries of Australia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Australia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Australia's 2017 emissions (exclLU, exclBunkers; total 0.6~Gt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 70.8\% & \bfseries 6.8\% & \bfseries 0.6\% & / & / & / & / & 78.2\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 3.7\% & \bfseries 0.01\% & \bfseries 0.3\% & \bfseries 2.2\% & \bfseries 0.03\% & \bfseries 0.03\% & \bfseries / & 6.3\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.5\% & \bfseries 9.8\% & \bfseries 2.8\% & / & / & / & / & 13.1\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 2.0\% & \bfseries 0.1\% & / & / & / & / & 2.1\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries 0.0\% & \bfseries 0.0\% & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 75.1\% & 18.6\% & 4.1\% & 2.2\% & 0.03\% & 0.03\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/AUS/ts_ndcs_quantis_AUS.png}
 ...
 \vspace{-.2cm} \item \href{https://www.theguardian.com/australia-news/2020/sep/23/labor-commits-to-environmentally-sustainable-gas-development?utm_campaign=Carbon%20Brief%20Daily%20Briefing&utm_medium=email&utm_source=Revue%20newsletter}{Labor commits to 'environmentally sustainable' gas development} (September 2020)
