\documentclass[12pt]{article}
 ...
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Antilles is estimated to emit 7.2~Mt CO$_2$eq in 2030.
 ...
 The country's global rank in terms of total emissions per unit of GDP was 8 in 2017, and 4 regarding the per-capita emissions (5 and 4 in 2030).
 ...
 For Antilles, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (97.7\%), followed by IPPU (1.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 98.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (0.9\%)
 ...
 LULUCF emissions data for Antilles are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.0~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 7.5~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -0.0--0.03~Mt CO$_2$eq.
