\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Sri Lanka: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 38.6~Mt CO$_2$eq, Sri Lanka contributed 0.08\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.09\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Sri Lanka is estimated to emit 55.2~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 43.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 45.0--64.1~Mt CO$_2$eq in 2030, and 65.1--123.5~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 192 in 2017, and 171 regarding the per-capita emissions (195 and 155 in 2030).
 In terms of accumulated historical emissions, Sri Lanka contributed to the global 1850--2017 emissions by 0.06\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Sri Lanka, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 38.6 & Mt CO$_2$eq & 0.08\% & 95 \tabularnewline 
 \bfseries  & 2030 & 55.2 & Mt CO$_2$eq & 0.09\% & 91 \tabularnewline \hline
 \bfseries GDP & 2017 & 255.2 & Billion 2011~GK\$ & 0.2\% & 59 \tabularnewline 
 \bfseries  & 2030 & 491.2 & Billion 2011~GK\$ & 0.2\% & 53 \tabularnewline \hline
 \bfseries Emissions & 2017 & 151.1 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 192 \tabularnewline 
 \bfseries per GDP & 2030 & 112.3 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 195 \tabularnewline \hline
 \bfseries Population & 2017 & 21.1 & Million Pers & 0.2\% & 58 \tabularnewline 
 \bfseries  & 2030 & 22.5 & Million Pers & 0.2\% & 62 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.8 & t CO$_2$eq /  Pers & 0.1\% & 171 \tabularnewline 
 \bfseries per capita & 2030 & 2.5 & t CO$_2$eq /  Pers & 0.1\% & 155 \tabularnewline 
 \end{tabular}
 \end{table}

 For Sri Lanka, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (73.3\%), followed by Agriculture (15.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 74.0\% of the national emissions. 
 Second largest contributor was CH$_4$ (19.7\%)
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LKA/ts_emi_exclLU_LKA.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LKA/ts_gdp_pop_LKA.png}
 ...
 Sri Lanka's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Sri Lanka are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 2.8~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 38.6~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 2.3--4.9~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LKA/ts_emi_onlyLU_LKA.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Sri Lanka's NDC (if needed). 
 ...
 Sri Lanka has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Sri Lanka's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 RBU & uncondi. & best & -3.8\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -18.1\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LKA/ts_pc_cov_LKA.png}
 \caption{Timeseries of Sri Lanka's national emissions (exclLU) and the share of emissions that is assumed to be covered by Sri Lanka's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Sri Lanka's 2017 emissions (exclLU, exclBunkers; total 38.6~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 2.8~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 69.0\% & \bfseries 3.4\% & \bfseries 0.9\% & / & / & / & / & 73.3\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 2.9\% & \bfseries / & \bfseries 0.0\% & / & / & / & / & 2.9\% \tabularnewline 
 \bfseries Agri. & / & -- & 2.1\% & 9.4\% & 3.8\% & / & / & / & / & 15.3\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 6.9\% & \bfseries 0.6\% & / & / & / & / & 7.5\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 1.0\% & / & / & / & / & 1.0\% \tabularnewline \hline
 \bfseries Total &  &  & 74.0\% & 19.7\% & 6.3\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LKA/ts_ndcs_quantis_LKA.png}
