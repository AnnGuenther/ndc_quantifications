\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Brit. Virgin Is.: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 211.4~kt CO$_2$eq, Brit. Virgin Is. contributed 0.0004\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.0003\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Brit. Virgin Is. is estimated to emit 204.1~kt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -3.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 204.1--204.1~kt CO$_2$eq in 2030, and 204.1--204.1~kt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 154 in 2017, and 71 regarding the per-capita emissions (126 and 76 in 2030).
 In terms of accumulated historical emissions, Brit. Virgin Is. contributed to the global 1850--2017 emissions by 0.0002\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Brit. Virgin Is., together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 211.4 & kt CO$_2$eq & 0.0004\% & 195 \tabularnewline 
 \bfseries  & 2030 & 204.1 & kt CO$_2$eq & 0.0003\% & 195 \tabularnewline \hline
 \bfseries GDP & 2017 & 796.3 & Million 2011~GK\$ & 0.0007\% & 188 \tabularnewline 
 \bfseries  & 2030 & 787.0 & Million 2011~GK\$ & 0.0004\% & 187 \tabularnewline \hline
 \bfseries Emissions & 2017 & 265.5 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 154 \tabularnewline 
 \bfseries per GDP & 2030 & 259.3 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 126 \tabularnewline \hline
 \bfseries Population & 2017 & 29.6 & Thousand Pers & 0.0003\% & 197 \tabularnewline 
 \bfseries  & 2030 & 29.1 & Thousand Pers & 0.0003\% & 197 \tabularnewline \hline
 \bfseries Emissions & 2017 & 7.1 & t CO$_2$eq /  Pers & 0.4\% & 71 \tabularnewline 
 \bfseries per capita & 2030 & 7.0 & t CO$_2$eq /  Pers & 0.4\% & 76 \tabularnewline 
 \end{tabular}
 \end{table}

 For Brit. Virgin Is., in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (91.1\%), followed by Agriculture (4.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 90.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (7.0\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 90.2\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VGB/ts_emi_exclLU_VGB.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VGB/ts_gdp_pop_VGB.png}
 ...
 Brit. Virgin Is.'s population is assumed to diminish towars 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Brit. Virgin Is. are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 5.2~kt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 211.4~kt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is -36.7--36.7~kt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VGB/ts_emi_onlyLU_VGB.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Brit. Virgin Is.'s NDC (if needed). 
 ...
 Brit. Virgin Is. does not have an (I)NDC.
