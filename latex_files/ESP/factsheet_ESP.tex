\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Spain: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 343.8~Mt CO$_2$eq, Spain contributed 0.7\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.5\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Spain is estimated to emit 305.7~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial decrease of -11.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 256.5--355.6~Mt CO$_2$eq in 2030, and 256.0--618.5~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 180 in 2017, and 65 regarding the per-capita emissions (178 and 90 in 2030).
 In terms of accumulated historical emissions, Spain contributed to the global 1850--2017 emissions by 0.8\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Spain, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 343.8 & Mt CO$_2$eq & 0.7\% & 27 \tabularnewline 
 \bfseries  & 2030 & 305.7 & Mt CO$_2$eq & 0.5\% & 33 \tabularnewline \hline
 \bfseries GDP & 2017 & 1.7 & Trillion 2011~GK\$ & 1.5\% & 15 \tabularnewline 
 \bfseries  & 2030 & 1.9 & Trillion 2011~GK\$ & 1.0\% & 21 \tabularnewline \hline
 \bfseries Emissions & 2017 & 202.0 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 180 \tabularnewline 
 \bfseries per GDP & 2030 & 164.9 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 178 \tabularnewline \hline
 \bfseries Population & 2017 & 46.6 & Million Pers & 0.6\% & 30 \tabularnewline 
 \bfseries  & 2030 & 48.9 & Million Pers & 0.6\% & 34 \tabularnewline \hline
 \bfseries Emissions & 2017 & 7.4 & t CO$_2$eq /  Pers & 0.5\% & 65 \tabularnewline 
 \bfseries per capita & 2030 & 6.3 & t CO$_2$eq /  Pers & 0.4\% & 90 \tabularnewline 
 \end{tabular}
 \end{table}

 For Spain, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (75.3\%), followed by Agriculture (11.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 80.7\% of the national emissions. 
 Second largest contributor was CH$_4$ (11.6\%)
 The total of F-gasesonly represented 2.0\%.
 The total CO$_2$ emissions are expected to be 77.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ESP/ts_emi_exclLU_ESP.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ESP/ts_gdp_pop_ESP.png}
 ...
 Spain's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Spain are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -38.3~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 343.8~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -40.6---32.7~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ESP/ts_emi_onlyLU_ESP.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Spain's NDC (if needed). 
 ...
 Spain has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Spain's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Spain is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ESP/ts_pc_cov_ESP.png}
 \caption{Timeseries of Spain's national emissions (exclLU) and the share of emissions that is assumed to be covered by Spain's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Spain's 2017 emissions (exclLU, exclBunkers; total 343.8~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -38.3~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 73.9\% & \bfseries 0.8\% & \bfseries 0.6\% & / & / & / & / & 75.3\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 6.7\% & \bfseries 0.06\% & \bfseries 0.2\% & \bfseries 1.8\% & \bfseries 0.03\% & \bfseries 0.06\% & \bfseries 0.02\% & 8.9\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 7.2\% & \bfseries 4.1\% & / & / & / & / & 11.5\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 3.6\% & \bfseries 0.3\% & / & / & / & / & 3.9\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 80.7\% & 11.6\% & 5.7\% & 1.8\% & 0.03\% & 0.06\% & 0.02\% & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ESP/ts_ndcs_quantis_ESP.png}
