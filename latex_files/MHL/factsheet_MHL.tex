\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Marshall Is.: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 223.9~kt CO$_2$eq, Marshall Is. contributed 0.0004\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.0003\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Marshall Is. is estimated to emit 197.7~kt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial decrease of -11.7\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 197.7--197.7~kt CO$_2$eq in 2030, and 197.7--197.7~kt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 17 in 2017, and 111 regarding the per-capita emissions (7 and 132 in 2030).
 In terms of accumulated historical emissions, Marshall Is. contributed to the global 1850--2017 emissions by 0.0002\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Marshall Is., together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 223.9 & kt CO$_2$eq & 0.0004\% & 194 \tabularnewline 
 \bfseries  & 2030 & 197.7 & kt CO$_2$eq & 0.0003\% & 196 \tabularnewline \hline
 \bfseries GDP & 2017 & 205.1 & Million 2011~GK\$ & 0.0001\% & 196 \tabularnewline 
 \bfseries  & 2030 & 196.6 & Million 2011~GK\$ & 0.0001\% & 196 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.1 & t CO$_2$eq / Thousand 2011~GK\$ & 1.0\% & 17 \tabularnewline 
 \bfseries per GDP & 2030 & 1.0 & t CO$_2$eq / Thousand 2011~GK\$ & 1.3\% & 7 \tabularnewline \hline
 \bfseries Population & 2017 & 58.1 & Thousand Pers & 0.0007\% & 191 \tabularnewline 
 \bfseries  & 2030 & 57.3 & Thousand Pers & 0.0006\% & 191 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.9 & t CO$_2$eq /  Pers & 0.2\% & 111 \tabularnewline 
 \bfseries per capita & 2030 & 3.4 & t CO$_2$eq /  Pers & 0.2\% & 132 \tabularnewline 
 \end{tabular}
 \end{table}

 For Marshall Is., in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (81.6\%), followed by Waste (18.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 76.5\% of the national emissions. 
 Second largest contributor was CH$_4$ (22.1\%)
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MHL/ts_emi_exclLU_MHL.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MHL/ts_gdp_pop_MHL.png}
 ...
 Marshall Is.'s population is assumed to diminish towars 2050, and the per capita emissions are expected to decline towars 2050. 
 No LULUCF data are available for Marshall Is. from the following sources: CRF (2019), CRF (2018), BUR (3$^{rd}$), BUR (2$^{nd}$), BUR (1$^{st}$), UNFCCC (2019), FAO (2019).
 ...
 Marshall Is. has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Marshall Is.'s GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & condi. & best & 0.12 Mt~CO$_2$eq & 2010 & 2025 & exclLU \tabularnewline 
 ABS & condi. & best & 0.10 Mt~CO$_2$eq & 2010 & 2030 & exclLU \tabularnewline 
 ABS & condi. & best & 0.077 Mt~CO$_2$eq & 2010 & 2035 & exclLU \tabularnewline \hline
 RBY & condi. & best & -32\% & 2010 & 2025 & exclLU \tabularnewline 
 RBY & condi. & best & -45\% & 2010 & 2030 & exclLU \tabularnewline 
 RBY & condi. & best & -58\% & 2010 & 2035 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MHL/ts_pc_cov_MHL.png}
 \caption{Timeseries of Marshall Is.'s national emissions (exclLU) and the share of emissions that is assumed to be covered by Marshall Is.'s mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Marshall Is.'s 2017 emissions (exclLU, exclBunkers; total 223.9~kt CO$_2$eq).
 ...
 LULUCF: NDC '--' and adapted '--' (estimated as a net source of nan~kt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 76.5\% & \bfseries 4.3\% & \bfseries 0.8\% & / & / & / & / & 81.6\% \tabularnewline 
 \bfseries IPPU & / & \bfseries + & \bfseries 0.0\% & \bfseries / & \bfseries 0.1\% & / & / & / & / & 0.1\% \tabularnewline 
 \bfseries Agri. & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.0\% & / & / & / & / & 0.0\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 17.8\% & \bfseries 0.4\% & / & / & / & / & 18.3\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries / & / & / & / & / & / \tabularnewline \hline
 \bfseries Total &  &  & 76.5\% & 22.1\% & 1.4\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MHL/ts_ndcs_quantis_MHL.png}
