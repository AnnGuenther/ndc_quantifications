\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Montenegro: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 4.6~Mt CO$_2$eq, Montenegro contributed 0.009\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.008\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Montenegro is estimated to emit 4.7~Mt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 2.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 4.4--5.5~Mt CO$_2$eq in 2030, and 4.6--8.7~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 102 in 2017, and 66 regarding the per-capita emissions (90 and 72 in 2030).
 In terms of accumulated historical emissions, Montenegro contributed to the global 1850--2017 emissions by 0.01\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Montenegro, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 4.6 & Mt CO$_2$eq & 0.009\% & 157 \tabularnewline 
 \bfseries  & 2030 & 4.7 & Mt CO$_2$eq & 0.008\% & 161 \tabularnewline \hline
 \bfseries GDP & 2017 & 10.7 & Billion 2011~GK\$ & 0.009\% & 154 \tabularnewline 
 \bfseries  & 2030 & 14.2 & Billion 2011~GK\$ & 0.007\% & 160 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 102 \tabularnewline 
 \bfseries per GDP & 2030 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.4\% & 90 \tabularnewline \hline
 \bfseries Population & 2017 & 627.6 & Thousand Pers & 0.008\% & 164 \tabularnewline 
 \bfseries  & 2030 & 652.0 & Thousand Pers & 0.007\% & 166 \tabularnewline \hline
 \bfseries Emissions & 2017 & 7.4 & t CO$_2$eq /  Pers & 0.4\% & 66 \tabularnewline 
 \bfseries per capita & 2030 & 7.3 & t CO$_2$eq /  Pers & 0.4\% & 72 \tabularnewline 
 \end{tabular}
 \end{table}

 For Montenegro, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (58.9\%), followed by IPPU (23.1\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  59.0\% of the national emissions. 
 Second largest contributor was HFCs (20.0\%)
 The total of F-gasesrepresented 20.1\%.
 The trend in total emissions is mostly driven by F-gases emissions from the IPPU sector, which contributed 20.1\% to Montenegro's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 58.6\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MNE/ts_emi_exclLU_MNE.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MNE/ts_gdp_pop_MNE.png}
 ...
 Montenegro's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Montenegro are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 22, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -2.2~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 4.6~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -2.4---1.5~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MNE/ts_emi_onlyLU_MNE.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Montenegro's NDC (if needed). 
 ...
 Montenegro has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Montenegro's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & uncondi. & best & 3.66 Mt~CO$_2$eq SAR & 1990 & 2030 & exclLU \tabularnewline \hline
 RBY & uncondi. & best & -30\% & 1990 & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MNE/ts_pc_cov_MNE.png}
 \caption{Timeseries of Montenegro's national emissions (exclLU) and the share of emissions that is assumed to be covered by Montenegro's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Montenegro's 2017 emissions (exclLU, exclBunkers; total 4.6~Mt CO$_2$eq).
 ...
 LULUCF: NDC '--' and adapted '--' (estimated as a net sink of -2.2~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 55.3\% & \bfseries 2.9\% & \bfseries 0.7\% & / & / & / & / & 58.9\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 2.7\% & \bfseries 0.0\% & \bfseries 0.2\% & \bfseries 20.0\% & \bfseries 0.0\% & \bfseries 0.04\% & \bfseries / & 23.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 1.0\% & \bfseries 10.5\% & \bfseries 1.6\% & / & / & / & / & 13.1\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.01\% & \bfseries 4.1\% & \bfseries 0.2\% & / & / & / & / & 4.4\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.5\% & / & / & / & / & 0.5\% \tabularnewline \hline
 \bfseries Total &  &  & 59.0\% & 17.6\% & 3.3\% & 20.0\% & 0.0\% & 0.04\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MNE/ts_ndcs_quantis_MNE.png}
