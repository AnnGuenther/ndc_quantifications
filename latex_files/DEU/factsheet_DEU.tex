\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Germany: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 0.9~Gt CO$_2$eq, Germany contributed 1.9\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 1.5\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Germany is estimated to emit 0.8~Gt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -7.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 0.7--1.0~Gt CO$_2$eq in 2030, and 0.6--1.5~Gt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 173 in 2017, and 32 regarding the per-capita emissions (170 and 36 in 2030).
 In terms of accumulated historical emissions, Germany contributed to the global 1850--2017 emissions by 4.7\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 2.7\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Germany, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 0.9 & Gt CO$_2$eq & 1.9\% & 8 \tabularnewline 
 \bfseries  & 2030 & 0.8 & Gt CO$_2$eq & 1.5\% & 11 \tabularnewline \hline
 \bfseries GDP & 2017 & 4.0 & Trillion 2011~GK\$ & 3.6\% & 5 \tabularnewline 
 \bfseries  & 2030 & 4.4 & Trillion 2011~GK\$ & 2.5\% & 8 \tabularnewline \hline
 \bfseries Emissions & 2017 & 228.9 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 173 \tabularnewline 
 \bfseries per GDP & 2030 & 191.4 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 170 \tabularnewline \hline
 \bfseries Population & 2017 & 82.7 & Million Pers & 1.1\% & 16 \tabularnewline 
 \bfseries  & 2030 & 81.4 & Million Pers & 1.0\% & 19 \tabularnewline \hline
 \bfseries Emissions & 2017 & 11.1 & t CO$_2$eq /  Pers & 0.8\% & 32 \tabularnewline 
 \bfseries per capita & 2030 & 10.4 & t CO$_2$eq /  Pers & 0.7\% & 36 \tabularnewline 
 \end{tabular}
 \end{table}

 For Germany, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (83.7\%), followed by IPPU (7.8\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 88.1\% of the national emissions. 
 Second largest contributor was CH$_4$ (6.0\%)
 The total of F-gasesonly represented 1.6\%.
 The total CO$_2$ emissions are expected to be 85.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/DEU/ts_emi_exclLU_DEU.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/DEU/ts_gdp_pop_DEU.png}
 ...
 Germany's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Germany are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.0~Gt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 0.9~Gt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -0.0---0.0~Gt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/DEU/ts_emi_onlyLU_DEU.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Germany's NDC (if needed). 
 ...
 Germany has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Germany's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Germany is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/DEU/ts_pc_cov_DEU.png}
 \caption{Timeseries of Germany's national emissions (exclLU) and the share of emissions that is assumed to be covered by Germany's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Germany's 2017 emissions (exclLU, exclBunkers; total 0.9~Gt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 81.8\% & \bfseries 1.3\% & \bfseries 0.6\% & / & / & / & / & 83.7\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 6.0\% & \bfseries 0.05\% & \bfseries 0.1\% & \bfseries 1.2\% & \bfseries 0.0\% & \bfseries 0.4\% & \bfseries 0.0\% & 7.8\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.3\% & \bfseries 3.6\% & \bfseries 3.3\% & / & / & / & / & 7.2\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 1.0\% & \bfseries 0.09\% & / & / & / & / & 1.1\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 88.1\% & 6.0\% & 4.3\% & 1.2\% & 0.0\% & 0.4\% & 0.0\% & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/DEU/ts_ndcs_quantis_DEU.png}
 ...
 \begin{itemize}
 \item \href{https://www.bmwi.de/Redaktion/DE/Pressemitteilungen/2020/09/20200923-altmaier-eeg-novelle-2021-klares-zukunftssignal-fuer-mehr-klimaschutz-und-mehr-erneuerbare.html}{Altmaier: 'EEG Novelle 2021 klares Zukunftssignal fuer mehr Klimaschutz und mehr Erneuerbare'} (23 September 2020)
