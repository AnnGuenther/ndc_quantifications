\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Paraguay: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 55.7~Mt CO$_2$eq, Paraguay contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Paraguay is estimated to emit 79.8~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 43.4\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 75.4--104.9~Mt CO$_2$eq in 2030, and 112.4--148.2~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 21 in 2017, and 57 regarding the per-capita emissions (16 and 43 in 2030).
 In terms of accumulated historical emissions, Paraguay contributed to the global 1850--2017 emissions by 0.07\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.09\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Paraguay, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 55.7 & Mt CO$_2$eq & 0.1\% & 79 \tabularnewline 
 \bfseries  & 2030 & 79.8 & Mt CO$_2$eq & 0.1\% & 66 \tabularnewline \hline
 \bfseries GDP & 2017 & 56.0 & Billion 2011~GK\$ & 0.04\% & 104 \tabularnewline 
 \bfseries  & 2030 & 110.7 & Billion 2011~GK\$ & 0.06\% & 99 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.0 & t CO$_2$eq / Thousand 2011~GK\$ & 0.9\% & 21 \tabularnewline 
 \bfseries per GDP & 2030 & 0.7 & t CO$_2$eq / Thousand 2011~GK\$ & 1.0\% & 16 \tabularnewline \hline
 \bfseries Population & 2017 & 6.9 & Million Pers & 0.09\% & 107 \tabularnewline 
 \bfseries  & 2030 & 8.0 & Million Pers & 0.09\% & 105 \tabularnewline \hline
 \bfseries Emissions & 2017 & 8.1 & t CO$_2$eq /  Pers & 0.6\% & 57 \tabularnewline 
 \bfseries per capita & 2030 & 9.9 & t CO$_2$eq /  Pers & 0.7\% & 43 \tabularnewline 
 \end{tabular}
 \end{table}

 For Paraguay, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (76.7\%), followed by Energy (15.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  48.1\% of the national emissions. 
 Second largest contributor was N$_2$O (39.8\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by N$_2$O and CH$_4$ emissions from the Agriculture sector, which contributed 39.2\% and 37.5\% to Paraguay's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 16.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PRY/ts_emi_exclLU_PRY.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PRY/ts_gdp_pop_PRY.png}
 ...
 Paraguay's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Paraguay are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 5, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net source of 99.9~Mt CO$_2$eq, which in absolute terms is higher than the non-LULUCF emissions of 55.7~Mt CO$_2$eq.
 The large emissions range for UNFCCC (2019) and 1990--2017 is 69.0--122.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PRY/ts_emi_onlyLU_PRY.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Paraguay's NDC (if needed). 
 ...
 Paraguay has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Paraguay's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 374 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 333 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -10\% & 2030 & inclLU \tabularnewline 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PRY/ts_pc_cov_PRY.png}
 \caption{Timeseries of Paraguay's national emissions (exclLU) and the share of emissions that is assumed to be covered by Paraguay's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Paraguay's 2017 emissions (exclLU, exclBunkers; total 55.7~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 99.9~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 10.2\% & \bfseries 4.4\% & \bfseries 0.4\% & / & / & / & / & 15.0\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 1.9\% & \bfseries / & \bfseries 0.01\% & \bfseries / & \bfseries / & \bfseries / & \bfseries / & 1.9\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.01\% & \bfseries 37.5\% & \bfseries 39.2\% & / & / & / & / & 76.7\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 6.3\% & \bfseries 0.0\% & / & / & / & / & 6.3\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 12.1\% & 48.1\% & 39.8\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PRY/ts_ndcs_quantis_PRY.png}
