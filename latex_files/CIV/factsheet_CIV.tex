\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Cote d'Ivoire: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 30.5~Mt CO$_2$eq, Cote d'Ivoire contributed 0.06\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.1\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Cote d'Ivoire is estimated to emit 58.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 89.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 55.5--78.3~Mt CO$_2$eq in 2030, and 97.4--255.3~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 122 in 2017, and 189 regarding the per-capita emissions (136 and 169 in 2030).
 In terms of accumulated historical emissions, Cote d'Ivoire contributed to the global 1850--2017 emissions by 0.04\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Cote d'Ivoire, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 30.5 & Mt CO$_2$eq & 0.06\% & 106 \tabularnewline 
 \bfseries  & 2030 & 58.0 & Mt CO$_2$eq & 0.1\% & 87 \tabularnewline \hline
 \bfseries GDP & 2017 & 86.7 & Billion 2011~GK\$ & 0.07\% & 87 \tabularnewline 
 \bfseries  & 2030 & 241.3 & Billion 2011~GK\$ & 0.1\% & 74 \tabularnewline \hline
 \bfseries Emissions & 2017 & 352.2 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 122 \tabularnewline 
 \bfseries per GDP & 2030 & 240.3 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 136 \tabularnewline \hline
 \bfseries Population & 2017 & 24.4 & Million Pers & 0.3\% & 55 \tabularnewline 
 \bfseries  & 2030 & 28.7 & Million Pers & 0.3\% & 55 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.2 & t CO$_2$eq /  Pers & 0.08\% & 189 \tabularnewline 
 \bfseries per capita & 2030 & 2.0 & t CO$_2$eq /  Pers & 0.1\% & 169 \tabularnewline 
 \end{tabular}
 \end{table}

 For Cote d'Ivoire, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (59.2\%), followed by Agriculture (23.9\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  43.5\% of the national emissions. 
 Second largest contributor was CH$_4$ (43.0\%)
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CIV/ts_emi_exclLU_CIV.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CIV/ts_gdp_pop_CIV.png}
 ...
 Cote d'Ivoire's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Cote d'Ivoire are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 7.2~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 30.5~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is -7.9--8.0~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CIV/ts_emi_onlyLU_CIV.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Cote d'Ivoire's NDC (if needed). 
 ...
 Cote d'Ivoire has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Cote d'Ivoire's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 24.57 Mt~CO$_2$eq SAR & 2030 & exclLU \tabularnewline \hline
 RBU & condi. & best & -28\% & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CIV/ts_pc_cov_CIV.png}
 \caption{Timeseries of Cote d'Ivoire's national emissions (exclLU) and the share of emissions that is assumed to be covered by Cote d'Ivoire's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Cote d'Ivoire's 2017 emissions (exclLU, exclBunkers; total 30.5~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '--' (estimated as a net source of 7.2~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 37.9\% & \bfseries 20.1\% & \bfseries 1.1\% & / & / & / & / & 59.2\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 4.6\% & \bfseries / & \bfseries 0.0\% & / & / & / & / & 4.6\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 1.0\% & \bfseries 11.9\% & \bfseries 11.0\% & / & / & / & / & 23.9\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 10.9\% & \bfseries 0.8\% & / & / & / & / & 11.8\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.6\% & / & / & / & / & 0.6\% \tabularnewline \hline
 \bfseries Total &  &  & 43.5\% & 43.0\% & 13.5\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CIV/ts_ndcs_quantis_CIV.png}
