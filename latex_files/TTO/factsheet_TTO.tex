\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Trinidad \& Tobago: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 90.0~Mt CO$_2$eq, Trinidad \& Tobago contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Trinidad \& Tobago is estimated to emit 86.5~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -3.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 86.5--105.8~Mt CO$_2$eq in 2030, and 64.2--91.0~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 5 in 2017, and 2 regarding the per-capita emissions (6 and 2 in 2030).
 In terms of accumulated historical emissions, Trinidad \& Tobago contributed to the global 1850--2017 emissions by 0.09\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Trinidad \& Tobago, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 90.0 & Mt CO$_2$eq & 0.1\% & 60 \tabularnewline 
 \bfseries  & 2030 & 86.5 & Mt CO$_2$eq & 0.1\% & 64 \tabularnewline \hline
 \bfseries GDP & 2017 & 56.7 & Billion 2011~GK\$ & 0.05\% & 103 \tabularnewline 
 \bfseries  & 2030 & 80.9 & Billion 2011~GK\$ & 0.04\% & 112 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.6 & t CO$_2$eq / Thousand 2011~GK\$ & 1.4\% & 5 \tabularnewline 
 \bfseries per GDP & 2030 & 1.1 & t CO$_2$eq / Thousand 2011~GK\$ & 1.4\% & 6 \tabularnewline \hline
 \bfseries Population & 2017 & 1.4 & Million Pers & 0.01\% & 151 \tabularnewline 
 \bfseries  & 2030 & 1.4 & Million Pers & 0.01\% & 153 \tabularnewline \hline
 \bfseries Emissions & 2017 & 65.1 & t CO$_2$eq /  Pers & 4.4\% & 2 \tabularnewline 
 \bfseries per capita & 2030 & 62.8 & t CO$_2$eq /  Pers & 4.3\% & 2 \tabularnewline 
 \end{tabular}
 \end{table}

 For Trinidad \& Tobago, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (69.3\%), followed by IPPU (27.1\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 73.4\% of the national emissions. 
 Second largest contributor was CH$_4$ (26.2\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CO$_2$ emissions from the IPPU sector, and CH$_4$ emissions from the Energy sector, which contributed 26.6\% and 22.4\% to Trinidad \& Tobago's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TTO/ts_emi_exclLU_TTO.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TTO/ts_gdp_pop_TTO.png}
 ...
 Trinidad \& Tobago's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 

 LULUCF emissions data for Trinidad \& Tobago are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.4~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 90.0~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is -0.5--0.3~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TTO/ts_emi_onlyLU_TTO.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Trinidad \& Tobago's NDC (if needed). 
 ...
 Trinidad \& Tobago has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Trinidad \& Tobago's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TTO/ts_pc_cov_TTO.png}
 \caption{Timeseries of Trinidad \& Tobago's national emissions (exclLU) and the share of emissions that is assumed to be covered by Trinidad \& Tobago's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Trinidad \& Tobago's 2017 emissions (exclLU, exclBunkers; total 90.0~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 46.8\% & \bfseries 22.4\% & \bfseries 0.04\% & / & / & / & / & 69.3\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 26.6\% & \bfseries 0.5\% & \bfseries 0.0\% & / & / & / & / & 27.1\% \tabularnewline 
 \bfseries Agri. & -- & -- & 0.02\% & 0.1\% & 0.2\% & / & / & / & / & 0.3\% \tabularnewline 
 \bfseries Waste & -- & -- & / & 3.1\% & 0.02\% & / & / & / & / & 3.1\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.09\% & / & / & / & / & 0.09\% \tabularnewline \hline
 \bfseries Total &  &  & 73.4\% & 26.2\% & 0.3\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TTO/ts_ndcs_quantis_TTO.png}
