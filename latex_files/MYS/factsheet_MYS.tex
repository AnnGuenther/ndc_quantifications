\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Malaysia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 373.5~Mt CO$_2$eq, Malaysia contributed 0.8\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.7\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Malaysia is estimated to emit 394.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 5.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 353.8--443.1~Mt CO$_2$eq in 2030, and 377.6--635.2~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 90 in 2017, and 29 regarding the per-capita emissions (109 and 32 in 2030).
 In terms of accumulated historical emissions, Malaysia contributed to the global 1850--2017 emissions by 0.3\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Malaysia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 373.5 & Mt CO$_2$eq & 0.8\% & 23 \tabularnewline 
 \bfseries  & 2030 & 394.0 & Mt CO$_2$eq & 0.7\% & 29 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.8 & Trillion 2011~GK\$ & 0.7\% & 27 \tabularnewline 
 \bfseries  & 2030 & 1.3 & Trillion 2011~GK\$ & 0.7\% & 26 \tabularnewline \hline
 \bfseries Emissions & 2017 & 460.9 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 90 \tabularnewline 
 \bfseries per GDP & 2030 & 292.1 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 109 \tabularnewline \hline
 \bfseries Population & 2017 & 31.1 & Million Pers & 0.4\% & 44 \tabularnewline 
 \bfseries  & 2030 & 36.6 & Million Pers & 0.4\% & 45 \tabularnewline \hline
 \bfseries Emissions & 2017 & 12.0 & t CO$_2$eq /  Pers & 0.8\% & 29 \tabularnewline 
 \bfseries per capita & 2030 & 10.8 & t CO$_2$eq /  Pers & 0.7\% & 32 \tabularnewline 
 \end{tabular}
 \end{table}

 For Malaysia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (74.5\%), followed by Waste (13.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  69.7\% of the national emissions. 
 Second largest contributor was CH$_4$ (25.3\%)
 The total of F-gasesonly represented 0.6\%.
 The total CO$_2$ emissions are expected to be 69.8\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MYS/ts_emi_exclLU_MYS.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MYS/ts_gdp_pop_MYS.png}
 ...
 Malaysia's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Malaysia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 22, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -261.6~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 373.5~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -262.7---87.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MYS/ts_emi_onlyLU_MYS.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Malaysia's NDC (if needed). 
 ...
 Malaysia has an NDC, with a GHG mitigation target of the type REI (relative emissions intensity reduction; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Malaysia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 REI & condi. & best & -45\% & 2005 & 2030 & GDP & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MYS/ts_pc_cov_MYS.png}
 \caption{Timeseries of Malaysia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Malaysia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Malaysia's 2017 emissions (exclLU, exclBunkers; total 373.5~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -261.6~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 62.9\% & \bfseries 11.4\% & \bfseries 0.1\% & / & / & / & / & 74.5\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 6.2\% & \bfseries 0.03\% & \bfseries 0.2\% & 0.3\% & 0.2\% & 0.0\% & / & 7.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.6\% & \bfseries 1.0\% & \bfseries 3.6\% & / & / & / & / & 5.2\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.01\% & \bfseries 12.8\% & \bfseries 0.1\% & / & / & / & / & 13.0\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 69.7\% & 25.3\% & 4.5\% & 0.3\% & 0.2\% & 0.0\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MYS/ts_ndcs_quantis_MYS.png}
