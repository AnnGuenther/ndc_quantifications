\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} St. Kitts \& Nevis: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 278.0~kt CO$_2$eq, St. Kitts \& Nevis contributed 0.0005\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.0004\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which St. Kitts \& Nevis is estimated to emit 268.5~kt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -3.4\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 268.5--268.5~kt CO$_2$eq in 2030, and 268.5--268.5~kt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 179 in 2017, and 99 regarding the per-capita emissions (156 and 102 in 2030).
 In terms of accumulated historical emissions, St. Kitts \& Nevis contributed to the global 1850--2017 emissions by 0.0003\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for St. Kitts \& Nevis, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 278.0 & kt CO$_2$eq & 0.0005\% & 187 \tabularnewline 
 \bfseries  & 2030 & 268.5 & kt CO$_2$eq & 0.0004\% & 187 \tabularnewline \hline
 \bfseries GDP & 2017 & 1.4 & Billion 2011~GK\$ & 0.001\% & 182 \tabularnewline 
 \bfseries  & 2030 & 1.3 & Billion 2011~GK\$ & 0.0007\% & 185 \tabularnewline \hline
 \bfseries Emissions & 2017 & 203.4 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 179 \tabularnewline 
 \bfseries per GDP & 2030 & 209.8 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 156 \tabularnewline \hline
 \bfseries Population & 2017 & 52.0 & Thousand Pers & 0.0006\% & 192 \tabularnewline 
 \bfseries  & 2030 & 51.0 & Thousand Pers & 0.0006\% & 192 \tabularnewline \hline
 \bfseries Emissions & 2017 & 5.3 & t CO$_2$eq /  Pers & 0.3\% & 99 \tabularnewline 
 \bfseries per capita & 2030 & 5.3 & t CO$_2$eq /  Pers & 0.3\% & 102 \tabularnewline 
 \end{tabular}
 \end{table}

 For St. Kitts \& Nevis, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (87.7\%), followed by Waste (4.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 87.4\% of the national emissions. 
 Second largest contributor was CH$_4$ (6.2\%)
 The total of F-gasesonly represented 3.3\%.
 The total CO$_2$ emissions are expected to be 87.0\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KNA/ts_emi_exclLU_KNA.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KNA/ts_gdp_pop_KNA.png}
 ...
 St. Kitts \& Nevis's population is assumed to diminish towars 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for St. Kitts \& Nevis are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 21.0~kt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 278.0~kt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is -36.7--110.0~kt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KNA/ts_emi_onlyLU_KNA.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of St. Kitts \& Nevis's NDC (if needed). 
 ...
 St. Kitts \& Nevis has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on St. Kitts \& Nevis's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 0.52 Mt~CO$_2$eq & 2025 & inclLU \tabularnewline 
 ABS & condi. & best & 0.54 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline \hline
 RBU & condi. & best & -22\% & 2025 & inclLU \tabularnewline 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KNA/ts_pc_cov_KNA.png}
 \caption{Timeseries of St. Kitts \& Nevis's national emissions (exclLU) and the share of emissions that is assumed to be covered by St. Kitts \& Nevis's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in St. Kitts \& Nevis's 2017 emissions (exclLU, exclBunkers; total 278.0~kt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 21.0~kt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 86.9\% & 0.4\% & 0.3\% & / & / & / & / & 87.7\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 0.1\% & / & 0.0\% & 3.3\% & / & / & / & 3.5\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.3\% & 1.7\% & 1.3\% & / & / & / & / & 3.4\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & 4.0\% & 0.2\% & / & / & / & / & 4.3\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & / & 1.2\% & / & / & / & / & 1.2\% \tabularnewline \hline
 \bfseries Total &  &  & 87.4\% & 6.2\% & 3.1\% & 3.3\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KNA/ts_ndcs_quantis_KNA.png}
