\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Finland: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 56.1~Mt CO$_2$eq, Finland contributed 0.1\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.09\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Finland is estimated to emit 54.6~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -2.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 46.8--63.9~Mt CO$_2$eq in 2030, and 45.3--103.0~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 167 in 2017, and 38 regarding the per-capita emissions (164 and 45 in 2030).
 In terms of accumulated historical emissions, Finland contributed to the global 1850--2017 emissions by 0.2\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Finland, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 56.1 & Mt CO$_2$eq & 0.1\% & 78 \tabularnewline 
 \bfseries  & 2030 & 54.6 & Mt CO$_2$eq & 0.09\% & 92 \tabularnewline \hline
 \bfseries GDP & 2017 & 234.6 & Billion 2011~GK\$ & 0.2\% & 62 \tabularnewline 
 \bfseries  & 2030 & 278.6 & Billion 2011~GK\$ & 0.1\% & 69 \tabularnewline \hline
 \bfseries Emissions & 2017 & 239.1 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 167 \tabularnewline 
 \bfseries per GDP & 2030 & 196.1 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 164 \tabularnewline \hline
 \bfseries Population & 2017 & 5.5 & Million Pers & 0.07\% & 116 \tabularnewline 
 \bfseries  & 2030 & 5.8 & Million Pers & 0.06\% & 119 \tabularnewline \hline
 \bfseries Emissions & 2017 & 10.2 & t CO$_2$eq /  Pers & 0.7\% & 38 \tabularnewline 
 \bfseries per capita & 2030 & 9.4 & t CO$_2$eq /  Pers & 0.6\% & 45 \tabularnewline 
 \end{tabular}
 \end{table}

 For Finland, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (73.7\%), followed by Agriculture (11.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 80.5\% of the national emissions. 
 Second largest contributor was N$_2$O (8.8\%)
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/FIN/ts_emi_exclLU_FIN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/FIN/ts_gdp_pop_FIN.png}
 ...
 Finland's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Finland are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -20.4~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 56.1~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -33.7---14.0~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/FIN/ts_emi_onlyLU_FIN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Finland's NDC (if needed). 
 ...
 Finland has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Finland's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Finland is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/FIN/ts_pc_cov_FIN.png}
 \caption{Timeseries of Finland's national emissions (exclLU) and the share of emissions that is assumed to be covered by Finland's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Finland's 2017 emissions (exclLU, exclBunkers; total 56.1~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -20.4~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 72.2\% & \bfseries 0.6\% & \bfseries 1.0\% & / & / & / & / & 73.7\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 8.0\% & \bfseries 0.0\% & \bfseries 0.4\% & \bfseries 2.3\% & \bfseries 0.01\% & \bfseries 0.08\% & \bfseries / & 10.8\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.3\% & \bfseries 4.5\% & \bfseries 6.7\% & / & / & / & / & 11.6\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 3.1\% & \bfseries 0.2\% & / & / & / & / & 3.4\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 80.5\% & 8.3\% & 8.8\% & 2.3\% & 0.01\% & 0.08\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/FIN/ts_ndcs_quantis_FIN.png}
