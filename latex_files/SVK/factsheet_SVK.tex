\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Slovakia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 43.6~Mt CO$_2$eq, Slovakia contributed 0.09\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.08\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Slovakia is estimated to emit 47.5~Mt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 9.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 40.7--55.2~Mt CO$_2$eq in 2030, and 39.0--86.9~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 156 in 2017, and 58 regarding the per-capita emissions (160 and 50 in 2030).
 In terms of accumulated historical emissions, Slovakia contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Slovakia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 43.6 & Mt CO$_2$eq & 0.09\% & 89 \tabularnewline 
 \bfseries  & 2030 & 47.5 & Mt CO$_2$eq & 0.08\% & 102 \tabularnewline \hline
 \bfseries GDP & 2017 & 165.3 & Billion 2011~GK\$ & 0.1\% & 65 \tabularnewline 
 \bfseries  & 2030 & 231.9 & Billion 2011~GK\$ & 0.1\% & 77 \tabularnewline \hline
 \bfseries Emissions & 2017 & 263.6 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 156 \tabularnewline 
 \bfseries per GDP & 2030 & 205.0 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 160 \tabularnewline \hline
 \bfseries Population & 2017 & 5.4 & Million Pers & 0.07\% & 117 \tabularnewline 
 \bfseries  & 2030 & 5.5 & Million Pers & 0.06\% & 123 \tabularnewline \hline
 \bfseries Emissions & 2017 & 8.0 & t CO$_2$eq /  Pers & 0.5\% & 58 \tabularnewline 
 \bfseries per capita & 2030 & 8.6 & t CO$_2$eq /  Pers & 0.6\% & 50 \tabularnewline 
 \end{tabular}
 \end{table}

 For Slovakia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (67.6\%), followed by IPPU (22.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 82.7\% of the national emissions. 
 Second largest contributor was CH$_4$ (10.6\%)
 The total of F-gasesonly represented 1.7\%.
 The total CO$_2$ emissions are expected to be 80.6\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SVK/ts_emi_exclLU_SVK.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SVK/ts_gdp_pop_SVK.png}
 ...
 Slovakia's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Slovakia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -6.6~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 43.6~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -11.0---5.7~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SVK/ts_emi_onlyLU_SVK.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Slovakia's NDC (if needed). 
 ...
 Slovakia has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Slovakia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Slovakia is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SVK/ts_pc_cov_SVK.png}
 \caption{Timeseries of Slovakia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Slovakia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Slovakia's 2017 emissions (exclLU, exclBunkers; total 43.6~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 62.5\% & \bfseries 4.5\% & \bfseries 0.5\% & / & / & / & / & 67.6\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 20.0\% & \bfseries 0.0\% & \bfseries 0.4\% & \bfseries 1.7\% & \bfseries 0.01\% & \bfseries 0.01\% & \bfseries / & 22.2\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 2.5\% & \bfseries 3.5\% & / & / & / & / & 6.2\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 3.5\% & \bfseries 0.3\% & / & / & / & / & 3.9\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 82.7\% & 10.6\% & 4.9\% & 1.7\% & 0.01\% & 0.01\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SVK/ts_ndcs_quantis_SVK.png}
