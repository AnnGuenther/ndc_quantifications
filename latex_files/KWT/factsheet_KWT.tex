\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Kuwait: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 128.8~Mt CO$_2$eq, Kuwait contributed 0.2\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.3\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Kuwait is estimated to emit 179.1~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 39.0\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 162.2--212.1~Mt CO$_2$eq in 2030, and 137.0--312.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 32 in 2017, and 5 regarding the per-capita emissions (26 and 3 in 2030).
 In terms of accumulated historical emissions, Kuwait contributed to the global 1850--2017 emissions by 0.2\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Kuwait, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 128.8 & Mt CO$_2$eq & 0.2\% & 45 \tabularnewline 
 \bfseries  & 2030 & 179.1 & Mt CO$_2$eq & 0.3\% & 42 \tabularnewline \hline
 \bfseries GDP & 2017 & 157.0 & Billion 2011~GK\$ & 0.1\% & 67 \tabularnewline 
 \bfseries  & 2030 & 315.1 & Billion 2011~GK\$ & 0.1\% & 67 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.8 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 32 \tabularnewline 
 \bfseries per GDP & 2030 & 0.6 & t CO$_2$eq / Thousand 2011~GK\$ & 0.8\% & 26 \tabularnewline \hline
 \bfseries Population & 2017 & 4.1 & Million Pers & 0.05\% & 130 \tabularnewline 
 \bfseries  & 2030 & 5.4 & Million Pers & 0.06\% & 124 \tabularnewline \hline
 \bfseries Emissions & 2017 & 31.8 & t CO$_2$eq /  Pers & 2.2\% & 5 \tabularnewline 
 \bfseries per capita & 2030 & 33.0 & t CO$_2$eq /  Pers & 2.2\% & 3 \tabularnewline 
 \end{tabular}
 \end{table}

 For Kuwait, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (90.7\%), followed by IPPU (6.9\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 78.7\% of the national emissions. 
 Second largest contributor was CH$_4$ (18.9\%)
 The total of F-gasesonly represented 1.5\%.
 The total CO$_2$ emissions are expected to be 82.5\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KWT/ts_emi_exclLU_KWT.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KWT/ts_gdp_pop_KWT.png}
 ...
 Kuwait's population is assumed to grow towards 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 

 LULUCF emissions data for Kuwait are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.0~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 128.8~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -0.1--0.0~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KWT/ts_emi_onlyLU_KWT.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Kuwait's NDC (if needed). 
 ...
 Kuwait has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KWT/ts_pc_cov_KWT.png}
 \caption{Timeseries of Kuwait's national emissions (exclLU) and the share of emissions that is assumed to be covered by Kuwait's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Kuwait's 2017 emissions (exclLU, exclBunkers; total 128.8~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 73.5\% & \bfseries 17.1\% & \bfseries 0.1\% & / & / & / & / & 90.7\% \tabularnewline 
 \bfseries IPPU & / & -- & 5.2\% & 0.01\% & 0.1\% & 1.2\% & / & 0.2\% & / & 6.9\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.0\% & 0.1\% & 0.2\% & / & / & / & / & 0.3\% \tabularnewline 
 \bfseries Waste & / & -- & / & 1.7\% & 0.06\% & / & / & / & / & 1.7\% \tabularnewline 
 \bfseries Other & / & -- & 0.0\% & 0.0\% & 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 78.7\% & 18.9\% & 0.9\% & 1.2\% & / & 0.2\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KWT/ts_ndcs_quantis_KWT.png}
