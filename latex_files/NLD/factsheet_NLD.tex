\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Netherlands: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 194.6~Mt CO$_2$eq, Netherlands contributed 0.4\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.3\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Netherlands is estimated to emit 192.3~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -1.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 161.6--221.2~Mt CO$_2$eq in 2030, and 151.8--347.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 171 in 2017, and 30 regarding the per-capita emissions (168 and 31 in 2030).
 In terms of accumulated historical emissions, Netherlands contributed to the global 1850--2017 emissions by 0.7\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 0.6\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Netherlands, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 194.6 & Mt CO$_2$eq & 0.4\% & 39 \tabularnewline 
 \bfseries  & 2030 & 192.3 & Mt CO$_2$eq & 0.3\% & 41 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.8 & Trillion 2011~GK\$ & 0.8\% & 25 \tabularnewline 
 \bfseries  & 2030 & 1.0 & Trillion 2011~GK\$ & 0.6\% & 33 \tabularnewline \hline
 \bfseries Emissions & 2017 & 230.3 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 171 \tabularnewline 
 \bfseries per GDP & 2030 & 191.6 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 168 \tabularnewline \hline
 \bfseries Population & 2017 & 17.0 & Million Pers & 0.2\% & 66 \tabularnewline 
 \bfseries  & 2030 & 17.9 & Million Pers & 0.2\% & 72 \tabularnewline \hline
 \bfseries Emissions & 2017 & 11.4 & t CO$_2$eq /  Pers & 0.8\% & 30 \tabularnewline 
 \bfseries per capita & 2030 & 10.8 & t CO$_2$eq /  Pers & 0.7\% & 31 \tabularnewline 
 \end{tabular}
 \end{table}

 For Netherlands, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (82.8\%), followed by Agriculture (9.7\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 85.0\% of the national emissions. 
 Second largest contributor was CH$_4$ (9.3\%)
 The total of F-gasesonly represented 1.0\%.
 The total CO$_2$ emissions are expected to be 83.1\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NLD/ts_emi_exclLU_NLD.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NLD/ts_gdp_pop_NLD.png}
 ...
 Netherlands's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Netherlands are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net source of 5.6~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 194.6~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is 5.4--6.6~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NLD/ts_emi_onlyLU_NLD.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Netherlands's NDC (if needed). 
 ...
 Netherlands has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Netherlands's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Netherlands is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NLD/ts_pc_cov_NLD.png}
 \caption{Timeseries of Netherlands's national emissions (exclLU) and the share of emissions that is assumed to be covered by Netherlands's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Netherlands's 2017 emissions (exclLU, exclBunkers; total 194.6~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 5.6~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 81.3\% & \bfseries 1.2\% & \bfseries 0.3\% & / & / & / & / & 82.8\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 3.7\% & \bfseries 0.1\% & \bfseries 0.8\% & \bfseries 0.9\% & \bfseries 0.03\% & \bfseries 0.06\% & \bfseries 0.0\% & 5.7\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.02\% & \bfseries 6.4\% & \bfseries 3.3\% & / & / & / & / & 9.7\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 1.5\% & \bfseries 0.08\% & / & / & / & / & 1.6\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 85.0\% & 9.3\% & 4.7\% & 0.9\% & 0.03\% & 0.06\% & 0.0\% & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NLD/ts_ndcs_quantis_NLD.png}
