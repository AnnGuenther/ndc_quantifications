\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Libya: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 82.4~Mt CO$_2$eq, Libya contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Libya is estimated to emit 68.8~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial decrease of -16.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 63.1--82.6~Mt CO$_2$eq in 2030, and 67.4--127.3~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 12 in 2017, and 27 regarding the per-capita emissions (9 and 48 in 2030).
 In terms of accumulated historical emissions, Libya contributed to the global 1850--2017 emissions by 0.2\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Libya, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 82.4 & Mt CO$_2$eq & 0.1\% & 63 \tabularnewline 
 \bfseries  & 2030 & 68.8 & Mt CO$_2$eq & 0.1\% & 78 \tabularnewline \hline
 \bfseries GDP & 2017 & 66.6 & Billion 2011~GK\$ & 0.05\% & 98 \tabularnewline 
 \bfseries  & 2030 & 69.9 & Billion 2011~GK\$ & 0.03\% & 117 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.2 & t CO$_2$eq / Thousand 2011~GK\$ & 1.1\% & 12 \tabularnewline 
 \bfseries per GDP & 2030 & 1.0 & t CO$_2$eq / Thousand 2011~GK\$ & 1.3\% & 9 \tabularnewline \hline
 \bfseries Population & 2017 & 6.6 & Million Pers & 0.08\% & 109 \tabularnewline 
 \bfseries  & 2030 & 7.6 & Million Pers & 0.09\% & 107 \tabularnewline \hline
 \bfseries Emissions & 2017 & 12.5 & t CO$_2$eq /  Pers & 0.9\% & 27 \tabularnewline 
 \bfseries per capita & 2030 & 9.0 & t CO$_2$eq /  Pers & 0.6\% & 48 \tabularnewline 
 \end{tabular}
 \end{table}

 For Libya, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (89.2\%), followed by IPPU (4.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  66.4\% of the national emissions. 
 Second largest contributor was CH$_4$ (30.6\%)
 The total of F-gasesonly represented 0.5\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Energy sector, which contributed 26.2\% to Libya's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LBY/ts_emi_exclLU_LBY.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LBY/ts_gdp_pop_LBY.png}
 ...
 Libya's population is assumed to grow towards 2050, and the per capita emissions are expected to decline towars 2050. 

 \newpage %%%
 \section{LULUCF emissions}
 \label{sec:emiLULUCF}
 No LULUCF data are available for Libya from the following sources: CRF (2019), CRF (2018), BUR (3$^{rd}$), BUR (2$^{nd}$), BUR (1$^{st}$), UNFCCC (2019), FAO (2019).
