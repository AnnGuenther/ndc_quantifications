\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Bulgaria: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 61.7~Mt CO$_2$eq, Bulgaria contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Bulgaria is estimated to emit 70.2~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 13.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 65.8--85.9~Mt CO$_2$eq in 2030, and 65.1--130.0~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 99 in 2017, and 49 regarding the per-capita emissions (95 and 35 in 2030).
 In terms of accumulated historical emissions, Bulgaria contributed to the global 1850--2017 emissions by 0.2\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Bulgaria, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 61.7 & Mt CO$_2$eq & 0.1\% & 75 \tabularnewline 
 \bfseries  & 2030 & 70.2 & Mt CO$_2$eq & 0.1\% & 76 \tabularnewline \hline
 \bfseries GDP & 2017 & 141.9 & Billion 2011~GK\$ & 0.1\% & 75 \tabularnewline 
 \bfseries  & 2030 & 218.6 & Billion 2011~GK\$ & 0.1\% & 81 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 99 \tabularnewline 
 \bfseries per GDP & 2030 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.4\% & 95 \tabularnewline \hline
 \bfseries Population & 2017 & 7.1 & Million Pers & 0.09\% & 105 \tabularnewline 
 \bfseries  & 2030 & 6.7 & Million Pers & 0.07\% & 111 \tabularnewline \hline
 \bfseries Emissions & 2017 & 8.7 & t CO$_2$eq /  Pers & 0.6\% & 49 \tabularnewline 
 \bfseries per capita & 2030 & 10.5 & t CO$_2$eq /  Pers & 0.7\% & 35 \tabularnewline 
 \end{tabular}
 \end{table}

 For Bulgaria, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (72.3\%), followed by Agriculture (10.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 76.9\% of the national emissions. 
 Second largest contributor was CH$_4$ (11.0\%)
 The total of F-gasesonly represented 3.0\%.
 The total CO$_2$ emissions are expected to be 74.8\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BGR/ts_emi_exclLU_BGR.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BGR/ts_gdp_pop_BGR.png}
 ...
 Bulgaria's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Bulgaria are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -8.0~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 61.7~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -12.8---6.5~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BGR/ts_emi_onlyLU_BGR.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Bulgaria's NDC (if needed). 
 ...
 Bulgaria has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Bulgaria's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Bulgaria is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BGR/ts_pc_cov_BGR.png}
 \caption{Timeseries of Bulgaria's national emissions (exclLU) and the share of emissions that is assumed to be covered by Bulgaria's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Bulgaria's 2017 emissions (exclLU, exclBunkers; total 61.7~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -8.0~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 69.5\% & \bfseries 2.3\% & \bfseries 0.5\% & / & / & / & / & 72.3\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 7.3\% & \bfseries 0.0\% & \bfseries 0.1\% & \bfseries 2.9\% & \bfseries 0.0\% & \bfseries 0.02\% & \bfseries / & 10.4\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.05\% & \bfseries 2.8\% & \bfseries 7.7\% & / & / & / & / & 10.6\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.02\% & \bfseries 5.9\% & \bfseries 0.2\% & / & / & / & / & 6.1\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 76.9\% & 11.0\% & 9.2\% & 2.9\% & 0.0\% & 0.02\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BGR/ts_ndcs_quantis_BGR.png}
