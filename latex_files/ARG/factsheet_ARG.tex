\documentclass[12pt]{article}
 ...
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Argentina is estimated to emit 403.7~Mt CO$_2$eq in 2030.
 ...
 The country's global rank in terms of total emissions per unit of GDP was 87 in 2017, and 59 regarding the per-capita emissions (84 and 52 in 2030).
 ...
 For Argentina, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (56.7\%), followed by Agriculture (32.8\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  58.7\% of the national emissions. 
 Second largest contributor was CH$_4$ (27.8\%)
 The total of F-gasesonly represented 0.2\%.
 ...
 LULUCF emissions data for Argentina are available from the following sources (Fig.~\ref{fig:tsLULUCF}): BUR (2$^{nd}$)~/ 25, UNFCCC (2019)~/ 6, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net source of 70.4~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 348.2~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is 45.7--104.7~Mt CO$_2$eq.
