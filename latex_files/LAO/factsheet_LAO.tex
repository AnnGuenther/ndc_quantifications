\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Laos: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 13.7~Mt CO$_2$eq, Laos contributed 0.02\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.03\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Laos is estimated to emit 19.6~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 42.8\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 17.1--22.2~Mt CO$_2$eq in 2030, and 22.8--42.9~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 138 in 2017, and 166 regarding the per-capita emissions (159 and 154 in 2030).
 In terms of accumulated historical emissions, Laos contributed to the global 1850--2017 emissions by 0.02\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Laos, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 13.7 & Mt CO$_2$eq & 0.02\% & 132 \tabularnewline 
 \bfseries  & 2030 & 19.6 & Mt CO$_2$eq & 0.03\% & 125 \tabularnewline \hline
 \bfseries GDP & 2017 & 44.8 & Billion 2011~GK\$ & 0.03\% & 112 \tabularnewline 
 \bfseries  & 2030 & 94.0 & Billion 2011~GK\$ & 0.05\% & 105 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.2\% & 138 \tabularnewline 
 \bfseries per GDP & 2030 & 0.2 & t CO$_2$eq / Thousand 2011~GK\$ & 0.2\% & 159 \tabularnewline \hline
 \bfseries Population & 2017 & 7.0 & Million Pers & 0.09\% & 106 \tabularnewline 
 \bfseries  & 2030 & 8.0 & Million Pers & 0.09\% & 106 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.0 & t CO$_2$eq /  Pers & 0.1\% & 166 \tabularnewline 
 \bfseries per capita & 2030 & 2.5 & t CO$_2$eq /  Pers & 0.1\% & 154 \tabularnewline 
 \end{tabular}
 \end{table}

 For Laos, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (71.4\%), followed by Energy (12.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  66.3\% of the national emissions. 
 Second largest contributor was N$_2$O (19.8\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Agriculture sector, and CO$_2$ emissions from the IPPU sector, which contributed 53.1\% and 7.2\% to Laos's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LAO/ts_emi_exclLU_LAO.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LAO/ts_gdp_pop_LAO.png}
 ...
 Laos's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Laos are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 23.7~Mt CO$_2$eq, which in absolute terms is higher than the non-LULUCF emissions of 13.7~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 10.2--30.6~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LAO/ts_emi_onlyLU_LAO.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Laos's NDC (if needed). 
 ...
 Laos has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 The reclassified target type is ABU (absolute reduction compared to Business-As-Usual).

 \begin{table}[H]
 \centering
 \caption{Information on Laos's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABU & condi. & best & -16.53 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LAO/ts_pc_cov_LAO.png}
 \caption{Timeseries of Laos's national emissions (exclLU) and the share of emissions that is assumed to be covered by Laos's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Laos's 2017 emissions (exclLU, exclBunkers; total 13.7~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 23.7~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 6.8\% & \bfseries 5.0\% & \bfseries 0.5\% & / & / & / & / & 12.3\% \tabularnewline 
 \bfseries IPPU & / & -- & 7.2\% & / & 0.0\% & / & / & / & / & 7.2\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.0\% & 53.1\% & 18.3\% & / & / & / & / & 71.4\% \tabularnewline 
 \bfseries Waste & / & -- & / & 8.1\% & 0.6\% & / & / & / & / & 8.8\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 13.9\% & 66.3\% & 19.8\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LAO/ts_ndcs_quantis_LAO.png}
