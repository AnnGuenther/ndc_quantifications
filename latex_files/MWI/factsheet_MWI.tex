\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Malawi: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 12.4~Mt CO$_2$eq, Malawi contributed 0.02\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Malawi is estimated to emit 16.3~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 32.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 16.3--25.6~Mt CO$_2$eq in 2030, and 31.3--98.6~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 56 in 2017, and 202 regarding the per-capita emissions (74 and 205 in 2030).
 In terms of accumulated historical emissions, Malawi contributed to the global 1850--2017 emissions by 0.01\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Malawi, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 12.4 & Mt CO$_2$eq & 0.02\% & 138 \tabularnewline 
 \bfseries  & 2030 & 16.3 & Mt CO$_2$eq & 0.02\% & 133 \tabularnewline \hline
 \bfseries GDP & 2017 & 18.5 & Billion 2011~GK\$ & 0.01\% & 147 \tabularnewline 
 \bfseries  & 2030 & 43.4 & Billion 2011~GK\$ & 0.02\% & 137 \tabularnewline \hline
 \bfseries Emissions & 2017 & 667.8 & t CO$_2$eq / Million 2011~GK\$ & 0.6\% & 56 \tabularnewline 
 \bfseries per GDP & 2030 & 376.0 & t CO$_2$eq / Million 2011~GK\$ & 0.5\% & 74 \tabularnewline \hline
 \bfseries Population & 2017 & 17.7 & Million Pers & 0.2\% & 64 \tabularnewline 
 \bfseries  & 2030 & 25.2 & Million Pers & 0.2\% & 59 \tabularnewline \hline
 \bfseries Emissions & 2017 & 699.3 & t CO$_2$eq / Thousand Pers & 0.04\% & 202 \tabularnewline 
 \bfseries per capita & 2030 & 648.9 & t CO$_2$eq / Thousand Pers & 0.04\% & 205 \tabularnewline 
 \end{tabular}
 \end{table}

 For Malawi, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (51.8\%), followed by Energy (23.7\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  56.2\% of the national emissions. 
 Second largest contributor was N$_2$O (32.2\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ and N$_2$O emissions from the Agriculture sector, which contributed 23.4\% and 28.2\% to Malawi's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 21.6\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MWI/ts_emi_exclLU_MWI.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MWI/ts_gdp_pop_MWI.png}
 ...
 Malawi's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Malawi are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 5.3~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 12.4~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 4.6--8.9~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MWI/ts_emi_onlyLU_MWI.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Malawi's NDC (if needed). 
 ...
 Malawi has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Malawi's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & worst & 22.39 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 20.39 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MWI/ts_pc_cov_MWI.png}
 \caption{Timeseries of Malawi's national emissions (exclLU) and the share of emissions that is assumed to be covered by Malawi's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Malawi's 2017 emissions (exclLU, exclBunkers; total 12.4~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 5.3~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 9.4\% & \bfseries 13.3\% & \bfseries 1.0\% & / & / & / & / & 23.7\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 2.0\% & \bfseries / & \bfseries 0.8\% & / & / & / & / & 2.8\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.2\% & \bfseries 23.4\% & \bfseries 28.2\% & / & / & / & / & 51.8\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 19.6\% & \bfseries 1.7\% & / & / & / & / & 21.2\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.5\% & / & / & / & / & 0.5\% \tabularnewline \hline
 \bfseries Total &  &  & 11.6\% & 56.2\% & 32.2\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MWI/ts_ndcs_quantis_MWI.png}
