\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} St. Vincent \& Grenadines: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 335.9~kt CO$_2$eq, St. Vincent \& Grenadines contributed 0.0007\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.0005\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which St. Vincent \& Grenadines is estimated to emit 333.6~kt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -0.7\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 333.6--333.6~kt CO$_2$eq in 2030, and 333.6--333.6~kt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 140 in 2017, and 135 regarding the per-capita emissions (98 and 137 in 2030).
 In terms of accumulated historical emissions, St. Vincent \& Grenadines contributed to the global 1850--2017 emissions by 0.0004\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.0007\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for St. Vincent \& Grenadines, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 335.9 & kt CO$_2$eq & 0.0007\% & 185 \tabularnewline 
 \bfseries  & 2030 & 333.6 & kt CO$_2$eq & 0.0005\% & 184 \tabularnewline \hline
 \bfseries GDP & 2017 & 1.1 & Billion 2011~GK\$ & 0.0009\% & 185 \tabularnewline 
 \bfseries  & 2030 & 1.1 & Billion 2011~GK\$ & 0.0005\% & 186 \tabularnewline \hline
 \bfseries Emissions & 2017 & 304.4 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 140 \tabularnewline 
 \bfseries per GDP & 2030 & 315.7 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 98 \tabularnewline \hline
 \bfseries Population & 2017 & 109.8 & Thousand Pers & 0.001\% & 184 \tabularnewline 
 \bfseries  & 2030 & 109.1 & Thousand Pers & 0.001\% & 185 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.1 & t CO$_2$eq /  Pers & 0.2\% & 135 \tabularnewline 
 \bfseries per capita & 2030 & 3.1 & t CO$_2$eq /  Pers & 0.2\% & 137 \tabularnewline 
 \end{tabular}
 \end{table}

 For St. Vincent \& Grenadines, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (65.7\%), followed by Waste (25.9\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  64.9\% of the national emissions. 
 Second largest contributor was CH$_4$ (29.0\%)
 The total of F-gasesonly represented 1.6\%.
 The total CO$_2$ emissions are expected to be 65.9\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VCT/ts_emi_exclLU_VCT.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VCT/ts_gdp_pop_VCT.png}
 ...
 St. Vincent \& Grenadines's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 

 LULUCF emissions data for St. Vincent \& Grenadines are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 5, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -34.2~kt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 335.9~kt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -131.9---28.0~kt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VCT/ts_emi_onlyLU_VCT.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of St. Vincent \& Grenadines's NDC (if needed). 
 ...
 St. Vincent \& Grenadines has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on St. Vincent \& Grenadines's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 0.46 Mt~CO$_2$eq AR4 & 2025 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -22\% & 2025 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VCT/ts_pc_cov_VCT.png}
 \caption{Timeseries of St. Vincent \& Grenadines's national emissions (exclLU) and the share of emissions that is assumed to be covered by St. Vincent \& Grenadines's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in St. Vincent \& Grenadines's 2017 emissions (exclLU, exclBunkers; total 335.9~kt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -34.2~kt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 64.3\% & \bfseries 1.1\% & \bfseries 0.2\% & / & / & / & / & 65.7\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 0.3\% & \bfseries / & \bfseries 0.0\% & \bfseries 1.6\% & / & / & / & 1.9\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.2\% & \bfseries 2.7\% & \bfseries 1.7\% & / & / & / & / & 4.7\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 25.1\% & \bfseries 0.8\% & / & / & / & / & 25.9\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 1.8\% & / & / & / & / & 1.8\% \tabularnewline \hline
 \bfseries Total &  &  & 64.9\% & 29.0\% & 4.5\% & 1.6\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VCT/ts_ndcs_quantis_VCT.png}
