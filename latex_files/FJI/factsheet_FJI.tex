\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Fiji: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 2.9~Mt CO$_2$eq, Fiji contributed 0.006\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.004\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Fiji is estimated to emit 2.6~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial decrease of -10.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 2.2--2.9~Mt CO$_2$eq in 2030, and 2.3--4.4~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 118 in 2017, and 129 regarding the per-capita emissions (141 and 141 in 2030).
 In terms of accumulated historical emissions, Fiji contributed to the global 1850--2017 emissions by 0.005\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Fiji, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 2.9 & Mt CO$_2$eq & 0.006\% & 163 \tabularnewline 
 \bfseries  & 2030 & 2.6 & Mt CO$_2$eq & 0.004\% & 170 \tabularnewline \hline
 \bfseries GDP & 2017 & 7.8 & Billion 2011~GK\$ & 0.006\% & 159 \tabularnewline 
 \bfseries  & 2030 & 11.2 & Billion 2011~GK\$ & 0.006\% & 163 \tabularnewline \hline
 \bfseries Emissions & 2017 & 368.0 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 118 \tabularnewline 
 \bfseries per GDP & 2030 & 228.6 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 141 \tabularnewline \hline
 \bfseries Population & 2017 & 877.5 & Thousand Pers & 0.01\% & 159 \tabularnewline 
 \bfseries  & 2030 & 927.6 & Thousand Pers & 0.01\% & 160 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.3 & t CO$_2$eq /  Pers & 0.2\% & 129 \tabularnewline 
 \bfseries per capita & 2030 & 2.8 & t CO$_2$eq /  Pers & 0.1\% & 141 \tabularnewline 
 \end{tabular}
 \end{table}

 For Fiji, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (52.0\%), followed by Agriculture (35.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  55.0\% of the national emissions. 
 Second largest contributor was CH$_4$ (31.7\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 57.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/FJI/ts_emi_exclLU_FJI.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/FJI/ts_gdp_pop_FJI.png}
 ...
 Fiji's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Fiji are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -2.5~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 2.9~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -3.0--0.7~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/FJI/ts_emi_onlyLU_FJI.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Fiji's NDC (if needed). 
 ...
 Fiji has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Fiji's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/FJI/ts_pc_cov_FJI.png}
 \caption{Timeseries of Fiji's national emissions (exclLU) and the share of emissions that is assumed to be covered by Fiji's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Fiji's 2017 emissions (exclLU, exclBunkers; total 2.9~Mt CO$_2$eq).
 ...
 LULUCF: NDC '/' and adapted '--' (estimated as a net sink of -2.5~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 51.4\% & 0.3\% & 0.2\% & / & / & / & / & 52.0\% \tabularnewline 
 \bfseries IPPU & / & -- & 3.3\% & / & 0.1\% & / & / & / & / & 3.5\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.3\% & 23.2\% & 11.8\% & / & / & / & / & 35.3\% \tabularnewline 
 \bfseries Waste & / & -- & / & 8.1\% & 0.4\% & / & / & / & / & 8.5\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.6\% & / & / & / & / & 0.6\% \tabularnewline \hline
 \bfseries Total &  &  & 55.0\% & 31.7\% & 13.3\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/FJI/ts_ndcs_quantis_FJI.png}
