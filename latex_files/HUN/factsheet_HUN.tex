\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Hungary: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 64.2~Mt CO$_2$eq, Hungary contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Hungary is estimated to emit 64.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -0.3\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 54.6--74.3~Mt CO$_2$eq in 2030, and 54.8--123.9~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 166 in 2017, and 80 regarding the per-capita emissions (174 and 83 in 2030).
 In terms of accumulated historical emissions, Hungary contributed to the global 1850--2017 emissions by 0.2\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Hungary, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 64.2 & Mt CO$_2$eq & 0.1\% & 73 \tabularnewline 
 \bfseries  & 2030 & 64.0 & Mt CO$_2$eq & 0.1\% & 82 \tabularnewline \hline
 \bfseries GDP & 2017 & 267.4 & Billion 2011~GK\$ & 0.2\% & 58 \tabularnewline 
 \bfseries  & 2030 & 342.7 & Billion 2011~GK\$ & 0.1\% & 60 \tabularnewline \hline
 \bfseries Emissions & 2017 & 240.0 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 166 \tabularnewline 
 \bfseries per GDP & 2030 & 186.7 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 174 \tabularnewline \hline
 \bfseries Population & 2017 & 9.7 & Million Pers & 0.1\% & 93 \tabularnewline 
 \bfseries  & 2030 & 9.4 & Million Pers & 0.1\% & 99 \tabularnewline \hline
 \bfseries Emissions & 2017 & 6.6 & t CO$_2$eq /  Pers & 0.4\% & 80 \tabularnewline 
 \bfseries per capita & 2030 & 6.8 & t CO$_2$eq /  Pers & 0.4\% & 83 \tabularnewline 
 \end{tabular}
 \end{table}

 For Hungary, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (71.9\%), followed by IPPU (11.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 77.7\% of the national emissions. 
 Second largest contributor was CH$_4$ (11.7\%)
 The total of F-gasesonly represented 3.0\%.
 The total CO$_2$ emissions are expected to be 75.1\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HUN/ts_emi_exclLU_HUN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HUN/ts_gdp_pop_HUN.png}
 ...
 Hungary's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Hungary are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -5.4~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 64.2~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -5.8---0.4~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HUN/ts_emi_onlyLU_HUN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Hungary's NDC (if needed). 
 ...
 Hungary has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Hungary's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Hungary is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HUN/ts_pc_cov_HUN.png}
 \caption{Timeseries of Hungary's national emissions (exclLU) and the share of emissions that is assumed to be covered by Hungary's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Hungary's 2017 emissions (exclLU, exclBunkers; total 64.2~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -5.4~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 69.0\% & \bfseries 2.4\% & \bfseries 0.5\% & / & / & / & / & 71.9\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 8.3\% & \bfseries 0.07\% & \bfseries 0.2\% & \bfseries 2.8\% & \bfseries 0.0\% & \bfseries 0.1\% & \bfseries / & 11.6\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.3\% & \bfseries 4.3\% & \bfseries 6.4\% & / & / & / & / & 11.0\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.05\% & \bfseries 5.0\% & \bfseries 0.1\% & / & / & / & / & 5.3\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 77.7\% & 11.7\% & 7.6\% & 2.8\% & 0.0\% & 0.1\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HUN/ts_ndcs_quantis_HUN.png}
