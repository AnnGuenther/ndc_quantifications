\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Haiti: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 16.2~Mt CO$_2$eq, Haiti contributed 0.03\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.04\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Haiti is estimated to emit 24.8~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 53.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 22.5--33.2~Mt CO$_2$eq in 2030, and 30.5--72.0~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 23 in 2017, and 183 regarding the per-capita emissions (17 and 167 in 2030).
 In terms of accumulated historical emissions, Haiti contributed to the global 1850--2017 emissions by 0.02\%. 
 When only accounting for the years 1990--2017, its contribution stays the same to 0.02\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Haiti, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 16.2 & Mt CO$_2$eq & 0.03\% & 127 \tabularnewline 
 \bfseries  & 2030 & 24.8 & Mt CO$_2$eq & 0.04\% & 118 \tabularnewline \hline
 \bfseries GDP & 2017 & 16.5 & Billion 2011~GK\$ & 0.01\% & 150 \tabularnewline 
 \bfseries  & 2030 & 35.5 & Billion 2011~GK\$ & 0.01\% & 145 \tabularnewline \hline
 \bfseries Emissions & 2017 & 982.7 & t CO$_2$eq / Million 2011~GK\$ & 0.9\% & 23 \tabularnewline 
 \bfseries per GDP & 2030 & 700.0 & t CO$_2$eq / Million 2011~GK\$ & 0.9\% & 17 \tabularnewline \hline
 \bfseries Population & 2017 & 11.0 & Million Pers & 0.1\% & 83 \tabularnewline 
 \bfseries  & 2030 & 12.1 & Million Pers & 0.1\% & 84 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.5 & t CO$_2$eq /  Pers & 0.1\% & 183 \tabularnewline 
 \bfseries per capita & 2030 & 2.0 & t CO$_2$eq /  Pers & 0.1\% & 167 \tabularnewline 
 \end{tabular}
 \end{table}

 For Haiti, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (48.7\%), followed by Agriculture (27.4\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting as much as 71.1\% of the national emissions. 
 Second largest contributor was CO$_2$ (18.4\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Energy sector, which contributed 30.2\% to Haiti's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HTI/ts_emi_exclLU_HTI.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HTI/ts_gdp_pop_HTI.png}
 ...
 Haiti's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Haiti are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.1~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 16.2~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 0.1--0.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HTI/ts_emi_onlyLU_HTI.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Haiti's NDC (if needed). 
 ...
 Haiti has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Haiti's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 19.69 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 14.30 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -5\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -31\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HTI/ts_pc_cov_HTI.png}
 \caption{Timeseries of Haiti's national emissions (exclLU) and the share of emissions that is assumed to be covered by Haiti's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Haiti's 2017 emissions (exclLU, exclBunkers; total 16.2~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 0.1~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 17.5\% & \bfseries 30.2\% & \bfseries 1.1\% & / & / & / & / & 48.7\% \tabularnewline 
 \bfseries IPPU & / & -- & 0.9\% & / & 0.0\% & / & / & / & / & 0.9\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 19.1\% & \bfseries 8.3\% & / & / & / & / & 27.4\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 21.8\% & \bfseries 0.6\% & / & / & / & / & 22.5\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.5\% & / & / & / & / & 0.5\% \tabularnewline \hline
 \bfseries Total &  &  & 18.4\% & 71.1\% & 10.6\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HTI/ts_ndcs_quantis_HTI.png}
