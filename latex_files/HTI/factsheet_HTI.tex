\documentclass[12pt]{article}
 ...
 \label{sec:emiLULUCF}
 LULUCF emissions data for Haiti are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019).
 ...
 ABS & condi. & best & 14.30 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}
