\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Moldova: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 15.6~Mt CO$_2$eq, Moldova contributed 0.03\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Moldova is estimated to emit 17.2~Mt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 9.8\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 17.2--24.4~Mt CO$_2$eq in 2030, and 22.1--36.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 54 in 2017, and 112 regarding the per-capita emissions (59 and 105 in 2030).
 In terms of accumulated historical emissions, Moldova contributed to the global 1850--2017 emissions by 0.07\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 0.04\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Moldova, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 15.6 & Mt CO$_2$eq & 0.03\% & 129 \tabularnewline 
 \bfseries  & 2030 & 17.2 & Mt CO$_2$eq & 0.03\% & 130 \tabularnewline \hline
 \bfseries GDP & 2017 & 22.6 & Billion 2011~GK\$ & 0.02\% & 139 \tabularnewline 
 \bfseries  & 2030 & 40.5 & Billion 2011~GK\$ & 0.02\% & 142 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.7 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 54 \tabularnewline 
 \bfseries per GDP & 2030 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 59 \tabularnewline \hline
 \bfseries Population & 2017 & 4.1 & Million Pers & 0.05\% & 129 \tabularnewline 
 \bfseries  & 2030 & 3.5 & Million Pers & 0.04\% & 133 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.9 & t CO$_2$eq /  Pers & 0.2\% & 112 \tabularnewline 
 \bfseries per capita & 2030 & 4.9 & t CO$_2$eq /  Pers & 0.3\% & 105 \tabularnewline 
 \end{tabular}
 \end{table}

 For Moldova, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (65.6\%), followed by Agriculture (18.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  63.7\% of the national emissions. 
 Second largest contributor was CH$_4$ (19.9\%)
 The total of F-gasesonly represented 1.4\%.
 The trend in total emissions is mostly driven by N$_2$O emissions from the Agriculture sector, which contributed 13.5\% to Moldova's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 67.9\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MDA/ts_emi_exclLU_MDA.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MDA/ts_gdp_pop_MDA.png}
 ...
 Moldova's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Moldova are available from the following sources (Fig.~\ref{fig:tsLULUCF}): BUR (2$^{nd}$)~/ 27, UNFCCC (2019)~/ 24, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.8~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 15.6~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -2.6---0.5~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MDA/ts_emi_onlyLU_MDA.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Moldova's NDC (if needed). 
 ...
 Moldova has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Moldova's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & uncondi. & worst & 9.74 Mt~CO$_2$eq AR4 & 1990 & 2030 & inclLU \tabularnewline 
 ABS & uncondi. & best & 8.44 Mt~CO$_2$eq AR4 & 1990 & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 3.66 Mt~CO$_2$eq AR4 & 1990 & 2030 & inclLU \tabularnewline \hline
 RBY & uncondi. & worst & -64\% & 1990 & 2030 & inclLU \tabularnewline 
 RBY & uncondi. & best & -67\% & 1990 & 2030 & inclLU \tabularnewline 
 RBY & condi. & best & -78\% & 1990 & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MDA/ts_pc_cov_MDA.png}
 \caption{Timeseries of Moldova's national emissions (exclLU) and the share of emissions that is assumed to be covered by Moldova's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Moldova's 2017 emissions (exclLU, exclBunkers; total 15.6~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -0.8~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 58.3\% & \bfseries 6.4\% & \bfseries 1.0\% & / & / & / & / & 65.6\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 5.3\% & \bfseries / & \bfseries 0.0\% & \bfseries 1.4\% & \bfseries 0.0\% & \bfseries 0.0\% & \bfseries / & 6.8\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.04\% & \bfseries 4.8\% & \bfseries 13.5\% & / & / & / & / & 18.3\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.09\% & \bfseries 8.8\% & \bfseries 0.4\% & / & / & / & / & 9.3\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries 0.0\% & \bfseries 0.0\% & \bfseries 0.0\% & / & / & / & / & 0.0\% \tabularnewline \hline
 \bfseries Total &  &  & 63.7\% & 19.9\% & 14.9\% & 1.4\% & 0.0\% & 0.0\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MDA/ts_ndcs_quantis_MDA.png}
