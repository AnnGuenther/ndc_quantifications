\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Suriname: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 3.5~Mt CO$_2$eq, Suriname contributed 0.007\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.008\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Suriname is estimated to emit 5.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 43.7\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 4.9--6.2~Mt CO$_2$eq in 2030, and 6.3--8.7~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 88 in 2017, and 87 regarding the per-capita emissions (88 and 63 in 2030).
 In terms of accumulated historical emissions, Suriname contributed to the global 1850--2017 emissions by 0.008\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 0.007\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Suriname, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 3.5 & Mt CO$_2$eq & 0.007\% & 160 \tabularnewline 
 \bfseries  & 2030 & 5.0 & Mt CO$_2$eq & 0.008\% & 159 \tabularnewline \hline
 \bfseries GDP & 2017 & 7.4 & Billion 2011~GK\$ & 0.006\% & 160 \tabularnewline 
 \bfseries  & 2030 & 14.6 & Billion 2011~GK\$ & 0.008\% & 158 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.4\% & 88 \tabularnewline 
 \bfseries per GDP & 2030 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.4\% & 88 \tabularnewline \hline
 \bfseries Population & 2017 & 570.5 & Thousand Pers & 0.007\% & 167 \tabularnewline 
 \bfseries  & 2030 & 626.5 & Thousand Pers & 0.007\% & 167 \tabularnewline \hline
 \bfseries Emissions & 2017 & 6.1 & t CO$_2$eq /  Pers & 0.4\% & 87 \tabularnewline 
 \bfseries per capita & 2030 & 7.9 & t CO$_2$eq /  Pers & 0.5\% & 63 \tabularnewline 
 \end{tabular}
 \end{table}

 For Suriname, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (71.9\%), followed by Agriculture (21.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 71.7\% of the national emissions. 
 Second largest contributor was CH$_4$ (19.3\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 71.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SUR/ts_emi_exclLU_SUR.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SUR/ts_gdp_pop_SUR.png}
 ...
 Suriname's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Suriname are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 4.1~Mt CO$_2$eq, which in absolute terms is higher than the non-LULUCF emissions of 3.5~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 2.6--7.6~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SUR/ts_emi_onlyLU_SUR.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Suriname's NDC (if needed). 
 ...
 Suriname has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SUR/ts_pc_cov_SUR.png}
 \caption{Timeseries of Suriname's national emissions (exclLU) and the share of emissions that is assumed to be covered by Suriname's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Suriname's 2017 emissions (exclLU, exclBunkers; total 3.5~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 4.1~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 70.0\% & \bfseries 1.5\% & \bfseries 0.4\% & / & / & / & / & 71.9\% \tabularnewline 
 \bfseries IPPU & / & -- & 1.8\% & / & 0.01\% & / & 0.0\% & / & / & 1.8\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.0\% & 14.3\% & 7.0\% & / & / & / & / & 21.2\% \tabularnewline 
 \bfseries Waste & / & -- & 0.0\% & 3.5\% & 0.1\% & / & / & / & / & 3.7\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 1.4\% & / & / & / & / & 1.4\% \tabularnewline \hline
 \bfseries Total &  &  & 71.7\% & 19.3\% & 8.9\% & / & 0.0\% & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SUR/ts_ndcs_quantis_SUR.png}
