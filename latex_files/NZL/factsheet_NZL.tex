\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} New Zealand: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 81.2~Mt CO$_2$eq, New Zealand contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which New Zealand is estimated to emit 79.4~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -2.3\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 74.5--92.1~Mt CO$_2$eq in 2030, and 76.7--149.0~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 96 in 2017, and 18 regarding the per-capita emissions (85 and 21 in 2030).
 In terms of accumulated historical emissions, New Zealand contributed to the global 1850--2017 emissions by 0.2\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for New Zealand, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 81.2 & Mt CO$_2$eq & 0.1\% & 64 \tabularnewline 
 \bfseries  & 2030 & 79.4 & Mt CO$_2$eq & 0.1\% & 67 \tabularnewline \hline
 \bfseries GDP & 2017 & 181.9 & Billion 2011~GK\$ & 0.1\% & 63 \tabularnewline 
 \bfseries  & 2030 & 230.6 & Billion 2011~GK\$ & 0.1\% & 78 \tabularnewline \hline
 \bfseries Emissions & 2017 & 446.8 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 96 \tabularnewline 
 \bfseries per GDP & 2030 & 344.2 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 85 \tabularnewline \hline
 \bfseries Population & 2017 & 4.7 & Million Pers & 0.06\% & 123 \tabularnewline 
 \bfseries  & 2030 & 5.3 & Million Pers & 0.06\% & 127 \tabularnewline \hline
 \bfseries Emissions & 2017 & 17.3 & t CO$_2$eq /  Pers & 1.2\% & 18 \tabularnewline 
 \bfseries per capita & 2030 & 15.0 & t CO$_2$eq /  Pers & 1.0\% & 21 \tabularnewline 
 \end{tabular}
 \end{table}

 For New Zealand, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (47.9\%), followed by Energy (40.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  44.8\% of the national emissions. 
 Second largest contributor was CH$_4$ (42.0\%)
 The total of F-gasesonly represented 1.9\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Agriculture sector, which contributed 35.9\% to New Zealand's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 46.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NZL/ts_emi_exclLU_NZL.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NZL/ts_gdp_pop_NZL.png}
 ...
 New Zealand's population is assumed to grow towards 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for New Zealand are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -24.0~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 81.2~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -33.6---23.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NZL/ts_emi_onlyLU_NZL.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of New Zealand's NDC (if needed). 
 ...
 New Zealand has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on New Zealand's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NZL/ts_pc_cov_NZL.png}
 \caption{Timeseries of New Zealand's national emissions (exclLU) and the share of emissions that is assumed to be covered by New Zealand's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in New Zealand's 2017 emissions (exclLU, exclBunkers; total 81.2~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -24.0~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 39.1\% & \bfseries 1.1\% & \bfseries 0.2\% & / & / & / & / & 40.5\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 4.4\% & \bfseries 0.1\% & \bfseries 0.07\% & \bfseries 1.9\% & \bfseries 0.07\% & \bfseries 0.01\% & \bfseries / & 6.6\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 1.3\% & \bfseries 35.9\% & \bfseries 10.7\% & / & / & / & / & 47.9\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 4.9\% & \bfseries 0.1\% & / & / & / & / & 5.1\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries 0.0\% & \bfseries 0.0\% & \bfseries 0.0\% & / & / & / & / & 0.0\% \tabularnewline \hline
 \bfseries Total &  &  & 44.8\% & 42.0\% & 11.2\% & 1.9\% & 0.07\% & 0.01\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NZL/ts_ndcs_quantis_NZL.png}
