\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Lithuania: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 21.1~Mt CO$_2$eq, Lithuania contributed 0.04\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.03\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Lithuania is estimated to emit 21.7~Mt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 2.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 18.9--25.2~Mt CO$_2$eq in 2030, and 16.8--32.7~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 169 in 2017, and 64 regarding the per-capita emissions (169 and 61 in 2030).
 In terms of accumulated historical emissions, Lithuania contributed to the global 1850--2017 emissions by 0.09\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 0.06\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Lithuania, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 21.1 & Mt CO$_2$eq & 0.04\% & 117 \tabularnewline 
 \bfseries  & 2030 & 21.7 & Mt CO$_2$eq & 0.03\% & 123 \tabularnewline \hline
 \bfseries GDP & 2017 & 89.4 & Billion 2011~GK\$ & 0.07\% & 85 \tabularnewline 
 \bfseries  & 2030 & 113.1 & Billion 2011~GK\$ & 0.06\% & 98 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.2 & t CO$_2$eq / Thousand 2011~GK\$ & 0.2\% & 169 \tabularnewline 
 \bfseries per GDP & 2030 & 0.1 & t CO$_2$eq / Thousand 2011~GK\$ & 0.2\% & 169 \tabularnewline \hline
 \bfseries Population & 2017 & 2.8 & Million Pers & 0.03\% & 139 \tabularnewline 
 \bfseries  & 2030 & 2.7 & Million Pers & 0.03\% & 142 \tabularnewline \hline
 \bfseries Emissions & 2017 & 7.4 & t CO$_2$eq /  Pers & 0.5\% & 64 \tabularnewline 
 \bfseries per capita & 2030 & 8.1 & t CO$_2$eq /  Pers & 0.5\% & 61 \tabularnewline 
 \end{tabular}
 \end{table}

 For Lithuania, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (55.2\%), followed by Agriculture (21.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  65.8\% of the national emissions. 
 Second largest contributor was CH$_4$ (15.8\%)
 The total of F-gasesonly represented 3.5\%.
 The trend in total emissions is mostly driven by N$_2$O emissions from the IPPU sector, which contributed 1.1\% to Lithuania's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 67.1\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LTU/ts_emi_exclLU_LTU.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LTU/ts_gdp_pop_LTU.png}
 ...
 Lithuania's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Lithuania are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -5.3~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 21.1~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -9.0--1.3~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LTU/ts_emi_onlyLU_LTU.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Lithuania's NDC (if needed). 
 ...
 Lithuania has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Lithuania's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Lithuania is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LTU/ts_pc_cov_LTU.png}
 \caption{Timeseries of Lithuania's national emissions (exclLU) and the share of emissions that is assumed to be covered by Lithuania's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Lithuania's 2017 emissions (exclLU, exclBunkers; total 21.1~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -5.3~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 51.9\% & \bfseries 2.4\% & \bfseries 0.9\% & / & / & / & / & 55.2\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 13.7\% & \bfseries 0.02\% & \bfseries 1.1\% & \bfseries 3.4\% & \bfseries 0.06\% & \bfseries 0.03\% & \bfseries 0.0\% & 18.3\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 8.5\% & \bfseries 12.3\% & / & / & / & / & 21.0\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 4.7\% & \bfseries 0.3\% & / & / & / & / & 5.1\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 65.8\% & 15.8\% & 15.0\% & 3.4\% & 0.06\% & 0.03\% & 0.0\% & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LTU/ts_ndcs_quantis_LTU.png}
