\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Yemen: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 43.2~Mt CO$_2$eq, Yemen contributed 0.09\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.1\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Yemen is estimated to emit 74.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 71.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 67.6--83.9~Mt CO$_2$eq in 2030, and 89.0--173.9~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 27 in 2017, and 179 regarding the per-capita emissions (28 and 172 in 2030).
 In terms of accumulated historical emissions, Yemen contributed to the global 1850--2017 emissions by 0.05\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Yemen, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 43.2 & Mt CO$_2$eq & 0.09\% & 91 \tabularnewline 
 \bfseries  & 2030 & 74.0 & Mt CO$_2$eq & 0.1\% & 71 \tabularnewline \hline
 \bfseries GDP & 2017 & 50.7 & Billion 2011~GK\$ & 0.04\% & 108 \tabularnewline 
 \bfseries  & 2030 & 133.1 & Billion 2011~GK\$ & 0.07\% & 93 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.9 & t CO$_2$eq / Thousand 2011~GK\$ & 0.8\% & 27 \tabularnewline 
 \bfseries per GDP & 2030 & 0.6 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 28 \tabularnewline \hline
 \bfseries Population & 2017 & 27.8 & Million Pers & 0.3\% & 49 \tabularnewline 
 \bfseries  & 2030 & 37.9 & Million Pers & 0.4\% & 42 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.6 & t CO$_2$eq /  Pers & 0.1\% & 179 \tabularnewline 
 \bfseries per capita & 2030 & 2.0 & t CO$_2$eq /  Pers & 0.1\% & 172 \tabularnewline 
 \end{tabular}
 \end{table}

 For Yemen, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (60.6\%), followed by Agriculture (26.4\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  57.9\% of the national emissions. 
 Second largest contributor was CH$_4$ (23.3\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 68.5\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/YEM/ts_emi_exclLU_YEM.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/YEM/ts_gdp_pop_YEM.png}
 ...
 Yemen's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Yemen are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 4, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -1.7~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 43.2~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -9.7---1.5~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/YEM/ts_emi_onlyLU_YEM.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Yemen's NDC (if needed). 
 ...
 Yemen has an INDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Yemen's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 39.50 Mt~CO$_2$eq SAR & 2025 & exclLU \tabularnewline 
 ABS & condi. & best & 36.74 Mt~CO$_2$eq SAR & 2025 & exclLU \tabularnewline \hline
 ABS & uncondi. & best & 43.35 Mt~CO$_2$eq SAR & 2030 & exclLU \tabularnewline 
 ABS & condi. & best & 37.67 Mt~CO$_2$eq SAR & 2030 & exclLU \tabularnewline 
 RBU & uncondi. & best & -1\% & 2030 & exclLU \tabularnewline 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/YEM/ts_pc_cov_YEM.png}
 \caption{Timeseries of Yemen's national emissions (exclLU) and the share of emissions that is assumed to be covered by Yemen's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from INDC and adapted ('Adap.': used to calculate \%cov), and their shares in Yemen's 2017 emissions (exclLU, exclBunkers; total 43.2~Mt CO$_2$eq).
 ...
 LULUCF: INDC '/' and adapted '--' (estimated as a net sink of -1.7~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 54.9\% & \bfseries 5.6\% & \bfseries 0.2\% & / & / & / & / & 60.6\% \tabularnewline 
 \bfseries IPPU & / & -- & 3.0\% & / & 2.9\% & / & / & / & / & 5.8\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.01\% & \bfseries 11.9\% & \bfseries 14.4\% & / & / & / & / & 26.4\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 5.8\% & \bfseries 1.0\% & / & / & / & / & 6.8\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 57.9\% & 23.3\% & 18.8\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/YEM/ts_ndcs_quantis_YEM.png}
