\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Saudi Arabia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 0.7~Gt CO$_2$eq, Saudi Arabia contributed 1.4\% to global emissions in 2017, while in 2030 its share is estimated to increase to 1.6\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Saudi Arabia is estimated to emit 0.9~Gt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 36.3\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 0.8--1.1~Gt CO$_2$eq in 2030, and 0.7--1.6~Gt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 79 in 2017, and 10 regarding the per-capita emissions (70 and 10 in 2030).
 In terms of accumulated historical emissions, Saudi Arabia contributed to the global 1850--2017 emissions by 0.8\%. 
 When only accounting for the years 1990--2017, its contribution increases to 1.1\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Saudi Arabia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 0.7 & Gt CO$_2$eq & 1.4\% & 13 \tabularnewline 
 \bfseries  & 2030 & 0.9 & Gt CO$_2$eq & 1.6\% & 9 \tabularnewline \hline
 \bfseries GDP & 2017 & 1.3 & Trillion 2011~GK\$ & 1.1\% & 17 \tabularnewline 
 \bfseries  & 2030 & 2.4 & Trillion 2011~GK\$ & 1.3\% & 15 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.5 & t CO$_2$eq / Thousand 2011~GK\$ & 0.4\% & 79 \tabularnewline 
 \bfseries per GDP & 2030 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.5\% & 70 \tabularnewline \hline
 \bfseries Population & 2017 & 33.1 & Million Pers & 0.4\% & 41 \tabularnewline 
 \bfseries  & 2030 & 42.8 & Million Pers & 0.5\% & 37 \tabularnewline \hline
 \bfseries Emissions & 2017 & 20.4 & t CO$_2$eq /  Pers & 1.4\% & 10 \tabularnewline 
 \bfseries per capita & 2030 & 21.5 & t CO$_2$eq /  Pers & 1.5\% & 10 \tabularnewline 
 \end{tabular}
 \end{table}

 For Saudi Arabia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (83.6\%), followed by IPPU (9.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 81.0\% of the national emissions. 
 Second largest contributor was CH$_4$ (16.3\%)
 The total of F-gasesonly represented 0.07\%.
 The total CO$_2$ emissions are expected to be 85.8\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SAU/ts_emi_exclLU_SAU.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SAU/ts_gdp_pop_SAU.png}
 ...
 Saudi Arabia's population is assumed to grow towards 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 

 LULUCF emissions data for Saudi Arabia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 4, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.0~Gt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 0.7~Gt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -0.0---0.0~Gt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SAU/ts_emi_onlyLU_SAU.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Saudi Arabia's NDC (if needed). 
 ...
 Saudi Arabia has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 The reclassified target type is ABU (absolute reduction compared to Business-As-Usual).

 \begin{table}[H]
 \centering
 \caption{Information on Saudi Arabia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABU & condi. & best & -130 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SAU/ts_pc_cov_SAU.png}
 \caption{Timeseries of Saudi Arabia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Saudi Arabia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Saudi Arabia's 2017 emissions (exclLU, exclBunkers; total 0.7~Gt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 72.2\% & \bfseries 11.2\% & 0.1\% & / & / & / & / & 83.6\% \tabularnewline 
 \bfseries IPPU & / & -- & 8.8\% & 0.1\% & 0.2\% & 0.07\% & / & 0.0\% & / & 9.3\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.02\% & \bfseries 0.3\% & 1.6\% & / & / & / & / & 2.0\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 4.6\% & 0.1\% & / & / & / & / & 4.8\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 81.0\% & 16.3\% & 2.6\% & 0.07\% & / & 0.0\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SAU/ts_ndcs_quantis_SAU.png}
