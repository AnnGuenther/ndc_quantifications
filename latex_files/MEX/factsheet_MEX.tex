\documentclass[12pt]{article}
 ...
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Mexico is estimated to emit 0.9~Gt CO$_2$eq in 2030.
 ...
 The country's global rank in terms of total emissions per unit of GDP was 133 in 2017, and 89 regarding the per-capita emissions (133 and 89 in 2030).
 ...
 For Mexico, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (71.1\%), followed by Agriculture (13.9\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 72.7\% of the national emissions. 
 ...
 LULUCF emissions data for Mexico are available from the following sources (Fig.~\ref{fig:tsLULUCF}): BUR (2$^{nd}$)~/ 26, UNFCCC (2019)~/ 24, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.1~Gt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 0.7~Gt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -0.2---0.1~Gt CO$_2$eq.
 ...
 ABS & condi. & best & 622.72 Mt~CO$_2$eq & 2030 & 2030 & inclLU \tabularnewline \hline
