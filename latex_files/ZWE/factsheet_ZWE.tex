\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Zimbabwe: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 25.4~Mt CO$_2$eq, Zimbabwe contributed 0.05\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Zimbabwe is estimated to emit 29.3~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 15.4\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 27.9--38.0~Mt CO$_2$eq in 2030, and 42.0--114.0~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 40 in 2017, and 173 regarding the per-capita emissions (44 and 170 in 2030).
 In terms of accumulated historical emissions, Zimbabwe contributed to the global 1850--2017 emissions by 0.08\%. 
 When only accounting for the years 1990--2017, its contribution stays the same to 0.08\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Zimbabwe, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 25.4 & Mt CO$_2$eq & 0.05\% & 114 \tabularnewline 
 \bfseries  & 2030 & 29.3 & Mt CO$_2$eq & 0.05\% & 114 \tabularnewline \hline
 \bfseries GDP & 2017 & 33.0 & Billion 2011~GK\$ & 0.02\% & 123 \tabularnewline 
 \bfseries  & 2030 & 61.4 & Billion 2011~GK\$ & 0.03\% & 121 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.8 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 40 \tabularnewline 
 \bfseries per GDP & 2030 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 44 \tabularnewline \hline
 \bfseries Population & 2017 & 14.2 & Million Pers & 0.1\% & 74 \tabularnewline 
 \bfseries  & 2030 & 14.7 & Million Pers & 0.1\% & 77 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.8 & t CO$_2$eq /  Pers & 0.1\% & 173 \tabularnewline 
 \bfseries per capita & 2030 & 2.0 & t CO$_2$eq /  Pers & 0.1\% & 170 \tabularnewline 
 \end{tabular}
 \end{table}

 For Zimbabwe, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (50.9\%), followed by Agriculture (43.9\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  53.4\% of the national emissions. 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ZWE/ts_emi_exclLU_ZWE.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ZWE/ts_gdp_pop_ZWE.png}
 ...
 Zimbabwe's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Zimbabwe are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 3, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -83.0~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 25.4~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -88.0---62.2~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ZWE/ts_emi_onlyLU_ZWE.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Zimbabwe's NDC (if needed). 
 ...
 Zimbabwe has an NDC, with a GHG mitigation target of the type REI (relative emissions intensity reduction; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Zimbabwe's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 REI & condi. & best & -33\% & 2030 & POP & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ZWE/ts_pc_cov_ZWE.png}
 \caption{Timeseries of Zimbabwe's national emissions (exclLU) and the share of emissions that is assumed to be covered by Zimbabwe's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Zimbabwe's 2017 emissions (exclLU, exclBunkers; total 25.4~Mt CO$_2$eq).
 ...
 LULUCF: NDC '/' and adapted '--' (estimated as a net sink of -83.0~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 50.9\% & \bfseries 0.0\% & \bfseries 0.0\% & / & / & / & / & 50.9\% \tabularnewline 
 \bfseries IPPU & / & -- & 2.6\% & 0.0\% & 0.3\% & / & / & / & / & 2.9\% \tabularnewline 
 \bfseries Agri. & / & -- & / & 25.4\% & 18.5\% & / & / & / & / & 43.9\% \tabularnewline 
 \bfseries Waste & / & -- & / & 1.0\% & 0.6\% & / & / & / & / & 1.6\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.7\% & / & / & / & / & 0.7\% \tabularnewline \hline
 \bfseries Total &  &  & 53.4\% & 26.4\% & 20.2\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ZWE/ts_ndcs_quantis_ZWE.png}
