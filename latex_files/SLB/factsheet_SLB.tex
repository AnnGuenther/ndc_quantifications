\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Solomon Is.: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 0.4~Mt CO$_2$eq, Solomon Is. contributed 0.0009\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.001\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Solomon Is. is estimated to emit 0.6~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 22.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 0.5--0.6~Mt CO$_2$eq in 2030, and 0.8--1.5~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 125 in 2017, and 201 regarding the per-capita emissions (151 and 203 in 2030).
 In terms of accumulated historical emissions, Solomon Is. contributed to the global 1850--2017 emissions by 0.0006\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.0008\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Solomon Is., together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 0.4 & Mt CO$_2$eq & 0.0009\% & 183 \tabularnewline 
 \bfseries  & 2030 & 0.6 & Mt CO$_2$eq & 0.001\% & 182 \tabularnewline \hline
 \bfseries GDP & 2017 & 1.4 & Billion 2011~GK\$ & 0.001\% & 183 \tabularnewline 
 \bfseries  & 2030 & 2.6 & Billion 2011~GK\$ & 0.001\% & 177 \tabularnewline \hline
 \bfseries Emissions & 2017 & 341.1 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 125 \tabularnewline 
 \bfseries per GDP & 2030 & 215.7 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 151 \tabularnewline \hline
 \bfseries Population & 2017 & 636.0 & Thousand Pers & 0.008\% & 163 \tabularnewline 
 \bfseries  & 2030 & 785.6 & Thousand Pers & 0.009\% & 163 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.7 & t CO$_2$eq /  Pers & 0.04\% & 201 \tabularnewline 
 \bfseries per capita & 2030 & 0.7 & t CO$_2$eq /  Pers & 0.04\% & 203 \tabularnewline 
 \end{tabular}
 \end{table}

 For Solomon Is., in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (63.0\%), followed by Waste (16.7\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  55.8\% of the national emissions. 
 Second largest contributor was CH$_4$ (35.8\%)
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SLB/ts_emi_exclLU_SLB.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SLB/ts_gdp_pop_SLB.png}
 ...
 Solomon Is.'s population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Solomon Is. are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 1.9~Mt CO$_2$eq, which in absolute terms is higher than the non-LULUCF emissions of 0.4~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 1.6--2.0~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SLB/ts_emi_onlyLU_SLB.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Solomon Is.'s NDC (if needed). 
 ...
 Solomon Is. has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Solomon Is.'s GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 RBU & uncondi. & best & -30\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -45\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -50\% & 2050 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SLB/ts_pc_cov_SLB.png}
 \caption{Timeseries of Solomon Is.'s national emissions (exclLU) and the share of emissions that is assumed to be covered by Solomon Is.'s mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Solomon Is.'s 2017 emissions (exclLU, exclBunkers; total 0.4~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 1.9~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 53.6\% & 7.9\% & 1.5\% & / & / & / & / & 63.0\% \tabularnewline 
 \bfseries IPPU & / & -- & 2.3\% & / & 0.8\% & / & / & / & / & 3.1\% \tabularnewline 
 \bfseries Agri. & / & -- & / & 12.5\% & 3.6\% & / & / & / & / & 16.1\% \tabularnewline 
 \bfseries Waste & / & -- & / & 15.3\% & 1.4\% & / & / & / & / & 16.7\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 1.1\% & / & / & / & / & 1.1\% \tabularnewline \hline
 \bfseries Total &  &  & 55.8\% & 35.8\% & 8.4\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SLB/ts_ndcs_quantis_SLB.png}
