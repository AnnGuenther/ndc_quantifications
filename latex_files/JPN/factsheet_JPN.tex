\documentclass[12pt]{article}
 ...
 LULUCF emissions data for Japan are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.1~Gt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 1.3~Gt CO$_2$eq.
 ...
 ABS & uncondi. & best & 1079.40 Mt~CO$_2$eq AR4 & 2013 & 2030 & exclLU \tabularnewline \hline
