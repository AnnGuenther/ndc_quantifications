\documentclass[12pt]{article}
 ...
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Armenia is estimated to emit 11.6~Mt CO$_2$eq in 2030.
 ...
 The country's global rank in terms of total emissions per unit of GDP was 112 in 2017, and 114 regarding the per-capita emissions (117 and 120 in 2030).
 ...
 For Armenia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (63.8\%), followed by Agriculture (18.1\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  58.4\% of the national emissions. 
 Second largest contributor was CH$_4$ (26.4\%)
 The total of F-gasesrepresented 8.5\%.
 ...
 LULUCF emissions data for Armenia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 4, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.5~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 11.2~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -0.8---0.5~Mt CO$_2$eq.
 ...
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries intensRef & \bfseries LU \tabularnewline \hline \hline
