\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Niger: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 27.9~Mt CO$_2$eq, Niger contributed 0.05\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.06\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Niger is estimated to emit 35.7~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 28.0\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 35.7--55.5~Mt CO$_2$eq in 2030, and 62.1--203.8~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 7 in 2017, and 188 regarding the per-capita emissions (10 and 195 in 2030).
 In terms of accumulated historical emissions, Niger contributed to the global 1850--2017 emissions by 0.03\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Niger, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 27.9 & Mt CO$_2$eq & 0.05\% & 110 \tabularnewline 
 \bfseries  & 2030 & 35.7 & Mt CO$_2$eq & 0.06\% & 110 \tabularnewline \hline
 \bfseries GDP & 2017 & 18.7 & Billion 2011~GK\$ & 0.01\% & 146 \tabularnewline 
 \bfseries  & 2030 & 42.1 & Billion 2011~GK\$ & 0.02\% & 141 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.5 & t CO$_2$eq / Thousand 2011~GK\$ & 1.3\% & 7 \tabularnewline 
 \bfseries per GDP & 2030 & 0.8 & t CO$_2$eq / Thousand 2011~GK\$ & 1.1\% & 10 \tabularnewline \hline
 \bfseries Population & 2017 & 21.6 & Million Pers & 0.2\% & 57 \tabularnewline 
 \bfseries  & 2030 & 32.3 & Million Pers & 0.3\% & 52 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.3 & t CO$_2$eq /  Pers & 0.08\% & 188 \tabularnewline 
 \bfseries per capita & 2030 & 1.1 & t CO$_2$eq /  Pers & 0.07\% & 195 \tabularnewline 
 \end{tabular}
 \end{table}

 For Niger, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (74.1\%), followed by Energy (23.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting as much as 72.5\% of the national emissions. 
 Second largest contributor was CO$_2$ (15.6\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Agriculture sector, which contributed 64.7\% to Niger's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 25.0\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NER/ts_emi_exclLU_NER.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NER/ts_gdp_pop_NER.png}
 ...
 Niger's population is assumed to grow towards 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Niger are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 3, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -34.6~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 27.9~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -34.6--6.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NER/ts_emi_onlyLU_NER.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Niger's NDC (if needed). 
 ...
 Niger has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Niger's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 93.091 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 63.090 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -3.5\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -34.6\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NER/ts_pc_cov_NER.png}
 \caption{Timeseries of Niger's national emissions (exclLU) and the share of emissions that is assumed to be covered by Niger's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Niger's 2017 emissions (exclLU, exclBunkers; total 27.9~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -34.6~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 15.4\% & \bfseries 7.0\% & \bfseries 0.8\% & / & / & / & / & 23.2\% \tabularnewline 
 \bfseries IPPU & / & -- & 0.2\% & / & 0.0\% & / & / & / & / & 0.2\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 64.7\% & \bfseries 9.4\% & / & / & / & / & 74.1\% \tabularnewline 
 \bfseries Waste & / & -- & / & 0.7\% & 1.3\% & / & / & / & / & 2.0\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 15.6\% & 72.5\% & 11.9\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NER/ts_ndcs_quantis_NER.png}
