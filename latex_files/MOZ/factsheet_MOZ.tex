\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Mozambique: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 42.1~Mt CO$_2$eq, Mozambique contributed 0.08\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.1\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Mozambique is estimated to emit 58.9~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 40.0\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 58.9--88.8~Mt CO$_2$eq in 2030, and 84.3--288.0~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 13 in 2017, and 184 regarding the per-capita emissions (14 and 179 in 2030).
 In terms of accumulated historical emissions, Mozambique contributed to the global 1850--2017 emissions by 0.08\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 0.07\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Mozambique, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 42.1 & Mt CO$_2$eq & 0.08\% & 92 \tabularnewline 
 \bfseries  & 2030 & 58.9 & Mt CO$_2$eq & 0.1\% & 86 \tabularnewline \hline
 \bfseries GDP & 2017 & 34.2 & Billion 2011~GK\$ & 0.03\% & 121 \tabularnewline 
 \bfseries  & 2030 & 81.2 & Billion 2011~GK\$ & 0.04\% & 111 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.2 & t CO$_2$eq / Thousand 2011~GK\$ & 1.1\% & 13 \tabularnewline 
 \bfseries per GDP & 2030 & 0.7 & t CO$_2$eq / Thousand 2011~GK\$ & 1.0\% & 14 \tabularnewline \hline
 \bfseries Population & 2017 & 28.6 & Million Pers & 0.3\% & 48 \tabularnewline 
 \bfseries  & 2030 & 35.6 & Million Pers & 0.4\% & 46 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.5 & t CO$_2$eq /  Pers & 0.09\% & 184 \tabularnewline 
 \bfseries per capita & 2030 & 1.7 & t CO$_2$eq /  Pers & 0.1\% & 179 \tabularnewline 
 \end{tabular}
 \end{table}

 For Mozambique, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (45.9\%), followed by Energy (34.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  47.5\% of the national emissions. 
 Second largest contributor was CO$_2$ (25.5\%)
 The total of F-gasesonly represented 1.6\%.
 The total CO$_2$ emissions are expected to be 33.7\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MOZ/ts_emi_exclLU_MOZ.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MOZ/ts_gdp_pop_MOZ.png}
 ...
 Mozambique's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Mozambique are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 38.4~Mt CO$_2$eq, which in absolute terms is in the range of the non-LULUCF emissions of 42.1~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 31.6--50.8~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MOZ/ts_emi_onlyLU_MOZ.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Mozambique's NDC (if needed). 
 ...
 Mozambique has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 The reclassified target type is ABU (absolute reduction compared to Business-As-Usual).

 \begin{table}[H]
 \centering
 \caption{Information on Mozambique's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABU & condi. & best & -4.59 Mt~CO$_2$eq & 2024 & inclLU \tabularnewline 
 ABU & condi. & best & -8.90 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MOZ/ts_pc_cov_MOZ.png}
 \caption{Timeseries of Mozambique's national emissions (exclLU) and the share of emissions that is assumed to be covered by Mozambique's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Mozambique's 2017 emissions (exclLU, exclBunkers; total 42.1~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 38.4~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 20.1\% & \bfseries 13.3\% & \bfseries 0.9\% & / & / & / & / & 34.2\% \tabularnewline 
 \bfseries IPPU & / & -- & 5.4\% & / & 0.4\% & 0.5\% & 1.1\% & / & / & 7.4\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.0\% & 22.8\% & 23.1\% & / & / & / & / & 45.9\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 11.4\% & \bfseries 0.6\% & / & / & / & / & 12.0\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 25.5\% & 47.5\% & 25.5\% & 0.5\% & 1.1\% & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MOZ/ts_ndcs_quantis_MOZ.png}
