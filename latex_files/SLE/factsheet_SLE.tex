\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Sierra Leone: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 7.4~Mt CO$_2$eq, Sierra Leone contributed 0.01\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Sierra Leone is estimated to emit 9.6~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 29.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 9.6--14.7~Mt CO$_2$eq in 2030, and 13.7--47.8~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 52 in 2017, and 197 regarding the per-capita emissions (58 and 199 in 2030).
 In terms of accumulated historical emissions, Sierra Leone contributed to the global 1850--2017 emissions by 0.01\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Sierra Leone, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 7.4 & Mt CO$_2$eq & 0.01\% & 152 \tabularnewline 
 \bfseries  & 2030 & 9.6 & Mt CO$_2$eq & 0.01\% & 148 \tabularnewline \hline
 \bfseries GDP & 2017 & 10.5 & Billion 2011~GK\$ & 0.009\% & 155 \tabularnewline 
 \bfseries  & 2030 & 22.3 & Billion 2011~GK\$ & 0.01\% & 152 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.7 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 52 \tabularnewline 
 \bfseries per GDP & 2030 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 58 \tabularnewline \hline
 \bfseries Population & 2017 & 7.5 & Million Pers & 0.09\% & 103 \tabularnewline 
 \bfseries  & 2030 & 9.5 & Million Pers & 0.1\% & 97 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.0 & t CO$_2$eq /  Pers & 0.06\% & 197 \tabularnewline 
 \bfseries per capita & 2030 & 1.0 & t CO$_2$eq /  Pers & 0.06\% & 199 \tabularnewline 
 \end{tabular}
 \end{table}

 For Sierra Leone, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (46.9\%), followed by Energy (33.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  63.7\% of the national emissions. 
 Second largest contributor was N$_2$O (18.1\%)
 The total of F-gasesonly represented 0.1\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Agriculture sector, which contributed 32.2\% to Sierra Leone's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 28.0\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SLE/ts_emi_exclLU_SLE.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SLE/ts_gdp_pop_SLE.png}
 ...
 Sierra Leone's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Sierra Leone are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 7.3~Mt CO$_2$eq, which in absolute terms is in the range of the non-LULUCF emissions of 7.4~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 5.8--9.8~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SLE/ts_emi_onlyLU_SLE.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Sierra Leone's NDC (if needed). 
 ...
 Sierra Leone has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Sierra Leone's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 7.58 Mt~CO$_2$eq & 2035 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SLE/ts_pc_cov_SLE.png}
 \caption{Timeseries of Sierra Leone's national emissions (exclLU) and the share of emissions that is assumed to be covered by Sierra Leone's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Sierra Leone's 2017 emissions (exclLU, exclBunkers; total 7.4~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 7.3~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 14.8\% & \bfseries 17.2\% & \bfseries 1.5\% & / & / & / & / & 33.5\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 3.3\% & \bfseries / & \bfseries 0.0\% & 0.1\% & / & / & / & 3.5\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 32.2\% & \bfseries 14.7\% & / & / & / & / & 46.9\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 14.3\% & \bfseries 1.0\% & / & / & / & / & 15.3\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.9\% & / & / & / & / & 0.9\% \tabularnewline \hline
 \bfseries Total &  &  & 18.0\% & 63.7\% & 18.1\% & 0.1\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SLE/ts_ndcs_quantis_SLE.png}
