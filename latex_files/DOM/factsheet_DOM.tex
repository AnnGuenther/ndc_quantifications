\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Dominican Rep.: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 31.0~Mt CO$_2$eq, Dominican Rep. contributed 0.06\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.07\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Dominican Rep. is estimated to emit 42.8~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 37.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 36.5--48.8~Mt CO$_2$eq in 2030, and 49.1--74.5~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 182 in 2017, and 138 regarding the per-capita emissions (177 and 129 in 2030).
 In terms of accumulated historical emissions, Dominican Rep. contributed to the global 1850--2017 emissions by 0.04\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.06\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Dominican Rep., together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 31.0 & Mt CO$_2$eq & 0.06\% & 105 \tabularnewline 
 \bfseries  & 2030 & 42.8 & Mt CO$_2$eq & 0.07\% & 106 \tabularnewline \hline
 \bfseries GDP & 2017 & 155.6 & Billion 2011~GK\$ & 0.1\% & 68 \tabularnewline 
 \bfseries  & 2030 & 241.1 & Billion 2011~GK\$ & 0.1\% & 75 \tabularnewline \hline
 \bfseries Emissions & 2017 & 199.5 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 182 \tabularnewline 
 \bfseries per GDP & 2030 & 177.5 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 177 \tabularnewline \hline
 \bfseries Population & 2017 & 10.5 & Million Pers & 0.1\% & 88 \tabularnewline 
 \bfseries  & 2030 & 11.7 & Million Pers & 0.1\% & 86 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.0 & t CO$_2$eq /  Pers & 0.2\% & 138 \tabularnewline 
 \bfseries per capita & 2030 & 3.6 & t CO$_2$eq /  Pers & 0.2\% & 129 \tabularnewline 
 \end{tabular}
 \end{table}

 For Dominican Rep., in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (41.6\%), followed by Agriculture (27.7\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  44.4\% of the national emissions. 
 Second largest contributor was CH$_4$ (42.4\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Waste sector, which contributed 22.6\% to Dominican Rep.'s 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 53.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/DOM/ts_emi_exclLU_DOM.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/DOM/ts_gdp_pop_DOM.png}
 ...
 Dominican Rep.'s population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Dominican Rep. are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 5, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -3.1~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 31.0~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -19.1---3.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/DOM/ts_emi_onlyLU_DOM.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Dominican Rep.'s NDC (if needed). 
 ...
 Dominican Rep. has an NDC, with a GHG mitigation target of the type REI (relative emissions intensity reduction; main target type).
 The reclassified target type is AEI (absolute emissions intensity target).

 \begin{table}[H]
 \centering
 \caption{Information on Dominican Rep.'s GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 AEI & condi. & best & 2.70 t~CO$_2$eq SAR/capita & 2010 & 2030 & POP & inclLU \tabularnewline \hline
 REI & condi. & best & -25\% & 2010 & 2030 & POP & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/DOM/ts_pc_cov_DOM.png}
 \caption{Timeseries of Dominican Rep.'s national emissions (exclLU) and the share of emissions that is assumed to be covered by Dominican Rep.'s mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Dominican Rep.'s 2017 emissions (exclLU, exclBunkers; total 31.0~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -3.1~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 36.5\% & \bfseries 1.2\% & \bfseries 3.8\% & / & / & / & / & 41.6\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 7.0\% & \bfseries / & \bfseries 0.0\% & / & / & / & / & 7.0\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.8\% & \bfseries 18.6\% & \bfseries 8.4\% & / & / & / & / & 27.7\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.04\% & \bfseries 22.6\% & \bfseries 0.1\% & / & / & / & / & 22.8\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.8\% & / & / & / & / & 0.8\% \tabularnewline \hline
 \bfseries Total &  &  & 44.4\% & 42.4\% & 13.2\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/DOM/ts_ndcs_quantis_DOM.png}
