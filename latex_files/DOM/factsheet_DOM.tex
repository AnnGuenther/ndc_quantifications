\documentclass[12pt]{article}
 ...
 \label{sec:emiLULUCF}
 LULUCF emissions data for Dominican Rep. are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019), FAO (2019).
 ...
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries refYr & \bfseries tarYr & \bfseries intensRef & \bfseries LU \tabularnewline \hline
 REI & condi. & best & -25\% & 2010 & 2030 & POP & inclLU \tabularnewline 
 AEI & condi. & best & 2.70 t~CO$_2$eq SAR/capita & 2010 & 2030 & POP & inclLU \tabularnewline 
 \end{tabular}
 \end{table}
