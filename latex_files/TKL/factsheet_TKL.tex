\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Tokelau: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 454.4~t CO$_2$eq, Tokelau contributed 0.0000009\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.0000008\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Tokelau is estimated to emit 455.2~t CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 0.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 455.2--455.2~t CO$_2$eq in 2030, and 455.2--455.2~t CO$_2$eq in 2050.
 The country's global rank in terms of total per-capita emissions was 206 in 2017 (206 in 2030).
 In terms of accumulated historical emissions, Tokelau contributed to the global 1850--2017 emissions by 0.000001\%. 
 When only accounting for the years 1990--2017, its contribution stays the same to 0.000001\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Tokelau, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 454.4 & t CO$_2$eq & 0.0000009\% & 207 \tabularnewline 
 \bfseries  & 2030 & 455.2 & t CO$_2$eq & 0.0000008\% & 207 \tabularnewline \hline
 ...
 \bfseries Population & 2017 & 1.3 & Thousand Pers & 0.00001\% & 205 \tabularnewline 
 \bfseries  & 2030 & 1.2 & Thousand Pers & 0.00001\% & 205 \tabularnewline \hline
 \bfseries Emissions & 2017 & 349.6 & t CO$_2$eq / Thousand Pers & 0.02\% & 206 \tabularnewline 
 \bfseries per capita & 2030 & 368.7 & t CO$_2$eq / Thousand Pers & 0.02\% & 206 \tabularnewline 
 \end{tabular}
 \end{table}

 For Tokelau, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (97.1\%), followed by Energy (1.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting as much as 85.4\% of the national emissions. 
 Second largest contributor was N$_2$O (14.6\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by N$_2$O emissions from the IPPU sector, which contributed 1.1\% to Tokelau's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 0.01\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TKL/ts_emi_exclLU_TKL.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TKL/ts_gdp_pop_TKL.png}
 ...
 Tokelau's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 
 For Tokelau, no GDP data are available from dmSSPs.
 No LULUCF data are available for Tokelau from the following sources: CRF (2019), CRF (2018), BUR (3$^{rd}$), BUR (2$^{nd}$), BUR (1$^{st}$), UNFCCC (2019), FAO (2019).
 ...
 Tokelau does not have an (I)NDC.
