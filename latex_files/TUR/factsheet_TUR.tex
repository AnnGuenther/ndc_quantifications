\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Turkey: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 0.5~Gt CO$_2$eq, Turkey contributed 1.1\% to global emissions in 2017, while in 2030 its share is estimated to increase to 1.2\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Turkey is estimated to emit 0.7~Gt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 25.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 0.6--0.8~Gt CO$_2$eq in 2030, and 0.7--1.4~Gt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 164 in 2017, and 81 regarding the per-capita emissions (161 and 67 in 2030).
 In terms of accumulated historical emissions, Turkey contributed to the global 1850--2017 emissions by 0.6\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Turkey, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 0.5 & Gt CO$_2$eq & 1.1\% & 15 \tabularnewline 
 \bfseries  & 2030 & 0.7 & Gt CO$_2$eq & 1.2\% & 14 \tabularnewline \hline
 \bfseries GDP & 2017 & 2.1 & Trillion 2011~GK\$ & 1.9\% & 13 \tabularnewline 
 \bfseries  & 2030 & 3.3 & Trillion 2011~GK\$ & 1.8\% & 12 \tabularnewline \hline
 \bfseries Emissions & 2017 & 252.8 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 164 \tabularnewline 
 \bfseries per GDP & 2030 & 202.6 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 161 \tabularnewline \hline
 \bfseries Population & 2017 & 81.1 & Million Pers & 1.1\% & 18 \tabularnewline 
 \bfseries  & 2030 & 90.2 & Million Pers & 1.1\% & 17 \tabularnewline \hline
 \bfseries Emissions & 2017 & 6.6 & t CO$_2$eq /  Pers & 0.4\% & 81 \tabularnewline 
 \bfseries per capita & 2030 & 7.5 & t CO$_2$eq /  Pers & 0.5\% & 67 \tabularnewline 
 \end{tabular}
 \end{table}

 For Turkey, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (71.4\%), followed by IPPU (13.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 80.1\% of the national emissions. 
 Second largest contributor was CH$_4$ (10.2\%)
 The total of F-gasesonly represented 1.5\%.
 The total CO$_2$ emissions are expected to be 78.2\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TUR/ts_emi_exclLU_TUR.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TUR/ts_gdp_pop_TUR.png}
 ...
 Turkey's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Turkey are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.1~Gt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 0.5~Gt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -0.1---0.1~Gt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TUR/ts_emi_onlyLU_TUR.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Turkey's NDC (if needed). 
 ...
 Turkey has an INDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Turkey's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 929 Mt~CO$_2$eq AR4 & 2030 & inclLU \tabularnewline \hline
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TUR/ts_pc_cov_TUR.png}
 \caption{Timeseries of Turkey's national emissions (exclLU) and the share of emissions that is assumed to be covered by Turkey's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from INDC and adapted ('Adap.': used to calculate \%cov), and their shares in Turkey's 2017 emissions (exclLU, exclBunkers; total 0.5~Gt CO$_2$eq).
 ...
 LULUCF: INDC '+' and adapted '+' (estimated as a net sink of -0.1~Gt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 69.0\% & \bfseries 1.7\% & \bfseries 0.8\% & / & / & / & / & 71.4\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 10.9\% & \bfseries 0.0\% & \bfseries 0.9\% & \bfseries 1.5\% & \bfseries 0.01\% & \bfseries 0.01\% & \bfseries / & 13.3\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.2\% & \bfseries 6.3\% & \bfseries 5.1\% & / & / & / & / & 11.7\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 2.2\% & \bfseries 1.1\% & / & / & / & / & 3.3\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 80.1\% & 10.2\% & 8.2\% & 1.5\% & 0.01\% & 0.01\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TUR/ts_ndcs_quantis_TUR.png}
