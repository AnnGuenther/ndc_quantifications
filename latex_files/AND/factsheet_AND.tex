\documentclass[12pt]{article}
 ...
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Andorra is estimated to emit 578.6~kt CO$_2$eq in 2030.
 ...
 The country's global rank in terms of total per-capita emissions was 62 in 2017 (71 in 2030).
 ...
 For Andorra, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (86.7\%), followed by IPPU (10.4\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 93.1\% of the national emissions. 
 Second largest contributor was HFCs (2.3\%)
 ...
 For Andorra, no GDP data are available from dmSSPs.

 LULUCF emissions data for Andorra are available from the following sources (Fig.~\ref{fig:tsLULUCF}): BUR (3$^{rd}$)~/ 12, BUR (2$^{nd}$)~/ 8, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from BUR (3$^{rd}$), for the year 2017, LULUCF is estimated to be a net sink of -135.6~kt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 581.0~kt CO$_2$eq.
 The emissions range for BUR (3$^{rd}$) and 1990--2017 is -136.6---114.1~kt CO$_2$eq.
 ...
 ABS & uncondi. & best & 0.33 Mt~CO$_2$eq SAR & 2030 & exclLU \tabularnewline \hline
