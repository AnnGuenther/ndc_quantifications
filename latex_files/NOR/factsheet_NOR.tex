\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Norway: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 53.7~Mt CO$_2$eq, Norway contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Norway is estimated to emit 61.1~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 13.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 51.3--74.8~Mt CO$_2$eq in 2030, and 50.5--129.3~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 187 in 2017, and 41 regarding the per-capita emissions (185 and 41 in 2030).
 In terms of accumulated historical emissions, Norway contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Norway, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 53.7 & Mt CO$_2$eq & 0.1\% & 82 \tabularnewline 
 \bfseries  & 2030 & 61.1 & Mt CO$_2$eq & 0.1\% & 84 \tabularnewline \hline
 \bfseries GDP & 2017 & 300.9 & Billion 2011~GK\$ & 0.2\% & 52 \tabularnewline 
 \bfseries  & 2030 & 385.6 & Billion 2011~GK\$ & 0.2\% & 57 \tabularnewline \hline
 \bfseries Emissions & 2017 & 178.4 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 187 \tabularnewline 
 \bfseries per GDP & 2030 & 158.6 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 185 \tabularnewline \hline
 \bfseries Population & 2017 & 5.3 & Million Pers & 0.07\% & 118 \tabularnewline 
 \bfseries  & 2030 & 6.1 & Million Pers & 0.07\% & 118 \tabularnewline \hline
 \bfseries Emissions & 2017 & 10.1 & t CO$_2$eq /  Pers & 0.7\% & 41 \tabularnewline 
 \bfseries per capita & 2030 & 10.1 & t CO$_2$eq /  Pers & 0.7\% & 41 \tabularnewline 
 \end{tabular}
 \end{table}

 For Norway, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (71.5\%), followed by IPPU (17.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 82.8\% of the national emissions. 
 Second largest contributor was CH$_4$ (9.4\%)
 The total of F-gasesonly represented 3.0\%.
 The total CO$_2$ emissions are expected to be 81.0\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NOR/ts_emi_exclLU_NOR.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NOR/ts_gdp_pop_NOR.png}
 ...
 Norway's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Norway are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -25.0~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 53.7~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -30.3---10.0~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NOR/ts_emi_onlyLU_NOR.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Norway's NDC (if needed). 
 ...
 Norway has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Norway's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & uncondi. & worst & 0.0 Mt~CO$_2$eq AR5 & 1990 & 2030 & exclLU \tabularnewline 
 ABS & uncondi. & best & 23.39 Mt~CO$_2$eq AR5 & 1990 & 2030 & exclLU \tabularnewline \hline
 RBY & uncondi. & worst & -50\% & 1990 & 2030 & exclLU \tabularnewline 
 RBY & uncondi. & best & -55\% & 1990 & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NOR/ts_pc_cov_NOR.png}
 \caption{Timeseries of Norway's national emissions (exclLU) and the share of emissions that is assumed to be covered by Norway's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Norway's 2017 emissions (exclLU, exclBunkers; total 53.7~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -25.0~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 68.7\% & \bfseries 2.4\% & \bfseries 0.3\% & / & / & / & / & 71.5\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 13.9\% & \bfseries 0.03\% & \bfseries 0.6\% & \bfseries 2.6\% & \bfseries 0.2\% & \bfseries 0.1\% & \bfseries / & 17.5\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 4.9\% & \bfseries 3.3\% & / & / & / & / & 8.3\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 2.0\% & \bfseries 0.2\% & / & / & / & / & 2.2\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 82.8\% & 9.4\% & 4.9\% & 2.6\% & 0.2\% & 0.1\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NOR/ts_ndcs_quantis_NOR.png}
