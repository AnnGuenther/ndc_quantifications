\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Tonga: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 253.5~kt CO$_2$eq, Tonga contributed 0.0005\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.0004\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Tonga is estimated to emit 237.2~kt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -6.4\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 237.2--237.2~kt CO$_2$eq in 2030, and 237.2--237.2~kt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 101 in 2017, and 149 regarding the per-capita emissions (57 and 157 in 2030).
 In terms of accumulated historical emissions, Tonga contributed to the global 1850--2017 emissions by 0.0004\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Tonga, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 253.5 & kt CO$_2$eq & 0.0005\% & 189 \tabularnewline 
 \bfseries  & 2030 & 237.2 & kt CO$_2$eq & 0.0004\% & 188 \tabularnewline \hline
 \bfseries GDP & 2017 & 586.1 & Million 2011~GK\$ & 0.0005\% & 191 \tabularnewline 
 \bfseries  & 2030 & 550.1 & Million 2011~GK\$ & 0.0003\% & 191 \tabularnewline \hline
 \bfseries Emissions & 2017 & 432.5 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 101 \tabularnewline 
 \bfseries per GDP & 2030 & 431.2 & t CO$_2$eq / Million 2011~GK\$ & 0.6\% & 57 \tabularnewline \hline
 \bfseries Population & 2017 & 102.0 & Thousand Pers & 0.001\% & 186 \tabularnewline 
 \bfseries  & 2030 & 101.6 & Thousand Pers & 0.001\% & 186 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.5 & t CO$_2$eq /  Pers & 0.1\% & 149 \tabularnewline 
 \bfseries per capita & 2030 & 2.3 & t CO$_2$eq /  Pers & 0.1\% & 157 \tabularnewline 
 \end{tabular}
 \end{table}

 For Tonga, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (59.4\%), followed by Agriculture (30.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  61.0\% of the national emissions. 
 Second largest contributor was CH$_4$ (30.1\%)
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TON/ts_emi_exclLU_TON.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TON/ts_gdp_pop_TON.png}
 ...
 Tonga's population is assumed to diminish towars 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Tonga are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -73.3~kt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 253.5~kt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -513.3--0.0~kt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TON/ts_emi_onlyLU_TON.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Tonga's NDC (if needed). 
 ...
 Tonga has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 The reclassified target type is ABU (absolute reduction compared to Business-As-Usual).

 \begin{table}[H]
 \centering
 \caption{Information on Tonga's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABU & condi. & best & -0.27 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TON/ts_pc_cov_TON.png}
 \caption{Timeseries of Tonga's national emissions (exclLU) and the share of emissions that is assumed to be covered by Tonga's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Tonga's 2017 emissions (exclLU, exclBunkers; total 253.5~kt CO$_2$eq).
 ...
 LULUCF: NDC '/' and adapted '--' (estimated as a net sink of -73.3~kt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 58.5\% & \bfseries 0.6\% & \bfseries 0.3\% & / & / & / & / & 59.4\% \tabularnewline 
 \bfseries IPPU & / & -- & 2.5\% & / & 0.2\% & / & / & / & / & 2.8\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries / & \bfseries 22.7\% & \bfseries 7.9\% & / & / & / & / & 30.5\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 6.9\% & \bfseries / & / & / & / & / & 6.9\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 61.0\% & 30.1\% & 8.8\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TON/ts_ndcs_quantis_TON.png}
