\documentclass[12pt]{article}
 ...
 \label{sec:emiLULUCF}
 LULUCF emissions data for Jordan are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019).
 ...
 ABS & condi. & best & 43.88 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}
