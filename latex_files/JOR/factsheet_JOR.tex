\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Jordan: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 27.9~Mt CO$_2$eq, Jordan contributed 0.05\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.09\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Jordan is estimated to emit 52.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 86.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 46.8--61.2~Mt CO$_2$eq in 2030, and 84.8--182.7~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 130 in 2017, and 141 regarding the per-capita emissions (121 and 124 in 2030).
 In terms of accumulated historical emissions, Jordan contributed to the global 1850--2017 emissions by 0.03\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Jordan, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 27.9 & Mt CO$_2$eq & 0.05\% & 109 \tabularnewline 
 \bfseries  & 2030 & 52.0 & Mt CO$_2$eq & 0.09\% & 96 \tabularnewline \hline
 \bfseries GDP & 2017 & 84.3 & Billion 2011~GK\$ & 0.07\% & 88 \tabularnewline 
 \bfseries  & 2030 & 193.6 & Billion 2011~GK\$ & 0.1\% & 83 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.2\% & 130 \tabularnewline 
 \bfseries per GDP & 2030 & 0.2 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 121 \tabularnewline \hline
 \bfseries Population & 2017 & 9.8 & Million Pers & 0.1\% & 92 \tabularnewline 
 \bfseries  & 2030 & 13.2 & Million Pers & 0.1\% & 80 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.9 & t CO$_2$eq /  Pers & 0.1\% & 141 \tabularnewline 
 \bfseries per capita & 2030 & 3.9 & t CO$_2$eq /  Pers & 0.2\% & 124 \tabularnewline 
 \end{tabular}
 \end{table}

 For Jordan, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (71.4\%), followed by IPPU (12.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 80.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (14.2\%)
 The total of F-gasesonly represented 1.2\%.
 The total CO$_2$ emissions are expected to be 84.9\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/JOR/ts_emi_exclLU_JOR.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/JOR/ts_gdp_pop_JOR.png}
 ...
 Jordan's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Jordan are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 3, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net source of 0.9~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 27.9~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -3.6--0.9~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/JOR/ts_emi_onlyLU_JOR.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Jordan's NDC (if needed). 
 ...
 Jordan has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Jordan's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 50.26 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 43.88 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -1.5\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -14\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/JOR/ts_pc_cov_JOR.png}
 \caption{Timeseries of Jordan's national emissions (exclLU) and the share of emissions that is assumed to be covered by Jordan's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Jordan's 2017 emissions (exclLU, exclBunkers; total 27.9~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 70.1\% & \bfseries 1.1\% & \bfseries 0.2\% & / & / & / & / & 71.4\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 10.1\% & \bfseries / & \bfseries 1.2\% & \bfseries 1.2\% & \bfseries / & \bfseries / & / & 12.5\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 2.2\% & \bfseries 2.2\% & / & / & / & / & 4.4\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 10.9\% & \bfseries 0.4\% & / & / & / & / & 11.3\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 80.2\% & 14.2\% & 4.5\% & 1.2\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/JOR/ts_ndcs_quantis_JOR.png}
