\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Venezuela: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 255.1~Mt CO$_2$eq, Venezuela contributed 0.5\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.6\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Venezuela is estimated to emit 315.8~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 23.8\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 313.9--387.6~Mt CO$_2$eq in 2030, and 293.5--525.8~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 18 in 2017, and 50 regarding the per-capita emissions (15 and 49 in 2030).
 In terms of accumulated historical emissions, Venezuela contributed to the global 1850--2017 emissions by 0.6\%. 
 When only accounting for the years 1990--2017, its contribution stays the same to 0.6\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Venezuela, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 255.1 & Mt CO$_2$eq & 0.5\% & 34 \tabularnewline 
 \bfseries  & 2030 & 315.8 & Mt CO$_2$eq & 0.6\% & 31 \tabularnewline \hline
 \bfseries GDP & 2017 & 249.4 & Billion 2011~GK\$ & 0.2\% & 61 \tabularnewline 
 \bfseries  & 2030 & 435.9 & Billion 2011~GK\$ & 0.2\% & 55 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.0 & t CO$_2$eq / Thousand 2011~GK\$ & 0.9\% & 18 \tabularnewline 
 \bfseries per GDP & 2030 & 0.7 & t CO$_2$eq / Thousand 2011~GK\$ & 1.0\% & 15 \tabularnewline \hline
 \bfseries Population & 2017 & 29.4 & Million Pers & 0.3\% & 46 \tabularnewline 
 \bfseries  & 2030 & 34.9 & Million Pers & 0.4\% & 47 \tabularnewline \hline
 \bfseries Emissions & 2017 & 8.7 & t CO$_2$eq /  Pers & 0.6\% & 50 \tabularnewline 
 \bfseries per capita & 2030 & 9.0 & t CO$_2$eq /  Pers & 0.6\% & 49 \tabularnewline 
 \end{tabular}
 \end{table}

 For Venezuela, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (74.5\%), followed by Agriculture (15.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  66.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (27.2\%)
 The total of F-gasesonly represented 0.9\%.
 The total CO$_2$ emissions are expected to be 67.7\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VEN/ts_emi_exclLU_VEN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VEN/ts_gdp_pop_VEN.png}
 ...
 Venezuela's population is assumed to grow towards 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 

 LULUCF emissions data for Venezuela are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 71.2~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 255.1~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 3.3--142.9~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VEN/ts_emi_onlyLU_VEN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Venezuela's NDC (if needed). 
 ...
 Venezuela has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Venezuela's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VEN/ts_pc_cov_VEN.png}
 \caption{Timeseries of Venezuela's national emissions (exclLU) and the share of emissions that is assumed to be covered by Venezuela's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Venezuela's 2017 emissions (exclLU, exclBunkers; total 255.1~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 71.2~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 61.0\% & \bfseries 13.2\% & 0.3\% & / & / & / & / & 74.5\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 5.0\% & \bfseries 0.03\% & 0.02\% & 0.8\% & 0.0\% & 0.1\% & / & 6.0\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.1\% & 10.5\% & 4.6\% & / & / & / & / & 15.3\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 3.5\% & 0.2\% & / & / & / & / & 3.8\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 66.2\% & 27.2\% & 5.6\% & 0.8\% & 0.0\% & 0.1\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VEN/ts_ndcs_quantis_VEN.png}
