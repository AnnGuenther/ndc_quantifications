\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Seychelles: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 547.6~kt CO$_2$eq, Seychelles contributed 0.001\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Seychelles is estimated to emit 565.9~kt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 3.4\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 565.9--565.9~kt CO$_2$eq in 2030, and 565.9--565.9~kt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 181 in 2017, and 92 regarding the per-capita emissions (145 and 94 in 2030).
 In terms of accumulated historical emissions, Seychelles contributed to the global 1850--2017 emissions by 0.0008\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Seychelles, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 547.6 & kt CO$_2$eq & 0.001\% & 181 \tabularnewline 
 \bfseries  & 2030 & 565.9 & kt CO$_2$eq & 0.001\% & 181 \tabularnewline \hline
 \bfseries GDP & 2017 & 2.7 & Billion 2011~GK\$ & 0.002\% & 176 \tabularnewline 
 \bfseries  & 2030 & 2.5 & Billion 2011~GK\$ & 0.001\% & 178 \tabularnewline \hline
 \bfseries Emissions & 2017 & 199.8 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 181 \tabularnewline 
 \bfseries per GDP & 2030 & 224.6 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 145 \tabularnewline \hline
 \bfseries Population & 2017 & 96.4 & Thousand Pers & 0.001\% & 187 \tabularnewline 
 \bfseries  & 2030 & 94.6 & Thousand Pers & 0.001\% & 187 \tabularnewline \hline
 \bfseries Emissions & 2017 & 5.7 & t CO$_2$eq /  Pers & 0.3\% & 92 \tabularnewline 
 \bfseries per capita & 2030 & 6.0 & t CO$_2$eq /  Pers & 0.4\% & 94 \tabularnewline 
 \end{tabular}
 \end{table}

 For Seychelles, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (88.8\%), followed by IPPU (4.8\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 78.3\% of the national emissions. 
 Second largest contributor was CH$_4$ (18.2\%)
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SYC/ts_emi_exclLU_SYC.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SYC/ts_gdp_pop_SYC.png}
 ...
 Seychelles's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 
 No LULUCF data are available for Seychelles from the following sources: CRF (2019), CRF (2018), BUR (3$^{rd}$), BUR (2$^{nd}$), BUR (1$^{st}$), UNFCCC (2019), FAO (2019).
 ...
 Seychelles has an NDC, with a GHG mitigation target of the type ABU (absolute reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Seychelles's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & -0.049 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 ABU & condi. & best & -0.12 Mt~CO$_2$eq & 2025 & inclLU \tabularnewline \hline
 ABU & condi. & best & -0.18 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SYC/ts_pc_cov_SYC.png}
 \caption{Timeseries of Seychelles's national emissions (exclLU) and the share of emissions that is assumed to be covered by Seychelles's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Seychelles's 2017 emissions (exclLU, exclBunkers; total 547.6~kt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 73.5\% & \bfseries 14.4\% & 1.0\% & / & / & / & / & 88.8\% \tabularnewline 
 \bfseries IPPU & -- & \bfseries + & \bfseries 4.8\% & \bfseries / & 0.0\% & / & / & / & / & 4.8\% \tabularnewline 
 \bfseries Agri. & -- & \bfseries + & \bfseries 0.0\% & \bfseries 0.2\% & 0.6\% & / & / & / & / & 0.8\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 3.5\% & 0.1\% & / & / & / & / & 3.7\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & 1.8\% & / & / & / & / & 1.8\% \tabularnewline \hline
 \bfseries Total &  &  & 78.3\% & 18.2\% & 3.5\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SYC/ts_ndcs_quantis_SYC.png}
