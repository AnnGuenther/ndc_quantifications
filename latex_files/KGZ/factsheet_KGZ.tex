\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Kyrgyzstan: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 19.2~Mt CO$_2$eq, Kyrgyzstan contributed 0.04\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Kyrgyzstan is estimated to emit 22.8~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 18.7\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 22.8--31.0~Mt CO$_2$eq in 2030, and 34.5--57.9~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 36 in 2017, and 133 regarding the per-capita emissions (39 and 133 in 2030).
 In terms of accumulated historical emissions, Kyrgyzstan contributed to the global 1850--2017 emissions by 0.06\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Kyrgyzstan, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 19.2 & Mt CO$_2$eq & 0.04\% & 119 \tabularnewline 
 \bfseries  & 2030 & 22.8 & Mt CO$_2$eq & 0.04\% & 121 \tabularnewline \hline
 \bfseries GDP & 2017 & 24.7 & Billion 2011~GK\$ & 0.02\% & 134 \tabularnewline 
 \bfseries  & 2030 & 46.6 & Billion 2011~GK\$ & 0.02\% & 132 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.8 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 36 \tabularnewline 
 \bfseries per GDP & 2030 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 39 \tabularnewline \hline
 \bfseries Population & 2017 & 6.2 & Million Pers & 0.08\% & 112 \tabularnewline 
 \bfseries  & 2030 & 6.6 & Million Pers & 0.07\% & 112 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.1 & t CO$_2$eq /  Pers & 0.2\% & 133 \tabularnewline 
 \bfseries per capita & 2030 & 3.4 & t CO$_2$eq /  Pers & 0.2\% & 133 \tabularnewline 
 \end{tabular}
 \end{table}

 For Kyrgyzstan, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (57.4\%), followed by Agriculture (31.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  48.7\% of the national emissions. 
 Second largest contributor was CH$_4$ (39.7\%)
 The total of F-gasesonly represented 0.3\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Energy sector, which contributed 12.2\% to Kyrgyzstan's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 56.1\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KGZ/ts_emi_exclLU_KGZ.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KGZ/ts_gdp_pop_KGZ.png}
 ...
 Kyrgyzstan's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Kyrgyzstan are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 21, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.2~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 19.2~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -0.3--0.04~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KGZ/ts_emi_onlyLU_KGZ.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Kyrgyzstan's NDC (if needed). 
 ...
 Kyrgyzstan has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Kyrgyzstan's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 RBU & uncondi. & worst & -11.49\% & 2030 & inclLU \tabularnewline 
 RBU & uncondi. & best & -13.75\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & worst & -29\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -30.89\% & 2030 & inclLU \tabularnewline 
 RBU & uncondi. & worst & -12.67\% & 2050 & inclLU \tabularnewline 
 RBU & uncondi. & best & -15.69\% & 2050 & inclLU \tabularnewline 
 RBU & condi. & worst & -35.06\% & 2050 & inclLU \tabularnewline 
 RBU & condi. & best & -36.75\% & 2050 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KGZ/ts_pc_cov_KGZ.png}
 \caption{Timeseries of Kyrgyzstan's national emissions (exclLU) and the share of emissions that is assumed to be covered by Kyrgyzstan's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Kyrgyzstan's 2017 emissions (exclLU, exclBunkers; total 19.2~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 45.0\% & \bfseries 12.2\% & \bfseries 0.1\% & / & / & / & / & 57.4\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 3.7\% & \bfseries / & \bfseries 0.0\% & \bfseries 0.3\% & \bfseries / & \bfseries / & \bfseries / & 4.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 20.9\% & \bfseries 10.3\% & / & / & / & / & 31.2\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 6.7\% & \bfseries 0.5\% & / & / & / & / & 7.2\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 48.7\% & 39.7\% & 11.2\% & 0.3\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KGZ/ts_ndcs_quantis_KGZ.png}
