\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Comoros: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 0.7~Mt CO$_2$eq, Comoros contributed 0.001\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Comoros is estimated to emit 1.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 43.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 1.0--1.5~Mt CO$_2$eq in 2030, and 1.7--5.4~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 136 in 2017, and 199 regarding the per-capita emissions (155 and 198 in 2030).
 In terms of accumulated historical emissions, Comoros contributed to the global 1850--2017 emissions by 0.001\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Comoros, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 0.7 & Mt CO$_2$eq & 0.001\% & 178 \tabularnewline 
 \bfseries  & 2030 & 1.0 & Mt CO$_2$eq & 0.001\% & 176 \tabularnewline \hline
 \bfseries GDP & 2017 & 2.3 & Billion 2011~GK\$ & 0.002\% & 177 \tabularnewline 
 \bfseries  & 2030 & 4.9 & Billion 2011~GK\$ & 0.002\% & 174 \tabularnewline \hline
 \bfseries Emissions & 2017 & 312.6 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 136 \tabularnewline 
 \bfseries per GDP & 2030 & 210.4 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 155 \tabularnewline \hline
 \bfseries Population & 2017 & 0.8 & Million Pers & 0.01\% & 160 \tabularnewline 
 \bfseries  & 2030 & 1.0 & Million Pers & 0.01\% & 159 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.9 & t CO$_2$eq /  Pers & 0.05\% & 199 \tabularnewline 
 \bfseries per capita & 2030 & 1.0 & t CO$_2$eq /  Pers & 0.06\% & 198 \tabularnewline 
 \end{tabular}
 \end{table}

 For Comoros, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (42.1\%), followed by Energy (38.9\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  66.7\% of the national emissions. 
 Second largest contributor was CO$_2$ (24.7\%)
 The total of F-gasesonly represented 0.1\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Agriculture and Energy sectors, which contributed 35.4\% and 14.4\% to Comoros's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 39.7\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COM/ts_emi_exclLU_COM.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COM/ts_gdp_pop_COM.png}
 ...
 Comoros's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Comoros are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.07~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 0.7~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 0.03--0.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COM/ts_emi_onlyLU_COM.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Comoros's NDC (if needed). 
 ...
 Comoros has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Comoros's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 0.10 Mt~CO$_2$eq & 2025 & exclLU \tabularnewline 
 ABS & condi. & best & 0.032 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 ABS & condi. & best & 0.13 Mt~CO$_2$eq & 2025 & inclLU \tabularnewline 
 ABS & condi. & best & 0.081 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline \hline
 RBU & condi. & best & -74.1\% & 2025 & exclLU \tabularnewline 
 RBU & condi. & best & -93.1\% & 2030 & exclLU \tabularnewline 
 RBU & condi. & best & -69\% & 2025 & inclLU \tabularnewline 
 RBU & condi. & best & -84\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COM/ts_pc_cov_COM.png}
 \caption{Timeseries of Comoros's national emissions (exclLU) and the share of emissions that is assumed to be covered by Comoros's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Comoros's 2017 emissions (exclLU, exclBunkers; total 0.7~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 0.07~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 23.7\% & \bfseries 14.4\% & \bfseries 0.8\% & / & / & / & / & 38.9\% \tabularnewline 
 \bfseries IPPU & / & \bfseries + & \bfseries 1.0\% & \bfseries / & \bfseries 0.0\% & \bfseries 0.1\% & \bfseries / & \bfseries / & \bfseries / & 1.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 35.4\% & \bfseries 6.6\% & / & / & / & / & 42.1\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 16.8\% & \bfseries 0.7\% & / & / & / & / & 17.5\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 24.7\% & 66.7\% & 8.5\% & 0.1\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COM/ts_ndcs_quantis_COM.png}
