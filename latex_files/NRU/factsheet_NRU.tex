\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Nauru: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 57.3~kt CO$_2$eq, Nauru contributed 0.0001\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.00008\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Nauru is estimated to emit 49.5~kt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial decrease of -13.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 49.5--49.5~kt CO$_2$eq in 2030, and 49.5--49.5~kt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 131 in 2017, and 97 regarding the per-capita emissions (81 and 108 in 2030).
 In terms of accumulated historical emissions, Nauru contributed to the global 1850--2017 emissions by 0.00009\%. 
 When only accounting for the years 1990--2017, its contribution stays the same to 0.00009\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Nauru, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 57.3 & kt CO$_2$eq & 0.0001\% & 201 \tabularnewline 
 \bfseries  & 2030 & 49.5 & kt CO$_2$eq & 0.00008\% & 201 \tabularnewline \hline
 \bfseries GDP & 2017 & 176.0 & Million 2011~GK\$ & 0.0001\% & 197 \tabularnewline 
 \bfseries  & 2030 & 139.5 & Million 2011~GK\$ & 0.00007\% & 197 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.2\% & 131 \tabularnewline 
 \bfseries per GDP & 2030 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.4\% & 81 \tabularnewline \hline
 \bfseries Population & 2017 & 10.6 & Thousand Pers & 0.0001\% & 202 \tabularnewline 
 \bfseries  & 2030 & 10.3 & Thousand Pers & 0.0001\% & 202 \tabularnewline \hline
 \bfseries Emissions & 2017 & 5.4 & t CO$_2$eq /  Pers & 0.3\% & 97 \tabularnewline 
 \bfseries per capita & 2030 & 4.8 & t CO$_2$eq /  Pers & 0.3\% & 108 \tabularnewline 
 \end{tabular}
 \end{table}

 For Nauru, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (87.3\%), followed by Waste (8.4\%)
 ...
 The total CO$_2$ emissions are expected to be 88.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NRU/ts_emi_exclLU_NRU.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NRU/ts_gdp_pop_NRU.png}
 ...
 Nauru's population is assumed to diminish towars 2050, and the per capita emissions are expected to decline towars 2050. 
 No LULUCF data are available for Nauru from the following sources: CRF (2019), CRF (2018), BUR (3$^{rd}$), BUR (2$^{nd}$), BUR (1$^{st}$), UNFCCC (2019), FAO (2019).
 ...
 Nauru has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NRU/ts_pc_cov_NRU.png}
 \caption{Timeseries of Nauru's national emissions (exclLU) and the share of emissions that is assumed to be covered by Nauru's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Nauru's 2017 emissions (exclLU, exclBunkers; total 57.3~kt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 87.1\% & 0.04\% & 0.1\% & / & / & / & / & 87.3\% \tabularnewline 
 \bfseries IPPU & / & -- & 2.7\% & / & 0.1\% & / & / & / & / & 2.8\% \tabularnewline 
 \bfseries Agri. & / & -- & / & 1.2\% & 0.2\% & / & / & / & / & 1.5\% \tabularnewline 
 \bfseries Waste & / & -- & / & 8.1\% & 0.3\% & / & / & / & / & 8.4\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.0\% & / & / & / & / & 0.0\% \tabularnewline \hline
 \bfseries Total &  &  & 89.8\% & 9.3\% & 0.9\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NRU/ts_ndcs_quantis_NRU.png}
