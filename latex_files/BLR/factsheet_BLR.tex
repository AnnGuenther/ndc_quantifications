\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Belarus: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 100.4~Mt CO$_2$eq, Belarus contributed 0.2\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.1\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Belarus is estimated to emit 97.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -3.4\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 97.0--131.9~Mt CO$_2$eq in 2030, and 97.0--167.6~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 63 in 2017, and 36 regarding the per-capita emissions (71 and 30 in 2030).
 In terms of accumulated historical emissions, Belarus contributed to the global 1850--2017 emissions by 0.3\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Belarus, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 100.4 & Mt CO$_2$eq & 0.2\% & 54 \tabularnewline 
 \bfseries  & 2030 & 97.0 & Mt CO$_2$eq & 0.1\% & 60 \tabularnewline \hline
 \bfseries GDP & 2017 & 161.3 & Billion 2011~GK\$ & 0.1\% & 66 \tabularnewline 
 \bfseries  & 2030 & 252.8 & Billion 2011~GK\$ & 0.1\% & 71 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.6 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 63 \tabularnewline 
 \bfseries per GDP & 2030 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.5\% & 71 \tabularnewline \hline
 \bfseries Population & 2017 & 9.5 & Million Pers & 0.1\% & 95 \tabularnewline 
 \bfseries  & 2030 & 9.0 & Million Pers & 0.1\% & 102 \tabularnewline \hline
 \bfseries Emissions & 2017 & 10.6 & t CO$_2$eq /  Pers & 0.7\% & 36 \tabularnewline 
 \bfseries per capita & 2030 & 10.8 & t CO$_2$eq /  Pers & 0.7\% & 30 \tabularnewline 
 \end{tabular}
 \end{table}

 For Belarus, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (62.1\%), followed by Agriculture (24.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  67.3\% of the national emissions. 
 Second largest contributor was CH$_4$ (16.8\%)
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BLR/ts_emi_exclLU_BLR.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BLR/ts_gdp_pop_BLR.png}
 ...
 Belarus's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Belarus are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -13.3~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 100.4~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -40.1---13.3~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BLR/ts_emi_onlyLU_BLR.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Belarus's NDC (if needed). 
 ...
 Belarus has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Belarus's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & uncondi. & best & 100.18 Mt~CO$_2$eq SAR & 1990 & 2030 & exclLU \tabularnewline \hline
 RBY & uncondi. & best & -28\% & 1990 & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BLR/ts_pc_cov_BLR.png}
 \caption{Timeseries of Belarus's national emissions (exclLU) and the share of emissions that is assumed to be covered by Belarus's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Belarus's 2017 emissions (exclLU, exclBunkers; total 100.4~Mt CO$_2$eq).
 ...
 LULUCF: NDC '--' and adapted '--' (estimated as a net sink of -13.3~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 60.7\% & \bfseries 1.1\% & \bfseries 0.2\% & / & / & / & / & 62.1\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 5.5\% & \bfseries 0.06\% & \bfseries 0.7\% & \bfseries 1.2\% & \bfseries 0.03\% & \bfseries 0.0\% & / & 7.6\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 1.0\% & \bfseries 9.8\% & \bfseries 13.1\% & / & / & / & / & 24.0\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 5.9\% & \bfseries 0.2\% & / & / & / & / & 6.1\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 67.3\% & 16.8\% & 14.6\% & 1.2\% & 0.03\% & 0.0\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BLR/ts_ndcs_quantis_BLR.png}
