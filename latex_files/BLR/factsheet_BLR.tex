\documentclass[12pt]{article}
 ...
 \label{sec:emiLULUCF}
 LULUCF emissions data for Belarus are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019), CRF (2018), FAO (2019).
 ...
 ABS & uncondi. & best & 100.18 Mt~CO$_2$eq SAR & 1990 & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}
