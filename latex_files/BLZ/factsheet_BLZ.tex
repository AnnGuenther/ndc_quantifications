\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Belize: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 1.2~Mt CO$_2$eq, Belize contributed 0.002\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Belize is estimated to emit 1.3~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 16.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 1.3--1.7~Mt CO$_2$eq in 2030, and 1.6--2.4~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 121 in 2017, and 134 regarding the per-capita emissions (114 and 135 in 2030).
 In terms of accumulated historical emissions, Belize contributed to the global 1850--2017 emissions by 0.001\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.002\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Belize, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 1.2 & Mt CO$_2$eq & 0.002\% & 173 \tabularnewline 
 \bfseries  & 2030 & 1.3 & Mt CO$_2$eq & 0.002\% & 173 \tabularnewline \hline
 \bfseries GDP & 2017 & 3.2 & Billion 2011~GK\$ & 0.002\% & 175 \tabularnewline 
 \bfseries  & 2030 & 4.7 & Billion 2011~GK\$ & 0.002\% & 175 \tabularnewline \hline
 \bfseries Emissions & 2017 & 360.2 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 121 \tabularnewline 
 \bfseries per GDP & 2030 & 285.5 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 114 \tabularnewline \hline
 \bfseries Population & 2017 & 375.8 & Thousand Pers & 0.004\% & 173 \tabularnewline 
 \bfseries  & 2030 & 432.9 & Thousand Pers & 0.005\% & 173 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.1 & t CO$_2$eq /  Pers & 0.2\% & 134 \tabularnewline 
 \bfseries per capita & 2030 & 3.1 & t CO$_2$eq /  Pers & 0.2\% & 135 \tabularnewline 
 \end{tabular}
 \end{table}

 For Belize, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (58.6\%), followed by Agriculture (33.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  56.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (23.3\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by N$_2$O emissions from the Agriculture sector, which contributed 17.6\% to Belize's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 58.2\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BLZ/ts_emi_exclLU_BLZ.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BLZ/ts_gdp_pop_BLZ.png}
 ...
 Belize's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Belize are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 4.5~Mt CO$_2$eq, which in absolute terms is higher than the non-LULUCF emissions of 1.2~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 2.1--9.2~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BLZ/ts_emi_onlyLU_BLZ.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Belize's NDC (if needed). 
 ...
 Belize has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 The reclassified target type is ABU (absolute reduction compared to Business-As-Usual).

 \begin{table}[H]
 \centering
 \caption{Information on Belize's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABU & condi. & worst & -0.71 Mt~CO$_2$eq AR4 & 2030 & inclLU \tabularnewline 
 ABU & condi. & best & -0.75 Mt~CO$_2$eq AR4 & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BLZ/ts_pc_cov_BLZ.png}
 \caption{Timeseries of Belize's national emissions (exclLU) and the share of emissions that is assumed to be covered by Belize's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Belize's 2017 emissions (exclLU, exclBunkers; total 1.2~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 55.8\% & \bfseries 1.7\% & 1.2\% & / & / & / & / & 58.6\% \tabularnewline 
 \bfseries IPPU & / & -- & 0.4\% & / & 0.0\% & / & / & / & / & 0.4\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.0\% & 15.8\% & 17.6\% & / & / & / & / & 33.5\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 5.8\% & 0.4\% & / & / & / & / & 6.2\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 1.2\% & / & / & / & / & 1.2\% \tabularnewline \hline
 \bfseries Total &  &  & 56.2\% & 23.3\% & 20.4\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BLZ/ts_ndcs_quantis_BLZ.png}
