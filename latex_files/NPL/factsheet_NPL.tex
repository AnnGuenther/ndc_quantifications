\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Nepal: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 41.9~Mt CO$_2$eq, Nepal contributed 0.08\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Nepal is estimated to emit 50.2~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 19.7\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 46.4--53.4~Mt CO$_2$eq in 2030, and 60.4--145.6~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 68 in 2017, and 181 regarding the per-capita emissions (73 and 183 in 2030).
 In terms of accumulated historical emissions, Nepal contributed to the global 1850--2017 emissions by 0.09\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Nepal, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 41.9 & Mt CO$_2$eq & 0.08\% & 93 \tabularnewline 
 \bfseries  & 2030 & 50.2 & Mt CO$_2$eq & 0.08\% & 98 \tabularnewline \hline
 \bfseries GDP & 2017 & 69.6 & Billion 2011~GK\$ & 0.06\% & 96 \tabularnewline 
 \bfseries  & 2030 & 133.5 & Billion 2011~GK\$ & 0.07\% & 92 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.6 & t CO$_2$eq / Thousand 2011~GK\$ & 0.5\% & 68 \tabularnewline 
 \bfseries per GDP & 2030 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.5\% & 73 \tabularnewline \hline
 \bfseries Population & 2017 & 27.6 & Million Pers & 0.3\% & 50 \tabularnewline 
 \bfseries  & 2030 & 33.2 & Million Pers & 0.3\% & 51 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.5 & t CO$_2$eq /  Pers & 0.1\% & 181 \tabularnewline 
 \bfseries per capita & 2030 & 1.5 & t CO$_2$eq /  Pers & 0.1\% & 183 \tabularnewline 
 \end{tabular}
 \end{table}

 For Nepal, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (60.5\%), followed by Energy (27.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  62.5\% of the national emissions. 
 Second largest contributor was CO$_2$ (21.2\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 26.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NPL/ts_emi_exclLU_NPL.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NPL/ts_gdp_pop_NPL.png}
 ...
 Nepal's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Nepal are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 7.2~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 41.9~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 3.6--36.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NPL/ts_emi_onlyLU_NPL.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Nepal's NDC (if needed). 
 ...
 Nepal has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NPL/ts_pc_cov_NPL.png}
 \caption{Timeseries of Nepal's national emissions (exclLU) and the share of emissions that is assumed to be covered by Nepal's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Nepal's 2017 emissions (exclLU, exclBunkers; total 41.9~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 19.0\% & \bfseries 7.4\% & \bfseries 1.3\% & / & / & / & / & 27.6\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 2.2\% & \bfseries / & \bfseries 0.0\% & / & / & / & / & 2.2\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 47.1\% & \bfseries 13.5\% & / & / & / & / & 60.5\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 8.0\% & \bfseries 0.9\% & / & / & / & / & 8.9\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.7\% & / & / & / & / & 0.7\% \tabularnewline \hline
 \bfseries Total &  &  & 21.2\% & 62.5\% & 16.4\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NPL/ts_ndcs_quantis_NPL.png}
