\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Sudan: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 108.8~Mt CO$_2$eq, Sudan contributed 0.2\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Sudan is estimated to emit 140.2~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 28.8\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 138.7--203.8~Mt CO$_2$eq in 2030, and 182.8--511.7~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 45 in 2017, and 144 regarding the per-capita emissions (62 and 143 in 2030).
 In terms of accumulated historical emissions, Sudan contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Sudan, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 108.8 & Mt CO$_2$eq & 0.2\% & 51 \tabularnewline 
 \bfseries  & 2030 & 140.2 & Mt CO$_2$eq & 0.2\% & 50 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.1 & Trillion 2011~GK\$ & 0.1\% & 70 \tabularnewline 
 \bfseries  & 2030 & 0.3 & Trillion 2011~GK\$ & 0.1\% & 61 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.7 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 45 \tabularnewline 
 \bfseries per GDP & 2030 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.5\% & 62 \tabularnewline \hline
 \bfseries Population & 2017 & 40.8 & Million Pers & 0.5\% & 35 \tabularnewline 
 \bfseries  & 2030 & 51.4 & Million Pers & 0.6\% & 31 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.7 & t CO$_2$eq /  Pers & 0.1\% & 144 \tabularnewline 
 \bfseries per capita & 2030 & 2.7 & t CO$_2$eq /  Pers & 0.1\% & 143 \tabularnewline 
 \end{tabular}
 \end{table}

 For Sudan, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (69.2\%), followed by Energy (22.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  55.6\% of the national emissions. 
 Second largest contributor was N$_2$O (28.3\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ and N$_2$O emissions from the Agriculture sector, which contributed 42.0\% and 27.1\% to Sudan's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 26.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SDN/ts_emi_exclLU_SDN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SDN/ts_gdp_pop_SDN.png}
 ...
 Sudan's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Sudan are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 49.4~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 108.8~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 40.2--155.9~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SDN/ts_emi_onlyLU_SDN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Sudan's NDC (if needed). 
 ...
 Sudan has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SDN/ts_pc_cov_SDN.png}
 \caption{Timeseries of Sudan's national emissions (exclLU) and the share of emissions that is assumed to be covered by Sudan's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Sudan's 2017 emissions (exclLU, exclBunkers; total 108.8~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 49.4~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 14.5\% & \bfseries 7.4\% & \bfseries 0.3\% & / & / & / & / & 22.2\% \tabularnewline 
 \bfseries IPPU & / & -- & 1.6\% & / & 0.0\% & / & / & / & / & 1.6\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.08\% & 42.0\% & 27.1\% & / & / & / & / & 69.2\% \tabularnewline 
 \bfseries Waste & \bfseries + & -- & / & 6.2\% & 0.5\% & / & / & / & / & 6.7\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 16.2\% & 55.6\% & 28.3\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SDN/ts_ndcs_quantis_SDN.png}
