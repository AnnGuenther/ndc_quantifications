\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Central African Rep.: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 10.6~Mt CO$_2$eq, Central African Rep. contributed 0.02\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.01\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Central African Rep. is estimated to emit 9.3~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial decrease of -12.7\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 9.3--15.1~Mt CO$_2$eq in 2030, and 11.0--42.8~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 2 in 2017, and 155 regarding the per-capita emissions (3 and 178 in 2030).
 In terms of accumulated historical emissions, Central African Rep. contributed to the global 1850--2017 emissions by 0.05\%. 
 When only accounting for the years 1990--2017, its contribution stays the same to 0.05\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Central African Rep., together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 10.6 & Mt CO$_2$eq & 0.02\% & 143 \tabularnewline 
 \bfseries  & 2030 & 9.3 & Mt CO$_2$eq & 0.01\% & 150 \tabularnewline \hline
 \bfseries GDP & 2017 & 3.4 & Billion 2011~GK\$ & 0.002\% & 172 \tabularnewline 
 \bfseries  & 2030 & 6.3 & Billion 2011~GK\$ & 0.003\% & 170 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.2 & t CO$_2$eq / Thousand 2011~GK\$ & 2.9\% & 2 \tabularnewline 
 \bfseries per GDP & 2030 & 1.5 & t CO$_2$eq / Thousand 2011~GK\$ & 1.9\% & 3 \tabularnewline \hline
 \bfseries Population & 2017 & 4.6 & Million Pers & 0.06\% & 125 \tabularnewline 
 \bfseries  & 2030 & 5.6 & Million Pers & 0.06\% & 122 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.3 & t CO$_2$eq /  Pers & 0.1\% & 155 \tabularnewline 
 \bfseries per capita & 2030 & 1.7 & t CO$_2$eq /  Pers & 0.1\% & 178 \tabularnewline 
 \end{tabular}
 \end{table}

 For Central African Rep., in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (88.2\%), followed by Energy (9.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  70.0\% of the national emissions. 
 Second largest contributor was N$_2$O (24.7\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ and N$_2$O emissions from the Agriculture sector, which contributed 64.2\% and 24.0\% to Central African Rep.'s 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 10.1\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CAF/ts_emi_exclLU_CAF.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CAF/ts_gdp_pop_CAF.png}
 ...
 Central African Rep.'s population is assumed to grow towards 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Central African Rep. are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 9, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -1743.2~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 10.6~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -1743.2---139.3~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CAF/ts_emi_onlyLU_CAF.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Central African Rep.'s NDC (if needed). 
 ...
 Central African Rep. has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Central African Rep.'s GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 30.99 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 ABS & condi. & best & 30.58 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 ABS & uncondi. & best & 56.52 Mt~CO$_2$eq & 2050 & exclLU \tabularnewline 
 ABS & condi. & best & 44.85 Mt~CO$_2$eq & 2050 & exclLU \tabularnewline \hline
 ABS & uncondi. & best & -171.35 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & -172.79 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 ABS & uncondi. & best & -131.28 Mt~CO$_2$eq & 2050 & inclLU \tabularnewline 
 ABS & condi. & best & -168.19 Mt~CO$_2$eq & 2050 & inclLU \tabularnewline 
 RBU & uncondi. & best & -3.7\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -5\% & 2030 & inclLU \tabularnewline 
 RBU & uncondi. & best & -5.5\% & 2050 & inclLU \tabularnewline 
 RBU & condi. & best & -25\% & 2050 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CAF/ts_pc_cov_CAF.png}
 \caption{Timeseries of Central African Rep.'s national emissions (exclLU) and the share of emissions that is assumed to be covered by Central African Rep.'s mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Central African Rep.'s 2017 emissions (exclLU, exclBunkers; total 10.6~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -1743.2~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 3.3\% & \bfseries 5.9\% & \bfseries 0.4\% & / & / & / & / & 9.5\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 2.0\% & \bfseries / & \bfseries 0.0\% & / & / & / & / & 2.0\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 64.2\% & \bfseries 24.0\% & / & / & / & / & 88.2\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 0.0\% & \bfseries 0.0\% & / & / & / & / & 0.0\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 5.3\% & 70.0\% & 24.7\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CAF/ts_ndcs_quantis_CAF.png}
