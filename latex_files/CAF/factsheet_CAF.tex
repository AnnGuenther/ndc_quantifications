\documentclass[12pt]{article}
 ...
 \label{sec:emiLULUCF}
 LULUCF emissions data for Central African Rep. are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019), FAO (2019).
 ...
 ABS & condi. & best & 44.85 Mt~CO$_2$eq & 2050 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}
