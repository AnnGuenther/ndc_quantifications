\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Greece: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 95.8~Mt CO$_2$eq, Greece contributed 0.2\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.1\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Greece is estimated to emit 88.8~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -7.3\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 80.6--106.3~Mt CO$_2$eq in 2030, and 81.9--172.9~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 128 in 2017, and 46 regarding the per-capita emissions (124 and 53 in 2030).
 In terms of accumulated historical emissions, Greece contributed to the global 1850--2017 emissions by 0.2\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Greece, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 95.8 & Mt CO$_2$eq & 0.2\% & 57 \tabularnewline 
 \bfseries  & 2030 & 88.8 & Mt CO$_2$eq & 0.1\% & 62 \tabularnewline \hline
 \bfseries GDP & 2017 & 283.3 & Billion 2011~GK\$ & 0.2\% & 54 \tabularnewline 
 \bfseries  & 2030 & 341.2 & Billion 2011~GK\$ & 0.1\% & 62 \tabularnewline \hline
 \bfseries Emissions & 2017 & 338.3 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 128 \tabularnewline 
 \bfseries per GDP & 2030 & 260.3 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 124 \tabularnewline \hline
 \bfseries Population & 2017 & 10.6 & Million Pers & 0.1\% & 87 \tabularnewline 
 \bfseries  & 2030 & 10.5 & Million Pers & 0.1\% & 94 \tabularnewline \hline
 \bfseries Emissions & 2017 & 9.1 & t CO$_2$eq /  Pers & 0.6\% & 46 \tabularnewline 
 \bfseries per capita & 2030 & 8.5 & t CO$_2$eq /  Pers & 0.6\% & 53 \tabularnewline 
 \end{tabular}
 \end{table}

 For Greece, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (73.2\%), followed by IPPU (13.4\%)
 ...
 The total of F-gasesonly represented 6.6\%.
 The total CO$_2$ emissions are expected to be 74.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GRC/ts_emi_exclLU_GRC.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GRC/ts_gdp_pop_GRC.png}
 ...
 Greece's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Greece are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -3.2~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 95.8~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -3.7---0.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GRC/ts_emi_onlyLU_GRC.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Greece's NDC (if needed). 
 ...
 Greece has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Greece's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Greece is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GRC/ts_pc_cov_GRC.png}
 \caption{Timeseries of Greece's national emissions (exclLU) and the share of emissions that is assumed to be covered by Greece's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Greece's 2017 emissions (exclLU, exclBunkers; total 95.8~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -3.2~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 71.5\% & \bfseries 1.2\% & \bfseries 0.5\% & / & / & / & / & 73.2\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 6.6\% & \bfseries 0.0\% & \bfseries 0.1\% & \bfseries 6.4\% & \bfseries 0.1\% & \bfseries 0.0\% & \bfseries / & 13.4\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.03\% & \bfseries 4.6\% & \bfseries 3.5\% & / & / & / & / & 8.2\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 4.5\% & \bfseries 0.3\% & / & / & / & / & 4.8\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 78.1\% & 10.3\% & 4.9\% & 6.4\% & 0.1\% & 0.0\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GRC/ts_ndcs_quantis_GRC.png}
