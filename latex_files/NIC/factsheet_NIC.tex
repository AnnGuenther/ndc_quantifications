\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Nicaragua: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 18.4~Mt CO$_2$eq, Nicaragua contributed 0.03\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.04\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Nicaragua is estimated to emit 25.4~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 38.0\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 23.9--31.0~Mt CO$_2$eq in 2030, and 31.0--53.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 72 in 2017, and 140 regarding the per-capita emissions (56 and 128 in 2030).
 In terms of accumulated historical emissions, Nicaragua contributed to the global 1850--2017 emissions by 0.02\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Nicaragua, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 18.4 & Mt CO$_2$eq & 0.03\% & 121 \tabularnewline 
 \bfseries  & 2030 & 25.4 & Mt CO$_2$eq & 0.04\% & 117 \tabularnewline \hline
 \bfseries GDP & 2017 & 32.9 & Billion 2011~GK\$ & 0.02\% & 124 \tabularnewline 
 \bfseries  & 2030 & 58.8 & Billion 2011~GK\$ & 0.03\% & 124 \tabularnewline \hline
 \bfseries Emissions & 2017 & 559.6 & t CO$_2$eq / Million 2011~GK\$ & 0.5\% & 72 \tabularnewline 
 \bfseries per GDP & 2030 & 432.3 & t CO$_2$eq / Million 2011~GK\$ & 0.6\% & 56 \tabularnewline \hline
 \bfseries Population & 2017 & 6.4 & Million Pers & 0.08\% & 111 \tabularnewline 
 \bfseries  & 2030 & 6.9 & Million Pers & 0.08\% & 109 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.9 & t CO$_2$eq /  Pers & 0.1\% & 140 \tabularnewline 
 \bfseries per capita & 2030 & 3.7 & t CO$_2$eq /  Pers & 0.2\% & 128 \tabularnewline 
 \end{tabular}
 \end{table}

 For Nicaragua, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (58.3\%), followed by Energy (32.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  49.5\% of the national emissions. 
 Second largest contributor was CO$_2$ (32.0\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Agriculture sector, which contributed 40.9\% to Nicaragua's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 35.1\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NIC/ts_emi_exclLU_NIC.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NIC/ts_gdp_pop_NIC.png}
 ...
 Nicaragua's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Nicaragua are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 5.0~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 18.4~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 0.2--30.4~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NIC/ts_emi_onlyLU_NIC.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Nicaragua's NDC (if needed). 
 ...
 Nicaragua has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NIC/ts_pc_cov_NIC.png}
 \caption{Timeseries of Nicaragua's national emissions (exclLU) and the share of emissions that is assumed to be covered by Nicaragua's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Nicaragua's 2017 emissions (exclLU, exclBunkers; total 18.4~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 5.0~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 30.0\% & 1.7\% & 0.4\% & / & / & / & / & 32.2\% \tabularnewline 
 \bfseries IPPU & / & -- & 1.7\% & / & 0.0\% & / & / & / & / & 1.7\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.3\% & 40.9\% & 17.1\% & / & / & / & / & 58.3\% \tabularnewline 
 \bfseries Waste & / & -- & / & 6.8\% & 0.4\% & / & / & / & / & 7.3\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.6\% & / & / & / & / & 0.6\% \tabularnewline \hline
 \bfseries Total &  &  & 32.0\% & 49.5\% & 18.5\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NIC/ts_ndcs_quantis_NIC.png}
