\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} North Korea: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 76.7~Mt CO$_2$eq, North Korea contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which North Korea is estimated to emit 71.1~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -7.4\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 71.1--71.1~Mt CO$_2$eq in 2030, and 71.1--71.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 4 in 2017, and 137 regarding the per-capita emissions (1 and 144 in 2030).
 In terms of accumulated historical emissions, North Korea contributed to the global 1850--2017 emissions by 0.3\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 0.2\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for North Korea, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 76.7 & Mt CO$_2$eq & 0.1\% & 65 \tabularnewline 
 \bfseries  & 2030 & 71.1 & Mt CO$_2$eq & 0.1\% & 74 \tabularnewline \hline
 \bfseries GDP & 2017 & 44.6 & Billion 2011~GK\$ & 0.03\% & 113 \tabularnewline 
 \bfseries  & 2030 & 43.7 & Billion 2011~GK\$ & 0.02\% & 136 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.7 & t CO$_2$eq / Thousand 2011~GK\$ & 1.6\% & 4 \tabularnewline 
 \bfseries per GDP & 2030 & 1.6 & t CO$_2$eq / Thousand 2011~GK\$ & 2.2\% & 1 \tabularnewline \hline
 \bfseries Population & 2017 & 25.4 & Million Pers & 0.3\% & 52 \tabularnewline 
 \bfseries  & 2030 & 26.2 & Million Pers & 0.3\% & 56 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.0 & t CO$_2$eq /  Pers & 0.2\% & 137 \tabularnewline 
 \bfseries per capita & 2030 & 2.7 & t CO$_2$eq /  Pers & 0.1\% & 144 \tabularnewline 
 \end{tabular}
 \end{table}

 For North Korea, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (76.3\%), followed by IPPU (15.4\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  66.7\% of the national emissions. 
 Second largest contributor was CH$_4$ (21.0\%)
 The total of F-gasesrepresented 9.5\%.
 The total CO$_2$ emissions are expected to be 65.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PRK/ts_emi_exclLU_PRK.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PRK/ts_gdp_pop_PRK.png}
 ...
 North Korea's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for North Korea are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 4, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -16.9~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 76.7~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -16.9---13.4~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PRK/ts_emi_onlyLU_PRK.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of North Korea's NDC (if needed). 
 ...
 North Korea has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on North Korea's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 172.72 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 112.18 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -8\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -40.25\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PRK/ts_pc_cov_PRK.png}
 \caption{Timeseries of North Korea's national emissions (exclLU) and the share of emissions that is assumed to be covered by North Korea's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in North Korea's 2017 emissions (exclLU, exclBunkers; total 76.7~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -16.9~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 60.6\% & \bfseries 15.4\% & \bfseries 0.3\% & / & / & / & / & 76.3\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 5.9\% & \bfseries 0.0\% & \bfseries 0.0\% & \bfseries 9.5\% & \bfseries / & \bfseries / & / & 15.4\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.05\% & \bfseries 4.0\% & \bfseries 1.8\% & / & / & / & / & 5.8\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.05\% & \bfseries 1.6\% & \bfseries 0.3\% & / & / & / & / & 2.0\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 66.7\% & 21.0\% & 2.9\% & 9.5\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PRK/ts_ndcs_quantis_PRK.png}
