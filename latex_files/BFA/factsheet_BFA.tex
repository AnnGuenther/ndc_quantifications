\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Burkina Faso: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 35.0~Mt CO$_2$eq, Burkina Faso contributed 0.07\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Burkina Faso is estimated to emit 42.1~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 20.3\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 42.1--63.3~Mt CO$_2$eq in 2030, and 60.7--170.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 14 in 2017, and 172 regarding the per-capita emissions (23 and 181 in 2030).
 In terms of accumulated historical emissions, Burkina Faso contributed to the global 1850--2017 emissions by 0.04\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.05\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Burkina Faso, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 35.0 & Mt CO$_2$eq & 0.07\% & 99 \tabularnewline 
 \bfseries  & 2030 & 42.1 & Mt CO$_2$eq & 0.07\% & 107 \tabularnewline \hline
 \bfseries GDP & 2017 & 31.4 & Billion 2011~GK\$ & 0.02\% & 126 \tabularnewline 
 \bfseries  & 2030 & 70.3 & Billion 2011~GK\$ & 0.03\% & 116 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.1 & t CO$_2$eq / Thousand 2011~GK\$ & 1.0\% & 14 \tabularnewline 
 \bfseries per GDP & 2030 & 0.6 & t CO$_2$eq / Thousand 2011~GK\$ & 0.8\% & 23 \tabularnewline \hline
 \bfseries Population & 2017 & 19.2 & Million Pers & 0.2\% & 60 \tabularnewline 
 \bfseries  & 2030 & 26.1 & Million Pers & 0.3\% & 57 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.8 & t CO$_2$eq /  Pers & 0.1\% & 172 \tabularnewline 
 \bfseries per capita & 2030 & 1.6 & t CO$_2$eq /  Pers & 0.1\% & 181 \tabularnewline 
 \end{tabular}
 \end{table}

 For Burkina Faso, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (68.4\%), followed by Energy (21.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  60.4\% of the national emissions. 
 Second largest contributor was N$_2$O (30.6\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Agriculture sector, and CH$_4$ emissions from the Energy sector, which contributed 40.8\% and 11.8\% to Burkina Faso's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 16.7\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BFA/ts_emi_exclLU_BFA.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BFA/ts_gdp_pop_BFA.png}
 ...
 Burkina Faso's population is assumed to grow towards 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Burkina Faso are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 9.1~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 35.0~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 8.8--12.4~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BFA/ts_emi_onlyLU_BFA.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Burkina Faso's NDC (if needed). 
 ...
 Burkina Faso has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Burkina Faso's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 98.70 Mt~CO$_2$eq & 2025 & inclLU \tabularnewline 
 ABS & condi. & best & 86.87 Mt~CO$_2$eq & 2025 & inclLU \tabularnewline 
 ABS & uncondi. & best & 110.51 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 96.74 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -6.27\% & 2025 & inclLU \tabularnewline 
 RBU & condi. & best & -17.47\% & 2025 & inclLU \tabularnewline 
 RBU & uncondi. & best & -6.6\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -18.2\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BFA/ts_pc_cov_BFA.png}
 \caption{Timeseries of Burkina Faso's national emissions (exclLU) and the share of emissions that is assumed to be covered by Burkina Faso's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Burkina Faso's 2017 emissions (exclLU, exclBunkers; total 35.0~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 9.1~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 8.4\% & \bfseries 11.8\% & \bfseries 1.4\% & / & / & / & / & 21.6\% \tabularnewline 
 \bfseries IPPU & / & \bfseries + & \bfseries 0.7\% & \bfseries / & \bfseries 0.0\% & \bfseries / & \bfseries / & \bfseries / & \bfseries / & 0.7\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 40.8\% & \bfseries 27.6\% & / & / & / & / & 68.4\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 7.7\% & \bfseries 0.8\% & / & / & / & / & 8.5\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.7\% & / & / & / & / & 0.7\% \tabularnewline \hline
 \bfseries Total &  &  & 9.1\% & 60.4\% & 30.6\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BFA/ts_ndcs_quantis_BFA.png}
