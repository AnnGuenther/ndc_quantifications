\documentclass[12pt]{article}
 ...
 \label{sec:emiLULUCF}
 LULUCF emissions data for Gambia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019).
 ...
 ABS & condi. & best & 2.10 Mt~CO$_2$eq AR4 & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}
