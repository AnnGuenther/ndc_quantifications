\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Gambia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 2.6~Mt CO$_2$eq, Gambia contributed 0.005\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Gambia is estimated to emit 3.2~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 25.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 3.1--4.5~Mt CO$_2$eq in 2030, and 4.6--12.0~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 77 in 2017, and 193 regarding the per-capita emissions (94 and 193 in 2030).
 In terms of accumulated historical emissions, Gambia contributed to the global 1850--2017 emissions by 0.004\%. 
 When only accounting for the years 1990--2017, its contribution stays the same to 0.004\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Gambia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 2.6 & Mt CO$_2$eq & 0.005\% & 166 \tabularnewline 
 \bfseries  & 2030 & 3.2 & Mt CO$_2$eq & 0.005\% & 165 \tabularnewline \hline
 \bfseries GDP & 2017 & 4.9 & Billion 2011~GK\$ & 0.004\% & 167 \tabularnewline 
 \bfseries  & 2030 & 10.1 & Billion 2011~GK\$ & 0.005\% & 166 \tabularnewline \hline
 \bfseries Emissions & 2017 & 526.9 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 77 \tabularnewline 
 \bfseries per GDP & 2030 & 321.6 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 94 \tabularnewline \hline
 \bfseries Population & 2017 & 2.2 & Million Pers & 0.02\% & 142 \tabularnewline 
 \bfseries  & 2030 & 2.8 & Million Pers & 0.03\% & 139 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.2 & t CO$_2$eq /  Pers & 0.07\% & 193 \tabularnewline 
 \bfseries per capita & 2030 & 1.2 & t CO$_2$eq /  Pers & 0.07\% & 193 \tabularnewline 
 \end{tabular}
 \end{table}

 For Gambia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (50.7\%), followed by Energy (33.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  59.5\% of the national emissions. 
 Second largest contributor was CO$_2$ (24.4\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Agriculture sector, which contributed 36.6\% to Gambia's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 35.6\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GMB/ts_emi_exclLU_GMB.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GMB/ts_gdp_pop_GMB.png}
 ...
 Gambia's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Gambia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.4~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 2.6~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -0.5---0.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GMB/ts_emi_onlyLU_GMB.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Gambia's NDC (if needed). 
 ...
 Gambia has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Gambia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 1.80 Mt~CO$_2$eq AR4 & 2025 & exclLU \tabularnewline 
 ABS & condi. & best & 2.10 Mt~CO$_2$eq AR4 & 2030 & exclLU \tabularnewline \hline
 RBU & condi. & best & -0.444\% & 2025 & exclLU \tabularnewline 
 RBU & condi. & best & -0.454\% & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GMB/ts_pc_cov_GMB.png}
 \caption{Timeseries of Gambia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Gambia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Gambia's 2017 emissions (exclLU, exclBunkers; total 2.6~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 24.0\% & \bfseries 8.6\% & \bfseries 0.6\% & / & / & / & / & 33.2\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 0.4\% & \bfseries / & \bfseries 0.0\% & \bfseries / & \bfseries / & \bfseries / & \bfseries / & 0.4\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 36.6\% & \bfseries 14.1\% & / & / & / & / & 50.7\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 14.4\% & \bfseries 1.0\% & / & / & / & / & 15.4\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 24.4\% & 59.5\% & 16.1\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GMB/ts_ndcs_quantis_GMB.png}
