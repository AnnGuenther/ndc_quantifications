\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Egypt: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 0.3~Gt CO$_2$eq, Egypt contributed 0.7\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.9\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Egypt is estimated to emit 0.4~Gt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 58.3\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 0.4--0.6~Gt CO$_2$eq in 2030, and 0.7--1.4~Gt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 137 in 2017, and 130 regarding the per-capita emissions (140 and 116 in 2030).
 In terms of accumulated historical emissions, Egypt contributed to the global 1850--2017 emissions by 0.3\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Egypt, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 0.3 & Gt CO$_2$eq & 0.7\% & 31 \tabularnewline 
 \bfseries  & 2030 & 0.4 & Gt CO$_2$eq & 0.9\% & 21 \tabularnewline \hline
 \bfseries GDP & 2017 & 1.0 & Trillion 2011~GK\$ & 0.9\% & 24 \tabularnewline 
 \bfseries  & 2030 & 2.1 & Trillion 2011~GK\$ & 1.2\% & 16 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.2\% & 137 \tabularnewline 
 \bfseries per GDP & 2030 & 0.2 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 140 \tabularnewline \hline
 \bfseries Population & 2017 & 96.4 & Million Pers & 1.3\% & 14 \tabularnewline 
 \bfseries  & 2030 & 112.9 & Million Pers & 1.3\% & 14 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.2 & t CO$_2$eq /  Pers & 0.2\% & 130 \tabularnewline 
 \bfseries per capita & 2030 & 4.3 & t CO$_2$eq /  Pers & 0.2\% & 116 \tabularnewline 
 \end{tabular}
 \end{table}

 For Egypt, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (63.9\%), followed by Agriculture (13.4\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 71.5\% of the national emissions. 
 Second largest contributor was CH$_4$ (18.3\%)
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/EGY/ts_emi_exclLU_EGY.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/EGY/ts_gdp_pop_EGY.png}
 ...
 Egypt's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Egypt are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.0~Gt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 0.3~Gt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -0.0---0.0~Gt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/EGY/ts_emi_onlyLU_EGY.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Egypt's NDC (if needed). 
 ...
 Egypt has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/EGY/ts_pc_cov_EGY.png}
 \caption{Timeseries of Egypt's national emissions (exclLU) and the share of emissions that is assumed to be covered by Egypt's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Egypt's 2017 emissions (exclLU, exclBunkers; total 0.3~Gt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 60.7\% & \bfseries 3.2\% & \bfseries 0.02\% & / & / & / & / & 63.9\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 9.5\% & \bfseries 0.0\% & \bfseries 2.0\% & 0.2\% & 0.8\% & 0.0\% & / & 12.6\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 1.3\% & \bfseries 5.9\% & \bfseries 6.2\% & / & / & / & / & 13.4\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 9.2\% & \bfseries 0.6\% & / & / & / & / & 9.8\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 71.5\% & 18.3\% & 9.1\% & 0.2\% & 0.8\% & 0.0\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/EGY/ts_ndcs_quantis_EGY.png}
