\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} India: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 3.0~Gt CO$_2$eq, India contributed 6.3\% to global emissions in 2017, while in 2030 its share is estimated to increase to 7.1\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which India is estimated to emit 4.0~Gt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 32.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 3.7--4.3~Gt CO$_2$eq in 2030, and 5.9--9.6~Gt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 119 in 2017, and 157 regarding the per-capita emissions (137 and 147 in 2030).
 In terms of accumulated historical emissions, India contributed to the global 1850--2017 emissions by 4.3\%. 
 When only accounting for the years 1990--2017, its contribution increases to 4.9\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for India, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 3.0 & Gt CO$_2$eq & 6.3\% & 3 \tabularnewline 
 \bfseries  & 2030 & 4.0 & Gt CO$_2$eq & 7.1\% & 3 \tabularnewline \hline
 \bfseries GDP & 2017 & 8.2 & Trillion 2011~GK\$ & 7.3\% & 3 \tabularnewline 
 \bfseries  & 2030 & 16.7 & Trillion 2011~GK\$ & 9.3\% & 3 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 119 \tabularnewline 
 \bfseries per GDP & 2030 & 0.2 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 137 \tabularnewline \hline
 \bfseries Population & 2017 & 1.3 & Billion Pers & 17.7\% & 2 \tabularnewline 
 \bfseries  & 2030 & 1.5 & Billion Pers & 18.1\% & 1 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.2 & t CO$_2$eq /  Pers & 0.1\% & 157 \tabularnewline 
 \bfseries per capita & 2030 & 2.6 & t CO$_2$eq /  Pers & 0.1\% & 147 \tabularnewline 
 \end{tabular}
 \end{table}

 For India, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (73.8\%), followed by Agriculture (16.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 77.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (17.0\%)
 The total of F-gasesonly represented 1.0\%.
 The total CO$_2$ emissions are expected to be 76.8\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/IND/ts_emi_exclLU_IND.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/IND/ts_gdp_pop_IND.png}
 ...
 India's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for India are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 3, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.3~Gt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 3.0~Gt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -0.3--0.01~Gt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/IND/ts_emi_onlyLU_IND.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of India's NDC (if needed). 
 ...
 India has an NDC, with a GHG mitigation target of the type REI (relative emissions intensity reduction; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on India's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 REI & uncondi. & worst & -33\% & 2005 & 2030 & GDP & inclLU \tabularnewline 
 REI & uncondi. & best & -35\% & 2005 & 2030 & GDP & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/IND/ts_pc_cov_IND.png}
 \caption{Timeseries of India's national emissions (exclLU) and the share of emissions that is assumed to be covered by India's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in India's 2017 emissions (exclLU, exclBunkers; total 3.0~Gt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -0.3~Gt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 71.1\% & \bfseries 2.2\% & \bfseries 0.6\% & / & / & / & / & 73.8\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 5.2\% & \bfseries 0.02\% & \bfseries 0.2\% & 0.9\% & 0.05\% & 0.0\% & 0.0\% & 6.5\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.9\% & 12.5\% & 2.8\% & / & / & / & / & 16.2\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 2.3\% & \bfseries 0.6\% & / & / & / & / & 2.9\% \tabularnewline 
 \bfseries Other & / & -- & 0.0\% & 0.0\% & 0.6\% & / & / & / & / & 0.6\% \tabularnewline \hline
 \bfseries Total &  &  & 77.2\% & 17.0\% & 4.8\% & 0.9\% & 0.05\% & 0.0\% & 0.0\% & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/IND/ts_ndcs_quantis_IND.png}
