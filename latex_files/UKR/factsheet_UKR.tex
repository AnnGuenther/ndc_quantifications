\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Ukraine: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 326.2~Mt CO$_2$eq, Ukraine contributed 0.7\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.6\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Ukraine is estimated to emit 321.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -1.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 321.0--477.1~Mt CO$_2$eq in 2030, and 411.3--803.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 43 in 2017, and 67 regarding the per-capita emissions (47 and 65 in 2030).
 In terms of accumulated historical emissions, Ukraine contributed to the global 1850--2017 emissions by 1.9\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 1.3\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Ukraine, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 326.2 & Mt CO$_2$eq & 0.7\% & 29 \tabularnewline 
 \bfseries  & 2030 & 321.0 & Mt CO$_2$eq & 0.6\% & 30 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.4 & Trillion 2011~GK\$ & 0.3\% & 43 \tabularnewline 
 \bfseries  & 2030 & 0.7 & Trillion 2011~GK\$ & 0.3\% & 39 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.8 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 43 \tabularnewline 
 \bfseries per GDP & 2030 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 47 \tabularnewline \hline
 \bfseries Population & 2017 & 44.5 & Million Pers & 0.6\% & 31 \tabularnewline 
 \bfseries  & 2030 & 41.9 & Million Pers & 0.4\% & 38 \tabularnewline \hline
 \bfseries Emissions & 2017 & 7.3 & t CO$_2$eq /  Pers & 0.4\% & 67 \tabularnewline 
 \bfseries per capita & 2030 & 7.7 & t CO$_2$eq /  Pers & 0.5\% & 65 \tabularnewline 
 \end{tabular}
 \end{table}

 For Ukraine, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (67.9\%), followed by IPPU (16.1\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  69.7\% of the national emissions. 
 Second largest contributor was CH$_4$ (19.5\%)
 The total of F-gasesonly represented 0.3\%.
 The total CO$_2$ emissions are expected to be 73.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/UKR/ts_emi_exclLU_UKR.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/UKR/ts_gdp_pop_UKR.png}
 ...
 Ukraine's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Ukraine are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -10.4~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 326.2~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -63.6---1.8~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/UKR/ts_emi_onlyLU_UKR.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Ukraine's NDC (if needed). 
 ...
 Ukraine has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Ukraine's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & uncondi. & best & 496.83 Mt~CO$_2$eq AR4 & 1990 & 2030 & inclLU \tabularnewline \hline
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/UKR/ts_pc_cov_UKR.png}
 \caption{Timeseries of Ukraine's national emissions (exclLU) and the share of emissions that is assumed to be covered by Ukraine's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Ukraine's 2017 emissions (exclLU, exclBunkers; total 326.2~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -10.4~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 54.8\% & \bfseries 12.7\% & \bfseries 0.4\% & / & / & / & / & 67.9\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 14.8\% & \bfseries 0.4\% & \bfseries 0.4\% & \bfseries 0.3\% & \bfseries 0.02\% & \bfseries 0.0\% & \bfseries / & 16.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.2\% & \bfseries 3.0\% & \bfseries 8.8\% & / & / & / & / & 11.9\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 3.4\% & \bfseries 0.3\% & / & / & / & / & 3.7\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 69.7\% & 19.5\% & 10.4\% & 0.3\% & 0.02\% & 0.0\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/UKR/ts_ndcs_quantis_UKR.png}
