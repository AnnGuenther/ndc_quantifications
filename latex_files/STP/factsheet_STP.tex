\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Sao Tome \& Principe: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 226.8~kt CO$_2$eq, Sao Tome \& Principe contributed 0.0004\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.0003\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Sao Tome \& Principe is estimated to emit 208.5~kt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -8.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 208.5--208.5~kt CO$_2$eq in 2030, and 208.5--208.5~kt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 135 in 2017, and 195 regarding the per-capita emissions (93 and 197 in 2030).
 In terms of accumulated historical emissions, Sao Tome \& Principe contributed to the global 1850--2017 emissions by 0.0002\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.0003\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Sao Tome \& Principe, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 226.8 & kt CO$_2$eq & 0.0004\% & 193 \tabularnewline 
 \bfseries  & 2030 & 208.5 & kt CO$_2$eq & 0.0003\% & 194 \tabularnewline \hline
 \bfseries GDP & 2017 & 725.3 & Million 2011~GK\$ & 0.0006\% & 189 \tabularnewline 
 \bfseries  & 2030 & 638.0 & Million 2011~GK\$ & 0.0003\% & 190 \tabularnewline \hline
 \bfseries Emissions & 2017 & 312.8 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 135 \tabularnewline 
 \bfseries per GDP & 2030 & 326.8 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 93 \tabularnewline \hline
 \bfseries Population & 2017 & 207.1 & Thousand Pers & 0.002\% & 178 \tabularnewline 
 \bfseries  & 2030 & 197.7 & Thousand Pers & 0.002\% & 179 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.1 & t CO$_2$eq /  Pers & 0.07\% & 195 \tabularnewline 
 \bfseries per capita & 2030 & 1.1 & t CO$_2$eq /  Pers & 0.07\% & 197 \tabularnewline 
 \end{tabular}
 \end{table}

 For Sao Tome \& Principe, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (72.5\%), followed by Waste (17.4\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  61.6\% of the national emissions. 
 Second largest contributor was CH$_4$ (30.5\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 61.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/STP/ts_emi_exclLU_STP.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/STP/ts_gdp_pop_STP.png}
 ...
 Sao Tome \& Principe's population is assumed to diminish towars 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Sao Tome \& Principe are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 41.9~kt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 226.8~kt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 0.0--293.3~kt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/STP/ts_emi_onlyLU_STP.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Sao Tome \& Principe's NDC (if needed). 
 ...
 Sao Tome \& Principe has an NDC, with a GHG mitigation target of the type ABU (absolute reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Sao Tome \& Principe's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 0.18 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 ABS & condi. & best & -0.44 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline \hline
 ABU & condi. & best & -0.057 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 ABU & condi. & best & -0.057 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/STP/ts_pc_cov_STP.png}
 \caption{Timeseries of Sao Tome \& Principe's national emissions (exclLU) and the share of emissions that is assumed to be covered by Sao Tome \& Principe's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Sao Tome \& Principe's 2017 emissions (exclLU, exclBunkers; total 226.8~kt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 41.9~kt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 59.6\% & \bfseries 12.2\% & \bfseries 0.6\% & / & / & / & / & 72.5\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 2.0\% & \bfseries / & \bfseries 0.0\% & / & / & / & / & 2.0\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries / & \bfseries 2.0\% & \bfseries 5.6\% & / & / & / & / & 7.6\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 16.3\% & \bfseries 1.0\% & / & / & / & / & 17.4\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.6\% & / & / & / & / & 0.6\% \tabularnewline \hline
 \bfseries Total &  &  & 61.6\% & 30.5\% & 7.9\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/STP/ts_ndcs_quantis_STP.png}
