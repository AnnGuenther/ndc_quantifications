\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} St. Helena: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 14.3~kt CO$_2$eq, St. Helena contributed 0.00003\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.00002\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which St. Helena is estimated to emit 14.2~kt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -0.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 14.2--14.2~kt CO$_2$eq in 2030, and 14.2--14.2~kt CO$_2$eq in 2050.
 The country's global rank in terms of total per-capita emissions was 153 in 2017 (152 in 2030).
 In terms of accumulated historical emissions, St. Helena contributed to the global 1850--2017 emissions by 0.00003\%. 
 When only accounting for the years 1990--2017, its contribution stays the same to 0.00003\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for St. Helena, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 14.3 & kt CO$_2$eq & 0.00003\% & 204 \tabularnewline 
 \bfseries  & 2030 & 14.2 & kt CO$_2$eq & 0.00002\% & 204 \tabularnewline \hline
 ...
 \bfseries Population & 2017 & 6.0 & Thousand Pers & 0.00007\% & 203 \tabularnewline 
 \bfseries  & 2030 & 5.8 & Thousand Pers & 0.00006\% & 203 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.4 & t CO$_2$eq /  Pers & 0.1\% & 153 \tabularnewline 
 \bfseries per capita & 2030 & 2.5 & t CO$_2$eq /  Pers & 0.1\% & 152 \tabularnewline 
 \end{tabular}
 \end{table}

 For St. Helena, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (85.0\%), followed by Agriculture (12.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 76.8\% of the national emissions. 
 Second largest contributor was CH$_4$ (16.5\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Energy sector, which contributed 7.7\% to St. Helena's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SHN/ts_emi_exclLU_SHN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SHN/ts_gdp_pop_SHN.png}
 ...
 St. Helena's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 
 For St. Helena, no GDP data are available from dmSSPs.
 No LULUCF data are available for St. Helena from the following sources: CRF (2019), CRF (2018), BUR (3$^{rd}$), BUR (2$^{nd}$), BUR (1$^{st}$), UNFCCC (2019), FAO (2019).
 ...
 St. Helena does not have an (I)NDC.
