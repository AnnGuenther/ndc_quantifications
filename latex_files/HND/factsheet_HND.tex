\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Honduras: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 20.1~Mt CO$_2$eq, Honduras contributed 0.04\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Honduras is estimated to emit 25.9~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 28.7\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 25.3--32.4~Mt CO$_2$eq in 2030, and 34.6--64.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 81 in 2017, and 162 regarding the per-capita emissions (76 and 158 in 2030).
 In terms of accumulated historical emissions, Honduras contributed to the global 1850--2017 emissions by 0.02\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Honduras, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 20.1 & Mt CO$_2$eq & 0.04\% & 118 \tabularnewline 
 \bfseries  & 2030 & 25.9 & Mt CO$_2$eq & 0.04\% & 116 \tabularnewline \hline
 \bfseries GDP & 2017 & 41.1 & Billion 2011~GK\$ & 0.03\% & 116 \tabularnewline 
 \bfseries  & 2030 & 70.3 & Billion 2011~GK\$ & 0.03\% & 115 \tabularnewline \hline
 \bfseries Emissions & 2017 & 488.7 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 81 \tabularnewline 
 \bfseries per GDP & 2030 & 367.9 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 76 \tabularnewline \hline
 \bfseries Population & 2017 & 9.4 & Million Pers & 0.1\% & 96 \tabularnewline 
 \bfseries  & 2030 & 11.1 & Million Pers & 0.1\% & 87 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.1 & t CO$_2$eq /  Pers & 0.1\% & 162 \tabularnewline 
 \bfseries per capita & 2030 & 2.3 & t CO$_2$eq /  Pers & 0.1\% & 158 \tabularnewline 
 \end{tabular}
 \end{table}

 For Honduras, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (52.9\%), followed by Agriculture (34.8\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  52.3\% of the national emissions. 
 Second largest contributor was CH$_4$ (32.9\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 55.0\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HND/ts_emi_exclLU_HND.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HND/ts_gdp_pop_HND.png}
 ...
 Honduras's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Honduras are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 1.4~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 20.1~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 0.09--4.0~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HND/ts_emi_onlyLU_HND.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Honduras's NDC (if needed). 
 ...
 Honduras has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Honduras's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 24.58 Mt~CO$_2$eq SAR & 2030 & exclLU \tabularnewline \hline
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HND/ts_pc_cov_HND.png}
 \caption{Timeseries of Honduras's national emissions (exclLU) and the share of emissions that is assumed to be covered by Honduras's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Honduras's 2017 emissions (exclLU, exclBunkers; total 20.1~Mt CO$_2$eq).
 ...
 LULUCF: NDC '/' and adapted '--' (estimated as a net source of 1.4~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 48.7\% & \bfseries 3.4\% & \bfseries 0.8\% & / & / & / & / & 52.9\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 3.6\% & \bfseries / & \bfseries 0.0\% & / & / & / & / & 3.6\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 22.5\% & \bfseries 12.2\% & / & / & / & / & 34.8\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 6.9\% & \bfseries 0.5\% & / & / & / & / & 7.4\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 1.3\% & / & / & / & / & 1.3\% \tabularnewline \hline
 \bfseries Total &  &  & 52.3\% & 32.9\% & 14.8\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/HND/ts_ndcs_quantis_HND.png}
