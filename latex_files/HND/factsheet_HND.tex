\documentclass[12pt]{article}
 ...
 \label{sec:emiLULUCF}
 LULUCF emissions data for Honduras are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019).
 ...
 ABS & condi. & best & 24.58 Mt~CO$_2$eq SAR & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}
