\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Antigua \& Barbuda: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 708.6~kt CO$_2$eq, Antigua \& Barbuda contributed 0.001\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Antigua \& Barbuda is estimated to emit 685.3~kt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -3.3\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 685.3--685.3~kt CO$_2$eq in 2030, and 685.3--685.3~kt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 123 in 2017, and 63 regarding the per-capita emissions (72 and 69 in 2030).
 In terms of accumulated historical emissions, Antigua \& Barbuda contributed to the global 1850--2017 emissions by 0.001\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Antigua \& Barbuda, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 708.6 & kt CO$_2$eq & 0.001\% & 179 \tabularnewline 
 \bfseries  & 2030 & 685.3 & kt CO$_2$eq & 0.001\% & 179 \tabularnewline \hline
 \bfseries GDP & 2017 & 2.1 & Billion 2011~GK\$ & 0.001\% & 179 \tabularnewline 
 \bfseries  & 2030 & 1.8 & Billion 2011~GK\$ & 0.001\% & 181 \tabularnewline \hline
 \bfseries Emissions & 2017 & 345.5 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 123 \tabularnewline 
 \bfseries per GDP & 2030 & 377.6 & t CO$_2$eq / Million 2011~GK\$ & 0.5\% & 72 \tabularnewline \hline
 \bfseries Population & 2017 & 95.4 & Thousand Pers & 0.001\% & 188 \tabularnewline 
 \bfseries  & 2030 & 93.0 & Thousand Pers & 0.001\% & 188 \tabularnewline \hline
 \bfseries Emissions & 2017 & 7.4 & t CO$_2$eq /  Pers & 0.5\% & 63 \tabularnewline 
 \bfseries per capita & 2030 & 7.4 & t CO$_2$eq /  Pers & 0.4\% & 69 \tabularnewline 
 \end{tabular}
 \end{table}

 For Antigua \& Barbuda, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (80.9\%), followed by IPPU (12.4\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 89.5\% of the national emissions. 
 Second largest contributor was CH$_4$ (5.3\%)
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ATG/ts_emi_exclLU_ATG.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ATG/ts_gdp_pop_ATG.png}
 ...
 Antigua \& Barbuda's population is assumed to diminish towars 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Antigua \& Barbuda are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 15.7~kt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 708.6~kt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is -36.7--110.0~kt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ATG/ts_emi_onlyLU_ATG.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Antigua \& Barbuda's NDC (if needed). 
 ...
 Antigua \& Barbuda has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ATG/ts_pc_cov_ATG.png}
 \caption{Timeseries of Antigua \& Barbuda's national emissions (exclLU) and the share of emissions that is assumed to be covered by Antigua \& Barbuda's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Antigua \& Barbuda's 2017 emissions (exclLU, exclBunkers; total 708.6~kt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 15.7~kt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 79.4\% & \bfseries 0.9\% & \bfseries 0.5\% & / & / & / & / & 80.9\% \tabularnewline 
 \bfseries IPPU & / & \bfseries + & \bfseries 10.1\% & \bfseries / & \bfseries 0.0\% & \bfseries 2.3\% & / & / & / & 12.4\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries / & \bfseries 2.1\% & \bfseries 1.2\% & / & / & / & / & 3.3\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 2.2\% & \bfseries 0.1\% & / & / & / & / & 2.4\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 1.0\% & / & / & / & / & 1.0\% \tabularnewline \hline
 \bfseries Total &  &  & 89.5\% & 5.3\% & 2.8\% & 2.3\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ATG/ts_ndcs_quantis_ATG.png}
