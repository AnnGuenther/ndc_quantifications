\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Bangladesh: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 157.8~Mt CO$_2$eq, Bangladesh contributed 0.3\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Bangladesh is estimated to emit 220.5~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 39.8\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 202.8--248.1~Mt CO$_2$eq in 2030, and 225.5--634.5~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 149 in 2017, and 196 regarding the per-capita emissions (171 and 189 in 2030).
 In terms of accumulated historical emissions, Bangladesh contributed to the global 1850--2017 emissions by 0.2\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Bangladesh, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 157.8 & Mt CO$_2$eq & 0.3\% & 41 \tabularnewline 
 \bfseries  & 2030 & 220.5 & Mt CO$_2$eq & 0.3\% & 40 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.6 & Trillion 2011~GK\$ & 0.4\% & 35 \tabularnewline 
 \bfseries  & 2030 & 1.2 & Trillion 2011~GK\$ & 0.6\% & 30 \tabularnewline \hline
 \bfseries Emissions & 2017 & 285.5 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 149 \tabularnewline 
 \bfseries per GDP & 2030 & 190.7 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 171 \tabularnewline \hline
 \bfseries Population & 2017 & 159.7 & Million Pers & 2.1\% & 8 \tabularnewline 
 \bfseries  & 2030 & 179.6 & Million Pers & 2.1\% & 8 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.0 & t CO$_2$eq /  Pers & 0.06\% & 196 \tabularnewline 
 \bfseries per capita & 2030 & 1.2 & t CO$_2$eq /  Pers & 0.08\% & 189 \tabularnewline 
 \end{tabular}
 \end{table}

 For Bangladesh, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (54.7\%), followed by Agriculture (28.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  56.0\% of the national emissions. 
 Second largest contributor was CH$_4$ (36.5\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 59.8\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BGD/ts_emi_exclLU_BGD.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BGD/ts_gdp_pop_BGD.png}
 ...
 Bangladesh's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Bangladesh are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 3, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net source of 18.2~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 157.8~Mt CO$_2$eq.
 The large emissions range for UNFCCC (2019) and 1990--2017 is 7.8--28.4~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BGD/ts_emi_onlyLU_BGD.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Bangladesh's NDC (if needed). 
 ...
 Bangladesh has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Bangladesh's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 327.12 Mt~CO$_2$eq SAR & 2030 & exclLU \tabularnewline 
 ABS & condi. & best & 303.12 Mt~CO$_2$eq SAR & 2030 & exclLU \tabularnewline \hline
 RBU & uncondi. & best & -5\% & 2030 & exclLU \tabularnewline 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BGD/ts_pc_cov_BGD.png}
 \caption{Timeseries of Bangladesh's national emissions (exclLU) and the share of emissions that is assumed to be covered by Bangladesh's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Bangladesh's 2017 emissions (exclLU, exclBunkers; total 157.8~Mt CO$_2$eq).
 ...
 LULUCF: NDC '--' and adapted '--' (estimated as a net source of 18.2~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 53.6\% & \bfseries 1.0\% & \bfseries 0.1\% & / & / & / & / & 54.7\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 1.1\% & \bfseries / & \bfseries 0.0\% & \bfseries / & \bfseries / & \bfseries / & / & 1.1\% \tabularnewline 
 \bfseries Agri. & -- & -- & 1.3\% & 21.7\% & 5.7\% & / & / & / & / & 28.6\% \tabularnewline 
 \bfseries Waste & -- & -- & / & 13.8\% & 1.1\% & / & / & / & / & 15.0\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.5\% & / & / & / & / & 0.5\% \tabularnewline \hline
 \bfseries Total &  &  & 56.0\% & 36.5\% & 7.5\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BGD/ts_ndcs_quantis_BGD.png}
