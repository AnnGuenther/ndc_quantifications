\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Azerbaijan: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 71.0~Mt CO$_2$eq, Azerbaijan contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Azerbaijan is estimated to emit 64.8~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -8.8\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 64.8--85.2~Mt CO$_2$eq in 2030, and 59.9--103.9~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 82 in 2017, and 68 regarding the per-capita emissions (101 and 92 in 2030).
 In terms of accumulated historical emissions, Azerbaijan contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Azerbaijan, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 71.0 & Mt CO$_2$eq & 0.1\% & 70 \tabularnewline 
 \bfseries  & 2030 & 64.8 & Mt CO$_2$eq & 0.1\% & 80 \tabularnewline \hline
 \bfseries GDP & 2017 & 145.5 & Billion 2011~GK\$ & 0.1\% & 74 \tabularnewline 
 \bfseries  & 2030 & 210.0 & Billion 2011~GK\$ & 0.1\% & 82 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.4\% & 82 \tabularnewline 
 \bfseries per GDP & 2030 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.4\% & 101 \tabularnewline \hline
 \bfseries Population & 2017 & 9.8 & Million Pers & 0.1\% & 91 \tabularnewline 
 \bfseries  & 2030 & 10.6 & Million Pers & 0.1\% & 92 \tabularnewline \hline
 \bfseries Emissions & 2017 & 7.2 & t CO$_2$eq /  Pers & 0.4\% & 68 \tabularnewline 
 \bfseries per capita & 2030 & 6.1 & t CO$_2$eq /  Pers & 0.4\% & 92 \tabularnewline 
 \end{tabular}
 \end{table}

 For Azerbaijan, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (80.2\%), followed by Agriculture (10.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  58.0\% of the national emissions. 
 Second largest contributor was CH$_4$ (34.8\%)
 The total of F-gasesonly represented 2.8\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Energy sector, which contributed 24.9\% to Azerbaijan's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 63.8\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/AZE/ts_emi_exclLU_AZE.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/AZE/ts_gdp_pop_AZE.png}
 ...
 Azerbaijan's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 

 LULUCF emissions data for Azerbaijan are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 24, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -5.6~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 71.0~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -6.2---3.6~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/AZE/ts_emi_onlyLU_AZE.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Azerbaijan's NDC (if needed). 
 ...
 Azerbaijan has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Azerbaijan's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & uncondi. & best & 47.66 Mt~CO$_2$eq SAR & 1990 & 2030 & exclLU \tabularnewline 
 ABS & uncondi. & best & 45.26 Mt~CO$_2$eq SAR & 1990 & 2030 & inclLU \tabularnewline \hline
 RBY & uncondi. & best & -35\% & 1990 & 2030 & exclLU \tabularnewline 
 RBY & uncondi. & best & -35\% & 1990 & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/AZE/ts_pc_cov_AZE.png}
 \caption{Timeseries of Azerbaijan's national emissions (exclLU) and the share of emissions that is assumed to be covered by Azerbaijan's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Azerbaijan's 2017 emissions (exclLU, exclBunkers; total 71.0~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -5.6~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 54.9\% & \bfseries 24.9\% & \bfseries 0.3\% & / & / & / & / & 80.2\% \tabularnewline 
 \bfseries IPPU & / & \bfseries + & \bfseries 3.1\% & \bfseries 0.0\% & \bfseries 0.05\% & \bfseries 2.2\% & \bfseries 0.7\% & \bfseries / & \bfseries / & 5.9\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 6.8\% & \bfseries 3.5\% & / & / & / & / & 10.3\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 3.1\% & \bfseries 0.3\% & / & / & / & / & 3.5\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 58.0\% & 34.8\% & 4.4\% & 2.2\% & 0.7\% & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/AZE/ts_ndcs_quantis_AZE.png}
