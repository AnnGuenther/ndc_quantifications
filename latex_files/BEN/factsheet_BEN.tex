\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Benin: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 16.9~Mt CO$_2$eq, Benin contributed 0.03\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Benin is estimated to emit 20.3~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 20.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 20.3--29.6~Mt CO$_2$eq in 2030, and 27.2--101.9~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 38 in 2017, and 182 regarding the per-capita emissions (45 and 186 in 2030).
 In terms of accumulated historical emissions, Benin contributed to the global 1850--2017 emissions by 0.02\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Benin, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 16.9 & Mt CO$_2$eq & 0.03\% & 126 \tabularnewline 
 \bfseries  & 2030 & 20.3 & Mt CO$_2$eq & 0.03\% & 124 \tabularnewline \hline
 \bfseries GDP & 2017 & 21.8 & Billion 2011~GK\$ & 0.01\% & 142 \tabularnewline 
 \bfseries  & 2030 & 42.9 & Billion 2011~GK\$ & 0.02\% & 139 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.8 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 38 \tabularnewline 
 \bfseries per GDP & 2030 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 45 \tabularnewline \hline
 \bfseries Population & 2017 & 11.2 & Million Pers & 0.1\% & 82 \tabularnewline 
 \bfseries  & 2030 & 14.8 & Million Pers & 0.1\% & 76 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.5 & t CO$_2$eq /  Pers & 0.1\% & 182 \tabularnewline 
 \bfseries per capita & 2030 & 1.4 & t CO$_2$eq /  Pers & 0.09\% & 186 \tabularnewline 
 \end{tabular}
 \end{table}

 For Benin, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (46.6\%), followed by Agriculture (36.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  42.9\% of the national emissions. 
 Second largest contributor was CH$_4$ (39.0\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 54.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BEN/ts_emi_exclLU_BEN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BEN/ts_gdp_pop_BEN.png}
 ...
 Benin's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Benin are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 10.6~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 16.9~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 10.5--16.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BEN/ts_emi_onlyLU_BEN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Benin's NDC (if needed). 
 ...
 Benin has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Benin's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 37 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 ABS & condi. & best & 32.50 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BEN/ts_pc_cov_BEN.png}
 \caption{Timeseries of Benin's national emissions (exclLU) and the share of emissions that is assumed to be covered by Benin's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Benin's 2017 emissions (exclLU, exclBunkers; total 16.9~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 10.6~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 38.4\% & \bfseries 7.4\% & \bfseries 0.8\% & / & / & / & / & 46.6\% \tabularnewline 
 \bfseries IPPU & / & -- & 4.5\% & / & 0.0\% & / & / & / & / & 4.5\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.01\% & \bfseries 20.5\% & \bfseries 15.8\% & / & / & / & / & 36.3\% \tabularnewline 
 \bfseries Waste & / & -- & / & 11.1\% & 0.8\% & / & / & / & / & 11.9\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.7\% & / & / & / & / & 0.7\% \tabularnewline \hline
 \bfseries Total &  &  & 42.9\% & 39.0\% & 18.1\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BEN/ts_ndcs_quantis_BEN.png}
