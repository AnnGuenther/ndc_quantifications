\documentclass[12pt]{article}
 ...
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Afghanistan is estimated to emit 43.7~Mt CO$_2$eq in 2030.
 ...
 The country's global rank in terms of total emissions per unit of GDP was 84 in 2017, and 198 regarding the per-capita emissions (99 and 201 in 2030).
 ...
 For Afghanistan, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (44.9\%), followed by Energy (41.7\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  44.0\% of the national emissions. 
 Second largest contributor was CO$_2$ (40.1\%)
 ...
 LULUCF emissions data for Afghanistan are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.0~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 34.0~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 0.0--0.0006~Mt CO$_2$eq.
 ...
 ABS & condi. & best & 54.79 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline \hline
