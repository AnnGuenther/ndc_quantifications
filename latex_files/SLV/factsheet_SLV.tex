\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} El Salvador: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 12.8~Mt CO$_2$eq, El Salvador contributed 0.02\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which El Salvador is estimated to emit 14.2~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 11.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 13.3--16.0~Mt CO$_2$eq in 2030, and 13.5--22.9~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 148 in 2017, and 165 regarding the per-capita emissions (144 and 161 in 2030).
 In terms of accumulated historical emissions, El Salvador contributed to the global 1850--2017 emissions by 0.02\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for El Salvador, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 12.8 & Mt CO$_2$eq & 0.02\% & 137 \tabularnewline 
 \bfseries  & 2030 & 14.2 & Mt CO$_2$eq & 0.02\% & 139 \tabularnewline \hline
 \bfseries GDP & 2017 & 44.4 & Billion 2011~GK\$ & 0.03\% & 114 \tabularnewline 
 \bfseries  & 2030 & 62.4 & Billion 2011~GK\$ & 0.03\% & 120 \tabularnewline \hline
 \bfseries Emissions & 2017 & 287.4 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 148 \tabularnewline 
 \bfseries per GDP & 2030 & 227.4 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 144 \tabularnewline \hline
 \bfseries Population & 2017 & 6.4 & Million Pers & 0.08\% & 110 \tabularnewline 
 \bfseries  & 2030 & 6.4 & Million Pers & 0.07\% & 114 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.0 & t CO$_2$eq /  Pers & 0.1\% & 165 \tabularnewline 
 \bfseries per capita & 2030 & 2.2 & t CO$_2$eq /  Pers & 0.1\% & 161 \tabularnewline 
 \end{tabular}
 \end{table}

 For El Salvador, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (61.6\%), followed by Agriculture (24.1\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  67.1\% of the national emissions. 
 Second largest contributor was CH$_4$ (21.1\%)
 The total of F-gasesonly represented 1.6\%.
 The total CO$_2$ emissions are expected to be 69.0\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SLV/ts_emi_exclLU_SLV.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SLV/ts_gdp_pop_SLV.png}
 ...
 El Salvador's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for El Salvador are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.8~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 12.8~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 0.7--0.9~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SLV/ts_emi_onlyLU_SLV.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of El Salvador's NDC (if needed). 
 ...
 El Salvador has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on El Salvador's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 RBU & uncondi. & best & -46\% & 2025 & exclLU \tabularnewline 
 RBU & condi. & best & -61\% & 2025 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SLV/ts_pc_cov_SLV.png}
 \caption{Timeseries of El Salvador's national emissions (exclLU) and the share of emissions that is assumed to be covered by El Salvador's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in El Salvador's 2017 emissions (exclLU, exclBunkers; total 12.8~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '--' (estimated as a net source of 0.8~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 59.9\% & \bfseries 1.2\% & \bfseries 0.4\% & / & / & / & / & 61.6\% \tabularnewline 
 \bfseries IPPU & / & -- & 3.7\% & / & 0.0\% & 1.6\% & / & / & / & 5.3\% \tabularnewline 
 \bfseries Agri. & \bfseries + & -- & 3.5\% & 12.3\% & 8.3\% & / & / & / & / & 24.1\% \tabularnewline 
 \bfseries Waste & \bfseries + & -- & / & 7.6\% & 0.7\% & / & / & / & / & 8.3\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.7\% & / & / & / & / & 0.7\% \tabularnewline \hline
 \bfseries Total &  &  & 67.1\% & 21.1\% & 10.1\% & 1.6\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SLV/ts_ndcs_quantis_SLV.png}
