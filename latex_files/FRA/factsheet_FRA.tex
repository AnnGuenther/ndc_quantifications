\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} France: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 0.4~Gt CO$_2$eq, France contributed 1.0\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.9\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which France is estimated to emit 0.5~Gt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 9.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 0.4--0.6~Gt CO$_2$eq in 2030, and 0.4--1.1~Gt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 191 in 2017, and 73 regarding the per-capita emissions (188 and 75 in 2030).
 In terms of accumulated historical emissions, France contributed to the global 1850--2017 emissions by 2.3\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 1.4\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for France, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 0.4 & Gt CO$_2$eq & 1.0\% & 19 \tabularnewline 
 \bfseries  & 2030 & 0.5 & Gt CO$_2$eq & 0.9\% & 20 \tabularnewline \hline
 \bfseries GDP & 2017 & 2.7 & Trillion 2011~GK\$ & 2.4\% & 10 \tabularnewline 
 \bfseries  & 2030 & 3.4 & Trillion 2011~GK\$ & 1.9\% & 11 \tabularnewline \hline
 \bfseries Emissions & 2017 & 174.1 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 191 \tabularnewline 
 \bfseries per GDP & 2030 & 153.4 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 188 \tabularnewline \hline
 \bfseries Population & 2017 & 67.6 & Million Pers & 0.9\% & 21 \tabularnewline 
 \bfseries  & 2030 & 73.0 & Million Pers & 0.9\% & 21 \tabularnewline \hline
 \bfseries Emissions & 2017 & 7.0 & t CO$_2$eq /  Pers & 0.4\% & 73 \tabularnewline 
 \bfseries per capita & 2030 & 7.1 & t CO$_2$eq /  Pers & 0.4\% & 75 \tabularnewline 
 \end{tabular}
 \end{table}

 For France, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (70.6\%), followed by Agriculture (16.1\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 74.7\% of the national emissions. 
 Second largest contributor was CH$_4$ (11.9\%)
 The total of F-gasesonly represented 4.2\%.
 The total CO$_2$ emissions are expected to be 73.6\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/FRA/ts_emi_exclLU_FRA.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/FRA/ts_gdp_pop_FRA.png}
 ...
 France's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for France are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.0~Gt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 0.4~Gt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -0.0---0.0~Gt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/FRA/ts_emi_onlyLU_FRA.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of France's NDC (if needed). 
 ...
 France has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on France's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As France is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/FRA/ts_pc_cov_FRA.png}
 \caption{Timeseries of France's national emissions (exclLU) and the share of emissions that is assumed to be covered by France's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in France's 2017 emissions (exclLU, exclBunkers; total 0.4~Gt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 69.2\% & \bfseries 0.6\% & \bfseries 0.8\% & / & / & / & / & 70.6\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 4.8\% & \bfseries 0.01\% & \bfseries 0.3\% & \bfseries 4.0\% & \bfseries 0.1\% & \bfseries 0.09\% & \bfseries 0.0\% & 9.4\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.4\% & \bfseries 8.2\% & \bfseries 7.6\% & / & / & / & / & 16.1\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.3\% & \bfseries 3.2\% & \bfseries 0.1\% & / & / & / & / & 3.7\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 74.7\% & 11.9\% & 9.1\% & 4.0\% & 0.1\% & 0.09\% & 0.0\% & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/FRA/ts_ndcs_quantis_FRA.png}
