\documentclass[12pt]{article}
 ...
 LULUCF emissions data for South Korea are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 25, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -46.5~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 745.5~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -59.2---31.4~Mt CO$_2$eq.
 ...
 ABS & uncondi. & best & 535.89 Mt~CO$_2$eq SAR & 2030 & exclLU \tabularnewline \hline
