\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Peru: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 111.1~Mt CO$_2$eq, Peru contributed 0.2\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Peru is estimated to emit 166.5~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 49.8\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 156.9--200.6~Mt CO$_2$eq in 2030, and 207.4--285.0~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 145 in 2017, and 119 regarding the per-capita emissions (134 and 104 in 2030).
 In terms of accumulated historical emissions, Peru contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Peru, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 111.1 & Mt CO$_2$eq & 0.2\% & 50 \tabularnewline 
 \bfseries  & 2030 & 166.5 & Mt CO$_2$eq & 0.2\% & 44 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.3 & Trillion 2011~GK\$ & 0.3\% & 48 \tabularnewline 
 \bfseries  & 2030 & 0.7 & Trillion 2011~GK\$ & 0.3\% & 40 \tabularnewline \hline
 \bfseries Emissions & 2017 & 294.2 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 145 \tabularnewline 
 \bfseries per GDP & 2030 & 246.2 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 134 \tabularnewline \hline
 \bfseries Population & 2017 & 31.4 & Million Pers & 0.4\% & 43 \tabularnewline 
 \bfseries  & 2030 & 33.4 & Million Pers & 0.3\% & 50 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.5 & t CO$_2$eq /  Pers & 0.2\% & 119 \tabularnewline 
 \bfseries per capita & 2030 & 5.0 & t CO$_2$eq /  Pers & 0.3\% & 104 \tabularnewline 
 \end{tabular}
 \end{table}

 For Peru, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (59.2\%), followed by Agriculture (26.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  61.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (24.8\%)
 The total of F-gasesonly represented 0.8\%.
 The total CO$_2$ emissions are expected to be 64.7\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PER/ts_emi_exclLU_PER.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PER/ts_gdp_pop_PER.png}
 ...
 Peru's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Peru are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 4, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net source of 65.6~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 111.1~Mt CO$_2$eq.
 The large emissions range for UNFCCC (2019) and 1990--2017 is 41.9--87.4~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PER/ts_emi_onlyLU_PER.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Peru's NDC (if needed). 
 ...
 Peru has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Peru's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 238.59 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 208.80 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline \hline
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PER/ts_pc_cov_PER.png}
 \caption{Timeseries of Peru's national emissions (exclLU) and the share of emissions that is assumed to be covered by Peru's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Peru's 2017 emissions (exclLU, exclBunkers; total 111.1~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 65.6~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 56.6\% & \bfseries 2.6\% & \bfseries 0.1\% & / & / & / & / & 59.2\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 4.3\% & \bfseries 0.0\% & \bfseries 0.02\% & 0.8\% & / & / & / & 5.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.3\% & \bfseries 13.8\% & \bfseries 12.2\% & / & / & / & / & 26.3\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 8.5\% & \bfseries 0.5\% & / & / & / & / & 9.0\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 61.2\% & 24.8\% & 13.2\% & 0.8\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PER/ts_ndcs_quantis_PER.png}
