\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Brazil: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 1.1~Gt CO$_2$eq, Brazil contributed 2.3\% to global emissions in 2017, while in 2030 its share is estimated to increase to 2.6\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Brazil is estimated to emit 1.5~Gt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 31.8\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 1.4--1.8~Gt CO$_2$eq in 2030, and 1.5--2.3~Gt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 115 in 2017, and 98 regarding the per-capita emissions (102 and 85 in 2030).
 In terms of accumulated historical emissions, Brazil contributed to the global 1850--2017 emissions by 1.7\%. 
 When only accounting for the years 1990--2017, its contribution increases to 2.3\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Brazil, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 1.1 & Gt CO$_2$eq & 2.3\% & 6 \tabularnewline 
 \bfseries  & 2030 & 1.5 & Gt CO$_2$eq & 2.6\% & 5 \tabularnewline \hline
 \bfseries GDP & 2017 & 2.9 & Trillion 2011~GK\$ & 2.6\% & 7 \tabularnewline 
 \bfseries  & 2030 & 4.8 & Trillion 2011~GK\$ & 2.7\% & 7 \tabularnewline \hline
 \bfseries Emissions & 2017 & 382.5 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 115 \tabularnewline 
 \bfseries per GDP & 2030 & 306.5 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 102 \tabularnewline \hline
 \bfseries Population & 2017 & 207.8 & Million Pers & 2.8\% & 6 \tabularnewline 
 \bfseries  & 2030 & 224.6 & Million Pers & 2.7\% & 7 \tabularnewline \hline
 \bfseries Emissions & 2017 & 5.4 & t CO$_2$eq /  Pers & 0.3\% & 98 \tabularnewline 
 \bfseries per capita & 2030 & 6.6 & t CO$_2$eq /  Pers & 0.4\% & 85 \tabularnewline 
 \end{tabular}
 \end{table}

 For Brazil, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (44.8\%), followed by Energy (39.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  45.5\% of the national emissions. 
 Second largest contributor was CH$_4$ (36.9\%)
 The total of F-gasesonly represented 1.1\%.
 The total CO$_2$ emissions are expected to be 51.8\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BRA/ts_emi_exclLU_BRA.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BRA/ts_gdp_pop_BRA.png}
 ...
 Brazil's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 

 LULUCF emissions data for Brazil are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 26, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net source of 0.3~Gt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 1.1~Gt CO$_2$eq.
 The large emissions range for UNFCCC (2019) and 1990--2017 is 0.2--2.7~Gt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BRA/ts_emi_onlyLU_BRA.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Brazil's NDC (if needed). 
 ...
 Brazil has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Brazil's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & uncondi. & best & 1300 Mt~CO$_2$eq AR5 & 2005 & 2025 & inclLU \tabularnewline 
 ABS & uncondi. & best & 1200 Mt~CO$_2$eq AR5 & 2005 & 2030 & inclLU \tabularnewline \hline
 RBY & uncondi. & best & -37\% & 2005 & 2025 & inclLU \tabularnewline 
 RBY & uncondi. & best & -43\% & 2005 & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BRA/ts_pc_cov_BRA.png}
 \caption{Timeseries of Brazil's national emissions (exclLU) and the share of emissions that is assumed to be covered by Brazil's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Brazil's 2017 emissions (exclLU, exclBunkers; total 1.1~Gt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 0.3~Gt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 36.1\% & \bfseries 1.6\% & \bfseries 1.4\% & / & / & / & / & 39.0\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 7.6\% & \bfseries 0.09\% & \bfseries 0.05\% & \bfseries 1.1\% & \bfseries 0.01\% & \bfseries 0.01\% & / & 8.8\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 1.8\% & \bfseries 28.5\% & \bfseries 14.4\% & / & / & / & / & 44.8\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.02\% & \bfseries 6.7\% & \bfseries 0.2\% & / & / & / & / & 6.9\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 45.5\% & 36.9\% & 16.5\% & 1.1\% & 0.01\% & 0.01\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BRA/ts_ndcs_quantis_BRA.png}
