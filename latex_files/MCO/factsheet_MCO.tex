\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Monaco: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 149.8~kt CO$_2$eq, Monaco contributed 0.0003\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.0002\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Monaco is estimated to emit 151.2~kt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 1.0\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 151.2--151.2~kt CO$_2$eq in 2030, and 151.2--151.2~kt CO$_2$eq in 2050.
 The country's global rank in terms of total per-capita emissions was 109 in 2017 (122 in 2030).
 In terms of accumulated historical emissions, Monaco contributed to the global 1850--2017 emissions by 0.0006\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 0.0004\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Monaco, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 149.8 & kt CO$_2$eq & 0.0003\% & 198 \tabularnewline 
 \bfseries  & 2030 & 151.2 & kt CO$_2$eq & 0.0002\% & 197 \tabularnewline \hline
 ...
 \bfseries Population & 2017 & 38.4 & Thousand Pers & 0.0005\% & 193 \tabularnewline 
 \bfseries  & 2030 & 37.5 & Thousand Pers & 0.0004\% & 193 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.9 & t CO$_2$eq /  Pers & 0.2\% & 109 \tabularnewline 
 \bfseries per capita & 2030 & 4.0 & t CO$_2$eq /  Pers & 0.2\% & 122 \tabularnewline 
 \end{tabular}
 \end{table}

 For Monaco, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (51.4\%), followed by Agriculture (28.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  62.5\% of the national emissions. 
 Second largest contributor was CH$_4$ (17.8\%)
 The total of F-gasesonly represented 5.5\%.
 The trend in total emissions is mostly driven by N$_2$O emissions from the IPPU sector, which contributed 0.2\% to Monaco's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MCO/ts_emi_exclLU_MCO.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MCO/ts_gdp_pop_MCO.png}
 ...
 Monaco's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 
 For Monaco, no GDP data are available from dmSSPs.

 LULUCF emissions data for Monaco are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.0~kt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 149.8~kt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -0.1--0.06~kt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MCO/ts_emi_onlyLU_MCO.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Monaco's NDC (if needed). 
 ...
 Monaco has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Monaco's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & condi. & best & 0.055 Mt~CO$_2$eq AR4 & 1990 & 2030 & inclLU \tabularnewline \hline
 RBY & uncondi. & best & -50\% & 1990 & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MCO/ts_pc_cov_MCO.png}
 \caption{Timeseries of Monaco's national emissions (exclLU) and the share of emissions that is assumed to be covered by Monaco's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Monaco's 2017 emissions (exclLU, exclBunkers; total 149.8~kt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of -0.0~kt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 49.6\% & \bfseries 0.4\% & \bfseries 1.4\% & / & / & / & / & 51.4\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 11.7\% & \bfseries 0.01\% & \bfseries 0.2\% & \bfseries 5.4\% & \bfseries 0.0\% & \bfseries 0.07\% & \bfseries / & 17.5\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.6\% & \bfseries 16.2\% & \bfseries 11.9\% & / & / & / & / & 28.6\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.6\% & \bfseries 1.2\% & \bfseries 0.3\% & / & / & / & / & 2.1\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 62.5\% & 17.8\% & 14.2\% & 5.4\% & 0.0\% & 0.07\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MCO/ts_ndcs_quantis_MCO.png}
