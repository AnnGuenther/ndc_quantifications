\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Dominica: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 227.9~kt CO$_2$eq, Dominica contributed 0.0004\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.0003\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Dominica is estimated to emit 223.5~kt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -1.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 223.5--223.5~kt CO$_2$eq in 2030, and 223.5--223.5~kt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 126 in 2017, and 131 regarding the per-capita emissions (100 and 134 in 2030).
 In terms of accumulated historical emissions, Dominica contributed to the global 1850--2017 emissions by 0.0003\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.0004\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Dominica, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 227.9 & kt CO$_2$eq & 0.0004\% & 191 \tabularnewline 
 \bfseries  & 2030 & 223.5 & kt CO$_2$eq & 0.0003\% & 192 \tabularnewline \hline
 \bfseries GDP & 2017 & 670.7 & Million 2011~GK\$ & 0.0005\% & 190 \tabularnewline 
 \bfseries  & 2030 & 718.0 & Million 2011~GK\$ & 0.0003\% & 189 \tabularnewline \hline
 \bfseries Emissions & 2017 & 339.9 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 126 \tabularnewline 
 \bfseries per GDP & 2030 & 311.3 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 100 \tabularnewline \hline
 \bfseries Population & 2017 & 71.5 & Thousand Pers & 0.0009\% & 190 \tabularnewline 
 \bfseries  & 2030 & 71.2 & Thousand Pers & 0.0008\% & 190 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.2 & t CO$_2$eq /  Pers & 0.2\% & 131 \tabularnewline 
 \bfseries per capita & 2030 & 3.1 & t CO$_2$eq /  Pers & 0.2\% & 134 \tabularnewline 
 \end{tabular}
 \end{table}

 For Dominica, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (64.8\%), followed by Agriculture (18.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  65.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (21.4\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 64.5\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/DMA/ts_emi_exclLU_DMA.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/DMA/ts_gdp_pop_DMA.png}
 ...
 Dominica's population is assumed to diminish towars 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Dominica are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 7, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -127.6~kt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 227.9~kt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -371.9---127.6~kt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/DMA/ts_emi_onlyLU_DMA.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Dominica's NDC (if needed). 
 ...
 Dominica has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Dominica's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & condi. & best & 0.10 Mt~CO$_2$eq SAR & 2014 & 2025 & exclLU \tabularnewline 
 ABS & condi. & best & 0.090 Mt~CO$_2$eq SAR & 2014 & 2030 & exclLU \tabularnewline \hline
 RBY & condi. & best & -39.2\% & 2014 & 2025 & exclLU \tabularnewline 
 RBY & condi. & best & -44.7\% & 2014 & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/DMA/ts_pc_cov_DMA.png}
 \caption{Timeseries of Dominica's national emissions (exclLU) and the share of emissions that is assumed to be covered by Dominica's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Dominica's 2017 emissions (exclLU, exclBunkers; total 227.9~kt CO$_2$eq).
 ...
 LULUCF: NDC '/' and adapted '--' (estimated as a net sink of -127.6~kt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 63.2\% & \bfseries 1.1\% & \bfseries 0.4\% & / & / & / & / & 64.8\% \tabularnewline 
 \bfseries IPPU & / & \bfseries + & \bfseries 2.0\% & \bfseries / & \bfseries 0.0\% & \bfseries / & / & / & / & 2.0\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.0\% & 9.0\% & 9.2\% & / & / & / & / & 18.2\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 11.3\% & \bfseries 2.1\% & / & / & / & / & 13.4\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 1.6\% & / & / & / & / & 1.6\% \tabularnewline \hline
 \bfseries Total &  &  & 65.2\% & 21.4\% & 13.4\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/DMA/ts_ndcs_quantis_DMA.png}
