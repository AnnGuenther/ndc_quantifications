\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Ireland: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 61.8~Mt CO$_2$eq, Ireland contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Ireland is estimated to emit 65.2~Mt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 5.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 54.4--74.7~Mt CO$_2$eq in 2030, and 57.7--135.3~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 186 in 2017, and 25 regarding the per-capita emissions (186 and 26 in 2030).
 In terms of accumulated historical emissions, Ireland contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Ireland, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 61.8 & Mt CO$_2$eq & 0.1\% & 74 \tabularnewline 
 \bfseries  & 2030 & 65.2 & Mt CO$_2$eq & 0.1\% & 79 \tabularnewline \hline
 \bfseries GDP & 2017 & 340.1 & Billion 2011~GK\$ & 0.3\% & 50 \tabularnewline 
 \bfseries  & 2030 & 415.9 & Billion 2011~GK\$ & 0.2\% & 56 \tabularnewline \hline
 \bfseries Emissions & 2017 & 181.8 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 186 \tabularnewline 
 \bfseries per GDP & 2030 & 156.8 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 186 \tabularnewline \hline
 \bfseries Population & 2017 & 4.8 & Million Pers & 0.06\% & 121 \tabularnewline 
 \bfseries  & 2030 & 5.4 & Million Pers & 0.06\% & 125 \tabularnewline \hline
 \bfseries Emissions & 2017 & 13.0 & t CO$_2$eq /  Pers & 0.9\% & 25 \tabularnewline 
 \bfseries per capita & 2030 & 12.1 & t CO$_2$eq /  Pers & 0.8\% & 26 \tabularnewline 
 \end{tabular}
 \end{table}

 For Ireland, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (61.0\%), followed by Agriculture (31.7\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  64.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (22.7\%)
 The total of F-gasesonly represented 2.0\%.
 The total CO$_2$ emissions are expected to be 65.6\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/IRL/ts_emi_exclLU_IRL.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/IRL/ts_gdp_pop_IRL.png}
 ...
 Ireland's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Ireland are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net source of 6.0~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 61.8~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is 3.8--6.4~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/IRL/ts_emi_onlyLU_IRL.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Ireland's NDC (if needed). 
 ...
 Ireland has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Ireland's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Ireland is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/IRL/ts_pc_cov_IRL.png}
 \caption{Timeseries of Ireland's national emissions (exclLU) and the share of emissions that is assumed to be covered by Ireland's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Ireland's 2017 emissions (exclLU, exclBunkers; total 61.8~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 6.0~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 60.0\% & \bfseries 0.4\% & \bfseries 0.6\% & / & / & / & / & 61.0\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 3.5\% & \bfseries / & \bfseries 0.06\% & \bfseries 1.8\% & \bfseries 0.07\% & \bfseries 0.06\% & \bfseries 0.0\% & 5.6\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.6\% & \bfseries 21.0\% & \bfseries 10.1\% & / & / & / & / & 31.7\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.03\% & \bfseries 1.3\% & \bfseries 0.1\% & / & / & / & / & 1.5\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 64.2\% & 22.7\% & 11.1\% & 1.8\% & 0.07\% & 0.06\% & 0.0\% & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/IRL/ts_ndcs_quantis_IRL.png}
