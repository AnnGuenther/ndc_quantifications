\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} San Marino: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 227.8~kt CO$_2$eq, San Marino contributed 0.0004\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which San Marino is estimated to emit 228.3~kt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 0.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 228.3--228.3~kt CO$_2$eq in 2030, and 228.3--228.3~kt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 195 in 2017, and 77 regarding the per-capita emissions (193 and 78 in 2030).
 In terms of accumulated historical emissions, San Marino contributed to the global 1850--2017 emissions by 0.0005\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for San Marino, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 227.8 & kt CO$_2$eq & 0.0004\% & 192 \tabularnewline 
 \bfseries  & 2030 & 228.3 & kt CO$_2$eq & 0.0004\% & 190 \tabularnewline \hline
 \bfseries GDP & 2017 & 1.9 & Billion 2011~GK\$ & 0.001\% & 180 \tabularnewline 
 \bfseries  & 2030 & 1.9 & Billion 2011~GK\$ & 0.001\% & 180 \tabularnewline \hline
 \bfseries Emissions & 2017 & 118.1 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 195 \tabularnewline 
 \bfseries per GDP & 2030 & 120.9 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 193 \tabularnewline \hline
 \bfseries Population & 2017 & 33.7 & Thousand Pers & 0.0004\% & 196 \tabularnewline 
 \bfseries  & 2030 & 33.0 & Thousand Pers & 0.0003\% & 196 \tabularnewline \hline
 \bfseries Emissions & 2017 & 6.8 & t CO$_2$eq /  Pers & 0.4\% & 77 \tabularnewline 
 \bfseries per capita & 2030 & 6.9 & t CO$_2$eq /  Pers & 0.4\% & 78 \tabularnewline 
 \end{tabular}
 \end{table}

 For San Marino, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (79.3\%), followed by IPPU (10.8\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 83.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (9.5\%)
 The total of F-gasesonly represented 4.8\%.
 The total CO$_2$ emissions are expected to be 83.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SMR/ts_emi_exclLU_SMR.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SMR/ts_gdp_pop_SMR.png}
 ...
 San Marino's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 
 No LULUCF data are available for San Marino from the following sources: CRF (2019), CRF (2018), BUR (3$^{rd}$), BUR (2$^{nd}$), BUR (1$^{st}$), UNFCCC (2019), FAO (2019).
 ...
 San Marino has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on San Marino's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & uncondi. & best & 0.17 Mt~CO$_2$eq SAR & 2005 & 2030 & inclLU \tabularnewline \hline
 RBY & uncondi. & best & -20\% & 2005 & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SMR/ts_pc_cov_SMR.png}
 \caption{Timeseries of San Marino's national emissions (exclLU) and the share of emissions that is assumed to be covered by San Marino's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in San Marino's 2017 emissions (exclLU, exclBunkers; total 227.8~kt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 77.0\% & \bfseries 1.6\% & \bfseries 0.8\% & / & / & / & / & 79.3\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 5.9\% & \bfseries 0.0\% & \bfseries 0.07\% & \bfseries 4.5\% & \bfseries 0.1\% & \bfseries 0.1\% & \bfseries / & 10.8\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 4.5\% & \bfseries 1.1\% & / & / & / & / & 5.7\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.2\% & \bfseries 3.4\% & \bfseries 0.3\% & / & / & / & / & 3.9\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 83.2\% & 9.5\% & 2.5\% & 4.5\% & 0.1\% & 0.1\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SMR/ts_ndcs_quantis_SMR.png}
