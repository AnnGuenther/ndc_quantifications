\documentclass[12pt]{article}
 ...
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Aruba is estimated to emit 1.1~Mt CO$_2$eq in 2030.
 ...
 The country's global rank in terms of total emissions per unit of GDP was 157 in 2017, and 42 regarding the per-capita emissions (190 and 46 in 2030).
 ...
 For Aruba, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (91.0\%), followed by IPPU (6.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 95.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (3.7\%)
 ...
 No LULUCF data are available for Aruba from the following sources: CRF (2019), CRF (2018), BUR (3$^{rd}$), BUR (2$^{nd}$), BUR (1$^{st}$), UNFCCC (2019), FAO (2019).
