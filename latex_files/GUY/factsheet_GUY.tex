\documentclass[12pt]{article}
 ...
 LULUCF emissions data for Guyana are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 15, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -54.6~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 4.1~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -60.6---54.6~Mt CO$_2$eq.
