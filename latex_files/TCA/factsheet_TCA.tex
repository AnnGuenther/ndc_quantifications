\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Turks \& Caicos Is.: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 235.9~kt CO$_2$eq, Turks \& Caicos Is. contributed 0.0004\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Turks \& Caicos Is. is estimated to emit 226.3~kt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -4.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 226.3--226.3~kt CO$_2$eq in 2030, and 226.3--226.3~kt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 150 in 2017, and 83 regarding the per-capita emissions (104 and 87 in 2030).
 In terms of accumulated historical emissions, Turks \& Caicos Is. contributed to the global 1850--2017 emissions by 0.0001\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Turks \& Caicos Is., together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 235.9 & kt CO$_2$eq & 0.0004\% & 190 \tabularnewline 
 \bfseries  & 2030 & 226.3 & kt CO$_2$eq & 0.0004\% & 191 \tabularnewline \hline
 \bfseries GDP & 2017 & 834.4 & Million 2011~GK\$ & 0.0007\% & 186 \tabularnewline 
 \bfseries  & 2030 & 748.0 & Million 2011~GK\$ & 0.0004\% & 188 \tabularnewline \hline
 \bfseries Emissions & 2017 & 282.7 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 150 \tabularnewline 
 \bfseries per GDP & 2030 & 302.5 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 104 \tabularnewline \hline
 \bfseries Population & 2017 & 37.1 & Thousand Pers & 0.0004\% & 195 \tabularnewline 
 \bfseries  & 2030 & 35.6 & Thousand Pers & 0.0004\% & 195 \tabularnewline \hline
 \bfseries Emissions & 2017 & 6.4 & t CO$_2$eq /  Pers & 0.4\% & 83 \tabularnewline 
 \bfseries per capita & 2030 & 6.4 & t CO$_2$eq /  Pers & 0.4\% & 87 \tabularnewline 
 \end{tabular}
 \end{table}

 For Turks \& Caicos Is., in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (91.6\%), followed by Waste (8.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 91.0\% of the national emissions. 
 Second largest contributor was CH$_4$ (8.5\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 91.5\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TCA/ts_emi_exclLU_TCA.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TCA/ts_gdp_pop_TCA.png}
 ...
 Turks \& Caicos Is.'s population is assumed to diminish towars 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Turks \& Caicos Is. are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 68.1~kt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 235.9~kt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is -109.9--332.1~kt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TCA/ts_emi_onlyLU_TCA.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Turks \& Caicos Is.'s NDC (if needed). 
 ...
 Turks \& Caicos Is. does not have an (I)NDC.
