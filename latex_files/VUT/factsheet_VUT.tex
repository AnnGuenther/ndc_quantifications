\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Vanuatu: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 0.7~Mt CO$_2$eq, Vanuatu contributed 0.001\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Vanuatu is estimated to emit 0.8~Mt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 3.4\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 0.8--0.8~Mt CO$_2$eq in 2030, and 1.2--1.2~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 24 in 2017, and 145 regarding the per-capita emissions (29 and 163 in 2030).
 In terms of accumulated historical emissions, Vanuatu contributed to the global 1850--2017 emissions by 0.001\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Vanuatu, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 0.7 & Mt CO$_2$eq & 0.001\% & 177 \tabularnewline 
 \bfseries  & 2030 & 0.8 & Mt CO$_2$eq & 0.001\% & 177 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.8 & Billion 2011~GK\$ & 0.0007\% & 187 \tabularnewline 
 \bfseries  & 2030 & 1.4 & Billion 2011~GK\$ & 0.0007\% & 184 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.9 & t CO$_2$eq / Thousand 2011~GK\$ & 0.8\% & 24 \tabularnewline 
 \bfseries per GDP & 2030 & 0.6 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 29 \tabularnewline \hline
 \bfseries Population & 2017 & 285.5 & Thousand Pers & 0.003\% & 176 \tabularnewline 
 \bfseries  & 2030 & 357.8 & Thousand Pers & 0.004\% & 175 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.6 & t CO$_2$eq /  Pers & 0.1\% & 145 \tabularnewline 
 \bfseries per capita & 2030 & 2.2 & t CO$_2$eq /  Pers & 0.1\% & 163 \tabularnewline 
 \end{tabular}
 \end{table}

 For Vanuatu, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (64.2\%), followed by Energy (26.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  54.6\% of the national emissions. 
 Second largest contributor was CO$_2$ (25.7\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 27.7\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VUT/ts_emi_exclLU_VUT.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VUT/ts_gdp_pop_VUT.png}
 ...
 Vanuatu's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Vanuatu are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.0~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 0.7~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -0.0--0.009~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VUT/ts_emi_onlyLU_VUT.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Vanuatu's NDC (if needed). 
 ...
 Vanuatu has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Vanuatu's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VUT/ts_pc_cov_VUT.png}
 \caption{Timeseries of Vanuatu's national emissions (exclLU) and the share of emissions that is assumed to be covered by Vanuatu's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Vanuatu's 2017 emissions (exclLU, exclBunkers; total 0.7~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 25.2\% & 0.6\% & 0.1\% & / & / & / & / & 26.0\% \tabularnewline 
 \bfseries IPPU & / & -- & 0.4\% & / & 0.2\% & / & / & / & / & 0.7\% \tabularnewline 
 \bfseries Agri. & / & -- & / & 45.5\% & 18.7\% & / & / & / & / & 64.2\% \tabularnewline 
 \bfseries Waste & / & -- & / & 8.5\% & 0.4\% & / & / & / & / & 9.0\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 25.7\% & 54.6\% & 19.7\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VUT/ts_ndcs_quantis_VUT.png}
