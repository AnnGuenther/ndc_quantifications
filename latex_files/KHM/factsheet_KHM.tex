\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Cambodia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 35.2~Mt CO$_2$eq, Cambodia contributed 0.07\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Cambodia is estimated to emit 43.2~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 22.8\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 39.6--48.0~Mt CO$_2$eq in 2030, and 43.3--77.8~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 61 in 2017, and 159 regarding the per-capita emissions (66 and 153 in 2030).
 In terms of accumulated historical emissions, Cambodia contributed to the global 1850--2017 emissions by 0.08\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Cambodia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 35.2 & Mt CO$_2$eq & 0.07\% & 98 \tabularnewline 
 \bfseries  & 2030 & 43.2 & Mt CO$_2$eq & 0.07\% & 105 \tabularnewline \hline
 \bfseries GDP & 2017 & 55.0 & Billion 2011~GK\$ & 0.04\% & 106 \tabularnewline 
 \bfseries  & 2030 & 109.1 & Billion 2011~GK\$ & 0.06\% & 101 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.6 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 61 \tabularnewline 
 \bfseries per GDP & 2030 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.5\% & 66 \tabularnewline \hline
 \bfseries Population & 2017 & 16.0 & Million Pers & 0.2\% & 70 \tabularnewline 
 \bfseries  & 2030 & 17.5 & Million Pers & 0.2\% & 73 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.2 & t CO$_2$eq /  Pers & 0.1\% & 159 \tabularnewline 
 \bfseries per capita & 2030 & 2.5 & t CO$_2$eq /  Pers & 0.1\% & 153 \tabularnewline 
 \end{tabular}
 \end{table}

 For Cambodia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (61.6\%), followed by Energy (29.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  63.7\% of the national emissions. 
 Second largest contributor was CO$_2$ (22.8\%)
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KHM/ts_emi_exclLU_KHM.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KHM/ts_gdp_pop_KHM.png}
 ...
 Cambodia's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Cambodia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 26.9~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 35.2~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 24.8--34.6~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KHM/ts_emi_onlyLU_KHM.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Cambodia's NDC (if needed). 
 ...
 Cambodia has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 The reclassified target type is ABU (absolute reduction compared to Business-As-Usual).

 \begin{table}[H]
 \centering
 \caption{Information on Cambodia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABU & condi. & best & -3.10 Mt~CO$_2$eq SAR & 2030 & exclLU \tabularnewline 
 ABU & condi. & best & -13.69 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KHM/ts_pc_cov_KHM.png}
 \caption{Timeseries of Cambodia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Cambodia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Cambodia's 2017 emissions (exclLU, exclBunkers; total 35.2~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 26.9~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 20.9\% & \bfseries 7.5\% & \bfseries 0.6\% & / & / & / & / & 29.0\% \tabularnewline 
 \bfseries IPPU & / & -- & 1.9\% & / & 0.0\% & / & / & / & / & 1.9\% \tabularnewline 
 \bfseries Agri. & / & -- & / & 49.7\% & 11.9\% & / & / & / & / & 61.6\% \tabularnewline 
 \bfseries Waste & / & -- & 0.03\% & 6.5\% & 0.6\% & / & / & / & / & 7.2\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 22.8\% & 63.7\% & 13.5\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/KHM/ts_ndcs_quantis_KHM.png}
