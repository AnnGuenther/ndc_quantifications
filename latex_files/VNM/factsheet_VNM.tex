\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Viet Nam: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 363.1~Mt CO$_2$eq, Viet Nam contributed 0.8\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Viet Nam is estimated to emit 429.2~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 18.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 403.6--476.8~Mt CO$_2$eq in 2030, and 494.9--759.8~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 67 in 2017, and 113 regarding the per-capita emissions (77 and 118 in 2030).
 In terms of accumulated historical emissions, Viet Nam contributed to the global 1850--2017 emissions by 0.4\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Viet Nam, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 363.1 & Mt CO$_2$eq & 0.8\% & 24 \tabularnewline 
 \bfseries  & 2030 & 429.2 & Mt CO$_2$eq & 0.8\% & 24 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.6 & Trillion 2011~GK\$ & 0.5\% & 33 \tabularnewline 
 \bfseries  & 2030 & 1.2 & Trillion 2011~GK\$ & 0.7\% & 29 \tabularnewline \hline
 \bfseries Emissions & 2017 & 602.7 & t CO$_2$eq / Million 2011~GK\$ & 0.5\% & 67 \tabularnewline 
 \bfseries per GDP & 2030 & 365.9 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 77 \tabularnewline \hline
 \bfseries Population & 2017 & 94.6 & Million Pers & 1.3\% & 15 \tabularnewline 
 \bfseries  & 2030 & 102.4 & Million Pers & 1.2\% & 16 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.8 & t CO$_2$eq /  Pers & 0.2\% & 113 \tabularnewline 
 \bfseries per capita & 2030 & 4.2 & t CO$_2$eq /  Pers & 0.2\% & 118 \tabularnewline 
 \end{tabular}
 \end{table}

 For Viet Nam, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (57.4\%), followed by Agriculture (24.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  61.6\% of the national emissions. 
 Second largest contributor was CH$_4$ (29.7\%)
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VNM/ts_emi_exclLU_VNM.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VNM/ts_gdp_pop_VNM.png}
 ...
 Viet Nam's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Viet Nam are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 4, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -26.6~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 363.1~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -34.2--20.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VNM/ts_emi_onlyLU_VNM.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Viet Nam's NDC (if needed). 
 ...
 Viet Nam has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Viet Nam's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 724.40 Mt~CO$_2$eq AR4 & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 590.54 Mt~CO$_2$eq AR4 & 2030 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -8\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -25\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VNM/ts_pc_cov_VNM.png}
 \caption{Timeseries of Viet Nam's national emissions (exclLU) and the share of emissions that is assumed to be covered by Viet Nam's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Viet Nam's 2017 emissions (exclLU, exclBunkers; total 363.1~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -26.6~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 49.6\% & \bfseries 7.6\% & \bfseries 0.2\% & / & / & / & / & 57.4\% \tabularnewline 
 \bfseries IPPU & -- & \bfseries + & \bfseries 11.4\% & \bfseries / & \bfseries 0.0\% & \bfseries / & \bfseries / & \bfseries / & / & 11.4\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.6\% & \bfseries 16.2\% & \bfseries 7.4\% & / & / & / & / & 24.2\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 5.9\% & \bfseries 0.6\% & / & / & / & / & 6.6\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 61.6\% & 29.7\% & 8.7\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VNM/ts_ndcs_quantis_VNM.png}
