\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Myanmar: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 130.0~Mt CO$_2$eq, Myanmar contributed 0.2\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Myanmar is estimated to emit 145.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 11.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 133.5--161.8~Mt CO$_2$eq in 2030, and 97.6--260.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 100 in 2017, and 152 regarding the per-capita emissions (120 and 145 in 2030).
 In terms of accumulated historical emissions, Myanmar contributed to the global 1850--2017 emissions by 0.2\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Myanmar, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 130.0 & Mt CO$_2$eq & 0.2\% & 42 \tabularnewline 
 \bfseries  & 2030 & 145.0 & Mt CO$_2$eq & 0.2\% & 48 \tabularnewline \hline
 \bfseries GDP & 2017 & 299.9 & Billion 2011~GK\$ & 0.2\% & 53 \tabularnewline 
 \bfseries  & 2030 & 539.2 & Billion 2011~GK\$ & 0.2\% & 50 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 100 \tabularnewline 
 \bfseries per GDP & 2030 & 0.2 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 120 \tabularnewline \hline
 \bfseries Population & 2017 & 53.4 & Million Pers & 0.7\% & 26 \tabularnewline 
 \bfseries  & 2030 & 55.0 & Million Pers & 0.7\% & 29 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.4 & t CO$_2$eq /  Pers & 0.1\% & 152 \tabularnewline 
 \bfseries per capita & 2030 & 2.6 & t CO$_2$eq /  Pers & 0.1\% & 145 \tabularnewline 
 \end{tabular}
 \end{table}

 For Myanmar, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (63.1\%), followed by Energy (28.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  61.9\% of the national emissions. 
 Second largest contributor was CO$_2$ (20.7\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 27.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MMR/ts_emi_exclLU_MMR.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MMR/ts_gdp_pop_MMR.png}
 ...
 Myanmar's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Myanmar are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 111.9~Mt CO$_2$eq, which in absolute terms is in the range of the non-LULUCF emissions of 130.0~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 83.4--121.2~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MMR/ts_emi_onlyLU_MMR.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Myanmar's NDC (if needed). 
 ...
 Myanmar has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MMR/ts_pc_cov_MMR.png}
 \caption{Timeseries of Myanmar's national emissions (exclLU) and the share of emissions that is assumed to be covered by Myanmar's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Myanmar's 2017 emissions (exclLU, exclBunkers; total 130.0~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 111.9~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 19.8\% & \bfseries 7.7\% & \bfseries 0.5\% & / & / & / & / & 28.0\% \tabularnewline 
 \bfseries IPPU & / & -- & 1.0\% & 0.0\% & 0.0\% & / & / & / & / & 1.0\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.0\% & 47.2\% & 15.9\% & / & / & / & / & 63.1\% \tabularnewline 
 \bfseries Waste & / & -- & / & 7.0\% & 0.7\% & / & / & / & / & 7.8\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 20.7\% & 61.9\% & 17.4\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MMR/ts_ndcs_quantis_MMR.png}
