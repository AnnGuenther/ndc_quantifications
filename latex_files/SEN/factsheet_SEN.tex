\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Senegal: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 25.9~Mt CO$_2$eq, Senegal contributed 0.05\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Senegal is estimated to emit 32.9~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 27.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 32.3--44.8~Mt CO$_2$eq in 2030, and 47.9--126.2~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 75 in 2017, and 178 regarding the per-capita emissions (89 and 177 in 2030).
 In terms of accumulated historical emissions, Senegal contributed to the global 1850--2017 emissions by 0.04\%. 
 When only accounting for the years 1990--2017, its contribution stays the same to 0.04\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Senegal, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 25.9 & Mt CO$_2$eq & 0.05\% & 113 \tabularnewline 
 \bfseries  & 2030 & 32.9 & Mt CO$_2$eq & 0.05\% & 112 \tabularnewline \hline
 \bfseries GDP & 2017 & 48.7 & Billion 2011~GK\$ & 0.04\% & 109 \tabularnewline 
 \bfseries  & 2030 & 97.3 & Billion 2011~GK\$ & 0.05\% & 104 \tabularnewline \hline
 \bfseries Emissions & 2017 & 531.5 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 75 \tabularnewline 
 \bfseries per GDP & 2030 & 337.9 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 89 \tabularnewline \hline
 \bfseries Population & 2017 & 15.4 & Million Pers & 0.2\% & 71 \tabularnewline 
 \bfseries  & 2030 & 19.6 & Million Pers & 0.2\% & 68 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.7 & t CO$_2$eq /  Pers & 0.1\% & 178 \tabularnewline 
 \bfseries per capita & 2030 & 1.7 & t CO$_2$eq /  Pers & 0.1\% & 177 \tabularnewline 
 \end{tabular}
 \end{table}

 For Senegal, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (46.8\%), followed by Energy (35.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  42.7\% of the national emissions. 
 Second largest contributor was CO$_2$ (35.7\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 49.5\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SEN/ts_emi_exclLU_SEN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SEN/ts_gdp_pop_SEN.png}
 ...
 Senegal's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Senegal are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 4.9~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 25.9~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 4.5--10.2~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SEN/ts_emi_onlyLU_SEN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Senegal's NDC (if needed). 
 ...
 Senegal has an INDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Senegal's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 28.80 Mt~CO$_2$eq & 2025 & inclLU \tabularnewline 
 ABS & condi. & best & 25.50 Mt~CO$_2$eq & 2025 & inclLU \tabularnewline 
 ABS & uncondi. & best & 35.60 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 29.60 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -4\% & 2025 & inclLU \tabularnewline 
 RBU & condi. & best & -15\% & 2025 & inclLU \tabularnewline 
 RBU & uncondi. & best & -5\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -21\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SEN/ts_pc_cov_SEN.png}
 \caption{Timeseries of Senegal's national emissions (exclLU) and the share of emissions that is assumed to be covered by Senegal's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from INDC and adapted ('Adap.': used to calculate \%cov), and their shares in Senegal's 2017 emissions (exclLU, exclBunkers; total 25.9~Mt CO$_2$eq).
 ...
 LULUCF: INDC '+' and adapted '+' (estimated as a net source of 4.9~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 28.4\% & \bfseries 6.8\% & \bfseries 0.2\% & / & / & / & / & 35.5\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 7.3\% & \bfseries / & \bfseries 0.0\% & / & / & / & / & 7.3\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 26.6\% & \bfseries 20.2\% & / & / & / & / & 46.8\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 9.3\% & \bfseries 0.7\% & / & / & / & / & 10.0\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 35.7\% & 42.7\% & 21.6\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SEN/ts_ndcs_quantis_SEN.png}
