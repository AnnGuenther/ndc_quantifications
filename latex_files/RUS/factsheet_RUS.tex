\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Russia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 2.2~Gt CO$_2$eq, Russia contributed 4.6\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 3.9\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Russia is estimated to emit 2.2~Gt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 0.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 2.2--2.6~Gt CO$_2$eq in 2030, and 2.2--4.0~Gt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 60 in 2017, and 20 regarding the per-capita emissions (67 and 19 in 2030).
 In terms of accumulated historical emissions, Russia contributed to the global 1850--2017 emissions by 6.4\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 5.6\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Russia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 2.2 & Gt CO$_2$eq & 4.6\% & 4 \tabularnewline 
 \bfseries  & 2030 & 2.2 & Gt CO$_2$eq & 3.9\% & 4 \tabularnewline \hline
 \bfseries GDP & 2017 & 3.4 & Trillion 2011~GK\$ & 3.0\% & 6 \tabularnewline 
 \bfseries  & 2030 & 5.6 & Trillion 2011~GK\$ & 3.1\% & 6 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.6 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 60 \tabularnewline 
 \bfseries per GDP & 2030 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.5\% & 67 \tabularnewline \hline
 \bfseries Population & 2017 & 145.5 & Million Pers & 1.9\% & 9 \tabularnewline 
 \bfseries  & 2030 & 142.5 & Million Pers & 1.7\% & 9 \tabularnewline \hline
 \bfseries Emissions & 2017 & 15.0 & t CO$_2$eq /  Pers & 1.0\% & 20 \tabularnewline 
 \bfseries per capita & 2030 & 15.4 & t CO$_2$eq /  Pers & 1.0\% & 19 \tabularnewline 
 \end{tabular}
 \end{table}

 For Russia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (78.7\%), followed by IPPU (10.9\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 76.5\% of the national emissions. 
 Second largest contributor was CH$_4$ (17.6\%)
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/RUS/ts_emi_exclLU_RUS.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/RUS/ts_gdp_pop_RUS.png}
 ...
 Russia's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Russia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.6~Gt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 2.2~Gt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -0.7---0.1~Gt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/RUS/ts_emi_onlyLU_RUS.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Russia's NDC (if needed). 
 ...
 Russia has an INDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Russia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 RBY & uncondi. & worst & -25\% & 1990 & 2030 & inclLU \tabularnewline 
 RBY & uncondi. & best & -30\% & 1990 & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/RUS/ts_pc_cov_RUS.png}
 \caption{Timeseries of Russia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Russia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from INDC and adapted ('Adap.': used to calculate \%cov), and their shares in Russia's 2017 emissions (exclLU, exclBunkers; total 2.2~Gt CO$_2$eq).
 ...
 LULUCF: INDC '+' and adapted '+' (estimated as a net sink of -0.6~Gt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 67.7\% & \bfseries 10.7\% & \bfseries 0.2\% & / & / & / & / & 78.7\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 8.8\% & \bfseries 0.02\% & \bfseries 0.3\% & \bfseries 1.6\% & \bfseries 0.1\% & \bfseries 0.05\% & \bfseries 0.0\% & 10.9\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.03\% & \bfseries 2.6\% & \bfseries 3.2\% & / & / & / & / & 5.9\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 4.2\% & \bfseries 0.1\% & / & / & / & / & 4.3\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 76.5\% & 17.6\% & 4.2\% & 1.6\% & 0.1\% & 0.05\% & 0.0\% & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/RUS/ts_ndcs_quantis_RUS.png}
