\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Serbia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 76.3~Mt CO$_2$eq, Serbia contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Serbia is estimated to emit 75.3~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -1.4\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 71.1--87.8~Mt CO$_2$eq in 2030, and 69.2--126.5~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 48 in 2017, and 51 regarding the per-capita emissions (34 and 51 in 2030).
 In terms of accumulated historical emissions, Serbia contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Serbia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 76.3 & Mt CO$_2$eq & 0.1\% & 67 \tabularnewline 
 \bfseries  & 2030 & 75.3 & Mt CO$_2$eq & 0.1\% & 70 \tabularnewline \hline
 \bfseries GDP & 2017 & 103.9 & Billion 2011~GK\$ & 0.09\% & 81 \tabularnewline 
 \bfseries  & 2030 & 143.2 & Billion 2011~GK\$ & 0.07\% & 90 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.7 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 48 \tabularnewline 
 \bfseries per GDP & 2030 & 0.5 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 34 \tabularnewline \hline
 \bfseries Population & 2017 & 8.8 & Million Pers & 0.1\% & 98 \tabularnewline 
 \bfseries  & 2030 & 8.8 & Million Pers & 0.1\% & 103 \tabularnewline \hline
 \bfseries Emissions & 2017 & 8.6 & t CO$_2$eq /  Pers & 0.6\% & 51 \tabularnewline 
 \bfseries per capita & 2030 & 8.6 & t CO$_2$eq /  Pers & 0.6\% & 51 \tabularnewline 
 \end{tabular}
 \end{table}

 For Serbia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (68.5\%), followed by IPPU (17.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  68.5\% of the national emissions. 
 Second largest contributor was HFCs (14.7\%)
 The total of F-gasesrepresented 14.7\%.
 The total CO$_2$ emissions are expected to be 63.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SRB/ts_emi_exclLU_SRB.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SRB/ts_gdp_pop_SRB.png}
 ...
 Serbia's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Serbia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -10.4~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 76.3~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -64.8--0.02~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SRB/ts_emi_onlyLU_SRB.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Serbia's NDC (if needed). 
 ...
 Serbia has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Serbia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 RBY & uncondi. & best & -9.8\% & 1990 & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SRB/ts_pc_cov_SRB.png}
 \caption{Timeseries of Serbia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Serbia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Serbia's 2017 emissions (exclLU, exclBunkers; total 76.3~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 66.0\% & \bfseries 1.9\% & \bfseries 0.6\% & / & / & / & / & 68.5\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 2.5\% & \bfseries 0.04\% & \bfseries 0.1\% & \bfseries 14.7\% & \bfseries 0.0\% & \bfseries / & / & 17.3\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 4.3\% & \bfseries 3.9\% & / & / & / & / & 8.3\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 5.4\% & \bfseries 0.1\% & / & / & / & / & 5.6\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 68.5\% & 11.7\% & 5.1\% & 14.7\% & 0.0\% & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SRB/ts_ndcs_quantis_SRB.png}
