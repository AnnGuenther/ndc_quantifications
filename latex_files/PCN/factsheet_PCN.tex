\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Pitcairn Is.: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 25.5~t CO$_2$eq, Pitcairn Is. contributed 0.00000005\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.00000004\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Pitcairn Is. is estimated to emit 25.6~t CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 0.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 25.6--25.6~t CO$_2$eq in 2030, and 25.6--25.6~t CO$_2$eq in 2050.
 In terms of accumulated historical emissions, Pitcairn Is. contributed to the global 1850--2017 emissions by 0.00000009\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 0.00000006\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Pitcairn Is., together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 25.5 & t CO$_2$eq & 0.00000005\% & 208 \tabularnewline 
 \bfseries  & 2030 & 25.6 & t CO$_2$eq & 0.00000004\% & 208 \tabularnewline \hline
 ...
 For Pitcairn Is., in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Waste sector (99.7\%), followed by IPPU (0.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting as much as 99.7\% of the national emissions. 
 Second largest contributor was N$_2$O (0.2\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Waste sector, which contributed 99.7\% to Pitcairn Is.'s 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PCN/ts_emi_exclLU_PCN.png}
 ...
 \label{fig:tsEmi}
 \end{figure}
 For Pitcairn Is., no GDP and population data are available from dmSSPs.

 LULUCF emissions data for Pitcairn Is. are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.0~t CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 25.5~t CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -36667.0--0.0~t CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PCN/ts_emi_onlyLU_PCN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Pitcairn Is.'s NDC (if needed). 
 ...
 Pitcairn Is. does not have an (I)NDC.
