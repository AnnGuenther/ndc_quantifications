\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Madagascar: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 34.0~Mt CO$_2$eq, Madagascar contributed 0.07\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Madagascar is estimated to emit 39.7~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 16.7\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 39.7--60.0~Mt CO$_2$eq in 2030, and 69.4--199.8~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 29 in 2017, and 186 regarding the per-capita emissions (51 and 192 in 2030).
 In terms of accumulated historical emissions, Madagascar contributed to the global 1850--2017 emissions by 0.07\%. 
 When only accounting for the years 1990--2017, its contribution stays the same to 0.07\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Madagascar, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 34.0 & Mt CO$_2$eq & 0.07\% & 102 \tabularnewline 
 \bfseries  & 2030 & 39.7 & Mt CO$_2$eq & 0.07\% & 108 \tabularnewline \hline
 \bfseries GDP & 2017 & 40.3 & Billion 2011~GK\$ & 0.03\% & 117 \tabularnewline 
 \bfseries  & 2030 & 86.6 & Billion 2011~GK\$ & 0.04\% & 108 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.8 & t CO$_2$eq / Thousand 2011~GK\$ & 0.8\% & 29 \tabularnewline 
 \bfseries per GDP & 2030 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 51 \tabularnewline \hline
 \bfseries Population & 2017 & 25.6 & Million Pers & 0.3\% & 51 \tabularnewline 
 \bfseries  & 2030 & 33.9 & Million Pers & 0.4\% & 49 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.3 & t CO$_2$eq /  Pers & 0.09\% & 186 \tabularnewline 
 \bfseries per capita & 2030 & 1.2 & t CO$_2$eq /  Pers & 0.07\% & 192 \tabularnewline 
 \end{tabular}
 \end{table}

 For Madagascar, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (75.4\%), followed by Energy (20.1\%)
 The Kyoto~GHG with the highest emissions in 2017 was N$_2$O, constituting  45.3\% of the national emissions. 
 Second largest contributor was CH$_4$ (44.0\%)
 The total of F-gasesonly represented 0.05\%.
 The trend in total emissions is mostly driven by N$_2$O emissions from the Agriculture sector, and CH$_4$ emissions from the Energy sector, which contributed 43.0\% and 9.3\% to Madagascar's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 19.9\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MDG/ts_emi_exclLU_MDG.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MDG/ts_gdp_pop_MDG.png}
 ...
 Madagascar's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Madagascar are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 8, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -96.2~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 34.0~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -238.7---96.2~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MDG/ts_emi_onlyLU_MDG.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Madagascar's NDC (if needed). 
 ...
 Madagascar has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Madagascar's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 184.20 Mt~CO$_2$eq SAR & 2030 & exclLU \tabularnewline \hline
 ABS & condi. & best & -68.90 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -14\% & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MDG/ts_pc_cov_MDG.png}
 \caption{Timeseries of Madagascar's national emissions (exclLU) and the share of emissions that is assumed to be covered by Madagascar's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Madagascar's 2017 emissions (exclLU, exclBunkers; total 34.0~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -96.2~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 9.5\% & \bfseries 9.3\% & \bfseries 1.2\% & / & / & / & / & 20.1\% \tabularnewline 
 \bfseries IPPU & / & \bfseries + & \bfseries 1.1\% & \bfseries / & \bfseries 0.0\% & 0.05\% & / & / & / & 1.2\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 32.4\% & \bfseries 43.0\% & / & / & / & / & 75.4\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 2.3\% & \bfseries 0.7\% & / & / & / & / & 3.0\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 10.6\% & 44.0\% & 45.3\% & 0.05\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MDG/ts_ndcs_quantis_MDG.png}
