\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Guinea: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 27.5~Mt CO$_2$eq, Guinea contributed 0.05\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.09\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Guinea is estimated to emit 53.9~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 96.4\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 49.5--95.1~Mt CO$_2$eq in 2030, and 69.8--229.4~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 20 in 2017, and 156 regarding the per-capita emissions (24 and 126 in 2030).
 In terms of accumulated historical emissions, Guinea contributed to the global 1850--2017 emissions by 0.04\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Guinea, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 27.5 & Mt CO$_2$eq & 0.05\% & 111 \tabularnewline 
 \bfseries  & 2030 & 53.9 & Mt CO$_2$eq & 0.09\% & 94 \tabularnewline \hline
 \bfseries GDP & 2017 & 27.4 & Billion 2011~GK\$ & 0.02\% & 133 \tabularnewline 
 \bfseries  & 2030 & 93.0 & Billion 2011~GK\$ & 0.05\% & 106 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.0 & t CO$_2$eq / Thousand 2011~GK\$ & 0.9\% & 20 \tabularnewline 
 \bfseries per GDP & 2030 & 0.6 & t CO$_2$eq / Thousand 2011~GK\$ & 0.8\% & 24 \tabularnewline \hline
 \bfseries Population & 2017 & 12.1 & Million Pers & 0.1\% & 76 \tabularnewline 
 \bfseries  & 2030 & 14.2 & Million Pers & 0.1\% & 78 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.3 & t CO$_2$eq /  Pers & 0.1\% & 156 \tabularnewline 
 \bfseries per capita & 2030 & 3.8 & t CO$_2$eq /  Pers & 0.2\% & 126 \tabularnewline 
 \end{tabular}
 \end{table}

 For Guinea, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (69.3\%), followed by Energy (21.8\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  62.7\% of the national emissions. 
 Second largest contributor was N$_2$O (24.1\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ and N$_2$O emissions from the Agriculture sector, which contributed 47.0\% and 22.3\% to Guinea's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GIN/ts_emi_exclLU_GIN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GIN/ts_gdp_pop_GIN.png}
 ...
 Guinea's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Guinea are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 16.4~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 27.5~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 14.2--19.2~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GIN/ts_emi_onlyLU_GIN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Guinea's NDC (if needed). 
 ...
 Guinea has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Guinea's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 38.50 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline \hline
 RBU & condi. & best & -30\% & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GIN/ts_pc_cov_GIN.png}
 \caption{Timeseries of Guinea's national emissions (exclLU) and the share of emissions that is assumed to be covered by Guinea's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Guinea's 2017 emissions (exclLU, exclBunkers; total 27.5~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '--' (estimated as a net source of 16.4~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 12.3\% & \bfseries 8.7\% & \bfseries 0.8\% & / & / & / & / & 21.8\% \tabularnewline 
 \bfseries IPPU & -- & -- & 0.8\% & / & 0.0\% & / & / & / & / & 0.8\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 47.0\% & \bfseries 22.3\% & / & / & / & / & 69.3\% \tabularnewline 
 \bfseries Waste & -- & -- & / & 7.1\% & 0.4\% & / & / & / & / & 7.5\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 13.2\% & 62.7\% & 24.1\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GIN/ts_ndcs_quantis_GIN.png}
