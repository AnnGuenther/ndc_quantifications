\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Luxembourg: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 10.3~Mt CO$_2$eq, Luxembourg contributed 0.02\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Luxembourg is estimated to emit 12.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 16.0\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 9.7--14.0~Mt CO$_2$eq in 2030, and 9.3--23.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 185 in 2017, and 16 regarding the per-capita emissions (184 and 16 in 2030).
 In terms of accumulated historical emissions, Luxembourg contributed to the global 1850--2017 emissions by 0.05\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Luxembourg, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 10.3 & Mt CO$_2$eq & 0.02\% & 144 \tabularnewline 
 \bfseries  & 2030 & 12.0 & Mt CO$_2$eq & 0.02\% & 142 \tabularnewline \hline
 \bfseries GDP & 2017 & 56.8 & Billion 2011~GK\$ & 0.05\% & 102 \tabularnewline 
 \bfseries  & 2030 & 75.6 & Billion 2011~GK\$ & 0.04\% & 113 \tabularnewline \hline
 \bfseries Emissions & 2017 & 182.1 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 185 \tabularnewline 
 \bfseries per GDP & 2030 & 158.6 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 184 \tabularnewline \hline
 \bfseries Population & 2017 & 591.9 & Thousand Pers & 0.007\% & 166 \tabularnewline 
 \bfseries  & 2030 & 700.8 & Thousand Pers & 0.008\% & 164 \tabularnewline \hline
 \bfseries Emissions & 2017 & 17.5 & t CO$_2$eq /  Pers & 1.2\% & 16 \tabularnewline 
 \bfseries per capita & 2030 & 17.1 & t CO$_2$eq /  Pers & 1.2\% & 16 \tabularnewline 
 \end{tabular}
 \end{table}

 For Luxembourg, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (84.9\%), followed by Agriculture (6.9\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 89.8\% of the national emissions. 
 Second largest contributor was CH$_4$ (5.8\%)
 The total of F-gasesonly represented 0.8\%.
 The total CO$_2$ emissions are expected to be 86.5\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LUX/ts_emi_exclLU_LUX.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LUX/ts_gdp_pop_LUX.png}
 ...
 Luxembourg's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Luxembourg are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.3~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 10.3~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -0.7--0.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LUX/ts_emi_onlyLU_LUX.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Luxembourg's NDC (if needed). 
 ...
 Luxembourg has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Luxembourg's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Luxembourg is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LUX/ts_pc_cov_LUX.png}
 \caption{Timeseries of Luxembourg's national emissions (exclLU) and the share of emissions that is assumed to be covered by Luxembourg's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Luxembourg's 2017 emissions (exclLU, exclBunkers; total 10.3~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 83.8\% & \bfseries 0.4\% & \bfseries 0.7\% & / & / & / & / & 84.9\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 6.0\% & \bfseries 0.01\% & \bfseries 0.04\% & \bfseries 0.7\% & \bfseries 0.01\% & \bfseries 0.09\% & \bfseries / & 6.9\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.07\% & \bfseries 4.5\% & \bfseries 2.3\% & / & / & / & / & 6.9\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 0.7\% & \bfseries 0.09\% & / & / & / & / & 0.8\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.5\% & / & / & / & / & 0.5\% \tabularnewline \hline
 \bfseries Total &  &  & 89.8\% & 5.8\% & 3.6\% & 0.7\% & 0.01\% & 0.09\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LUX/ts_ndcs_quantis_LUX.png}
