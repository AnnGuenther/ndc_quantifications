\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Chile: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 111.2~Mt CO$_2$eq, Chile contributed 0.2\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Chile is estimated to emit 153.4~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 38.0\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 143.2--182.7~Mt CO$_2$eq in 2030, and 167.9--253.6~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 158 in 2017, and 88 regarding the per-capita emissions (147 and 64 in 2030).
 In terms of accumulated historical emissions, Chile contributed to the global 1850--2017 emissions by 0.1\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.2\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Chile, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 111.2 & Mt CO$_2$eq & 0.2\% & 49 \tabularnewline 
 \bfseries  & 2030 & 153.4 & Mt CO$_2$eq & 0.2\% & 46 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.4 & Trillion 2011~GK\$ & 0.3\% & 44 \tabularnewline 
 \bfseries  & 2030 & 0.7 & Trillion 2011~GK\$ & 0.3\% & 38 \tabularnewline \hline
 \bfseries Emissions & 2017 & 260.2 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 158 \tabularnewline 
 \bfseries per GDP & 2030 & 221.6 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 147 \tabularnewline \hline
 \bfseries Population & 2017 & 18.5 & Million Pers & 0.2\% & 62 \tabularnewline 
 \bfseries  & 2030 & 19.9 & Million Pers & 0.2\% & 66 \tabularnewline \hline
 \bfseries Emissions & 2017 & 6.0 & t CO$_2$eq /  Pers & 0.4\% & 88 \tabularnewline 
 \bfseries per capita & 2030 & 7.7 & t CO$_2$eq /  Pers & 0.5\% & 64 \tabularnewline 
 \end{tabular}
 \end{table}

 For Chile, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (77.5\%), followed by Agriculture (10.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 78.1\% of the national emissions. 
 Second largest contributor was CH$_4$ (12.6\%)
 The total of F-gasesonly represented 2.7\%.
 The total CO$_2$ emissions are expected to be 78.1\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CHL/ts_emi_exclLU_CHL.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CHL/ts_gdp_pop_CHL.png}
 ...
 Chile's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Chile are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 7, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -69.6~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 111.2~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -71.5---19.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CHL/ts_emi_onlyLU_CHL.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Chile's NDC (if needed). 
 ...
 Chile has an NDC, with a GHG mitigation target of the type ABS (absolute emissions target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Chile's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & uncondi. & best & 99 Mt~CO$_2$eq & 2025 & 2030 & exclLU \tabularnewline 
 ABS & uncondi. & best & 95 Mt~CO$_2$eq & 2030 & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CHL/ts_pc_cov_CHL.png}
 \caption{Timeseries of Chile's national emissions (exclLU) and the share of emissions that is assumed to be covered by Chile's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Chile's 2017 emissions (exclLU, exclBunkers; total 111.2~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -69.6~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 74.9\% & \bfseries 1.5\% & \bfseries 1.1\% & / & / & / & / & 77.5\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 2.8\% & \bfseries 0.0\% & \bfseries 0.4\% & \bfseries 2.5\% & \bfseries 0.0\% & \bfseries 0.2\% & \bfseries / & 6.0\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.3\% & \bfseries 6.0\% & \bfseries 4.1\% & / & / & / & / & 10.5\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 5.1\% & \bfseries 0.3\% & / & / & / & / & 5.5\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.6\% & / & / & / & / & 0.6\% \tabularnewline \hline
 \bfseries Total &  &  & 78.1\% & 12.6\% & 6.7\% & 2.5\% & 0.0\% & 0.2\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CHL/ts_ndcs_quantis_CHL.png}
