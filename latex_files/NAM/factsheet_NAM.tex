\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Namibia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 14.8~Mt CO$_2$eq, Namibia contributed 0.03\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.02\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Namibia is estimated to emit 14.9~Mt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 0.4\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 13.9--19.5~Mt CO$_2$eq in 2030, and 13.1--32.2~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 74 in 2017, and 85 regarding the per-capita emissions (107 and 101 in 2030).
 In terms of accumulated historical emissions, Namibia contributed to the global 1850--2017 emissions by 0.04\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Namibia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 14.8 & Mt CO$_2$eq & 0.03\% & 131 \tabularnewline 
 \bfseries  & 2030 & 14.9 & Mt CO$_2$eq & 0.02\% & 137 \tabularnewline \hline
 \bfseries GDP & 2017 & 27.6 & Billion 2011~GK\$ & 0.02\% & 132 \tabularnewline 
 \bfseries  & 2030 & 50.0 & Billion 2011~GK\$ & 0.02\% & 128 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.5 & t CO$_2$eq / Thousand 2011~GK\$ & 0.4\% & 74 \tabularnewline 
 \bfseries per GDP & 2030 & 0.2 & t CO$_2$eq / Thousand 2011~GK\$ & 0.3\% & 107 \tabularnewline \hline
 \bfseries Population & 2017 & 2.4 & Million Pers & 0.03\% & 141 \tabularnewline 
 \bfseries  & 2030 & 2.8 & Million Pers & 0.03\% & 141 \tabularnewline \hline
 \bfseries Emissions & 2017 & 6.2 & t CO$_2$eq /  Pers & 0.4\% & 85 \tabularnewline 
 \bfseries per capita & 2030 & 5.3 & t CO$_2$eq /  Pers & 0.3\% & 101 \tabularnewline 
 \end{tabular}
 \end{table}

 For Namibia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (68.1\%), followed by Energy (25.4\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  48.2\% of the national emissions. 
 Second largest contributor was CO$_2$ (28.7\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ and N$_2$O emissions from the Agriculture sector, which contributed 45.8\% and 22.3\% to Namibia's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 43.7\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NAM/ts_emi_exclLU_NAM.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NAM/ts_gdp_pop_NAM.png}
 ...
 Namibia's population is assumed to grow towards 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Namibia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): BUR (3$^{rd}$)~/ 21, BUR (2$^{nd}$)~/ 13, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from BUR (3$^{rd}$), for the year 2017, LULUCF is estimated to be a net sink of -102.2~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 14.8~Mt CO$_2$eq.
 The emissions range for BUR (3$^{rd}$) and 1990--2017 is -112.6---87.9~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NAM/ts_emi_onlyLU_NAM.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Namibia's NDC (if needed). 
 ...
 Namibia has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Namibia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 20.38 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 2.49 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -10\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -88.6\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NAM/ts_pc_cov_NAM.png}
 \caption{Timeseries of Namibia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Namibia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Namibia's 2017 emissions (exclLU, exclBunkers; total 14.8~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -102.2~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 23.7\% & \bfseries 1.3\% & \bfseries 0.3\% & / & / & / & / & 25.4\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 5.0\% & \bfseries / & \bfseries 0.09\% & / & / & / & / & 5.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 45.8\% & \bfseries 22.3\% & / & / & / & / & 68.1\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.01\% & \bfseries 1.1\% & \bfseries 0.1\% & / & / & / & / & 1.3\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 28.7\% & 48.2\% & 23.1\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NAM/ts_ndcs_quantis_NAM.png}
