\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Uruguay: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 36.9~Mt CO$_2$eq, Uruguay contributed 0.07\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Uruguay is estimated to emit 43.4~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 17.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 40.5--53.4~Mt CO$_2$eq in 2030, and 39.5--53.8~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 78 in 2017, and 34 regarding the per-capita emissions (68 and 25 in 2030).
 In terms of accumulated historical emissions, Uruguay contributed to the global 1850--2017 emissions by 0.09\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 0.08\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Uruguay, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 36.9 & Mt CO$_2$eq & 0.07\% & 97 \tabularnewline 
 \bfseries  & 2030 & 43.4 & Mt CO$_2$eq & 0.07\% & 104 \tabularnewline \hline
 \bfseries GDP & 2017 & 70.1 & Billion 2011~GK\$ & 0.06\% & 93 \tabularnewline 
 \bfseries  & 2030 & 109.9 & Billion 2011~GK\$ & 0.06\% & 100 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.5 & t CO$_2$eq / Thousand 2011~GK\$ & 0.4\% & 78 \tabularnewline 
 \bfseries per GDP & 2030 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.5\% & 68 \tabularnewline \hline
 \bfseries Population & 2017 & 3.4 & Million Pers & 0.04\% & 132 \tabularnewline 
 \bfseries  & 2030 & 3.5 & Million Pers & 0.04\% & 135 \tabularnewline \hline
 \bfseries Emissions & 2017 & 10.7 & t CO$_2$eq /  Pers & 0.7\% & 34 \tabularnewline 
 \bfseries per capita & 2030 & 12.5 & t CO$_2$eq /  Pers & 0.8\% & 25 \tabularnewline 
 \end{tabular}
 \end{table}

 For Uruguay, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (71.0\%), followed by Energy (23.9\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  52.2\% of the national emissions. 
 Second largest contributor was CO$_2$ (24.2\%)
 The total of F-gasesonly represented 0.4\%.
 The trend in total emissions is mostly driven by N$_2$O emissions from the Agriculture sector, which contributed 22.2\% to Uruguay's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 30.2\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/URY/ts_emi_exclLU_URY.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/URY/ts_gdp_pop_URY.png}
 ...
 Uruguay's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Uruguay are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 11, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -6.6~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 36.9~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -12.4--0.7~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/URY/ts_emi_onlyLU_URY.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Uruguay's NDC (if needed). 
 ...
 Uruguay has an NDC, with a GHG mitigation target of the type REI (relative emissions intensity reduction; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Uruguay's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries refYr & \bfseries tarYr & \bfseries intensRef & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 41.79 Mt~CO$_2$eq AR2 & 1990 & 2025 & GDP & exclLU \tabularnewline 
 ABS & condi. & best & 0.0 Mt~CO$_2$eq AR2 & 1990 & 2025 & GDP & exclLU \tabularnewline \hline
 ABS & uncondi. & best & 35.79 Mt~CO$_2$eq SAR & 1990 & 2025 & GDP & inclLU \tabularnewline 
 ABS & condi. & best & 0.0 Mt~CO$_2$eq SAR & 1990 & 2025 & GDP & inclLU \tabularnewline 
 REI & uncondi. & best & -49\% (SAR) & 1990 & 2025 & GDP & exclLU \tabularnewline 
 REI & condi. & best & -52\% (SAR) & 1990 & 2025 & GDP & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/URY/ts_pc_cov_URY.png}
 \caption{Timeseries of Uruguay's national emissions (exclLU) and the share of emissions that is assumed to be covered by Uruguay's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Uruguay's 2017 emissions (exclLU, exclBunkers; total 36.9~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -6.6~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 22.7\% & \bfseries 0.6\% & \bfseries 0.5\% & / & / & / & / & 23.9\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 1.1\% & \bfseries 0.0\% & \bfseries 0.0\% & 0.2\% & / & 0.2\% & / & 1.6\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.3\% & \bfseries 48.4\% & \bfseries 22.2\% & / & / & / & / & 71.0\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 3.1\% & \bfseries 0.1\% & / & / & / & / & 3.3\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 24.2\% & 52.2\% & 23.1\% & 0.2\% & / & 0.2\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/URY/ts_ndcs_quantis_URY.png}
