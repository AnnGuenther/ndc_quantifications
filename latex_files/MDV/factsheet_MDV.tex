\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Maldives: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 1.5~Mt CO$_2$eq, Maldives contributed 0.003\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.002\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Maldives is estimated to emit 1.6~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 10.0\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 1.4--1.9~Mt CO$_2$eq in 2030, and 1.8--3.5~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 178 in 2017, and 139 regarding the per-capita emissions (191 and 140 in 2030).
 In terms of accumulated historical emissions, Maldives contributed to the global 1850--2017 emissions by 0.0009\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Maldives, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 1.5 & Mt CO$_2$eq & 0.003\% & 172 \tabularnewline 
 \bfseries  & 2030 & 1.6 & Mt CO$_2$eq & 0.002\% & 171 \tabularnewline \hline
 \bfseries GDP & 2017 & 7.1 & Billion 2011~GK\$ & 0.006\% & 161 \tabularnewline 
 \bfseries  & 2030 & 10.9 & Billion 2011~GK\$ & 0.006\% & 164 \tabularnewline \hline
 \bfseries Emissions & 2017 & 204.6 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 178 \tabularnewline 
 \bfseries per GDP & 2030 & 146.2 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 191 \tabularnewline \hline
 \bfseries Population & 2017 & 496.4 & Thousand Pers & 0.006\% & 169 \tabularnewline 
 \bfseries  & 2030 & 563.6 & Thousand Pers & 0.006\% & 169 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.9 & t CO$_2$eq /  Pers & 0.1\% & 139 \tabularnewline 
 \bfseries per capita & 2030 & 2.8 & t CO$_2$eq /  Pers & 0.1\% & 140 \tabularnewline 
 \end{tabular}
 \end{table}

 For Maldives, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (94.6\%), followed by Waste (3.9\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 94.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (3.6\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 92.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MDV/ts_emi_exclLU_MDV.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MDV/ts_gdp_pop_MDV.png}
 ...
 Maldives's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Maldives are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.005~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 1.5~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is -0.0--0.03~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MDV/ts_emi_onlyLU_MDV.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Maldives's NDC (if needed). 
 ...
 Maldives has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Maldives's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 2.97 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 ABS & condi. & best & 2.50 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline \hline
 RBU & uncondi. & best & -10\% & 2030 & exclLU \tabularnewline 
 RBU & condi. & best & -24\% & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MDV/ts_pc_cov_MDV.png}
 \caption{Timeseries of Maldives's national emissions (exclLU) and the share of emissions that is assumed to be covered by Maldives's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Maldives's 2017 emissions (exclLU, exclBunkers; total 1.5~Mt CO$_2$eq).
 ...
 LULUCF: NDC '/' and adapted '--' (estimated as a net source of 0.005~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 94.1\% & \bfseries 0.2\% & 0.3\% & / & / & / & / & 94.6\% \tabularnewline 
 \bfseries IPPU & / & -- & 0.1\% & / & 0.0\% & / & / & / & / & 0.1\% \tabularnewline 
 \bfseries Agri. & / & -- & / & 0.0\% & 0.1\% & / & / & / & / & 0.1\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 3.4\% & 0.4\% & / & / & / & / & 3.9\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 1.2\% & / & / & / & / & 1.2\% \tabularnewline \hline
 \bfseries Total &  &  & 94.2\% & 3.6\% & 2.1\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/MDV/ts_ndcs_quantis_MDV.png}
