\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Pakistan: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 0.4~Gt CO$_2$eq, Pakistan contributed 1.0\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.9\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Pakistan is estimated to emit 0.4~Gt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 7.0\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 0.4--0.5~Gt CO$_2$eq in 2030, and 0.6--1.1~Gt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 94 in 2017, and 160 regarding the per-capita emissions (116 and 173 in 2030).
 In terms of accumulated historical emissions, Pakistan contributed to the global 1850--2017 emissions by 0.6\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Pakistan, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 0.4 & Gt CO$_2$eq & 1.0\% & 20 \tabularnewline 
 \bfseries  & 2030 & 0.4 & Gt CO$_2$eq & 0.9\% & 22 \tabularnewline \hline
 \bfseries GDP & 2017 & 1.0 & Trillion 2011~GK\$ & 0.9\% & 23 \tabularnewline 
 \bfseries  & 2030 & 1.7 & Trillion 2011~GK\$ & 1.0\% & 22 \tabularnewline \hline
 \bfseries Emissions & 2017 & 454.9 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 94 \tabularnewline 
 \bfseries per GDP & 2030 & 279.9 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 116 \tabularnewline \hline
 \bfseries Population & 2017 & 207.9 & Million Pers & 2.8\% & 5 \tabularnewline 
 \bfseries  & 2030 & 252.5 & Million Pers & 3.0\% & 6 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.2 & t CO$_2$eq /  Pers & 0.1\% & 160 \tabularnewline 
 \bfseries per capita & 2030 & 1.9 & t CO$_2$eq /  Pers & 0.1\% & 173 \tabularnewline 
 \end{tabular}
 \end{table}

 For Pakistan, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (47.0\%), followed by Agriculture (41.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  46.8\% of the national emissions. 
 Second largest contributor was CH$_4$ (39.6\%)
 The total of F-gasesonly represented 0.02\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Agriculture sector, which contributed 27.9\% to Pakistan's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 48.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PAK/ts_emi_exclLU_PAK.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PAK/ts_gdp_pop_PAK.png}
 ...
 Pakistan's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Pakistan are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.02~Gt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 0.4~Gt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 0.02--0.02~Gt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PAK/ts_emi_onlyLU_PAK.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Pakistan's NDC (if needed). 
 ...
 Pakistan has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Pakistan's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 1282.40 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline \hline
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PAK/ts_pc_cov_PAK.png}
 \caption{Timeseries of Pakistan's national emissions (exclLU) and the share of emissions that is assumed to be covered by Pakistan's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Pakistan's 2017 emissions (exclLU, exclBunkers; total 0.4~Gt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 0.02~Gt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 40.8\% & \bfseries 5.7\% & \bfseries 0.4\% & / & / & / & / & 47.0\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 4.4\% & \bfseries / & \bfseries 0.0\% & / & / & 0.02\% & / & 4.4\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 1.6\% & \bfseries 27.9\% & \bfseries 12.1\% & / & / & / & / & 41.6\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 6.0\% & \bfseries 0.5\% & / & / & / & / & 6.6\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 46.8\% & 39.6\% & 13.5\% & / & / & 0.02\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PAK/ts_ndcs_quantis_PAK.png}
