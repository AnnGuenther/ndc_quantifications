\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Niue: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 20.3~kt CO$_2$eq, Niue contributed 0.00004\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.00002\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Niue is estimated to emit 16.3~kt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial decrease of -19.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 16.3--16.3~kt CO$_2$eq in 2030, and 16.3--16.3~kt CO$_2$eq in 2050.
 The country's global rank in terms of total per-capita emissions was 26 in 2017 (40 in 2030).
 In terms of accumulated historical emissions, Niue contributed to the global 1850--2017 emissions by 0.00001\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.00002\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Niue, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 20.3 & kt CO$_2$eq & 0.00004\% & 203 \tabularnewline 
 \bfseries  & 2030 & 16.3 & kt CO$_2$eq & 0.00002\% & 203 \tabularnewline \hline
 ...
 \bfseries Population & 2017 & 1.6 & Thousand Pers & 0.00002\% & 204 \tabularnewline 
 \bfseries  & 2030 & 1.6 & Thousand Pers & 0.00001\% & 204 \tabularnewline \hline
 \bfseries Emissions & 2017 & 12.6 & t CO$_2$eq /  Pers & 0.9\% & 26 \tabularnewline 
 \bfseries per capita & 2030 & 10.1 & t CO$_2$eq /  Pers & 0.7\% & 40 \tabularnewline 
 \end{tabular}
 \end{table}

 For Niue, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (91.8\%), followed by Agriculture (7.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 91.6\% of the national emissions. 
 Second largest contributor was CH$_4$ (6.7\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 89.7\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NIU/ts_emi_exclLU_NIU.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NIU/ts_gdp_pop_NIU.png}
 ...
 Niue's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to decline towars 2050. 
 For Niue, no GDP data are available from dmSSPs.

 LULUCF emissions data for Niue are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 36.7~kt CO$_2$eq, which in absolute terms is higher than the non-LULUCF emissions of 20.3~kt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is -36.7--73.3~kt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NIU/ts_emi_onlyLU_NIU.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Niue's NDC (if needed). 
 ...
 Niue has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 The reclassified target type is ABU (absolute reduction compared to Business-As-Usual).

 \begin{table}[H]
 \centering
 \caption{Information on Niue's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABU & uncondi. & best & -0.0011 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 ABU & condi. & best & -0.0030 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NIU/ts_pc_cov_NIU.png}
 \caption{Timeseries of Niue's national emissions (exclLU) and the share of emissions that is assumed to be covered by Niue's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Niue's 2017 emissions (exclLU, exclBunkers; total 20.3~kt CO$_2$eq).
 ...
 LULUCF: NDC '/' and adapted '--' (estimated as a net source of 36.7~kt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 91.6\% & \bfseries 0.02\% & \bfseries 0.1\% & / & / & / & / & 91.8\% \tabularnewline 
 \bfseries IPPU & / & -- & 0.0\% & / & 0.04\% & / & / & / & / & 0.04\% \tabularnewline 
 \bfseries Agri. & / & -- & / & 5.6\% & 1.5\% & / & / & / & / & 7.0\% \tabularnewline 
 \bfseries Waste & / & -- & / & 1.1\% & / & / & / & / & / & 1.1\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.0\% & / & / & / & / & 0.0\% \tabularnewline \hline
 \bfseries Total &  &  & 91.6\% & 6.7\% & 1.7\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/NIU/ts_ndcs_quantis_NIU.png}
