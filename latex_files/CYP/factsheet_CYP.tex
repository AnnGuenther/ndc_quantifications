\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Cyprus: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 9.2~Mt CO$_2$eq, Cyprus contributed 0.01\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Cyprus is estimated to emit 8.3~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -9.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 7.3--9.8~Mt CO$_2$eq in 2030, and 7.8--17.8~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 134 in 2017, and 60 regarding the per-capita emissions (138 and 93 in 2030).
 In terms of accumulated historical emissions, Cyprus contributed to the global 1850--2017 emissions by 0.01\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Cyprus, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 9.2 & Mt CO$_2$eq & 0.01\% & 148 \tabularnewline 
 \bfseries  & 2030 & 8.3 & Mt CO$_2$eq & 0.01\% & 152 \tabularnewline \hline
 \bfseries GDP & 2017 & 29.1 & Billion 2011~GK\$ & 0.02\% & 128 \tabularnewline 
 \bfseries  & 2030 & 34.8 & Billion 2011~GK\$ & 0.01\% & 146 \tabularnewline \hline
 \bfseries Emissions & 2017 & 314.0 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 134 \tabularnewline 
 \bfseries per GDP & 2030 & 237.5 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 138 \tabularnewline \hline
 \bfseries Population & 2017 & 1.2 & Million Pers & 0.01\% & 156 \tabularnewline 
 \bfseries  & 2030 & 1.4 & Million Pers & 0.01\% & 154 \tabularnewline \hline
 \bfseries Emissions & 2017 & 7.8 & t CO$_2$eq /  Pers & 0.5\% & 60 \tabularnewline 
 \bfseries per capita & 2030 & 6.1 & t CO$_2$eq /  Pers & 0.4\% & 93 \tabularnewline 
 \end{tabular}
 \end{table}

 For Cyprus, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (72.3\%), followed by IPPU (15.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 84.0\% of the national emissions. 
 Second largest contributor was CH$_4$ (9.6\%)
 The total of F-gasesonly represented 2.7\%.
 The total CO$_2$ emissions are expected to be 81.2\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CYP/ts_emi_exclLU_CYP.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CYP/ts_gdp_pop_CYP.png}
 ...
 Cyprus's population is assumed to grow towards 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Cyprus are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.5~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 9.2~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -0.6--0.07~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CYP/ts_emi_onlyLU_CYP.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Cyprus's NDC (if needed). 
 ...
 Cyprus has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Cyprus's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Cyprus is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CYP/ts_pc_cov_CYP.png}
 \caption{Timeseries of Cyprus's national emissions (exclLU) and the share of emissions that is assumed to be covered by Cyprus's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Cyprus's 2017 emissions (exclLU, exclBunkers; total 9.2~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 71.9\% & \bfseries 0.1\% & \bfseries 0.2\% & / & / & / & / & 72.3\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 12.1\% & \bfseries / & \bfseries 0.7\% & \bfseries 2.7\% & \bfseries / & \bfseries 0.0\% & \bfseries / & 15.5\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 3.4\% & \bfseries 2.1\% & / & / & / & / & 5.4\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 6.1\% & \bfseries 0.2\% & / & / & / & / & 6.3\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 84.0\% & 9.6\% & 3.6\% & 2.7\% & / & 0.0\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CYP/ts_ndcs_quantis_CYP.png}
