\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} China: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 13.0~Gt CO$_2$eq, China contributed 27.2\% to global emissions in 2017, while in 2030 its share is estimated to increase to 29.6\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which China is estimated to emit 16.5~Gt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 27.7\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 16.5--19.4~Gt CO$_2$eq in 2030, and 15.1--22.3~Gt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 46 in 2017, and 45 regarding the per-capita emissions (49 and 28 in 2030).
 In terms of accumulated historical emissions, China contributed to the global 1850--2017 emissions by 12.3\%. 
 However, when only accounting for the years 1990--2017, its contribution increases to 20.0\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for China, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 13.0 & Gt CO$_2$eq & 27.2\% & 1 \tabularnewline 
 \bfseries  & 2030 & 16.5 & Gt CO$_2$eq & 29.6\% & 1 \tabularnewline \hline
 \bfseries GDP & 2017 & 17.6 & Trillion 2011~GK\$ & 15.7\% & 2 \tabularnewline 
 \bfseries  & 2030 & 35.9 & Trillion 2011~GK\$ & 20.0\% & 1 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.7 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 46 \tabularnewline 
 \bfseries per GDP & 2030 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 49 \tabularnewline \hline
 \bfseries Population & 2017 & 1.4 & Billion Pers & 18.8\% & 1 \tabularnewline 
 \bfseries  & 2030 & 1.4 & Billion Pers & 17.0\% & 2 \tabularnewline \hline
 \bfseries Emissions & 2017 & 9.1 & t CO$_2$eq /  Pers & 0.6\% & 45 \tabularnewline 
 \bfseries per capita & 2030 & 11.6 & t CO$_2$eq /  Pers & 0.8\% & 28 \tabularnewline 
 \end{tabular}
 \end{table}

 For China, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (76.3\%), followed by IPPU (14.1\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 80.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (11.7\%)
 The total of F-gasesonly represented 2.9\%.
 The total CO$_2$ emissions are expected to be 79.2\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CHN/ts_emi_exclLU_CHN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CHN/ts_gdp_pop_CHN.png}
 ...
 China's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for China are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 3, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.6~Gt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 13.0~Gt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -0.6---0.4~Gt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CHN/ts_emi_onlyLU_CHN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of China's NDC (if needed). 
 ...
 China has an NDC, with a GHG mitigation target of the type REI (relative emissions intensity reduction; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on China's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries refYr & \bfseries tarYr & \bfseries peakYr & \bfseries intensRef & \bfseries LU \tabularnewline \hline \hline
 REI & uncondi. & worst & -60\% & 2005 & 2030 & 2030 & GDP & inclLU \tabularnewline 
 REI & uncondi. & best & -65\% & 2005 & 2030 & 2030 & GDP & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CHN/ts_pc_cov_CHN.png}
 \caption{Timeseries of China's national emissions (exclLU) and the share of emissions that is assumed to be covered by China's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in China's 2017 emissions (exclLU, exclBunkers; total 13.0~Gt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -0.6~Gt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 69.3\% & 6.3\% & 0.6\% & / & / & / & / & 76.3\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 10.5\% & 0.03\% & 0.7\% & 2.6\% & 0.1\% & 0.1\% & 0.0\% & 14.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.3\% & 4.5\% & 3.4\% & / & / & / & / & 8.2\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & 0.8\% & 0.2\% & / & / & / & / & 1.0\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries 0.0\% & 0.0\% & 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 80.2\% & 11.7\% & 5.3\% & 2.6\% & 0.1\% & 0.1\% & 0.0\% & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CHN/ts_ndcs_quantis_CHN.png}
 ...
 \begin{itemize}
 \item \href{https://www.carbonbrief.org/analysis-chinas-covid-stimulus-plans-for-fossil-fuels-three-times-larger-than-low-carbon?utm_campaign=Feed%3A%20carbonbrief%20%28The%20Carbon%20Brief%29&utm_medium=feed&utm_source=feedburner}{Analysis: China's Covid stimulus plans for fossil fuels three times larger than low-carbon: China's main energy-consuming and producing provinces are directing the equivalent of hundreds of billions of dollars into fossil fuel projects, analysis of spending plans reveals.} (23 September 2020)
 ...
 \vspace{-.2cm} \item \href{https://www.bbc.com/news/science-environment-54256826?utm_campaign=Carbon%20Brief%20Daily%20Briefing&utm_medium=email&utm_source=Revue%20newsletter}{Climate change: China aims for 'carbon neutrality by 2060'} (September 2020)
