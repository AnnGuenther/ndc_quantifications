\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Vatican City: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 6.5~kt CO$_2$eq, Vatican City contributed 0.00001\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Vatican City is estimated to emit 6.6~kt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 1.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 6.6--6.6~kt CO$_2$eq in 2030, and 6.6--6.6~kt CO$_2$eq in 2050.
 The country's global rank in terms of total per-capita emissions was 55 in 2017 (58 in 2030).
 In terms of accumulated historical emissions, Vatican City contributed to the global 1850--2017 emissions by 0.00002\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Vatican City, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 6.5 & kt CO$_2$eq & 0.00001\% & 205 \tabularnewline 
 \bfseries  & 2030 & 6.6 & kt CO$_2$eq & 0.00001\% & 205 \tabularnewline \hline
 ...
 \bfseries Population & 2017 & 793.0 &  Pers & 0.00001\% & 206 \tabularnewline 
 \bfseries  & 2030 & 800.3 &  Pers & 0.000009\% & 206 \tabularnewline \hline
 \bfseries Emissions & 2017 & 8.2 & t CO$_2$eq /  Pers & 0.6\% & 55 \tabularnewline 
 \bfseries per capita & 2030 & 8.3 & t CO$_2$eq /  Pers & 0.6\% & 58 \tabularnewline 
 \end{tabular}
 \end{table}

 For Vatican City, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (80.0\%), followed by IPPU (10.9\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 84.9\% of the national emissions. 
 Second largest contributor was CH$_4$ (7.6\%)
 The total of F-gasesonly represented 4.2\%.
 The total CO$_2$ emissions are expected to be 84.7\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VAT/ts_emi_exclLU_VAT.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/VAT/ts_gdp_pop_VAT.png}
 ...
 Vatican City's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 
 For Vatican City, no GDP data are available from dmSSPs.
 No LULUCF data are available for Vatican City from the following sources: CRF (2019), CRF (2018), BUR (3$^{rd}$), BUR (2$^{nd}$), BUR (1$^{st}$), UNFCCC (2019), FAO (2019).
 ...
 Vatican City does not have an (I)NDC.
