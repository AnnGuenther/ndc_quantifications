\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Sweden: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 55.2~Mt CO$_2$eq, Sweden contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Sweden is estimated to emit 69.6~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 26.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 54.8--82.5~Mt CO$_2$eq in 2030, and 66.2--178.0~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 196 in 2017, and 94 regarding the per-capita emissions (194 and 86 in 2030).
 In terms of accumulated historical emissions, Sweden contributed to the global 1850--2017 emissions by 0.2\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Sweden, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 55.2 & Mt CO$_2$eq & 0.1\% & 81 \tabularnewline 
 \bfseries  & 2030 & 69.6 & Mt CO$_2$eq & 0.1\% & 77 \tabularnewline \hline
 \bfseries GDP & 2017 & 468.9 & Billion 2011~GK\$ & 0.4\% & 40 \tabularnewline 
 \bfseries  & 2030 & 601.7 & Billion 2011~GK\$ & 0.3\% & 45 \tabularnewline \hline
 \bfseries Emissions & 2017 & 117.7 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 196 \tabularnewline 
 \bfseries per GDP & 2030 & 115.7 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 194 \tabularnewline \hline
 \bfseries Population & 2017 & 9.9 & Million Pers & 0.1\% & 90 \tabularnewline 
 \bfseries  & 2030 & 11.0 & Million Pers & 0.1\% & 89 \tabularnewline \hline
 \bfseries Emissions & 2017 & 5.6 & t CO$_2$eq /  Pers & 0.3\% & 94 \tabularnewline 
 \bfseries per capita & 2030 & 6.4 & t CO$_2$eq /  Pers & 0.4\% & 86 \tabularnewline 
 \end{tabular}
 \end{table}

 For Sweden, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (66.8\%), followed by IPPU (17.4\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 80.3\% of the national emissions. 
 Second largest contributor was N$_2$O (9.3\%)
 The total of F-gasesonly represented 2.2\%.
 The total CO$_2$ emissions are expected to be 78.7\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SWE/ts_emi_exclLU_SWE.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SWE/ts_gdp_pop_SWE.png}
 ...
 Sweden's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Sweden are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -43.7~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 55.2~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -45.5---28.8~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SWE/ts_emi_onlyLU_SWE.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Sweden's NDC (if needed). 
 ...
 Sweden has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Sweden's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Sweden is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SWE/ts_pc_cov_SWE.png}
 \caption{Timeseries of Sweden's national emissions (exclLU) and the share of emissions that is assumed to be covered by Sweden's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Sweden's 2017 emissions (exclLU, exclBunkers; total 55.2~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -43.7~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 65.1\% & \bfseries 0.5\% & \bfseries 1.2\% & / & / & / & / & 66.8\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 14.8\% & \bfseries 0.01\% & \bfseries 0.3\% & \bfseries 2.1\% & \bfseries 0.06\% & \bfseries 0.08\% & \bfseries 0.0\% & 17.4\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.2\% & \bfseries 6.0\% & \bfseries 6.8\% & / & / & / & / & 13.0\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 1.7\% & \bfseries 0.4\% & / & / & / & / & 2.3\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 80.3\% & 8.3\% & 9.3\% & 2.1\% & 0.06\% & 0.08\% & 0.0\% & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SWE/ts_ndcs_quantis_SWE.png}
