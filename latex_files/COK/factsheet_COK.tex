\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Cook Is.: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 103.0~kt CO$_2$eq, Cook Is. contributed 0.0002\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.0001\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Cook Is. is estimated to emit 92.2~kt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial decrease of -10.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 92.2--92.2~kt CO$_2$eq in 2030, and 92.2--92.2~kt CO$_2$eq in 2050.
 The country's global rank in terms of total per-capita emissions was 90 in 2017 (103 in 2030).
 In terms of accumulated historical emissions, Cook Is. contributed to the global 1850--2017 emissions by 0.0001\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Cook Is., together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 103.0 & kt CO$_2$eq & 0.0002\% & 200 \tabularnewline 
 \bfseries  & 2030 & 92.2 & kt CO$_2$eq & 0.0001\% & 200 \tabularnewline \hline
 ...
 \bfseries Population & 2017 & 17.5 & Thousand Pers & 0.0002\% & 199 \tabularnewline 
 \bfseries  & 2030 & 17.7 & Thousand Pers & 0.0002\% & 198 \tabularnewline \hline
 \bfseries Emissions & 2017 & 5.9 & t CO$_2$eq /  Pers & 0.3\% & 90 \tabularnewline 
 \bfseries per capita & 2030 & 5.2 & t CO$_2$eq /  Pers & 0.3\% & 103 \tabularnewline 
 \end{tabular}
 \end{table}

 For Cook Is., in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (83.1\%), followed by Agriculture (15.8\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 82.9\% of the national emissions. 
 Second largest contributor was CH$_4$ (13.9\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 81.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COK/ts_emi_exclLU_COK.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COK/ts_gdp_pop_COK.png}
 ...
 Cook Is.'s population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to decline towars 2050. 
 For Cook Is., no GDP data are available from dmSSPs.

 LULUCF emissions data for Cook Is. are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -5.2~kt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 103.0~kt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -73.3--0.0~kt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COK/ts_emi_onlyLU_COK.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Cook Is.'s NDC (if needed). 
 ...
 Cook Is. has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Cook Is.'s GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & condi. & best & 0.050 Mt~CO$_2$eq & 2006 & 2030 & exclLU \tabularnewline \hline
 RBY & condi. & best & -34.9\% & 2006 & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COK/ts_pc_cov_COK.png}
 \caption{Timeseries of Cook Is.'s national emissions (exclLU) and the share of emissions that is assumed to be covered by Cook Is.'s mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Cook Is.'s 2017 emissions (exclLU, exclBunkers; total 103.0~kt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 82.9\% & \bfseries 0.06\% & \bfseries 0.1\% & / & / & / & / & 83.1\% \tabularnewline 
 \bfseries IPPU & / & -- & 0.0\% & / & 0.1\% & / & / & / & / & 0.1\% \tabularnewline 
 \bfseries Agri. & / & -- & / & 13.0\% & 2.9\% & / & / & / & / & 15.8\% \tabularnewline 
 \bfseries Waste & / & -- & / & 0.8\% & / & / & / & / & / & 0.8\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 82.9\% & 13.9\% & 3.2\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COK/ts_ndcs_quantis_COK.png}
