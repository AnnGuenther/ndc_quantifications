\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Turkmenistan: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 108.2~Mt CO$_2$eq, Turkmenistan contributed 0.2\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Turkmenistan is estimated to emit 157.4~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 45.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 156.5--198.2~Mt CO$_2$eq in 2030, and 170.6--331.4~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 34 in 2017, and 14 regarding the per-capita emissions (42 and 6 in 2030).
 In terms of accumulated historical emissions, Turkmenistan contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Turkmenistan, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 108.2 & Mt CO$_2$eq & 0.2\% & 52 \tabularnewline 
 \bfseries  & 2030 & 157.4 & Mt CO$_2$eq & 0.2\% & 45 \tabularnewline \hline
 \bfseries GDP & 2017 & 134.4 & Billion 2011~GK\$ & 0.1\% & 76 \tabularnewline 
 \bfseries  & 2030 & 327.3 & Billion 2011~GK\$ & 0.1\% & 65 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.8 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 34 \tabularnewline 
 \bfseries per GDP & 2030 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 42 \tabularnewline \hline
 \bfseries Population & 2017 & 5.8 & Million Pers & 0.07\% & 114 \tabularnewline 
 \bfseries  & 2030 & 6.3 & Million Pers & 0.07\% & 115 \tabularnewline \hline
 \bfseries Emissions & 2017 & 18.8 & t CO$_2$eq /  Pers & 1.3\% & 14 \tabularnewline 
 \bfseries per capita & 2030 & 24.8 & t CO$_2$eq /  Pers & 1.7\% & 6 \tabularnewline 
 \end{tabular}
 \end{table}

 For Turkmenistan, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (86.2\%), followed by Agriculture (10.1\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  54.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (43.5\%)
 The total of F-gasesonly represented 0.2\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Energy sector, which contributed 34.7\% to Turkmenistan's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 59.5\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TKM/ts_emi_exclLU_TKM.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TKM/ts_gdp_pop_TKM.png}
 ...
 Turkmenistan's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Turkmenistan are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.0007~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 108.2~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -0.3--0.002~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TKM/ts_emi_onlyLU_TKM.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Turkmenistan's NDC (if needed). 
 ...
 Turkmenistan has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TKM/ts_pc_cov_TKM.png}
 \caption{Timeseries of Turkmenistan's national emissions (exclLU) and the share of emissions that is assumed to be covered by Turkmenistan's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Turkmenistan's 2017 emissions (exclLU, exclBunkers; total 108.2~Mt CO$_2$eq).
 ...
 LULUCF: NDC '/' and adapted '--' (estimated as a net source of 0.0007~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 51.4\% & \bfseries 34.7\% & \bfseries 0.09\% & / & / & / & / & 86.2\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 2.3\% & \bfseries 0.0\% & \bfseries 0.2\% & 0.2\% & / & / & / & 2.8\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.5\% & \bfseries 8.1\% & \bfseries 1.5\% & / & / & / & / & 10.1\% \tabularnewline 
 ...
 \bfseries Total &  &  & 54.2\% & 43.5\% & 2.1\% & 0.2\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TKM/ts_ndcs_quantis_TKM.png}
