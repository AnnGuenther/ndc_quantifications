\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} USA: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 6.5~Gt CO$_2$eq, USA contributed 13.7\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 12.0\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which USA is estimated to emit 6.7~Gt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 2.7\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 6.0--7.9~Gt CO$_2$eq in 2030, and 5.2--11.2~Gt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 120 in 2017, and 11 regarding the per-capita emissions (115 and 13 in 2030).
 In terms of accumulated historical emissions, USA contributed to the global 1850--2017 emissions by 24.1\%. 
 However, when only accounting for the years 1990--2017, its contribution decreases to 18.0\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for USA, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 6.5 & Gt CO$_2$eq & 13.7\% & 2 \tabularnewline 
 \bfseries  & 2030 & 6.7 & Gt CO$_2$eq & 12.0\% & 2 \tabularnewline \hline
 \bfseries GDP & 2017 & 18.0 & Trillion 2011~GK\$ & 16.1\% & 1 \tabularnewline 
 \bfseries  & 2030 & 23.7 & Trillion 2011~GK\$ & 13.2\% & 2 \tabularnewline \hline
 \bfseries Emissions & 2017 & 360.9 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 120 \tabularnewline 
 \bfseries per GDP & 2030 & 281.9 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 115 \tabularnewline \hline
 \bfseries Population & 2017 & 328.6 & Million Pers & 4.4\% & 3 \tabularnewline 
 \bfseries  & 2030 & 362.0 & Million Pers & 4.3\% & 3 \tabularnewline \hline
 \bfseries Emissions & 2017 & 19.8 & t CO$_2$eq /  Pers & 1.3\% & 11 \tabularnewline 
 \bfseries per capita & 2030 & 18.5 & t CO$_2$eq /  Pers & 1.3\% & 13 \tabularnewline 
 \end{tabular}
 \end{table}

 For USA, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (83.5\%), followed by Agriculture (8.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 81.8\% of the national emissions. 
 Second largest contributor was CH$_4$ (10.1\%)
 The total of F-gasesonly represented 2.4\%.
 The total CO$_2$ emissions are expected to be 80.1\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/USA/ts_emi_exclLU_USA.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/USA/ts_gdp_pop_USA.png}
 ...
 USA's population is assumed to grow towards 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for USA are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.7~Gt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 6.5~Gt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -0.8---0.6~Gt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/USA/ts_emi_onlyLU_USA.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of USA's NDC (if needed). 
 ...
 Table with the 'input' data and the resulting targets (like ndcs\_targets.csv, for SSP2 only?). \newline}Even though the USA has submitted an NDC to the UNFCCC, due to the initiated withdrawal from the Paris Agreement, the USA is no longer assessed as country with NDC.
 USA has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on USA's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & uncondi. & worst & 4588 Mt~CO$_2$eq AR4 & 2005 & 2025 & inclLU \tabularnewline 
 ABS & uncondi. & best & 4464 Mt~CO$_2$eq AR4 & 2005 & 2025 & inclLU \tabularnewline \hline
 RBY & uncondi. & worst & -26\% & 2005 & 2025 & inclLU \tabularnewline 
 RBY & uncondi. & best & -28\% & 2005 & 2025 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/USA/ts_pc_cov_USA.png}
 \caption{Timeseries of USA's national emissions (exclLU) and the share of emissions that is assumed to be covered by USA's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in USA's 2017 emissions (exclLU, exclBunkers; total 6.5~Gt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -0.7~Gt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 78.5\% & \bfseries 4.4\% & \bfseries 0.7\% & / & / & / & / & 83.5\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 3.1\% & \bfseries 0.0\% & \bfseries 0.3\% & \bfseries 2.2\% & \bfseries 0.06\% & \bfseries 0.09\% & \bfseries 0.0\% & 5.9\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 3.8\% & \bfseries 4.4\% & / & / & / & / & 8.3\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 1.9\% & \bfseries 0.1\% & / & / & / & / & 2.0\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries 0.0\% & \bfseries 0.0\% & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 81.8\% & 10.1\% & 5.8\% & 2.2\% & 0.06\% & 0.09\% & 0.0\% & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/USA/ts_ndcs_quantis_USA.png}
 ...
 \vspace{-.2cm} \item \href{https://www.nytimes.com/2020/09/22/climate/biden-climate-change.html?utm_campaign=Carbon\%20Brief\%20Daily\%20Briefing&utm_medium=email&utm_source=Revue\%20newsletter}{Democratic Donors Push Biden for a Cabinet Free of Fossil Fuel Connections} (September 2020)
 ...
 \vspace{-.2cm} \item \href{https://www.deccanherald.com/international/world-news-politics/joe-biden-vows-to-rejoin-paris-agreement-set-new-standards-887732.html}{Joe Biden vows to rejoin Paris Agreement, set new standards} (15 September 2020 )
 ...
 \vspace{-.2cm} \item \href{https://www.independent.co.uk/independentpremium/us/hawaii-tourists-beach-island-sea-level-rise-climate-change-oahu-b530969.html?utm_campaign=Carbon\%20Brief\%20Daily\%20Briefing&utm_medium=email&utm_source=Revue\%20newsletter}{Sea-level rise could claim 40\% of beaches on Hawaii's most visited island by 2050} (September 2020)
 ...
 \vspace{-.2cm} \item \href{https://www.carbonbrief.org/us-sees-alarming-increase-in-combined-heatwaves-and-droughts?utm_campaign=Carbon\%20Brief\%20Daily\%20Briefing&utm_medium=email&utm_source=Revue\%20newsletter}{US sees 'alarming' increase in combined heatwaves and droughts: Climate change has driven an 'alarming' increase in the number of years with both heatwaves and droughts across the US over the past five decades, a study finds.} (23 September 2020)
