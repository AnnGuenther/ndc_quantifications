\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Zambia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 41.1~Mt CO$_2$eq, Zambia contributed 0.08\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.1\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Zambia is estimated to emit 56.8~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 38.3\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 56.8--84.5~Mt CO$_2$eq in 2030, and 91.3--250.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 62 in 2017, and 150 regarding the per-capita emissions (79 and 150 in 2030).
 In terms of accumulated historical emissions, Zambia contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Zambia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 41.1 & Mt CO$_2$eq & 0.08\% & 94 \tabularnewline 
 \bfseries  & 2030 & 56.8 & Mt CO$_2$eq & 0.1\% & 88 \tabularnewline \hline
 \bfseries GDP & 2017 & 65.6 & Billion 2011~GK\$ & 0.05\% & 99 \tabularnewline 
 \bfseries  & 2030 & 156.9 & Billion 2011~GK\$ & 0.08\% & 87 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.6 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 62 \tabularnewline 
 \bfseries per GDP & 2030 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.4\% & 79 \tabularnewline \hline
 \bfseries Population & 2017 & 16.9 & Million Pers & 0.2\% & 68 \tabularnewline 
 \bfseries  & 2030 & 22.7 & Million Pers & 0.2\% & 61 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.4 & t CO$_2$eq /  Pers & 0.1\% & 150 \tabularnewline 
 \bfseries per capita & 2030 & 2.5 & t CO$_2$eq /  Pers & 0.1\% & 150 \tabularnewline 
 \end{tabular}
 \end{table}

 For Zambia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (67.7\%), followed by Energy (21.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  47.8\% of the national emissions. 
 Second largest contributor was N$_2$O (40.4\%)
 The total of F-gasesonly represented 0.002\%.
 The trend in total emissions is mostly driven by N$_2$O and CH$_4$ emissions from the Agriculture sector, which contributed 38.2\% and 29.5\% to Zambia's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 22.1\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ZMB/ts_emi_exclLU_ZMB.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ZMB/ts_gdp_pop_ZMB.png}
 ...
 Zambia's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Zambia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 421.9~Mt CO$_2$eq, which in absolute terms is higher than the non-LULUCF emissions of 41.1~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 342.7--531.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ZMB/ts_emi_onlyLU_ZMB.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Zambia's NDC (if needed). 
 ...
 Zambia has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Zambia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & worst & 0.0 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 42.89 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline \hline
 RBU & condi. & worst & -25\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -47\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ZMB/ts_pc_cov_ZMB.png}
 \caption{Timeseries of Zambia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Zambia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Zambia's 2017 emissions (exclLU, exclBunkers; total 41.1~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 421.9~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 9.1\% & \bfseries 11.1\% & \bfseries 0.8\% & / & / & / & / & 21.0\% \tabularnewline 
 \bfseries IPPU & / & -- & 2.7\% & / & 0.6\% & 0.0\% & / & / & / & 3.3\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries / & \bfseries 29.5\% & \bfseries 38.2\% & / & / & / & / & 67.7\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 7.2\% & \bfseries 0.3\% & / & / & / & / & 7.6\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 11.8\% & 47.8\% & 40.4\% & 0.0\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ZMB/ts_ndcs_quantis_ZMB.png}
