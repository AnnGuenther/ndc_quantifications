\documentclass[12pt]{article}
 ...
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Angola is estimated to emit 105.9~Mt CO$_2$eq in 2030.
 ...
 The country's global rank in terms of total emissions per unit of GDP was 55 in 2017, and 124 regarding the per-capita emissions (60 and 146 in 2030).
 ...
 For Angola, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (56.7\%), followed by Agriculture (36.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  41.9\% of the national emissions. 
 Second largest contributor was CO$_2$ (38.6\%)
 ...
 LULUCF emissions data for Angola are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 106.1~Mt CO$_2$eq, which in absolute terms is in the range of the non-LULUCF emissions of 100.5~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 89.2--132.8~Mt CO$_2$eq.
 ...
 ABS & condi. & best & 96.62 Mt~CO$_2$eq AR4 & 2030 & inclLU \tabularnewline \hline
