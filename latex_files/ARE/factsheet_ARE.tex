\documentclass[12pt]{article}
 ...
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which United Arab Emirates is estimated to emit 310.6~Mt CO$_2$eq in 2030.
 ...
 The country's global rank in terms of total emissions per unit of GDP was 98 in 2017, and 6 regarding the per-capita emissions (96 and 8 in 2030).
 ...
 For United Arab Emirates, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (83.5\%), followed by IPPU (10.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 80.3\% of the national emissions. 
 Second largest contributor was CH$_4$ (18.4\%)
 The total of F-gasesonly represented 0.7\%.
 ...
 LULUCF emissions data for United Arab Emirates are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 4, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -9.5~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 259.7~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -13.2---4.2~Mt CO$_2$eq.
