\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} United Arab Emirates: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 259.7~Mt CO$_2$eq, United Arab Emirates contributed 0.5\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.6\% (Table~\ref{tab:overview}).
 ...
 SSP5: Fossio-fuelled Development, Taking the Highway (high~/ low).} Middle of the Road marker scenario (dmSSP2), in which United Arab Emirates is estimated to emit 310.6~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 19.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 278.4--376.7~Mt CO$_2$eq in 2030, and 255.8--593.6~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP\footnote{\textbf{GDP}: Gross Domestic Product. 
 Throughout this document the GDP is given as GDP~PPP, with PPP being the Purchasing Power Parity.} was 98 in 2017, and 6 regarding the per-capita emissions (96 and 8 in 2030).
 In terms of accumulated historical emissions, United Arab Emirates contributed to the global 1850--2017 emissions by 0.2\%. 
 ...
 \begin{table}[htbp]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for United Arab Emirates, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 259.7 & Mt CO$_2$eq & 0.5\% & 33 \tabularnewline 
 \bfseries  & 2030 & 310.6 & Mt CO$_2$eq & 0.6\% & 32 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.6 & Trillion 2011~GK\$ & 0.5\% & 34 \tabularnewline 
 \bfseries  & 2030 & 1.0 & Trillion 2011~GK\$ & 0.5\% & 35 \tabularnewline \hline
 \bfseries Emissions & 2017 & 435.7 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 98 \tabularnewline 
 \bfseries per GDP & 2030 & 319.9 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 96 \tabularnewline \hline
 \bfseries Population & 2017 & 9.5 & Million Pers & 0.1\% & 94 \tabularnewline 
 \bfseries  & 2030 & 12.9 & Million Pers & 0.1\% & 81 \tabularnewline \hline
 \bfseries Emissions & 2017 & 27.4 & t CO$_2$eq /  Pers & 1.9\% & 6 \tabularnewline 
 \bfseries per capita & 2030 & 24.0 & t CO$_2$eq /  Pers & 1.6\% & 8 \tabularnewline 
 \end{tabular}
 \end{table}

 For United Arab Emirates, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (83.5\%), followed by IPPU (10.2\%), and Waste (5.5\%). 
 The Kyoto~GHG\footnote{\textbf{Kyoto~GHG} (Greenhouse Gas) basket: carbon dioxide (CO$_2$), methane (CH$_4$), nitrous oxide (N$_2$O), hydrofluorocarbons (HFCs), perfluorocarbons (PFCs), sulfur hexafluoride (SF$_6$), and nitrogen trifluoride (NF$_3$).} with the highest emissions in 2017 was CO$_2$, constituting as much as 80.3\% of the national emissions. 
 Second largest contributor was CH$_4$ (18.4\%), followed by N$_2$O (0.7\%). 
 The total of F-gases\footnote{\textbf{F-gases} (fluorinated gases): basket of HFCs, PFCs, and the gases SF$_6$ and NF$_3$. 
 Some F-gases have very long atmospheric lifetimes and high Global Warming Potentials.} only represented 0.7\%.
 The total CO$_2$ emissions are expected to be 84.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[htbp]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ARE/ts_emi_exclLU_ARE.png}
 ...
 \begin{figure}[htbp]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ARE/ts_gdp_pop_ARE.png}
 ...
 United Arab Emirates's population is assumed to grow towards 2050, and the per capita emissions are expected to decline towars 2050. 

 %%%
 \section{LULUCF emissions}
 \label{sec:emiLULUCF}
 LULUCF emissions data for United Arab Emirates are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019), FAO (2019).

 \textbf{High fluctuations? Data gaps? Difference between sources?}

 \begin{figure}[htbp]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ARE/ts_emi_onlyLU_ARE.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of United Arab Emirates's NDC (if needed). 
 ...
 United Arab Emirates has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[htbp]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ARE/ts_pc_cov_ARE.png}
 \caption{Timeseries of United Arab Emirates's national emissions (exclLU) and the share of emissions that is assumed to be covered by United Arab Emirates's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[htbp]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in United Arab Emirates's 2017 emissions (exclLU, exclBunkers; total 259.7~Mt CO$_2$eq).
 ...
 LULUCF: NDC '/' and adapted '--' (estimated as a net sink of -9.5~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 70.9\% & \bfseries 12.6\% & \bfseries 0.0\% & / & / & / & / & 83.5\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 9.3\% & \bfseries 0.0\% & \bfseries 0.1\% & / & 0.2\% & 0.4\% & / & 10.2\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.0\% & 0.4\% & 0.04\% & / & / & / & / & 0.4\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 5.4\% & \bfseries 0.1\% & / & / & / & / & 5.5\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 80.3\% & 18.4\% & 0.7\% & / & 0.2\% & 0.4\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[htbp]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ARE/ts_ndcs_quantis_ARE.png}
