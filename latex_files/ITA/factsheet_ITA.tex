\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Italy: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 432.7~Mt CO$_2$eq, Italy contributed 0.9\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.7\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Italy is estimated to emit 416.7~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -3.7\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 349.0--487.5~Mt CO$_2$eq in 2030, and 351.2--845.8~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 184 in 2017, and 72 regarding the per-capita emissions (182 and 82 in 2030).
 In terms of accumulated historical emissions, Italy contributed to the global 1850--2017 emissions by 1.3\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Italy, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 432.7 & Mt CO$_2$eq & 0.9\% & 21 \tabularnewline 
 \bfseries  & 2030 & 416.7 & Mt CO$_2$eq & 0.7\% & 26 \tabularnewline \hline
 \bfseries GDP & 2017 & 2.3 & Trillion 2011~GK\$ & 2.1\% & 12 \tabularnewline 
 \bfseries  & 2030 & 2.6 & Trillion 2011~GK\$ & 1.4\% & 14 \tabularnewline \hline
 \bfseries Emissions & 2017 & 187.2 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 184 \tabularnewline 
 \bfseries per GDP & 2030 & 160.0 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 182 \tabularnewline \hline
 \bfseries Population & 2017 & 60.7 & Million Pers & 0.8\% & 23 \tabularnewline 
 \bfseries  & 2030 & 61.3 & Million Pers & 0.7\% & 26 \tabularnewline \hline
 \bfseries Emissions & 2017 & 7.1 & t CO$_2$eq /  Pers & 0.4\% & 72 \tabularnewline 
 \bfseries per capita & 2030 & 6.8 & t CO$_2$eq /  Pers & 0.4\% & 82 \tabularnewline 
 \end{tabular}
 \end{table}

 For Italy, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (79.9\%), followed by IPPU (8.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 81.6\% of the national emissions. 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ITA/ts_emi_exclLU_ITA.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ITA/ts_gdp_pop_ITA.png}
 ...
 Italy's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Italy are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -18.4~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 432.7~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -39.6---1.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ITA/ts_emi_onlyLU_ITA.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Italy's NDC (if needed). 
 ...
 Italy has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Italy's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Italy is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ITA/ts_pc_cov_ITA.png}
 \caption{Timeseries of Italy's national emissions (exclLU) and the share of emissions that is assumed to be covered by Italy's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Italy's 2017 emissions (exclLU, exclBunkers; total 432.7~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -18.4~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 77.1\% & \bfseries 1.8\% & \bfseries 1.1\% & / & / & / & / & 79.9\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 4.4\% & \bfseries 0.01\% & \bfseries 0.1\% & \bfseries 3.5\% & \bfseries 0.3\% & \bfseries 0.09\% & \bfseries 0.0\% & 8.5\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 4.6\% & \bfseries 2.5\% & / & / & / & / & 7.1\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.02\% & \bfseries 3.8\% & \bfseries 0.4\% & / & / & / & / & 4.2\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 81.6\% & 10.1\% & 4.4\% & 3.5\% & 0.3\% & 0.09\% & 0.0\% & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ITA/ts_ndcs_quantis_ITA.png}
