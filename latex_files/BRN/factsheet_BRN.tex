\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Brunei: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 17.6~Mt CO$_2$eq, Brunei contributed 0.03\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.02\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Brunei is estimated to emit 15.1~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial decrease of -14.4\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 13.2--16.5~Mt CO$_2$eq in 2030, and 9.6--16.6~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 41 in 2017, and 3 regarding the per-capita emissions (54 and 5 in 2030).
 In terms of accumulated historical emissions, Brunei contributed to the global 1850--2017 emissions by 0.06\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Brunei, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 17.6 & Mt CO$_2$eq & 0.03\% & 124 \tabularnewline 
 \bfseries  & 2030 & 15.1 & Mt CO$_2$eq & 0.02\% & 136 \tabularnewline \hline
 \bfseries GDP & 2017 & 23.1 & Billion 2011~GK\$ & 0.02\% & 138 \tabularnewline 
 \bfseries  & 2030 & 34.4 & Billion 2011~GK\$ & 0.01\% & 147 \tabularnewline \hline
 \bfseries Emissions & 2017 & 763.9 & t CO$_2$eq / Million 2011~GK\$ & 0.7\% & 41 \tabularnewline 
 \bfseries per GDP & 2030 & 438.1 & t CO$_2$eq / Million 2011~GK\$ & 0.6\% & 54 \tabularnewline \hline
 \bfseries Population & 2017 & 424.5 & Thousand Pers & 0.005\% & 171 \tabularnewline 
 \bfseries  & 2030 & 501.0 & Thousand Pers & 0.005\% & 170 \tabularnewline \hline
 \bfseries Emissions & 2017 & 41.5 & t CO$_2$eq /  Pers & 2.8\% & 3 \tabularnewline 
 \bfseries per capita & 2030 & 30.1 & t CO$_2$eq /  Pers & 2.0\% & 5 \tabularnewline 
 \end{tabular}
 \end{table}

 For Brunei, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (93.2\%), followed by IPPU (5.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  61.3\% of the national emissions. 
 Second largest contributor was CH$_4$ (33.7\%)
 The total of F-gasesonly represented 4.1\%.
 The total CO$_2$ emissions are expected to be 59.8\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BRN/ts_emi_exclLU_BRN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BRN/ts_gdp_pop_BRN.png}
 ...
 Brunei's population is assumed to grow towards 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Brunei are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.6~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 17.6~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 0.3--6.4~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BRN/ts_emi_onlyLU_BRN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Brunei's NDC (if needed). 
 ...
 Brunei has an INDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BRN/ts_pc_cov_BRN.png}
 \caption{Timeseries of Brunei's national emissions (exclLU) and the share of emissions that is assumed to be covered by Brunei's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from INDC and adapted ('Adap.': used to calculate \%cov), and their shares in Brunei's 2017 emissions (exclLU, exclBunkers; total 17.6~Mt CO$_2$eq).
 ...
 LULUCF: INDC '+' and adapted '+' (estimated as a net source of 0.6~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 60.1\% & \bfseries 33.0\% & 0.1\% & / & / & / & / & 93.2\% \tabularnewline 
 \bfseries IPPU & / & -- & 1.1\% & / & 0.0\% & 4.1\% & / & / & / & 5.2\% \tabularnewline 
 \bfseries Agri. & / & -- & / & 0.1\% & 0.6\% & / & / & / & / & 0.7\% \tabularnewline 
 \bfseries Waste & / & -- & 0.01\% & 0.6\% & 0.04\% & / & / & / & / & 0.7\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 61.3\% & 33.7\% & 0.9\% & 4.1\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BRN/ts_ndcs_quantis_BRN.png}
