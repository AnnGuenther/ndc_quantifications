\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Samoa: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 527.3~kt CO$_2$eq, Samoa contributed 0.001\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.0008\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Samoa is estimated to emit 452.8~kt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial decrease of -14.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 452.8--452.8~kt CO$_2$eq in 2030, and 528.5--528.5~kt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 97 in 2017, and 143 regarding the per-capita emissions (113 and 160 in 2030).
 In terms of accumulated historical emissions, Samoa contributed to the global 1850--2017 emissions by 0.0008\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.0009\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Samoa, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 527.3 & kt CO$_2$eq & 0.001\% & 182 \tabularnewline 
 \bfseries  & 2030 & 452.8 & kt CO$_2$eq & 0.0008\% & 183 \tabularnewline \hline
 \bfseries GDP & 2017 & 1.2 & Billion 2011~GK\$ & 0.001\% & 184 \tabularnewline 
 \bfseries  & 2030 & 1.6 & Billion 2011~GK\$ & 0.0008\% & 182 \tabularnewline \hline
 \bfseries Emissions & 2017 & 444.7 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 97 \tabularnewline 
 \bfseries per GDP & 2030 & 286.3 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 113 \tabularnewline \hline
 \bfseries Population & 2017 & 195.4 & Thousand Pers & 0.002\% & 179 \tabularnewline 
 \bfseries  & 2030 & 204.3 & Thousand Pers & 0.002\% & 178 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.7 & t CO$_2$eq /  Pers & 0.1\% & 143 \tabularnewline 
 \bfseries per capita & 2030 & 2.2 & t CO$_2$eq /  Pers & 0.1\% & 160 \tabularnewline 
 \end{tabular}
 \end{table}

 For Samoa, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (53.7\%), followed by Agriculture (37.1\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  51.7\% of the national emissions. 
 Second largest contributor was CH$_4$ (37.4\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 52.5\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/WSM/ts_emi_exclLU_WSM.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/WSM/ts_gdp_pop_WSM.png}
 ...
 Samoa's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Samoa are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -77.7~kt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 527.3~kt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -2089.6--6.4~kt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/WSM/ts_emi_onlyLU_WSM.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Samoa's NDC (if needed). 
 ...
 Samoa has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Samoa's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 RBU & condi. & best & -13\% & 2025 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/WSM/ts_pc_cov_WSM.png}
 \caption{Timeseries of Samoa's national emissions (exclLU) and the share of emissions that is assumed to be covered by Samoa's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Samoa's 2017 emissions (exclLU, exclBunkers; total 527.3~kt CO$_2$eq).
 ...
 LULUCF: NDC '/' and adapted '--' (estimated as a net sink of -77.7~kt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 51.5\% & 1.8\% & 0.3\% & / & / & / & / & 53.7\% \tabularnewline 
 \bfseries IPPU & / & \bfseries + & \bfseries 0.2\% & / & 0.2\% & / & / & / & / & 0.4\% \tabularnewline 
 \bfseries Agri. & / & \bfseries + & \bfseries / & 27.8\% & 9.3\% & / & / & / & / & 37.1\% \tabularnewline 
 \bfseries Waste & / & \bfseries + & \bfseries / & 7.8\% & 0.6\% & / & / & / & / & 8.4\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & / & 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 51.7\% & 37.4\% & 10.9\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/WSM/ts_ndcs_quantis_WSM.png}
