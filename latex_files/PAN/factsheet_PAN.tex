\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Panama: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 15.6~Mt CO$_2$eq, Panama contributed 0.03\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.04\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Panama is estimated to emit 26.5~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 70.4\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 22.9--30.8~Mt CO$_2$eq in 2030, and 31.8--52.0~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 189 in 2017, and 116 regarding the per-capita emissions (179 and 99 in 2030).
 In terms of accumulated historical emissions, Panama contributed to the global 1850--2017 emissions by 0.02\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Panama, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 15.6 & Mt CO$_2$eq & 0.03\% & 130 \tabularnewline 
 \bfseries  & 2030 & 26.5 & Mt CO$_2$eq & 0.04\% & 115 \tabularnewline \hline
 \bfseries GDP & 2017 & 89.0 & Billion 2011~GK\$ & 0.07\% & 86 \tabularnewline 
 \bfseries  & 2030 & 161.1 & Billion 2011~GK\$ & 0.08\% & 86 \tabularnewline \hline
 \bfseries Emissions & 2017 & 175.0 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 189 \tabularnewline 
 \bfseries per GDP & 2030 & 164.7 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 179 \tabularnewline \hline
 \bfseries Population & 2017 & 4.1 & Million Pers & 0.05\% & 128 \tabularnewline 
 \bfseries  & 2030 & 4.7 & Million Pers & 0.05\% & 128 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.8 & t CO$_2$eq /  Pers & 0.2\% & 116 \tabularnewline 
 \bfseries per capita & 2030 & 5.6 & t CO$_2$eq /  Pers & 0.3\% & 99 \tabularnewline 
 \end{tabular}
 \end{table}

 For Panama, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (65.9\%), followed by Agriculture (22.4\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 70.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (21.0\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 73.2\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PAN/ts_emi_exclLU_PAN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PAN/ts_gdp_pop_PAN.png}
 ...
 Panama's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Panama are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 8.4~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 15.6~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 8.2--9.6~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PAN/ts_emi_onlyLU_PAN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Panama's NDC (if needed). 
 ...
 Panama has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PAN/ts_pc_cov_PAN.png}
 \caption{Timeseries of Panama's national emissions (exclLU) and the share of emissions that is assumed to be covered by Panama's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Panama's 2017 emissions (exclLU, exclBunkers; total 15.6~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 8.4~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 64.5\% & 0.9\% & 0.4\% & / & / & / & / & 65.9\% \tabularnewline 
 \bfseries IPPU & / & -- & 5.7\% & / & 0.0\% & / & / & / & / & 5.7\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.0\% & 15.2\% & 7.2\% & / & / & / & / & 22.4\% \tabularnewline 
 \bfseries Waste & / & -- & / & 4.9\% & 0.3\% & / & / & / & / & 5.3\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.7\% & / & / & / & / & 0.7\% \tabularnewline \hline
 \bfseries Total &  &  & 70.2\% & 21.0\% & 8.8\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PAN/ts_ndcs_quantis_PAN.png}
