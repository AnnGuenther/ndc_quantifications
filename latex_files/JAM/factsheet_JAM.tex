\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Jamaica: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 10.1~Mt CO$_2$eq, Jamaica contributed 0.02\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.01\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Jamaica is estimated to emit 9.2~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -9.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 9.1--10.9~Mt CO$_2$eq in 2030, and 10.5--13.1~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 92 in 2017, and 121 regarding the per-capita emissions (91 and 136 in 2030).
 In terms of accumulated historical emissions, Jamaica contributed to the global 1850--2017 emissions by 0.02\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Jamaica, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 10.1 & Mt CO$_2$eq & 0.02\% & 146 \tabularnewline 
 \bfseries  & 2030 & 9.2 & Mt CO$_2$eq & 0.01\% & 151 \tabularnewline \hline
 \bfseries GDP & 2017 & 22.1 & Billion 2011~GK\$ & 0.01\% & 141 \tabularnewline 
 \bfseries  & 2030 & 27.6 & Billion 2011~GK\$ & 0.01\% & 148 \tabularnewline \hline
 \bfseries Emissions & 2017 & 458.5 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 92 \tabularnewline 
 \bfseries per GDP & 2030 & 333.9 & t CO$_2$eq / Million 2011~GK\$ & 0.4\% & 91 \tabularnewline \hline
 \bfseries Population & 2017 & 2.9 & Million Pers & 0.03\% & 137 \tabularnewline 
 \bfseries  & 2030 & 3.0 & Million Pers & 0.03\% & 137 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.5 & t CO$_2$eq /  Pers & 0.2\% & 121 \tabularnewline 
 \bfseries per capita & 2030 & 3.1 & t CO$_2$eq /  Pers & 0.2\% & 136 \tabularnewline 
 \end{tabular}
 \end{table}

 For Jamaica, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (79.6\%), followed by Waste (8.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 76.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (17.8\%)
 The total of F-gasesonly represented 1.4\%.
 The total CO$_2$ emissions are expected to be 74.9\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/JAM/ts_emi_exclLU_JAM.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/JAM/ts_gdp_pop_JAM.png}
 ...
 Jamaica's population is assumed to grow after 2017 but to diminish again before 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Jamaica are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.4~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 10.1~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 0.3--0.7~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/JAM/ts_emi_onlyLU_JAM.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Jamaica's NDC (if needed). 
 ...
 Jamaica has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Jamaica's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 RBU & uncondi. & best & -8.0\% & 2025 & exclLU \tabularnewline 
 RBU & condi. & best & -10.0\% & 2025 & exclLU \tabularnewline 
 RBU & uncondi. & best & -7.8\% & 2030 & exclLU \tabularnewline 
 RBU & condi. & best & -10.0\% & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/JAM/ts_pc_cov_JAM.png}
 \caption{Timeseries of Jamaica's national emissions (exclLU) and the share of emissions that is assumed to be covered by Jamaica's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Jamaica's 2017 emissions (exclLU, exclBunkers; total 10.1~Mt CO$_2$eq).
 ...
 LULUCF: NDC '/' and adapted '--' (estimated as a net source of 0.4~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 72.2\% & \bfseries 6.6\% & \bfseries 0.8\% & / & / & / & / & 79.6\% \tabularnewline 
 \bfseries IPPU & / & -- & 4.0\% & / & 0.0\% & 1.4\% & / & / & / & 5.3\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.03\% & 2.9\% & 2.8\% & / & / & / & / & 5.7\% \tabularnewline 
 \bfseries Waste & / & -- & / & 8.2\% & 0.4\% & / & / & / & / & 8.6\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.7\% & / & / & / & / & 0.7\% \tabularnewline \hline
 \bfseries Total &  &  & 76.2\% & 17.8\% & 4.7\% & 1.4\% & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/JAM/ts_ndcs_quantis_JAM.png}
