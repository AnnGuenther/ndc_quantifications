\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Bahrain: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 33.7~Mt CO$_2$eq, Bahrain contributed 0.07\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.08\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Bahrain is estimated to emit 48.2~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 43.3\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 43.3--55.7~Mt CO$_2$eq in 2030, and 45.1--91.2~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 65 in 2017, and 8 regarding the per-capita emissions (50 and 7 in 2030).
 In terms of accumulated historical emissions, Bahrain contributed to the global 1850--2017 emissions by 0.04\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Bahrain, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 33.7 & Mt CO$_2$eq & 0.07\% & 103 \tabularnewline 
 \bfseries  & 2030 & 48.2 & Mt CO$_2$eq & 0.08\% & 101 \tabularnewline \hline
 \bfseries GDP & 2017 & 55.5 & Billion 2011~GK\$ & 0.04\% & 105 \tabularnewline 
 \bfseries  & 2030 & 105.2 & Billion 2011~GK\$ & 0.05\% & 102 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.6 & t CO$_2$eq / Thousand 2011~GK\$ & 0.5\% & 65 \tabularnewline 
 \bfseries per GDP & 2030 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 50 \tabularnewline \hline
 \bfseries Population & 2017 & 1.5 & Million Pers & 0.01\% & 150 \tabularnewline 
 \bfseries  & 2030 & 2.0 & Million Pers & 0.02\% & 149 \tabularnewline \hline
 \bfseries Emissions & 2017 & 22.5 & t CO$_2$eq /  Pers & 1.5\% & 8 \tabularnewline 
 \bfseries per capita & 2030 & 24.2 & t CO$_2$eq /  Pers & 1.6\% & 7 \tabularnewline 
 \end{tabular}
 \end{table}

 For Bahrain, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (85.9\%), followed by IPPU (11.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 79.0\% of the national emissions. 
 Second largest contributor was CH$_4$ (19.4\%)
 The total of F-gasesonly represented 1.1\%.
 The total CO$_2$ emissions are expected to be 83.6\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BHR/ts_emi_exclLU_BHR.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BHR/ts_gdp_pop_BHR.png}
 ...
 Bahrain's population is assumed to grow towards 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 

 LULUCF emissions data for Bahrain are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.0~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 33.7~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -0.0--0.0009~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BHR/ts_emi_onlyLU_BHR.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Bahrain's NDC (if needed). 
 ...
 Bahrain has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BHR/ts_pc_cov_BHR.png}
 \caption{Timeseries of Bahrain's national emissions (exclLU) and the share of emissions that is assumed to be covered by Bahrain's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Bahrain's 2017 emissions (exclLU, exclBunkers; total 33.7~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 68.9\% & \bfseries 17.0\% & \bfseries 0.08\% & / & / & / & / & 85.9\% \tabularnewline 
 \bfseries IPPU & / & -- & 10.1\% & 0.05\% & 0.2\% & / & 1.1\% & / & / & 11.5\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.0\% & 0.05\% & 0.04\% & / & / & / & / & 0.1\% \tabularnewline 
 \bfseries Waste & / & -- & / & 2.3\% & 0.01\% & / & / & / & / & 2.3\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 79.0\% & 19.4\% & 0.5\% & / & 1.1\% & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BHR/ts_ndcs_quantis_BHR.png}
