\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Liechtenstein: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 208.2~kt CO$_2$eq, Liechtenstein contributed 0.0004\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 0.0003\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Liechtenstein is estimated to emit 220.4~kt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 5.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 220.4--220.4~kt CO$_2$eq in 2030, and 220.4--220.4~kt CO$_2$eq in 2050.
 The country's global rank in terms of total per-capita emissions was 96 in 2017 (95 in 2030).
 In terms of accumulated historical emissions, Liechtenstein contributed to the global 1850--2017 emissions by 0.0007\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 0.0006\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Liechtenstein, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 208.2 & kt CO$_2$eq & 0.0004\% & 196 \tabularnewline 
 \bfseries  & 2030 & 220.4 & kt CO$_2$eq & 0.0003\% & 193 \tabularnewline \hline
 ...
 \bfseries Population & 2017 & 37.8 & Thousand Pers & 0.0005\% & 194 \tabularnewline 
 \bfseries  & 2030 & 37.3 & Thousand Pers & 0.0004\% & 194 \tabularnewline \hline
 \bfseries Emissions & 2017 & 5.5 & t CO$_2$eq /  Pers & 0.3\% & 96 \tabularnewline 
 \bfseries per capita & 2030 & 5.9 & t CO$_2$eq /  Pers & 0.4\% & 95 \tabularnewline 
 \end{tabular}
 \end{table}

 For Liechtenstein, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (75.6\%), followed by IPPU (12.1\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 81.1\% of the national emissions. 
 Second largest contributor was CH$_4$ (8.7\%)
 The total of F-gasesonly represented 5.2\%.
 The total CO$_2$ emissions are expected to be 81.8\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LIE/ts_emi_exclLU_LIE.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LIE/ts_gdp_pop_LIE.png}
 ...
 Liechtenstein's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase after 2017 but to decline again before 2050. 
 For Liechtenstein, no GDP data are available from dmSSPs.

 LULUCF emissions data for Liechtenstein are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net source of 10.5~kt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 208.2~kt CO$_2$eq.
 The large emissions range for CRF (2019) and 1990--2017 is -9.1--24.8~kt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LIE/ts_emi_onlyLU_LIE.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Liechtenstein's NDC (if needed). 
 ...
 Liechtenstein has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Liechtenstein's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & uncondi. & best & 0.13 Mt~CO$_2$eq & 1990 & 2030 & inclLU \tabularnewline \hline
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LIE/ts_pc_cov_LIE.png}
 \caption{Timeseries of Liechtenstein's national emissions (exclLU) and the share of emissions that is assumed to be covered by Liechtenstein's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Liechtenstein's 2017 emissions (exclLU, exclBunkers; total 208.2~kt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 10.5~kt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 74.4\% & \bfseries 0.8\% & \bfseries 0.4\% & / & / & / & / & 75.6\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 6.6\% & \bfseries 0.0\% & \bfseries 0.2\% & \bfseries 5.1\% & \bfseries 0.0\% & \bfseries 0.02\% & \bfseries / & 12.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.02\% & \bfseries 7.5\% & \bfseries 3.8\% & / & / & / & / & 11.3\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 0.4\% & \bfseries 0.3\% & / & / & / & / & 0.8\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 81.1\% & 8.7\% & 5.1\% & 5.1\% & 0.0\% & 0.02\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LIE/ts_ndcs_quantis_LIE.png}
