\documentclass[12pt]{article}
 ...
 \label{sec:emiLULUCF}
 LULUCF emissions data for Liechtenstein are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019), CRF (2018), FAO (2019).
 ...
 ABS & uncondi. & best & 0.13 Mt~CO$_2$eq & 1990 & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}
