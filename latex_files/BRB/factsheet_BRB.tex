\documentclass[12pt]{article}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BRB/ts_emi_exclLU_BRB.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BRB/ts_gdp_pop_BRB.png}
 ...
 LULUCF emissions data for Barbados are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.01~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 1.5~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is -0.0--0.07~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BRB/ts_emi_onlyLU_BRB.png}
 ...
 ABS & condi. & best & 1.40 Mt~CO$_2$eq AR4 & 2008 & 2030 & inclLU \tabularnewline \hline
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BRB/ts_pc_cov_BRB.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BRB/ts_ndcs_quantis_BRB.png}
