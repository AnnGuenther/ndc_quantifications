\documentclass[12pt]{article}
 ...
 LULUCF emissions data for Burundi are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 3.0~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 6.5~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is -0.5--9.5~Mt CO$_2$eq.
 ...
 ABS & condi. & best & 59.58 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline \hline
