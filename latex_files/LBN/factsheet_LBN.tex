\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Lebanon: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 22.9~Mt CO$_2$eq, Lebanon contributed 0.04\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.05\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Lebanon is estimated to emit 32.4~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 41.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 28.4--36.2~Mt CO$_2$eq in 2030, and 29.0--59.3~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 165 in 2017, and 126 regarding the per-capita emissions (148 and 114 in 2030).
 In terms of accumulated historical emissions, Lebanon contributed to the global 1850--2017 emissions by 0.04\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Lebanon, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 22.9 & Mt CO$_2$eq & 0.04\% & 115 \tabularnewline 
 \bfseries  & 2030 & 32.4 & Mt CO$_2$eq & 0.05\% & 113 \tabularnewline \hline
 \bfseries GDP & 2017 & 90.7 & Billion 2011~GK\$ & 0.08\% & 84 \tabularnewline 
 \bfseries  & 2030 & 148.3 & Billion 2011~GK\$ & 0.08\% & 89 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.2 & t CO$_2$eq / Thousand 2011~GK\$ & 0.2\% & 165 \tabularnewline 
 \bfseries per GDP & 2030 & 0.2 & t CO$_2$eq / Thousand 2011~GK\$ & 0.2\% & 148 \tabularnewline \hline
 \bfseries Population & 2017 & 6.8 & Million Pers & 0.09\% & 108 \tabularnewline 
 \bfseries  & 2030 & 7.4 & Million Pers & 0.08\% & 108 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.4 & t CO$_2$eq /  Pers & 0.2\% & 126 \tabularnewline 
 \bfseries per capita & 2030 & 4.4 & t CO$_2$eq /  Pers & 0.2\% & 114 \tabularnewline 
 \end{tabular}
 \end{table}

 For Lebanon, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (68.2\%), followed by Waste (14.8\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 77.4\% of the national emissions. 
 Second largest contributor was CH$_4$ (16.0\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 85.8\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LBN/ts_emi_exclLU_LBN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LBN/ts_gdp_pop_LBN.png}
 ...
 Lebanon's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Lebanon are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 5, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -3.1~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 22.9~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -3.4--0.2~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LBN/ts_emi_onlyLU_LBN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Lebanon's NDC (if needed). 
 ...
 Lebanon has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Lebanon's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 36.97 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 30.44 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline \hline
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LBN/ts_pc_cov_LBN.png}
 \caption{Timeseries of Lebanon's national emissions (exclLU) and the share of emissions that is assumed to be covered by Lebanon's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Lebanon's 2017 emissions (exclLU, exclBunkers; total 22.9~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 66.9\% & \bfseries 0.3\% & \bfseries 1.0\% & / & / & / & / & 68.2\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 10.4\% & \bfseries / & \bfseries 1.0\% & / & / & / & / & 11.4\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 1.5\% & \bfseries 3.1\% & / & / & / & / & 4.8\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 14.1\% & \bfseries 0.7\% & / & / & / & / & 14.8\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.7\% & / & / & / & / & 0.7\% \tabularnewline \hline
 \bfseries Total &  &  & 77.4\% & 16.0\% & 6.6\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LBN/ts_ndcs_quantis_LBN.png}
