\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Eswatini: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 2.8~Mt CO$_2$eq, Eswatini contributed 0.005\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Eswatini is estimated to emit 2.9~Mt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 1.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 2.7--3.8~Mt CO$_2$eq in 2030, and 3.2--9.8~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 153 in 2017, and 148 regarding the per-capita emissions (175 and 159 in 2030).
 In terms of accumulated historical emissions, Eswatini contributed to the global 1850--2017 emissions by 0.006\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Eswatini, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 2.8 & Mt CO$_2$eq & 0.005\% & 165 \tabularnewline 
 \bfseries  & 2030 & 2.9 & Mt CO$_2$eq & 0.005\% & 168 \tabularnewline \hline
 \bfseries GDP & 2017 & 10.5 & Billion 2011~GK\$ & 0.009\% & 156 \tabularnewline 
 \bfseries  & 2030 & 15.4 & Billion 2011~GK\$ & 0.008\% & 157 \tabularnewline \hline
 \bfseries Emissions & 2017 & 268.7 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 153 \tabularnewline 
 \bfseries per GDP & 2030 & 184.8 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 175 \tabularnewline \hline
 \bfseries Population & 2017 & 1.1 & Million Pers & 0.01\% & 157 \tabularnewline 
 \bfseries  & 2030 & 1.2 & Million Pers & 0.01\% & 157 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.5 & t CO$_2$eq /  Pers & 0.1\% & 148 \tabularnewline 
 \bfseries per capita & 2030 & 2.3 & t CO$_2$eq /  Pers & 0.1\% & 159 \tabularnewline 
 \end{tabular}
 \end{table}

 For Eswatini, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (55.7\%), followed by Agriculture (35.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  48.0\% of the national emissions. 
 Second largest contributor was CH$_4$ (36.6\%)
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SWZ/ts_emi_exclLU_SWZ.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SWZ/ts_gdp_pop_SWZ.png}
 ...
 Eswatini's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Eswatini are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.1~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 2.8~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 0.1--0.3~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SWZ/ts_emi_onlyLU_SWZ.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Eswatini's NDC (if needed). 
 ...
 Eswatini has an NDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 The reclassified target type is ABU (absolute reduction compared to Business-As-Usual).

 \begin{table}[H]
 \centering
 \caption{Information on Eswatini's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABU & condi. & best & -0.96 Mt~CO$_2$eq AR4 & 2010 & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SWZ/ts_pc_cov_SWZ.png}
 \caption{Timeseries of Eswatini's national emissions (exclLU) and the share of emissions that is assumed to be covered by Eswatini's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Eswatini's 2017 emissions (exclLU, exclBunkers; total 2.8~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 47.8\% & \bfseries 7.3\% & \bfseries 0.6\% & / & / & / & / & 55.7\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries / & \bfseries 0.2\% & \bfseries / & \bfseries / & \bfseries / & / & 0.4\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.0\% & 21.9\% & 13.7\% & / & / & / & / & 35.5\% \tabularnewline 
 \bfseries Waste & / & -- & / & 7.4\% & 0.4\% & / & / & / & / & 7.9\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 48.0\% & 36.6\% & 15.4\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SWZ/ts_ndcs_quantis_SWZ.png}
