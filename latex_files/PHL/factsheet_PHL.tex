\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Philippines: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 228.6~Mt CO$_2$eq, Philippines contributed 0.4\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Philippines is estimated to emit 257.2~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 12.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 226.8--290.7~Mt CO$_2$eq in 2030, and 312.5--609.8~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 146 in 2017, and 161 regarding the per-capita emissions (167 and 168 in 2030).
 In terms of accumulated historical emissions, Philippines contributed to the global 1850--2017 emissions by 0.3\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Philippines, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 228.6 & Mt CO$_2$eq & 0.4\% & 37 \tabularnewline 
 \bfseries  & 2030 & 257.2 & Mt CO$_2$eq & 0.4\% & 37 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.8 & Trillion 2011~GK\$ & 0.7\% & 28 \tabularnewline 
 \bfseries  & 2030 & 1.3 & Trillion 2011~GK\$ & 0.7\% & 28 \tabularnewline \hline
 \bfseries Emissions & 2017 & 291.0 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 146 \tabularnewline 
 \bfseries per GDP & 2030 & 191.8 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 167 \tabularnewline \hline
 \bfseries Population & 2017 & 105.2 & Million Pers & 1.4\% & 13 \tabularnewline 
 \bfseries  & 2030 & 126.0 & Million Pers & 1.5\% & 12 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.2 & t CO$_2$eq /  Pers & 0.1\% & 161 \tabularnewline 
 \bfseries per capita & 2030 & 2.0 & t CO$_2$eq /  Pers & 0.1\% & 168 \tabularnewline 
 \end{tabular}
 \end{table}

 For Philippines, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (58.1\%), followed by Agriculture (27.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  58.5\% of the national emissions. 
 Second largest contributor was CH$_4$ (35.3\%)
 The total of F-gasesonly represented 0.1\%.
 The total CO$_2$ emissions are expected to be 60.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PHL/ts_emi_exclLU_PHL.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PHL/ts_gdp_pop_PHL.png}
 ...
 Philippines's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Philippines are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -47.1~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 228.6~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -60.2--30.3~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PHL/ts_emi_onlyLU_PHL.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Philippines's NDC (if needed). 
 ...
 Philippines has an INDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Philippines's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 RBU & condi. & best & -70\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PHL/ts_pc_cov_PHL.png}
 \caption{Timeseries of Philippines's national emissions (exclLU) and the share of emissions that is assumed to be covered by Philippines's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from INDC and adapted ('Adap.': used to calculate \%cov), and their shares in Philippines's 2017 emissions (exclLU, exclBunkers; total 228.6~Mt CO$_2$eq).
 ...
 LULUCF: INDC '+' and adapted '+' (estimated as a net sink of -47.1~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 53.1\% & \bfseries 4.8\% & \bfseries 0.2\% & / & / & / & / & 58.1\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 5.0\% & \bfseries 0.0\% & \bfseries 0.0\% & / & / & 0.1\% & / & 5.2\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.3\% & 22.2\% & 5.0\% & / & / & / & / & 27.6\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 8.3\% & \bfseries 0.5\% & / & / & / & / & 8.8\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 58.5\% & 35.3\% & 6.1\% & / & / & 0.1\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/PHL/ts_ndcs_quantis_PHL.png}
