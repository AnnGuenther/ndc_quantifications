\documentclass[12pt]{article}
 ...
 \label{sec:emiLULUCF}
 LULUCF emissions data for Colombia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): BUR (2$^{nd}$), UNFCCC (2019), FAO (2019).
 ...
 ABS & condi. & best & 234.50 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}
