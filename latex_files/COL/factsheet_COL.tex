\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Colombia: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 166.7~Mt CO$_2$eq, Colombia contributed 0.3\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.4\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Colombia is estimated to emit 224.1~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 34.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 203.4--270.6~Mt CO$_2$eq in 2030, and 287.1--443.4~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 155 in 2017, and 122 regarding the per-capita emissions (146 and 121 in 2030).
 In terms of accumulated historical emissions, Colombia contributed to the global 1850--2017 emissions by 0.2\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.3\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Colombia, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 166.7 & Mt CO$_2$eq & 0.3\% & 40 \tabularnewline 
 \bfseries  & 2030 & 224.1 & Mt CO$_2$eq & 0.4\% & 39 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.6 & Trillion 2011~GK\$ & 0.6\% & 32 \tabularnewline 
 \bfseries  & 2030 & 1.0 & Trillion 2011~GK\$ & 0.6\% & 34 \tabularnewline \hline
 \bfseries Emissions & 2017 & 265.0 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 155 \tabularnewline 
 \bfseries per GDP & 2030 & 224.3 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 146 \tabularnewline \hline
 \bfseries Population & 2017 & 48.9 & Million Pers & 0.6\% & 29 \tabularnewline 
 \bfseries  & 2030 & 55.2 & Million Pers & 0.7\% & 28 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.4 & t CO$_2$eq /  Pers & 0.2\% & 122 \tabularnewline 
 \bfseries per capita & 2030 & 4.1 & t CO$_2$eq /  Pers & 0.2\% & 121 \tabularnewline 
 \end{tabular}
 \end{table}

 For Colombia, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (53.3\%), followed by Agriculture (29.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  50.6\% of the national emissions. 
 Second largest contributor was CH$_4$ (34.0\%)
 The total of F-gasesonly represented 1.3\%.
 The total CO$_2$ emissions are expected to be 56.8\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COL/ts_emi_exclLU_COL.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COL/ts_gdp_pop_COL.png}
 ...
 Colombia's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Colombia are available from the following sources (Fig.~\ref{fig:tsLULUCF}): BUR (2$^{nd}$)~/ 25, UNFCCC (2019)~/ 4, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net source of 113.9~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 166.7~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is 107.0--144.0~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COL/ts_emi_onlyLU_COL.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Colombia's NDC (if needed). 
 ...
 Colombia has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Colombia's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 268 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 234.50 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline \hline
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COL/ts_pc_cov_COL.png}
 \caption{Timeseries of Colombia's national emissions (exclLU) and the share of emissions that is assumed to be covered by Colombia's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Colombia's 2017 emissions (exclLU, exclBunkers; total 166.7~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 113.9~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 45.5\% & \bfseries 7.0\% & \bfseries 0.8\% & / & / & / & / & 53.3\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 4.7\% & \bfseries 0.0\% & \bfseries 0.6\% & \bfseries 1.2\% & \bfseries 0.0\% & \bfseries 0.09\% & / & 6.6\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 16.7\% & \bfseries 12.1\% & / & / & / & / & 29.0\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.2\% & \bfseries 10.3\% & \bfseries 0.3\% & / & / & / & / & 10.9\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 50.6\% & 34.0\% & 14.1\% & 1.2\% & 0.0\% & 0.09\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/COL/ts_ndcs_quantis_COL.png}
