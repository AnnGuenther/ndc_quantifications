\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Bhutan: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 2.5~Mt CO$_2$eq, Bhutan contributed 0.005\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.007\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Bhutan is estimated to emit 4.4~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 77.5\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 3.9--4.6~Mt CO$_2$eq in 2030, and 5.5--9.4~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 116 in 2017, and 128 regarding the per-capita emissions (131 and 107 in 2030).
 In terms of accumulated historical emissions, Bhutan contributed to the global 1850--2017 emissions by 0.003\%. 
 When only accounting for the years 1990--2017, its contribution increases to 0.004\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Bhutan, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 2.5 & Mt CO$_2$eq & 0.005\% & 167 \tabularnewline 
 \bfseries  & 2030 & 4.4 & Mt CO$_2$eq & 0.007\% & 162 \tabularnewline \hline
 \bfseries GDP & 2017 & 6.4 & Billion 2011~GK\$ & 0.005\% & 164 \tabularnewline 
 \bfseries  & 2030 & 17.2 & Billion 2011~GK\$ & 0.009\% & 156 \tabularnewline \hline
 \bfseries Emissions & 2017 & 381.2 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 116 \tabularnewline 
 \bfseries per GDP & 2030 & 253.4 & t CO$_2$eq / Million 2011~GK\$ & 0.3\% & 131 \tabularnewline \hline
 \bfseries Population & 2017 & 0.7 & Million Pers & 0.009\% & 162 \tabularnewline 
 \bfseries  & 2030 & 0.9 & Million Pers & 0.01\% & 161 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.3 & t CO$_2$eq /  Pers & 0.2\% & 128 \tabularnewline 
 \bfseries per capita & 2030 & 4.8 & t CO$_2$eq /  Pers & 0.3\% & 107 \tabularnewline 
 \end{tabular}
 \end{table}

 For Bhutan, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (40.4\%), followed by IPPU (32.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  57.6\% of the national emissions. 
 Second largest contributor was CH$_4$ (35.5\%)
 ...
 The total CO$_2$ emissions are expected to be 61.5\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BTN/ts_emi_exclLU_BTN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BTN/ts_gdp_pop_BTN.png}
 ...
 Bhutan's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Bhutan are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -3.6~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 2.5~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -4.4---2.8~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BTN/ts_emi_onlyLU_BTN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Bhutan's NDC (if needed). 
 ...
 Bhutan has an NDC, with a GHG mitigation target of the type ABS (absolute emissions target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Bhutan's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 6.29 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 ABS & condi. & best & 6.29 Mt~CO$_2$eq & 2050 & exclLU \tabularnewline 
 ABS & condi. & best & 0 Mt~CO$_2$eq & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 0 Mt~CO$_2$eq & 2050 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BTN/ts_pc_cov_BTN.png}
 \caption{Timeseries of Bhutan's national emissions (exclLU) and the share of emissions that is assumed to be covered by Bhutan's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Bhutan's 2017 emissions (exclLU, exclBunkers; total 2.5~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -3.6~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 25.2\% & \bfseries 13.5\% & \bfseries 1.7\% & / & / & / & / & 40.4\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 32.4\% & \bfseries 0.1\% & \bfseries 0.0\% & / & / & / & / & 32.5\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries / & \bfseries 17.2\% & \bfseries 4.1\% & / & / & / & / & 21.3\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 4.7\% & \bfseries 0.0\% & / & / & / & / & 4.7\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 1.1\% & / & / & / & / & 1.1\% \tabularnewline \hline
 \bfseries Total &  &  & 57.6\% & 35.5\% & 6.9\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BTN/ts_ndcs_quantis_BTN.png}
