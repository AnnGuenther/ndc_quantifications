\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} South Sudan: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 57.9~Mt CO$_2$eq, South Sudan contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which South Sudan is estimated to emit 60.3~Mt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 4.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 60.3--92.8~Mt CO$_2$eq in 2030, and 71.2--203.4~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 3 in 2017, and 101 regarding the per-capita emissions (4 and 98 in 2030).
 In terms of accumulated historical emissions, South Sudan contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for South Sudan, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 57.9 & Mt CO$_2$eq & 0.1\% & 77 \tabularnewline 
 \bfseries  & 2030 & 60.3 & Mt CO$_2$eq & 0.1\% & 85 \tabularnewline \hline
 \bfseries GDP & 2017 & 22.2 & Billion 2011~GK\$ & 0.01\% & 140 \tabularnewline 
 \bfseries  & 2030 & 43.9 & Billion 2011~GK\$ & 0.02\% & 135 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.6 & t CO$_2$eq / Thousand 2011~GK\$ & 2.4\% & 3 \tabularnewline 
 \bfseries per GDP & 2030 & 1.4 & t CO$_2$eq / Thousand 2011~GK\$ & 1.8\% & 4 \tabularnewline \hline
 \bfseries Population & 2017 & 10.9 & Million Pers & 0.1\% & 84 \tabularnewline 
 \bfseries  & 2030 & 10.6 & Million Pers & 0.1\% & 91 \tabularnewline \hline
 \bfseries Emissions & 2017 & 5.3 & t CO$_2$eq /  Pers & 0.3\% & 101 \tabularnewline 
 \bfseries per capita & 2030 & 5.7 & t CO$_2$eq /  Pers & 0.3\% & 98 \tabularnewline 
 \end{tabular}
 \end{table}

 For South Sudan, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (88.6\%), followed by Energy (7.1\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  54.7\% of the national emissions. 
 Second largest contributor was N$_2$O (41.6\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ and N$_2$O emissions from the Agriculture sector, which contributed 47.6\% and 40.9\% to South Sudan's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 7.0\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SSD/ts_emi_exclLU_SSD.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SSD/ts_gdp_pop_SSD.png}
 ...
 South Sudan's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for South Sudan are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 186.8~Mt CO$_2$eq, which in absolute terms is higher than the non-LULUCF emissions of 57.9~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 78.6--358.4~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SSD/ts_emi_onlyLU_SSD.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of South Sudan's NDC (if needed). 
 ...
 South Sudan has an INDC, with a GHG mitigation target of the type NGT (non-GHG target; main target type).
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SSD/ts_pc_cov_SSD.png}
 \caption{Timeseries of South Sudan's national emissions (exclLU) and the share of emissions that is assumed to be covered by South Sudan's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from INDC and adapted ('Adap.': used to calculate \%cov), and their shares in South Sudan's 2017 emissions (exclLU, exclBunkers; total 57.9~Mt CO$_2$eq).
 ...
 LULUCF: INDC '+' and adapted '+' (estimated as a net source of 186.8~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 3.2\% & 3.7\% & 0.1\% & / & / & / & / & 7.1\% \tabularnewline 
 \bfseries IPPU & / & -- & 0.4\% & / & 0.0\% & / & / & / & / & 0.4\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.04\% & 47.6\% & 40.9\% & / & / & / & / & 88.6\% \tabularnewline 
 \bfseries Waste & / & -- & / & 3.4\% & 0.3\% & / & / & / & / & 3.7\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 3.7\% & 54.7\% & 41.6\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/SSD/ts_ndcs_quantis_SSD.png}
