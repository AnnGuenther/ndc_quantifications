\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Tanzania: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 93.9~Mt CO$_2$eq, Tanzania contributed 0.1\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.2\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Tanzania is estimated to emit 131.1~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 39.7\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 128.6--192.6~Mt CO$_2$eq in 2030, and 195.9--556.9~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 53 in 2017, and 177 regarding the per-capita emissions (63 and 175 in 2030).
 In terms of accumulated historical emissions, Tanzania contributed to the global 1850--2017 emissions by 0.1\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Tanzania, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 93.9 & Mt CO$_2$eq & 0.1\% & 58 \tabularnewline 
 \bfseries  & 2030 & 131.1 & Mt CO$_2$eq & 0.2\% & 51 \tabularnewline \hline
 \bfseries GDP & 2017 & 0.1 & Trillion 2011~GK\$ & 0.1\% & 77 \tabularnewline 
 \bfseries  & 2030 & 0.3 & Trillion 2011~GK\$ & 0.1\% & 66 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.7 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 53 \tabularnewline 
 \bfseries per GDP & 2030 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.5\% & 63 \tabularnewline \hline
 \bfseries Population & 2017 & 54.7 & Million Pers & 0.7\% & 25 \tabularnewline 
 \bfseries  & 2030 & 73.3 & Million Pers & 0.9\% & 20 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.7 & t CO$_2$eq /  Pers & 0.1\% & 177 \tabularnewline 
 \bfseries per capita & 2030 & 1.8 & t CO$_2$eq /  Pers & 0.1\% & 175 \tabularnewline 
 \end{tabular}
 \end{table}

 For Tanzania, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (64.0\%), followed by Energy (23.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  59.7\% of the national emissions. 
 Second largest contributor was N$_2$O (27.4\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Agriculture sector, which contributed 39.1\% to Tanzania's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 23.0\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TZA/ts_emi_exclLU_TZA.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TZA/ts_gdp_pop_TZA.png}
 ...
 Tanzania's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Tanzania are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 222.3~Mt CO$_2$eq, which in absolute terms is higher than the non-LULUCF emissions of 93.9~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 214.7--272.3~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TZA/ts_emi_onlyLU_TZA.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Tanzania's NDC (if needed). 
 ...
 Tanzania has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Tanzania's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & worst & 130.94 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline 
 ABS & condi. & best & 116.40 Mt~CO$_2$eq & 2030 & exclLU \tabularnewline \hline
 RBU & condi. & worst & -10\% & 2030 & exclLU \tabularnewline 
 RBU & condi. & best & -20\% & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TZA/ts_pc_cov_TZA.png}
 \caption{Timeseries of Tanzania's national emissions (exclLU) and the share of emissions that is assumed to be covered by Tanzania's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Tanzania's 2017 emissions (exclLU, exclBunkers; total 93.9~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net source of 222.3~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 11.4\% & \bfseries 11.1\% & \bfseries 1.0\% & / & / & / & / & 23.5\% \tabularnewline 
 \bfseries IPPU & / & \bfseries + & \bfseries 1.5\% & \bfseries / & \bfseries 0.3\% & / & / & / & / & 1.8\% \tabularnewline 
 \bfseries Agri. & / & \bfseries + & \bfseries 0.08\% & \bfseries 39.1\% & \bfseries 24.8\% & / & / & / & / & 64.0\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 9.4\% & \bfseries 0.6\% & / & / & / & / & 10.0\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.6\% & / & / & / & / & 0.6\% \tabularnewline \hline
 \bfseries Total &  &  & 13.0\% & 59.7\% & 27.4\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TZA/ts_ndcs_quantis_TZA.png}
