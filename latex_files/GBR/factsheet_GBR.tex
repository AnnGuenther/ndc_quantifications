\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} UK: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 0.4~Gt CO$_2$eq, UK contributed 1.0\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which UK is estimated to emit 0.6~Gt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 14.2\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 0.4--0.7~Gt CO$_2$eq in 2030, and 0.4--1.2~Gt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 190 in 2017, and 70 regarding the per-capita emissions (187 and 66 in 2030).
 In terms of accumulated historical emissions, UK contributed to the global 1850--2017 emissions by 4.0\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 1.8\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for UK, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 0.4 & Gt CO$_2$eq & 1.0\% & 17 \tabularnewline 
 \bfseries  & 2030 & 0.6 & Gt CO$_2$eq & 1.0\% & 17 \tabularnewline \hline
 \bfseries GDP & 2017 & 2.8 & Trillion 2011~GK\$ & 2.5\% & 9 \tabularnewline 
 \bfseries  & 2030 & 3.5 & Trillion 2011~GK\$ & 2.0\% & 9 \tabularnewline \hline
 \bfseries Emissions & 2017 & 174.3 & t CO$_2$eq / Million 2011~GK\$ & 0.1\% & 190 \tabularnewline 
 \bfseries per GDP & 2030 & 156.2 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 187 \tabularnewline \hline
 \bfseries Population & 2017 & 67.1 & Million Pers & 0.9\% & 22 \tabularnewline 
 \bfseries  & 2030 & 72.6 & Million Pers & 0.9\% & 22 \tabularnewline \hline
 \bfseries Emissions & 2017 & 7.2 & t CO$_2$eq /  Pers & 0.4\% & 70 \tabularnewline 
 \bfseries per capita & 2030 & 7.6 & t CO$_2$eq /  Pers & 0.5\% & 66 \tabularnewline 
 \end{tabular}
 \end{table}

 For UK, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (79.5\%), followed by Agriculture (8.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 81.9\% of the national emissions. 
 Second largest contributor was CH$_4$ (10.8\%)
 The total of F-gasesonly represented 3.1\%.
 The total CO$_2$ emissions are expected to be 80.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GBR/ts_emi_exclLU_GBR.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GBR/ts_gdp_pop_GBR.png}
 ...
 UK's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for UK are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 ...
 The emissions range for CRF (2019) and 1990--2017 is -0.0--0.0002~Gt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GBR/ts_emi_onlyLU_GBR.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of UK's NDC (if needed). 
 ...
 UK has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on UK's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As UK is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GBR/ts_pc_cov_GBR.png}
 \caption{Timeseries of UK's national emissions (exclLU) and the share of emissions that is assumed to be covered by UK's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in UK's 2017 emissions (exclLU, exclBunkers; total 0.4~Gt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 77.5\% & \bfseries 1.5\% & \bfseries 0.5\% & / & / & / & / & 79.5\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 4.0\% & \bfseries 0.01\% & \bfseries 0.1\% & \bfseries 2.9\% & \bfseries 0.07\% & \bfseries 0.1\% & \bfseries 0.0\% & 7.4\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.2\% & \bfseries 5.4\% & \bfseries 3.0\% & / & / & / & / & 8.6\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.05\% & \bfseries 3.9\% & \bfseries 0.3\% & / & / & / & / & 4.3\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 81.9\% & 10.8\% & 4.2\% & 2.9\% & 0.07\% & 0.1\% & 0.0\% & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/GBR/ts_ndcs_quantis_GBR.png}
