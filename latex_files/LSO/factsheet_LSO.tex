\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Lesotho: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 5.1~Mt CO$_2$eq, Lesotho contributed 0.01\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Lesotho is estimated to emit 5.8~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 13.3\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 5.5--7.8~Mt CO$_2$eq in 2030, and 6.4--22.4~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 42 in 2017, and 151 regarding the per-capita emissions (43 and 148 in 2030).
 In terms of accumulated historical emissions, Lesotho contributed to the global 1850--2017 emissions by 0.009\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Lesotho, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 5.1 & Mt CO$_2$eq & 0.01\% & 155 \tabularnewline 
 \bfseries  & 2030 & 5.8 & Mt CO$_2$eq & 0.01\% & 156 \tabularnewline \hline
 \bfseries GDP & 2017 & 6.7 & Billion 2011~GK\$ & 0.005\% & 163 \tabularnewline 
 \bfseries  & 2030 & 12.1 & Billion 2011~GK\$ & 0.006\% & 162 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.8 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 42 \tabularnewline 
 \bfseries per GDP & 2030 & 0.4 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 43 \tabularnewline \hline
 \bfseries Population & 2017 & 2.1 & Million Pers & 0.02\% & 144 \tabularnewline 
 \bfseries  & 2030 & 2.3 & Million Pers & 0.02\% & 145 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.4 & t CO$_2$eq /  Pers & 0.1\% & 151 \tabularnewline 
 \bfseries per capita & 2030 & 2.5 & t CO$_2$eq /  Pers & 0.1\% & 148 \tabularnewline 
 \end{tabular}
 \end{table}

 For Lesotho, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (62.8\%), followed by Agriculture (29.0\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  54.3\% of the national emissions. 
 Second largest contributor was CH$_4$ (32.1\%)
 The total of F-gasesonly represented 0.0\%.
 The total CO$_2$ emissions are expected to be 65.0\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LSO/ts_emi_exclLU_LSO.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LSO/ts_gdp_pop_LSO.png}
 ...
 Lesotho's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Lesotho are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.2~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 5.1~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is -0.2--0.03~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LSO/ts_emi_onlyLU_LSO.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Lesotho's NDC (if needed). 
 ...
 Lesotho has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Lesotho's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 4.33 Mt~CO$_2$eq SAR & 2025 & inclLU \tabularnewline 
 ABS & condi. & best & 3.65 Mt~CO$_2$eq SAR & 2025 & inclLU \tabularnewline 
 ABS & uncondi. & best & 5.14 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 3.73 Mt~CO$_2$eq SAR & 2030 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -10.2\% & 2025 & inclLU \tabularnewline 
 RBU & condi. & best & -34.4\% & 2025 & inclLU \tabularnewline 
 RBU & uncondi. & best & -10\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -35\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LSO/ts_pc_cov_LSO.png}
 \caption{Timeseries of Lesotho's national emissions (exclLU) and the share of emissions that is assumed to be covered by Lesotho's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Lesotho's 2017 emissions (exclLU, exclBunkers; total 5.1~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 54.1\% & \bfseries 7.9\% & \bfseries 0.8\% & / & / & / & / & 62.8\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.4\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries / & \bfseries 17.5\% & \bfseries 11.5\% & / & / & / & / & 29.0\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 6.7\% & \bfseries 0.6\% & / & / & / & / & 7.3\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 54.3\% & 32.1\% & 13.6\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/LSO/ts_ndcs_quantis_LSO.png}
