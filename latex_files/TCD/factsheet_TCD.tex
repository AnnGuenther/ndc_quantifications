\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Chad: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 76.4~Mt CO$_2$eq, Chad contributed 0.1\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Chad is estimated to emit 71.4~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a decrease of -6.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 71.4--113.2~Mt CO$_2$eq in 2030, and 83.1--252.3~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 1 in 2017, and 103 regarding the per-capita emissions (2 and 130 in 2030).
 In terms of accumulated historical emissions, Chad contributed to the global 1850--2017 emissions by 0.07\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Chad, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 76.4 & Mt CO$_2$eq & 0.1\% & 66 \tabularnewline 
 \bfseries  & 2030 & 71.4 & Mt CO$_2$eq & 0.1\% & 72 \tabularnewline \hline
 \bfseries GDP & 2017 & 20.3 & Billion 2011~GK\$ & 0.01\% & 143 \tabularnewline 
 \bfseries  & 2030 & 45.8 & Billion 2011~GK\$ & 0.02\% & 134 \tabularnewline \hline
 \bfseries Emissions & 2017 & 3.8 & t CO$_2$eq / Thousand 2011~GK\$ & 3.4\% & 1 \tabularnewline 
 \bfseries per GDP & 2030 & 1.6 & t CO$_2$eq / Thousand 2011~GK\$ & 2.1\% & 2 \tabularnewline \hline
 \bfseries Population & 2017 & 15.0 & Million Pers & 0.1\% & 72 \tabularnewline 
 \bfseries  & 2030 & 20.2 & Million Pers & 0.2\% & 65 \tabularnewline \hline
 \bfseries Emissions & 2017 & 5.1 & t CO$_2$eq /  Pers & 0.3\% & 103 \tabularnewline 
 \bfseries per capita & 2030 & 3.5 & t CO$_2$eq /  Pers & 0.2\% & 130 \tabularnewline 
 \end{tabular}
 \end{table}

 For Chad, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (93.0\%), followed by Energy (6.1\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  64.7\% of the national emissions. 
 Second largest contributor was N$_2$O (33.8\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ and N$_2$O emissions from the Agriculture sector, which contributed 59.7\% and 33.2\% to Chad's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 4.2\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TCD/ts_emi_exclLU_TCD.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TCD/ts_gdp_pop_TCD.png}
 ...
 Chad's population is assumed to grow towards 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Chad are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 7, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -37.7~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 76.4~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -46.2---26.6~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TCD/ts_emi_onlyLU_TCD.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Chad's NDC (if needed). 
 ...
 Chad has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Chad's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 40.83 Mt~CO$_2$eq AR4 & 2030 & exclLU \tabularnewline 
 ABS & condi. & best & 32.64 Mt~CO$_2$eq AR4 & 2030 & exclLU \tabularnewline 
 ABS & uncondi. & best & 23.44 Mt~CO$_2$eq AR4 & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 8.22 Mt~CO$_2$eq AR4 & 2030 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -11.3\% & 2030 & exclLU \tabularnewline 
 RBU & condi. & best & -29.1\% & 2030 & exclLU \tabularnewline 
 RBU & uncondi. & best & -18.2\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -71\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TCD/ts_pc_cov_TCD.png}
 \caption{Timeseries of Chad's national emissions (exclLU) and the share of emissions that is assumed to be covered by Chad's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Chad's 2017 emissions (exclLU, exclBunkers; total 76.4~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -37.7~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 1.3\% & \bfseries 4.7\% & \bfseries 0.1\% & / & / & / & / & 6.1\% \tabularnewline 
 \bfseries IPPU & / & -- & 0.1\% & / & 0.0\% & / & / & / & / & 0.1\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 59.7\% & \bfseries 33.2\% & / & / & / & / & 93.0\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 0.3\% & \bfseries 0.2\% & / & / & / & / & 0.6\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.1\% & / & / & / & / & 0.1\% \tabularnewline \hline
 \bfseries Total &  &  & 1.4\% & 64.7\% & 33.8\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/TCD/ts_ndcs_quantis_TCD.png}
