\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Romania: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 114.8~Mt CO$_2$eq, Romania contributed 0.2\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Romania is estimated to emit 127.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 10.6\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 116.1--153.9~Mt CO$_2$eq in 2030, and 131.4--281.7~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 170 in 2017, and 91 regarding the per-capita emissions (172 and 81 in 2030).
 In terms of accumulated historical emissions, Romania contributed to the global 1850--2017 emissions by 0.6\%. 
 When only accounting for the years 1990--2017, its contribution decreases to 0.4\%.
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Romania, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 114.8 & Mt CO$_2$eq & 0.2\% & 48 \tabularnewline 
 \bfseries  & 2030 & 127.0 & Mt CO$_2$eq & 0.2\% & 52 \tabularnewline \hline
 \bfseries GDP & 2017 & 492.9 & Billion 2011~GK\$ & 0.4\% & 39 \tabularnewline 
 \bfseries  & 2030 & 669.0 & Billion 2011~GK\$ & 0.3\% & 41 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.2 & t CO$_2$eq / Thousand 2011~GK\$ & 0.2\% & 170 \tabularnewline 
 \bfseries per GDP & 2030 & 0.1 & t CO$_2$eq / Thousand 2011~GK\$ & 0.2\% & 172 \tabularnewline \hline
 \bfseries Population & 2017 & 19.7 & Million Pers & 0.2\% & 59 \tabularnewline 
 \bfseries  & 2030 & 18.6 & Million Pers & 0.2\% & 70 \tabularnewline \hline
 \bfseries Emissions & 2017 & 5.8 & t CO$_2$eq /  Pers & 0.3\% & 91 \tabularnewline 
 \bfseries per capita & 2030 & 6.8 & t CO$_2$eq /  Pers & 0.4\% & 81 \tabularnewline 
 \end{tabular}
 \end{table}

 For Romania, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (65.8\%), followed by Agriculture (16.8\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting  65.9\% of the national emissions. 
 Second largest contributor was CH$_4$ (25.0\%)
 The total of F-gasesonly represented 1.9\%.
 The total CO$_2$ emissions are expected to be 66.7\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ROU/ts_emi_exclLU_ROU.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ROU/ts_gdp_pop_ROU.png}
 ...
 Romania's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Romania are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -21.7~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 114.8~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -23.1---18.8~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ROU/ts_emi_onlyLU_ROU.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Romania's NDC (if needed). 
 ...
 Romania has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Romania's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Romania is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ROU/ts_pc_cov_ROU.png}
 \caption{Timeseries of Romania's national emissions (exclLU) and the share of emissions that is assumed to be covered by Romania's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Romania's 2017 emissions (exclLU, exclBunkers; total 114.8~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -21.7~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 56.0\% & \bfseries 9.3\% & \bfseries 0.5\% & / & / & / & / & 65.8\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 9.8\% & \bfseries 0.0\% & \bfseries 0.2\% & \bfseries 1.9\% & \bfseries 0.0\% & \bfseries 0.04\% & \bfseries / & 12.0\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 11.1\% & \bfseries 5.6\% & / & / & / & / & 16.8\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.0\% & \bfseries 4.6\% & \bfseries 0.4\% & / & / & / & / & 5.1\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 65.9\% & 25.0\% & 7.1\% & 1.9\% & 0.0\% & 0.04\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ROU/ts_ndcs_quantis_ROU.png}
