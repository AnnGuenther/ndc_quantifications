\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Bosnia \& Herzegovina: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 28.4~Mt CO$_2$eq, Bosnia \& Herzegovina contributed 0.05\% to global emissions in 2017, while in 2030 its share is estimated to increase to 0.06\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Bosnia \& Herzegovina is estimated to emit 33.7~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 18.8\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 32.0--40.2~Mt CO$_2$eq in 2030, and 31.1--56.3~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 57 in 2017, and 53 regarding the per-capita emissions (38 and 37 in 2030).
 In terms of accumulated historical emissions, Bosnia \& Herzegovina contributed to the global 1850--2017 emissions by 0.07\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Bosnia \& Herzegovina, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 28.4 & Mt CO$_2$eq & 0.05\% & 107 \tabularnewline 
 \bfseries  & 2030 & 33.7 & Mt CO$_2$eq & 0.06\% & 111 \tabularnewline \hline
 \bfseries GDP & 2017 & 42.6 & Billion 2011~GK\$ & 0.03\% & 115 \tabularnewline 
 \bfseries  & 2030 & 67.1 & Billion 2011~GK\$ & 0.03\% & 119 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.7 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 57 \tabularnewline 
 \bfseries per GDP & 2030 & 0.5 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 38 \tabularnewline \hline
 \bfseries Population & 2017 & 3.4 & Million Pers & 0.04\% & 134 \tabularnewline 
 \bfseries  & 2030 & 3.3 & Million Pers & 0.03\% & 136 \tabularnewline \hline
 \bfseries Emissions & 2017 & 8.5 & t CO$_2$eq /  Pers & 0.6\% & 53 \tabularnewline 
 \bfseries per capita & 2030 & 10.3 & t CO$_2$eq /  Pers & 0.7\% & 37 \tabularnewline 
 \end{tabular}
 \end{table}

 For Bosnia \& Herzegovina, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (73.9\%), followed by IPPU (12.3\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 78.2\% of the national emissions. 
 Second largest contributor was CH$_4$ (10.7\%)
 The total of F-gasesonly represented 4.9\%.
 The total CO$_2$ emissions are expected to be 76.3\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BIH/ts_emi_exclLU_BIH.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BIH/ts_gdp_pop_BIH.png}
 ...
 Bosnia \& Herzegovina's population is assumed to diminish towars 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Bosnia \& Herzegovina are available from the following sources (Fig.~\ref{fig:tsLULUCF}): UNFCCC (2019)~/ 14, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from UNFCCC (2019), for the year 2017, LULUCF is estimated to be a net sink of -6.3~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 28.4~Mt CO$_2$eq.
 The emissions range for UNFCCC (2019) and 1990--2017 is -10.6---6.1~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BIH/ts_emi_onlyLU_BIH.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Bosnia \& Herzegovina's NDC (if needed). 
 ...
 Bosnia \& Herzegovina has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Bosnia \& Herzegovina's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 ABS & uncondi. & best & 32.74 Mt~CO$_2$eq SAR & 1990 & 2030 & inclLU \tabularnewline 
 ABS & condi. & best & 25.59 Mt~CO$_2$eq SAR & 1990 & 2030 & inclLU \tabularnewline \hline
 RBU & uncondi. & best & -2\% & 1990 & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -23\% & 1990 & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BIH/ts_pc_cov_BIH.png}
 \caption{Timeseries of Bosnia \& Herzegovina's national emissions (exclLU) and the share of emissions that is assumed to be covered by Bosnia \& Herzegovina's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Bosnia \& Herzegovina's 2017 emissions (exclLU, exclBunkers; total 28.4~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '+' (estimated as a net sink of -6.3~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 70.7\% & \bfseries 2.5\% & \bfseries 0.7\% & / & / & / & / & 73.9\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 7.4\% & \bfseries 0.0\% & \bfseries 0.04\% & 4.5\% & 0.4\% & / & / & 12.3\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.03\% & \bfseries 3.8\% & \bfseries 4.8\% & / & / & / & / & 8.6\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.01\% & \bfseries 4.4\% & \bfseries 0.2\% & / & / & / & / & 4.7\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 78.2\% & 10.7\% & 6.2\% & 4.5\% & 0.4\% & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BIH/ts_ndcs_quantis_BIH.png}
