\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Cameroon: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 43.5~Mt CO$_2$eq, Cameroon contributed 0.09\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Cameroon is estimated to emit 53.5~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial increase of 22.9\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 51.6--73.7~Mt CO$_2$eq in 2030, and 78.4--202.8~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 70 in 2017, and 174 regarding the per-capita emissions (83 and 174 in 2030).
 In terms of accumulated historical emissions, Cameroon contributed to the global 1850--2017 emissions by 0.07\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Cameroon, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 43.5 & Mt CO$_2$eq & 0.09\% & 90 \tabularnewline 
 \bfseries  & 2030 & 53.5 & Mt CO$_2$eq & 0.09\% & 95 \tabularnewline \hline
 \bfseries GDP & 2017 & 74.7 & Billion 2011~GK\$ & 0.06\% & 91 \tabularnewline 
 \bfseries  & 2030 & 151.1 & Billion 2011~GK\$ & 0.08\% & 88 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.6 & t CO$_2$eq / Thousand 2011~GK\$ & 0.5\% & 70 \tabularnewline 
 \bfseries per GDP & 2030 & 0.3 & t CO$_2$eq / Thousand 2011~GK\$ & 0.4\% & 83 \tabularnewline \hline
 \bfseries Population & 2017 & 24.6 & Million Pers & 0.3\% & 54 \tabularnewline 
 \bfseries  & 2030 & 29.8 & Million Pers & 0.3\% & 53 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.8 & t CO$_2$eq /  Pers & 0.1\% & 174 \tabularnewline 
 \bfseries per capita & 2030 & 1.8 & t CO$_2$eq /  Pers & 0.1\% & 174 \tabularnewline 
 \end{tabular}
 \end{table}

 For Cameroon, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (49.0\%), followed by Agriculture (33.7\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  50.3\% of the national emissions. 
 Second largest contributor was CO$_2$ (32.7\%)
 The total of F-gasesonly represented 0.3\%.
 The trend in total emissions is mostly driven by CH$_4$ and N$_2$O emissions from the Agriculture sector, which contributed 18.5\% and 15.0\% to Cameroon's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 44.5\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CMR/ts_emi_exclLU_CMR.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CMR/ts_gdp_pop_CMR.png}
 ...
 Cameroon's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Cameroon are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 117.8~Mt CO$_2$eq, which in absolute terms is higher than the non-LULUCF emissions of 43.5~Mt CO$_2$eq.
 The emissions range for FAO (2019) and 1990--2017 is 113.4--122.8~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CMR/ts_emi_onlyLU_CMR.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Cameroon's NDC (if needed). 
 ...
 Cameroon has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Cameroon's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & condi. & best & 71 Mt~CO$_2$eq AR4 & 2035 & exclLU \tabularnewline \hline
 RBU & condi. & best & -32\% & 2035 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CMR/ts_pc_cov_CMR.png}
 \caption{Timeseries of Cameroon's national emissions (exclLU) and the share of emissions that is assumed to be covered by Cameroon's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Cameroon's 2017 emissions (exclLU, exclBunkers; total 43.5~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '--' (estimated as a net source of 117.8~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 26.7\% & \bfseries 21.7\% & \bfseries 0.6\% & / & / & / & / & 49.0\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 5.7\% & \bfseries / & \bfseries 0.0\% & / & 0.3\% & / & / & 6.0\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.2\% & \bfseries 18.5\% & \bfseries 15.0\% & / & / & / & / & 33.7\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 10.2\% & \bfseries 0.7\% & / & / & / & / & 10.9\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.3\% & / & / & / & / & 0.3\% \tabularnewline \hline
 \bfseries Total &  &  & 32.7\% & 50.3\% & 16.7\% & / & 0.3\% & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/CMR/ts_ndcs_quantis_CMR.png}
