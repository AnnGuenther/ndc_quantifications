\documentclass[12pt]{article}
 ...
 \label{sec:emiLULUCF}
 LULUCF emissions data for Cameroon are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019).
 ...
 ABS & condi. & best & 71 Mt~CO$_2$eq AR4 & 2035 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}
