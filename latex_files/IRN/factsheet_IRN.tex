\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Iran: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 0.9~Gt CO$_2$eq, Iran contributed 1.9\% to global emissions in 2017, while in 2030 its share is estimated to decrease to 1.7\% (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Iran is estimated to emit 0.9~Gt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 2.7\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 0.8--1.1~Gt CO$_2$eq in 2030, and 0.8--1.7~Gt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 50 in 2017, and 31 regarding the per-capita emissions (37 and 33 in 2030).
 In terms of accumulated historical emissions, Iran contributed to the global 1850--2017 emissions by 1.2\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Iran, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 0.9 & Gt CO$_2$eq & 1.9\% & 7 \tabularnewline 
 \bfseries  & 2030 & 0.9 & Gt CO$_2$eq & 1.7\% & 8 \tabularnewline \hline
 \bfseries GDP & 2017 & 1.3 & Trillion 2011~GK\$ & 1.1\% & 18 \tabularnewline 
 \bfseries  & 2030 & 1.9 & Trillion 2011~GK\$ & 1.0\% & 20 \tabularnewline \hline
 \bfseries Emissions & 2017 & 0.7 & t CO$_2$eq / Thousand 2011~GK\$ & 0.6\% & 50 \tabularnewline 
 \bfseries per GDP & 2030 & 0.5 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 37 \tabularnewline \hline
 \bfseries Population & 2017 & 80.7 & Million Pers & 1.1\% & 19 \tabularnewline 
 \bfseries  & 2030 & 88.4 & Million Pers & 1.0\% & 18 \tabularnewline \hline
 \bfseries Emissions & 2017 & 11.4 & t CO$_2$eq /  Pers & 0.8\% & 31 \tabularnewline 
 \bfseries per capita & 2030 & 10.6 & t CO$_2$eq /  Pers & 0.7\% & 33 \tabularnewline 
 \end{tabular}
 \end{table}

 For Iran, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (86.6\%), followed by IPPU (5.6\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 76.3\% of the national emissions. 
 Second largest contributor was CH$_4$ (20.2\%)
 The total of F-gasesonly represented 0.006\%.
 The total CO$_2$ emissions are expected to be 82.0\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/IRN/ts_emi_exclLU_IRN.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/IRN/ts_gdp_pop_IRN.png}
 ...
 Iran's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Iran are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.05~Gt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 0.9~Gt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is -0.0--0.06~Gt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/IRN/ts_emi_onlyLU_IRN.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Iran's NDC (if needed). 
 ...
 Iran has an INDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Iran's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 RBU & uncondi. & best & -4\% & 2030 & inclLU \tabularnewline 
 RBU & condi. & best & -12\% & 2030 & inclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/IRN/ts_pc_cov_IRN.png}
 \caption{Timeseries of Iran's national emissions (exclLU) and the share of emissions that is assumed to be covered by Iran's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from INDC and adapted ('Adap.': used to calculate \%cov), and their shares in Iran's 2017 emissions (exclLU, exclBunkers; total 0.9~Gt CO$_2$eq).
 ...
 LULUCF: INDC '+' and adapted '+' (estimated as a net source of 0.05~Gt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 71.4\% & \bfseries 14.9\% & \bfseries 0.3\% & / & / & / & / & 86.6\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 4.7\% & \bfseries 0.04\% & \bfseries 0.9\% & \bfseries / & \bfseries 0.0\% & \bfseries 0.0\% & \bfseries / & 5.6\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.2\% & \bfseries 1.9\% & \bfseries 1.7\% & / & / & / & / & 3.8\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries / & \bfseries 3.4\% & \bfseries 0.1\% & / & / & / & / & 3.5\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.4\% & / & / & / & / & 0.4\% \tabularnewline \hline
 \bfseries Total &  &  & 76.3\% & 20.2\% & 3.5\% & / & 0.0\% & 0.0\% & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/IRN/ts_ndcs_quantis_IRN.png}
