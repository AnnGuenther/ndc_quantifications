\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Eritrea: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 6.7~Mt CO$_2$eq, Eritrea contributed 0.01\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Eritrea is estimated to emit 6.0~Mt CO$_2$eq in 2030.
 That change in emissions would constitute a substantial decrease of -10.0\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 6.0--10.0~Mt CO$_2$eq in 2030, and 6.3--33.6~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 22 in 2017, and 168 regarding the per-capita emissions (30 and 188 in 2030).
 In terms of accumulated historical emissions, Eritrea contributed to the global 1850--2017 emissions by 0.01\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Eritrea, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 6.7 & Mt CO$_2$eq & 0.01\% & 153 \tabularnewline 
 \bfseries  & 2030 & 6.0 & Mt CO$_2$eq & 0.01\% & 155 \tabularnewline \hline
 \bfseries GDP & 2017 & 6.7 & Billion 2011~GK\$ & 0.005\% & 162 \tabularnewline 
 \bfseries  & 2030 & 10.9 & Billion 2011~GK\$ & 0.006\% & 165 \tabularnewline \hline
 \bfseries Emissions & 2017 & 1.0 & t CO$_2$eq / Thousand 2011~GK\$ & 0.9\% & 22 \tabularnewline 
 \bfseries per GDP & 2030 & 0.6 & t CO$_2$eq / Thousand 2011~GK\$ & 0.7\% & 30 \tabularnewline \hline
 \bfseries Population & 2017 & 3.4 & Million Pers & 0.04\% & 133 \tabularnewline 
 \bfseries  & 2030 & 4.6 & Million Pers & 0.05\% & 129 \tabularnewline \hline
 \bfseries Emissions & 2017 & 2.0 & t CO$_2$eq /  Pers & 0.1\% & 168 \tabularnewline 
 \bfseries per capita & 2030 & 1.3 & t CO$_2$eq /  Pers & 0.08\% & 188 \tabularnewline 
 \end{tabular}
 \end{table}

 For Eritrea, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Agriculture sector (68.8\%), followed by Energy (17.2\%)
 The Kyoto~GHG with the highest emissions in 2017 was CH$_4$, constituting  64.4\% of the national emissions. 
 Second largest contributor was N$_2$O (25.2\%)
 The total of F-gasesonly represented 0.0\%.
 The trend in total emissions is mostly driven by CH$_4$ emissions from the Agriculture sector, which contributed 44.6\% to Eritrea's 2017 emissions.\footnote{Analysis based on the correlations between total national emissions (exclLU) versus the emissions of the combinations of main-sectors \& the gases CO$_2$, CH$_4$, N$_2$O and F-gases. 
 ...
 The total CO$_2$ emissions are expected to be 18.4\% of the national Kyoto~GHG emissions in 2030 (dmSSP2).

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ERI/ts_emi_exclLU_ERI.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ERI/ts_gdp_pop_ERI.png}
 ...
 Eritrea's population is assumed to grow towards 2050, and the per capita emissions are expected to decline towars 2050. 

 LULUCF emissions data for Eritrea are available from the following sources (Fig.~\ref{fig:tsLULUCF}): FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from FAO (2019), for the year 2017, LULUCF is estimated to be a net source of 0.7~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 6.7~Mt CO$_2$eq.
 The large emissions range for FAO (2019) and 1990--2017 is 0.01--1.6~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ERI/ts_emi_onlyLU_ERI.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Eritrea's NDC (if needed). 
 ...
 Eritrea has an NDC, with a GHG mitigation target of the type RBU (relative reduction compared to Business-As-Usual; main target type).
 The reclassified target type is ABS (absolute emissions target).

 \begin{table}[H]
 \centering
 \caption{Information on Eritrea's GHG mitigation target(s).}
 \label{tab:mitiTars}
 \begin{tabular}{l l l l l l }
 \bfseries type & \bfseries condi. & \bfseries range & \bfseries value & \bfseries tarYr & \bfseries LU \tabularnewline \hline \hline
 ABS & uncondi. & best & 9.0030 Mt~CO$_2$eq AR4 & 2025 & exclLU \tabularnewline 
 ABS & condi. & best & 7.86 Mt~CO$_2$eq AR4 & 2025 & exclLU \tabularnewline 
 ABS & uncondi. & best & 10.48 Mt~CO$_2$eq AR4 & 2030 & exclLU \tabularnewline 
 ABS & condi. & best & 8.31 Mt~CO$_2$eq AR4 & 2030 & exclLU \tabularnewline \hline
 RBU & uncondi. & best & -6.2\% & 2025 & exclLU \tabularnewline 
 RBU & condi. & best & -24.9\% & 2025 & exclLU \tabularnewline 
 RBU & uncondi. & best & -12\% & 2030 & exclLU \tabularnewline 
 RBU & condi. & best & -38.5\% & 2030 & exclLU \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ERI/ts_pc_cov_ERI.png}
 \caption{Timeseries of Eritrea's national emissions (exclLU) and the share of emissions that is assumed to be covered by Eritrea's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Eritrea's 2017 emissions (exclLU, exclBunkers; total 6.7~Mt CO$_2$eq).
 ...
 LULUCF: NDC '+' and adapted '--' (estimated as a net source of 0.7~Mt CO$_2$eq in 2017; based on the 'chosen' LULUCF emissions).}
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 9.0\% & \bfseries 7.8\% & \bfseries 0.3\% & / & / & / & / & 17.2\% \tabularnewline 
 \bfseries IPPU & \bfseries + & -- & 1.5\% & / & 0.0\% & / & / & / & / & 1.5\% \tabularnewline 
 \bfseries Agri. & / & -- & 0.0\% & 44.6\% & 24.1\% & / & / & / & / & 68.8\% \tabularnewline 
 \bfseries Waste & \bfseries + & -- & / & 11.9\% & 0.4\% & / & / & / & / & 12.3\% \tabularnewline 
 \bfseries Other & / & -- & / & / & 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 10.5\% & 64.4\% & 25.2\% & / & / & / & / & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/ERI/ts_ndcs_quantis_ERI.png}
