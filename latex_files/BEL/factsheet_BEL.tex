\documentclass[12pt]{article}
 ...
 \title{ \bfseries \color{PIKorange} Belgium: information on national emissions, population and GDP, and mitigation targets}
 ...
 With national emissions of 116.1~Mt CO$_2$eq, Belgium contributed 0.2\% to global emissions in 2017, and in 2030 its share is estimated to stay at a similar level (Table~\ref{tab:overview}).
 The estimates for 2030 are based on the downscaled SSP2 Middle of the Road marker scenario (dmSSP2), in which Belgium is estimated to emit 119.7~Mt CO$_2$eq in 2030.
 That change in emissions would constitute an increase of 3.1\% compared to 2017. 
 The pathways dmSSP1--5 show a range of 99.6--137.7~Mt CO$_2$eq in 2030, and 99.7--232.5~Mt CO$_2$eq in 2050.
 The country's global rank in terms of total emissions per unit of GDP was 176 in 2017, and 39 regarding the per-capita emissions (176 and 44 in 2030).
 In terms of accumulated historical emissions, Belgium contributed to the global 1850--2017 emissions by 0.6\%. 
 ...
 \begin{table}[H]
 \centering
 \caption{National emissions (dmSSP2), GDP and population for Belgium, together with the emissions per unit of GDP and per capita emissions (all for 2017 and 2030). 
 ...
 \bfseries Emissions & 2017 & 116.1 & Mt CO$_2$eq & 0.2\% & 46 \tabularnewline 
 \bfseries  & 2030 & 119.7 & Mt CO$_2$eq & 0.2\% & 54 \tabularnewline \hline
 \bfseries GDP & 2017 & 522.4 & Billion 2011~GK\$ & 0.4\% & 36 \tabularnewline 
 \bfseries  & 2030 & 652.5 & Billion 2011~GK\$ & 0.3\% & 42 \tabularnewline \hline
 \bfseries Emissions & 2017 & 222.2 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 176 \tabularnewline 
 \bfseries per GDP & 2030 & 183.4 & t CO$_2$eq / Million 2011~GK\$ & 0.2\% & 176 \tabularnewline \hline
 \bfseries Population & 2017 & 11.4 & Million Pers & 0.1\% & 79 \tabularnewline 
 \bfseries  & 2030 & 12.1 & Million Pers & 0.1\% & 85 \tabularnewline \hline
 \bfseries Emissions & 2017 & 10.2 & t CO$_2$eq /  Pers & 0.7\% & 39 \tabularnewline 
 \bfseries per capita & 2030 & 9.9 & t CO$_2$eq /  Pers & 0.7\% & 44 \tabularnewline 
 \end{tabular}
 \end{table}

 For Belgium, in 2017 the main emissions share on sectoral level (Fig.~\ref{fig:tsEmi}) came from the Energy sector (72.3\%), followed by IPPU (17.5\%)
 The Kyoto~GHG with the highest emissions in 2017 was CO$_2$, constituting as much as 85.1\% of the national emissions. 
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BEL/ts_emi_exclLU_BEL.png}
 ...
 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BEL/ts_gdp_pop_BEL.png}
 ...
 Belgium's population is assumed to grow towards 2050, and the per capita emissions are expected to increase towards 2050. 

 LULUCF emissions data for Belgium are available from the following sources (Fig.~\ref{fig:tsLULUCF}): CRF (2019)~/ 28, CRF (2018)~/ 27, FAO (2019)~/ 28, with the number of available data points in 1990--2017 displayed additionally.
 Based on data from CRF (2019), for the year 2017, LULUCF is estimated to be a net sink of -0.3~Mt CO$_2$eq, which in absolute terms is lower than the non-LULUCF emissions of 116.1~Mt CO$_2$eq.
 The emissions range for CRF (2019) and 1990--2017 is -3.3---0.2~Mt CO$_2$eq.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BEL/ts_emi_onlyLU_BEL.png}
 \caption{Timeseries of emissions from LULUCF (CO$_2$ plus CH$_4$ and N$_2$O) as available from different data-sources. 
 Indicated in pink are the 'chosen' data, as used in our assessment of Belgium's NDC (if needed). 
 ...
 Belgium has an NDC, with a GHG mitigation target of the type RBY (base year target; main target type).
 The reclassified target type equals the main target type.

 \begin{table}[H]
 \centering
 \caption{Information on Belgium's GHG mitigation target(s).}
 \label{tab:mitiTars}
 ...
 As Belgium is part of the NDC by the European Union (28), the coverage of the EU28 NDC is used.

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BEL/ts_pc_cov_BEL.png}
 \caption{Timeseries of Belgium's national emissions (exclLU) and the share of emissions that is assumed to be covered by Belgium's mitigation target.}
 \label{fig:tsPcCov}
 \end{figure}

 \begin{table}[H]\small
 \centering
 \caption{Information on covered sectors and gases as retrieved from NDC and adapted ('Adap.': used to calculate \%cov), and their shares in Belgium's 2017 emissions (exclLU, exclBunkers; total 116.1~Mt CO$_2$eq).
 ...
 \bfseries Energy & \bfseries + & \bfseries + & \bfseries 70.9\% & \bfseries 0.9\% & \bfseries 0.6\% & / & / & / & / & 72.3\% \tabularnewline 
 \bfseries IPPU & \bfseries + & \bfseries + & \bfseries 13.9\% & \bfseries 0.01\% & \bfseries 0.9\% & \bfseries 2.4\% & \bfseries 0.1\% & \bfseries 0.07\% & \bfseries 0.0\% & 17.5\% \tabularnewline 
 \bfseries Agri. & \bfseries + & \bfseries + & \bfseries 0.1\% & \bfseries 5.0\% & \bfseries 3.5\% & / & / & / & / & 8.7\% \tabularnewline 
 \bfseries Waste & \bfseries + & \bfseries + & \bfseries 0.2\% & \bfseries 0.9\% & \bfseries 0.1\% & / & / & / & / & 1.3\% \tabularnewline 
 \bfseries Other & / & \bfseries + & \bfseries / & \bfseries / & \bfseries 0.2\% & / & / & / & / & 0.2\% \tabularnewline \hline
 \bfseries Total &  &  & 85.1\% & 6.9\% & 5.4\% & 2.4\% & 0.1\% & 0.07\% & 0.0\% & 100.0\% \tabularnewline 
 \end{tabular}
 \end{table}

 \begin{figure}[H]
 \centering
 \includegraphics[width=\textwidth]{C:/Users/annikag/primap/ndc_quantifications/latex_files/BEL/ts_ndcs_quantis_BEL.png}
